---
title: Bruke timelister for prosjekter| Microsoft-dokumentasjon
...
1. I øvre høyre hjørne, velger du ikonet **Søk etter side eller en rapport** ![Søk etter side eller rapport](media/ui-search/search_small.png "ikonet Søk etter side eller rapport"), angi **Timelister**, og deretter velger du den beslektede koblingen.
...
1. I øvre høyre hjørne, velger du ikonet **Søk etter side eller en rapport** ![Søk etter side eller rapport](media/ui-search/search_small.png "ikonet Søk etter side eller rapport"), angi **Timelister for leder**, og deretter velger du den beslektede koblingen.
...
1. I øvre høyre hjørne, velger du ikonet **Søk etter side eller en rapport** ![Søk etter side eller rapport](media/ui-search/search_small.png "ikonet Søk etter side eller rapport)"), angi **Timelister for leder** eller **Timelister**, og deretter velger du den beslektede koblingen.
...
1. I øvre høyre hjørne velger du ikonet **Søk etter side eller en rapport** ![Søk etter side eller rapport](media/ui-search/search_small.png "ikonet Søk etter side eller rapport"), angi **Ressurskladd**, og deretter velger du den beslektede koblingen.  
...
1. I øvre høyre hjørne velger du ikonet **Søk etter side eller en rapport** ![Søk etter side eller rapport](media/ui-search/search_small.png "ikonet Søk etter side eller rapport"), angi **Prosjektkladd**, og deretter velger du den beslektede koblingen.  
2. Velg handlingen **Foreslå linjer fra timelister**.  
3. Fyll ut feltene etter behov.  
...
1. I øvre høyre hjørne, velger du ikonet **Søk etter side eller en rapport** ![Søk etter side eller rapport](media/ui-search/search_small.png "ikonet Søk etter side eller rapport"), angi **Flytt timelister til arkiv**, og deretter velger du den beslektede koblingen.  
2. Fyll ut feltene etter behov, og klikk deretter **OK**.  
3. Hvis du vil se gjennom arkiverte timelister, i øvre høyre hjørne velger du ikonet **Søk etter side eller en rapport** ![Søk etter side eller rapport](media/ui-search/search_small.png "ikonet Søk etter side eller rapport)"), angi **Timelistearkiver** eller **Timelistearkiver for leder**, og deretter velger du den beslektede koblingen.
