...
|Pil høyre|Flytte i samme rad til neste handlingsfelt til høyre.| Flytte i samme rad til neste flis til høyre. |Dette gjelder ikke når listen kan redigeres.|
|Pil venstre|Flytte i samme rad til forrige felt til venstre. | Flytte i samme rad til forrige flis til venstre. |Dette gjelder ikke når listen kan redigeres.|
|Startside<br />(Fn + Pil venstre)|Flytte til det første feltet i raden.|Flytte til den første flisen i raden.||
|End<br />(Fn + Pil høyre)|Flytte til det første handlingsfeltet i raden.|Flytte til den siste flisen i raden.||
|En side opp<br />(Fn + Pil opp)|Flytte i samme kolonne til den øverste synlige raden.|Flytte i samme kolonne til den øverste synlige raden.||
|En side ned<br />(Fn + Pil ned)|Flytte i samme kolonne til den nederste synlige raden.|Flytte i samme kolonne til den nederste synlige raden.||
|Enter<br />(Fn + Pil ned)|Åpne posten som er knyttet til dette feltet.|Åpner posten.| Bare aktuelt hvis en kortside er tilknyttet posten.|
|Ctrl+Home<br />(Fn + Ctrl + Pil venstre)|Merke den første raden i listen. Fokus flyttes til det første handlingsfeltet i raden|Flytte til flisen i første rad i listen||
|Ctrl+End<br />(Fn + Ctrl + Pil høyre)|Merke den siste raden i listen. Fokus flyttes til det første handlingsfeltet i raden|Flytte til den første flisen i siste rad i listen||
