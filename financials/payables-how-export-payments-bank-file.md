---
title: Eksportere betalinger til en bankfil| Microsoft-dokumentasjon
description: "Fremgangsmåte: Eksportere betalinger til en bankfil"
...
---
# <a name="how-to-export-payments-to-a-bank-file"></a>Fremgangsmåte: Eksportere betalinger til en bankfil
...
**Merk**: Før du kan eksportere betalingsfiler fra betalingsjournalen, må du angi elektronisk format for bankkontoen som er involvert, og du må aktivere tjenesten bank data konvertering. Hvis du vil ha mer informasjon, kan du se [Opprette bankkonti](bank-how-setup-bank-accounts.md) og [Konfigurere Envestnet Yodlee Bank Feeds](bank-how-setup-bank-data-conversion-service.md). I tillegg må du merke av for **Tillat betalingseksport** i vinduet **Finanskladder**. Hvis du vil ha mer informasjon, kan du se [Arbeide med finanskladder](ui-work-general-journals.md).  
...
3. Fyll ut feltene på betalingskladdelinjene etter behov. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]
    ...
    **Merk**: Hvis du bruker EFT, må du velge enten **Elektronisk betaling** eller **Elektronisk betaling-IAT** i **Bankbetalingstype**-feltet.
...
6. I vinduet **Lagre som** angir du plasseringen som filen som blir eksportert til, og deretter velger du **Lagre**.
    ...
    **Merk**: Hvis du bruker EFT, lagre det resulterende remitteringsskjemaet for leverandører som et Word-dokument, eller velg at det skal sendes direkte til leverandøren via e-post. Betalingene er nå lagt til i vinduet **Generer EFT-fil**, og derfra kan du generere flere betalingsordrer sammen for å spare overføringskostnader. Hvis du vil ha mer informasjon, kan du se følgende trinn.
...
**Forsiktig**: Linjene i den resulterende tbetalingskladden kan ikke posteres, slettes eller annulleres.
...
**Merk**: Vær Eksporterte EFT-filer vises ikke i vinduet **Kredittoverføringsregistre**, og kan ikke eksporteres på nytt.

1. I øvre høyre hjørne, velger du ikonet **Søk etter side eller en rapport** ![Søk etter side eller rapport](media/ui-search/search_small.png "ikonet Søk etter side eller rapport"), angi **Kredittoverføringsregistre**, og deretter velger du den beslektede koblingen.
