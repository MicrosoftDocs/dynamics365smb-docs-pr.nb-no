...
ms.author: edupont
---
# <a name="batch-post-output-and-run-times" />Bokføre avgang og operasjonstid
...
## <a name="to-post-output-quantities-andor-register-run-times-for-one-or-more-production-order-lines" />Slik bokfører du avgangsantall og/eller registrerer kjøretider for en eller flere produksjonsordrelinjer
