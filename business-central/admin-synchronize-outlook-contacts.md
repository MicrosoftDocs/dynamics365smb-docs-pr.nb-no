...
ms.author: bholtorf
---
# <a name="synchronize-contacts-in-business-central-with-contacts-in-microsoft-outlook" />Synkronisere kontakter i Business Central med kontakter i Microsoft Outlook
...
## <a name="set-up-synchronization" />Definere synkronisering
...
### <a name="automate-synchronization" />Automatiser synkronisering
