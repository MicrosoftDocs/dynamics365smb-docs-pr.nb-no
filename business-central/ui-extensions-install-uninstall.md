...
# <a name="install-and-uninstall-extensions-apps-in-business-central"></a><a name="install-and-uninstall-extensions-apps-in-business-central"></a>Installer og avinstaller utvidelser (apper) i Business Central
...
## <a name="install-an-extension"></a><a name="install-an-extension"></a><a name="install"></a>Installere en utvidelse
...
## <a name="set-up-an-app"></a><a name="set-up-an-app"></a>Konfigurere en utvidelse
...
## <a name="upload-a-per-tenant-extension-pte"></a><a name="upload-a-per-tenant-extension-pte"></a>Last opp en per leietaker-utvidelse (PTE)
...
## <a name="uninstall-an-app"></a><a name="uninstall-an-app"></a>Avinstallere en app
