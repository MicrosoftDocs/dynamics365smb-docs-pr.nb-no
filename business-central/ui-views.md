...
ms.author: edupont
---
# <a name="save-and-personalize-list-views"></a><a name="save-and-personalize-list-views"></a><a name="save-and-personalize-list-views"></a>Lagre og tilpasse listevisninger
...
## <a name="to-save-a-view"></a><a name="to-save-a-view"></a><a name="to-save-a-view"></a>Lagre en visning
...
## <a name="to-rename-or-remove-a-view"></a><a name="to-rename-or-remove-a-view"></a><a name="to-rename-or-remove-a-view"></a>Endre navn på eller fjerne en visning
...
## <a name="managing-many-views"></a><a name="managing-many-views"></a><a name="managing-many-views"></a>Behandle mange visninger
