...
ms.author: edupont
---
# <a name="design-details-integration-with-inventory" />Designdetaljer: Integrasjon med lagerbeholdning

Lagerstyring og lagerfunksjoner samhandler med hverandre i vareopptelling og i lagerjustering.  

## <a name="physical-inventory" />Vareopptelling
...
## <a name="warehouse-adjustments-to-the-item-ledger" />Lagerjusteringer i vareposten
