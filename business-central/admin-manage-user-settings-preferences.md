...
ms.author: soalex
---
# <a name="manage-user-settings-and-preferences" />Behandle brukerinnstillinger og innstillinger
...
## <a name="types-of-user-settings" />Typer brukerinnstillinger
...
## <a name="overview-of-all-user-specific-changes" />Oversikt over alle brukerspesifikke endringer
...
## <a name="to-review-or-delete-user-personalizations" />Slik går du gjennom eller sletter brukertilpassinger
