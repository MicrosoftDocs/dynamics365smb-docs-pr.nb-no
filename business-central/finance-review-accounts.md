...
# <a name="review-amounts-in-general-ledger-accounts" />Gå gjennom beløp i finanskontoer
...
## <a name="set-up-accounts-for-reviews" />Definer kontoer for gjennomganger
...
## <a name="mark-entries-as-reviewed" />Merk oppføringer som gjennomgått
...
## <a name="review-accounts-that-have-old-entries" />Gå gjennom kontoer som har gamle oppføringer
...
## <a name="filter-entries" />Filtrer oppføringer
...
## <a name="analyze-entries" />Analyser oppføringer
