...
# <a name="set-up-service-contracts" />Definere servicekontrakter
...
## <a name="to-set-up-a-service-contract-group" />Slik definerer du servicekontraktgrupper
...
## <a name="to-set-up-a-service-contract-account-group" />Slik definerer du kontogrupper for servicekontrakter
...
## <a name="to-set-up-a-contract-template" />Slik definerer du kontraktmaler
...
## <a name="to-set-up-a-customer-template" />Slik definerer du kundemaler
