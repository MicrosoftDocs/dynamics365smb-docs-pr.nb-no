...
# <a name="report-vat-to-tax-authorities" />Rapportere mva til skattemyndighetene
...
### <a name="submit-an-ec-sales-list-report" />Send rapporten EU-salg – oversikt
...
## <a name="to-connect-to-your-tax-authoritys-web-service" />Koble til webtjenesten til skattemyndigheten
...
### <a name="to-set-up-vat-return-periods" />Slik definerer du mva-returperioder
...
## <a name="to-prepare-and-submit-a-vat-report" />Slik forbereder du og sender inn en omsetningsoppgave
...
### <a name="vat-return-statuses" />Mva-returstatuser
...
## <a name="viewing-communications-with-your-tax-authority" />Vise kommunikasjon med skattemyndigheten
...
## <a name="submitting-vat-reports-manually" />Sende inn mva-rapporter manuelt
...
## <a name="vat-settlement" />Mva-oppgjør
...
## <a name="configuring-your-own-vat-reports" />Konfigurere dine egne mva-rapporter
