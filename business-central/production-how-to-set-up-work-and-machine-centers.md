...
ms.author: edupont
---
# <a name="set-up-work-centers-and-machine-centers" />Konfigurere arbeidssentre og produksjonsressurser
...
## <a name="to-set-up-a-work-center" />Slik oppretter du et arbeidssenter:
...
## <a name="considerations-about-capacity" />Hensyn til kapasiteten
...
### <a name="setup-time" />Oppstillingstid
...
### <a name="work-center-processing-multiple-orders-simultaneously" />Arbeidssenter behandler flere ordrer samtidig
...
### <a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work" />Effektiv ressurs kan bare dedikere en del av arbeidsdatoen til produktivarbeid
...
### <a name="consolidated-calendar" />Konsolidert kalender
...
### <a name="example---different-machine-centers-assigned-to-a-work-center" />Eksempel – forskjellige produksjonsressurser tilordnet til et arbeidssenter
...
## <a name="to-set-up-a-capacity-constrained-machine-or-work-center" />Slik definerer du kapasitetsbegrensede maskiner eller arbeidssentre:
