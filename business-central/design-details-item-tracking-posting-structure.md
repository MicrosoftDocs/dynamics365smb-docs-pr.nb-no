...
ms.author: edupont
---
# <a name="design-details-item-tracking-posting-structure" />Designdetaljer: Bokføringsstruktur for varesporing
...
## <a name="one-to-many-relation" />Én-til-mange-relasjon
...
## <a name="codeunits-80-and-90" />Kodeenhet 80 og 90
...
## <a name="posting-the-item-journal" />Bokføre varekladden
...
## <a name="code-unit-22" />Kodeenhet 22
