...
ms.author: edupont
---
# <a name="batch-post-production-consumption" />Massebokføre produksjonsforbruk
...
## <a name="to-post-consumption-for-one-or-more-production-order-lines" />Slik bokfører du forbruk for en eller flere produksjonsordrelinjer
