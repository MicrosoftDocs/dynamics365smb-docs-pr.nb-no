...
## <a name="monitor-sensitive-fields"></a>Overvåke sensitive felt
...
### <a name="set-up-field-monitoring"></a>Sette opp feltovervåking
...
### <a name="view-field-monitoring-telemetry"></a>Vise telemetri for feltovervåking
