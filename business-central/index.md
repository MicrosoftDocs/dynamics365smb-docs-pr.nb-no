...
Hvis du allerede har [!INCLUDE[prod_short](includes/prod_short.md)], kan du logge på [https://businesscentral.dynamics.com](https://businesscentral.dynamics.com). Hvis ikke [henter du oversikten](https://dynamics.microsoft.com/business-central/overview/), [tar den veiledende gjennomgangen](https://dynamics.microsoft.com/en-us/guidedtour/dynamics/business-central/1/1) og [starter en gratis prøveversjon](https://go.microsoft.com/fwlink/?linkid=847861). Hvis du vil ha mer informasjon om hvordan du registrerer deg for [!INCLUDE[prod_short](includes/prod_short.md)], kan du se [Komme i gang med [!INCLUDE[prod_long](includes/prod_long.md)]](product-get-started.md).  

> [!TIP]
> Kom du hit fra [!INCLUDE [prod_short](includes/prod_short.md)]? Hvis du ikke er sikker på hvor du finner det du leter etter, kan du *filtrere etter titler* i navigasjonsruten til venstre, eller du kan bruke **Søke**-feltet øverst i nettleservinduet.
...
- [Microsoft Dynamics 365-lanseringsplaner](https://go.microsoft.com/fwlink/?linkid=2047422)
