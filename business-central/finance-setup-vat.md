...
## Definer mva. ved å bruke den assisterte veiledningen for oppsett (anbefalt)
...
### Aktivere eller deaktivere funksjonen Mva-dato
...
2.  **Åpne finanskontoen kort**  for kontoen.  
...
2. Gjør ett av følgende:  
    ...
    * Utvid **hurtigfanen** Pris og bokføring på Vare **kort og velg** deretter Vis mer **for å vise** feltet Mva-bokføringsgruppe **for** vare.  
...
2. I kolonnen **mva-beskrivelse Kode** velger du klausulen som skal brukes for hvert mva-bokføringsoppsett den gjelder.  
...
## Bruk omvendt belastet mva for handel mellom EU-land/-områder
...
[Kontrollere organisasjonsnumre](finance-how-validate-vat-registration-number.md)    
[Lokal funksjonalitet i Business Central](about-localization.md)    
[Mva-rapportering i tysk versjon](LocalFunctionality/Germany/vat-reporting.md)    
[Belgisk moms](LocalFunctionality/Belgium/belgian-vat.md)    
[Italiensk moms](LocalFunctionality/Italy/italian-vat.md)    
[Definere elektroniske mva- og ICP-deklarasjoner i den nederlandske versjonen](LocalFunctionality/Netherlands/how-to-set-up-electronic-vat-and-icp-declarations.md)    
[Mva-rapporter i den spanske versjonen](LocalFunctionality/Spain/vat-reports.md)    
[Definere mva-bokføring for varer og tjenester i den australske versjonen](LocalFunctionality/Australia/how-to-set-up-goods-and-service-tax-posting.md)    
[MVA i den tsjekkiske versjonen](LocalFunctionality/Czech/finance-vat.md)    
[Mva-rapportering i norsk versjon](LocalFunctionality/Norway/norwegian-vat-reporting.md)    
