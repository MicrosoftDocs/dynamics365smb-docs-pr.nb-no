...
ms.author: edupont
---
# <a name="design-details-revaluation" />Designdetaljer: Revaluering
...
## <a name="calculating-the-revaluable-quantity" />Beregne antall som kan revalueres
...
## <a name="expected-cost-in-revaluation" />Forventet kostnad i revaluering
...
## <a name="determining-whether-an-inventory-decrease-is-affected-by-revaluation" />Fastslå om en lagerreduksjon påvirkes av revaluering
...
## <a name="wip-inventory-revaluation" />Revaluering av VIA-beholdning
