...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-automatically" />Gjennomgang: planlegge forsyninger automatisk
...
### <a name="to-create-stockkeeping-units" />Slik oppretter du lagerføringsenheter
...
### <a name="to-change-selected-planning-parameters" />Slik endrer du valgte planleggingsparametre:
...
## <a name="creating-a-regenerative-supply-plan" />Opprette en replanlegging for forsyning
...
### <a name="to-create-the-sales-order" />Slik oppretter du ordren
...
### <a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east" />Slik oppretter du en ny planlegging for å dekke behovet i ØST
...
### <a name="to-calculate-mrp-to-include-underlying-component-needs" />Slik beregner du MRP for å inkludere underliggende komponentbehov:
...
## <a name="analyzing-the-planning-result" />Analysere planleggingsresultatet
...
### <a name="to-check-the-planning-parameter" />Slik kontrollerer du planleggingsparameteren:
...
### <a name="to-view-more-order-tracking-entries" />Slik viser du flere ordresporingsposter:
...
## <a name="carrying-out-action-messages" />Utføre handlingsmeldinger
...
### <a name="to-automatically-create-the-suggested-supply-orders" />Slik oppretter du de foreslåtte forsyningsordrene automatisk:
...
## <a name="creating-a-net-change-plan" />Opprette en bevegelsesplan
...
### <a name="to-create-the-new-sales-demand-and-replan-accordingly" />Slik oppretter du det nye salgsbehovet og planlegger på nytt i henhold til dette
...
## <a name="analyzing-the-changed-planning-result" />Analysere det endrede planleggingsresultatet
...
### <a name="to-view-an-existing-order" />Slik viser du en eksisterende ordre:
