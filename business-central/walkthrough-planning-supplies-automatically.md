...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-automatically"></a><a name="walkthrough-planning-supplies-automatically"></a>Gjennomgang: planlegge forsyninger automatisk
...
### <a name="to-create-stockkeeping-units"></a><a name="to-create-stockkeeping-units"></a>Slik oppretter du lagerføringsenheter
...
### <a name="to-change-selected-planning-parameters"></a><a name="to-change-selected-planning-parameters"></a>Slik endrer du valgte planleggingsparametre:
...
## <a name="creating-a-regenerative-supply-plan"></a><a name="creating-a-regenerative-supply-plan"></a>Opprette en replanlegging for forsyning
...
### <a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east"></a><a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east"></a>Slik oppretter du en ny planlegging for å dekke behovet i ØST
...
### <a name="to-calculate-mrp-to-include-underlying-component-needs"></a><a name="to-calculate-mrp-to-include-underlying-component-needs"></a>Slik beregner du MRP for å inkludere underliggende komponentbehov:
...
## <a name="analyzing-the-planning-result"></a><a name="analyzing-the-planning-result"></a>Analysere planleggingsresultatet
...
### <a name="to-view-order-tracking-entries-for-item-1300"></a><a name="to-view-order-tracking-entries-for-item-1300"></a>Slik viser du ordresporingsposter for element 1300:
...
### <a name="to-check-the-planning-parameter"></a><a name="to-check-the-planning-parameter"></a>Slik kontrollerer du planleggingsparameteren:
...
### <a name="to-view-more-order-tracking-entries"></a><a name="to-view-more-order-tracking-entries"></a>Slik viser du flere ordresporingsposter:
...
## <a name="carrying-out-action-messages"></a><a name="carrying-out-action-messages"></a>Utføre handlingsmeldinger
...
### <a name="to-automatically-create-the-suggested-supply-orders"></a><a name="to-automatically-create-the-suggested-supply-orders"></a>Slik oppretter du de foreslåtte forsyningsordrene automatisk:
...
## <a name="creating-a-net-change-plan"></a><a name="creating-a-net-change-plan"></a>Opprette en bevegelsesplan
...
### <a name="to-create-the-new-sales-demand-and-replan-accordingly"></a><a name="to-create-the-new-sales-demand-and-replan-accordingly"></a>Slik oppretter du det nye salgsbehovet og planlegger på nytt i henhold til dette
...
## <a name="analyzing-the-changed-planning-result"></a><a name="analyzing-the-changed-planning-result"></a>Analysere det endrede planleggingsresultatet
...
### <a name="to-view-order-tracking-entries-for-item-1250"></a><a name="to-view-order-tracking-entries-for-item-1250"></a>Slik viser du ordresporingsposter for element 1250:
...
### <a name="to-view-an-existing-order"></a><a name="to-view-an-existing-order"></a>Slik viser du en eksisterende ordre:
