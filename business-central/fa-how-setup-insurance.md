...
ms.author: edupont
---
# <a name="set-up-fixed-asset-insurance" />Definere aktivaforsikring
...
## <a name="to-set-up-general-insurance-information" />Slik definerer du generelle forsikringsopplysninger
...
## <a name="to-set-up-insurance-types" />Slik definerer du forsikringstyper
...
## <a name="to-set-up-insurance-cards" />Slik definerer du forsikringskort
...
## <a name="to-set-up-insurance-journal-templates" />Slik definerer du forsikringskladdemaler
...
## <a name="to-set-up-insurance-journal-batches" />Slik definerer du forsikringskladder
