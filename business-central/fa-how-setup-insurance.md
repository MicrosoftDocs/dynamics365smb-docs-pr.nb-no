...
ms.author: edupont
---
# <a name="set-up-fixed-asset-insurance"></a><a name="set-up-fixed-asset-insurance"></a>Definere aktivaforsikring
...
## <a name="to-set-up-general-insurance-information"></a><a name="to-set-up-general-insurance-information"></a>Slik definerer du generelle forsikringsopplysninger
...
## <a name="to-set-up-insurance-types"></a><a name="to-set-up-insurance-types"></a>Slik definerer du forsikringstyper
...
## <a name="to-set-up-insurance-cards"></a><a name="to-set-up-insurance-cards"></a>Slik definerer du forsikringskort
...
## <a name="to-set-up-insurance-journal-templates"></a><a name="to-set-up-insurance-journal-templates"></a>Slik definerer du forsikringskladdemaler
...
## <a name="to-set-up-insurance-journal-batches"></a><a name="to-set-up-insurance-journal-batches"></a>Slik definerer du forsikringskladder
