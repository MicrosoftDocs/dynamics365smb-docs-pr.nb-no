...
ms.author: edupont
---
# <a name="walkthrough-receiving-and-putting-away-in-advanced-warehouse-configurations"></a><a name="walkthrough-receiving-and-putting-away-in-advanced-warehouse-configurations"></a><a name="walkthrough-receiving-and-putting-away-in-advanced-warehouse-configurations"></a>Gjennomgang: Mottak og plassering i avansert lageroppsett
...
## <a name="reviewing-the-white-location-setup"></a><a name="reviewing-the-white-location-setup"></a><a name="reviewing-the-white-location-setup"></a>Se gjennom lokasjonsoppsettet KR.SAND

Oppsettet av siden **Lokasjonskort** definerer selskapets lagerflyter.  

### <a name="to-review-the-location-setup"></a><a name="to-review-the-location-setup"></a><a name="to-review-the-location-setup"></a>Slik går du gjennom lokasjonsoppsettet
...
## <a name="creating-the-purchase-orders"></a><a name="creating-the-purchase-orders"></a><a name="creating-the-purchase-orders"></a>Opprette bestillingene

Bestillinger er den vanligste typen inngående kildedokument.  

### <a name="to-create-the-purchase-orders"></a><a name="to-create-the-purchase-orders"></a><a name="to-create-the-purchase-orders"></a>Slik oppretter du bestillinger
...
## <a name="receiving-the-items"></a><a name="receiving-the-items"></a><a name="receiving-the-items"></a>Motta varene

På siden **Lagermottak** kan du håndtere flere inngående ordrer for kildedokumenter, for eksempel en bestilling.  

### <a name="to-receive-the-items"></a><a name="to-receive-the-items"></a><a name="to-receive-the-items"></a>Slik mottar du varer
...
## <a name="putting-the-items-away"></a><a name="putting-the-items-away"></a><a name="putting-the-items-away"></a>Plassere varene
...
### <a name="to-put-the-items-away"></a><a name="to-put-the-items-away"></a><a name="to-put-the-items-away"></a>Slik plasserer du varene
