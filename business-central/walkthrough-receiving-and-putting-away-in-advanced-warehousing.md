...
ms.author: edupont
---
# <a name="walkthrough-receiving-and-putting-away-in-advanced-warehouse-configurations" />Gjennomgang: Mottak og plassering i avansert lageroppsett
...
## <a name="reviewing-the-white-location-setup" />Se gjennom lokasjonsoppsettet KR.SAND

Oppsettet av siden **Lokasjonskort** definerer selskapets lagerflyter.  

### <a name="to-review-the-location-setup" />Slik går du gjennom lokasjonsoppsettet
...
## <a name="creating-the-purchase-orders" />Opprette bestillingene

Bestillinger er den vanligste typen inngående kildedokument.  

### <a name="to-create-the-purchase-orders" />Slik oppretter du bestillinger
...
## <a name="putting-the-items-away" />Plassere varene
...
### <a name="to-put-the-items-away" />Slik plasserer du varene
