...
ms.author: edupont
---
# <a name="analyze-data-by-dimensions" />Analysere data etter dimensjoner
...
## <a name="set-up-an-analysis-view" />Sette opp en analysevisning
...
## <a name="analyze-by-dimensions" />Analysere etter dimensjoner
...
## <a name="update-an-analysis-view" />Oppdatere en analysevisning
...
## <a name="see-related-training-at-microsoft-learnlearnmodulesdimensions-financial-reports-dynamics-365-business-centralindex" />Se relatert opplæring på [Microsoft Learn](/learn/modules/dimensions-financial-reports-dynamics-365-business-central/index).
