...
ms.author: edupont
---
# <a name="set-up-finance-charge-terms" />Definer rentenotabetingelser
...
## <a name="finance-charge-terms" />Rentenotabetingelser
...
### <a name="to-set-up-finance-charge-terms" />Definere rentenotabetingelser
...
## <a name="see-related-microsoft-training" />Se relatert [Microsoft-opplæring](/training/modules/send-memos-dynamics-365-business-central/)
