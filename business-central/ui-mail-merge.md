...
# <a name="use-word-templates-for-bulk-communication"></a><a name="use-word-templates-for-bulk-communication"></a>Bruk Word-maler til massekommunikasjon
...
## <a name="set-up-the-source-of-data"></a><a name="set-up-the-source-of-data"></a>Sett opp datakilden
...
## <a name="add-entries-that-are-related-or-unrelated-to-the-source-entity"></a><a name="add-entries-that-are-related-or-unrelated-to-the-source-entity"></a>Legg til poster som er relatert til eller ikke relatert til kildeenheten
...
### <a name="select-the-fields-to-include"></a><a name="select-the-fields-to-include"></a>Velg feltene som skal inkluderes
...
## <a name="to-create-a-word-template-in-business-central"></a><a name="to-create-a-word-template-in-business-central"></a>Slik oppretter du en Word-mal i Business Central
...
## <a name="set-up-the-template-in-word"></a><a name="set-up-the-template-in-word"></a>Definer malen i Word
...
## <a name="apply-a-template"></a><a name="apply-a-template"></a>Bruk en mal
...
## <a name="use-word-templates-with-email"></a><a name="use-word-templates-with-email"></a>Bruk Word-maler med e-post
...
## <a name="edit-a-word-template"></a><a name="edit-a-word-template"></a>Rediger en Word-mal
