...
ms.author: edupont
---
# <a name="set-up-work-hours-and-service-hours" />Konfigurere arbeidstimer og servicetimer
...
## <a name="to-set-up-default-service-hours" />Slik definerer du Standard servicetimer
...
## <a name="to-set-up-work-hour-templates" />Definere arbeidstidsmaler
...
## <a name="to-set-up-contract-specific-service-hours" />Slik definerer du kontraktsspesifikke servicetimer
