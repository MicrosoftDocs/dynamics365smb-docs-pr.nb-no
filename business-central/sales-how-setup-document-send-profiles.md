...
ms.author: edupont
---
# <a name="set-up-document-sending-profiles"></a><a name="set-up-document-sending-profiles"></a>Definere en profil for dokumentsending
...
## <a name="to-set-up-a-document-sending-profile"></a><a name="to-set-up-a-document-sending-profile"></a>Slik definerer du en profil for dokumentsending:
...
## <a name="to-specify-a-sending-profile-on-a-customer-card"></a><a name="to-specify-a-sending-profile-on-a-customer-card"></a>Slik angir du en sendingsprofil på et kundekort:
