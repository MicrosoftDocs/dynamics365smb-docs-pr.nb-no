...
ms.author: edupont
---
# <a name="set-up-document-sending-profiles" />Definere en profil for dokumentsending
...
## <a name="to-set-up-a-document-sending-profile" />Slik definerer du en profil for dokumentsending:
...
## <a name="to-specify-a-sending-profile-on-a-customer-card" />Slik angir du en sendingsprofil på et kundekort:
