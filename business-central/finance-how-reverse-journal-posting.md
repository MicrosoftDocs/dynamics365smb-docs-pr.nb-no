...
---
# <a name="reverse-journal-postings-and-undo-receiptsshipments" />Tilbakeføre kladdebokføringer og angre mottak/leveringer
...
## <a name="to-reverse-the-journal-posting-of-a-general-ledger-entry" />Tilbakeføre kladdebokføring av en finanspost
...
## <a name="to-post-a-negative-entry" />Bokføre en negativ post
...
## <a name="to-undo-a-quantity-on-a-posted-purchase-receipt" />Slik angrer du et antall på bokførte kjøpsmottak
...
## <a name="to-undo-and-then-redo-a-quantity-posting-on-a-posted-return-shipment" />Slik angrer du og gjør om en antallsbokføring på en bokført returforsendelse
