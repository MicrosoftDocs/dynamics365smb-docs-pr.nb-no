...
# <a name="manage-work-across-multiple-companies-in-the-company-hub"></a><a name="manage-work-across-multiple-companies-in-the-company-hub"></a>Administrere arbeid på tvers av flere selskaper i selskapshuben
...
## <a name="company-hub-home-page"></a><a name="company-hub-home-page"></a>Hjemmeside for selskapshub
...
## <a name="assigned-tasks"></a><a name="assigned-tasks"></a>Tilordnede oppgaver
...
### <a name="my-user-tasks"></a><a name="my-user-tasks"></a>Mine brukeroppgaver
...
## <a name="access-the-company-hub"></a><a name="access-the-company-hub"></a>Tilgang til selskapshuben
...
## <a name="set-up-the-company-hub"></a><a name="set-up-the-company-hub"></a>Konfigurere selskapshuben
