...
ms.author: edupont
---
# <a name="update-standard-costs"></a><a name="update-standard-costs"></a><a name="update-standard-costs"></a>Oppdatere standardkost
...
## <a name="to-update-standard-costs"></a><a name="to-update-standard-costs"></a><a name="to-update-standard-costs"></a>Slik oppdaterer du standardkost
