...
ms.author: edupont
---
# <a name="receive-and-convert-electronic-documents" />Motta og konvertere elektroniske dokumenter
...
### <a name="to-receive-and-convert-an-electronic-invoice-to-a-purchase-invoice" />Slik mottar og konverterer du en elektronisk faktura til en kjøpsfaktura
