...
### <a name="create-an-admin-role-group" />Opprett en administratorrollegruppe
...
### <a name="create-a-new-public-folder-mailbox" />Opprett en ny postboks for fellesmapper
...
### <a name="create-new-public-folders" />Opprette nye fellesmapper
...
### <a name="set-public-folder-ownership" />Angi eierskap for fellesmappe
...
### <a name="mail-enable-the-queue-public-folder" />Aktiver e-post for fellesmappen *Kø*
...
### <a name="mail-enable-sending-emails-to-the-queue-public-folder" />Aktiver sending av e-post til fellesmappen *Kø*
