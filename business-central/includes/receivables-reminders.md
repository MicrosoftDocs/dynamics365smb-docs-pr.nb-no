...
### <a name="to-create-a-reminder-automatically"></a><a name="to-create-a-reminder-automatically"></a>Slik oppretter du en purring automatisk
...
### <a name="to-create-a-reminder-manually"></a><a name="to-create-a-reminder-manually"></a>Slik oppretter du en purring manuelt
...
### <a name="to-replace-reminder-texts"></a><a name="to-replace-reminder-texts"></a>Slik erstatter du purretekst
...
### <a name="to-issue-a-reminder"></a><a name="to-issue-a-reminder"></a>Utstede en purring
...
### <a name="to-cancel-an-issued-reminder"></a><a name="to-cancel-an-issued-reminder"></a>Avbryte den utstedte purringen
