...
### <a name="to-create-a-reminder-automatically" />Slik oppretter du en purring automatisk
...
### <a name="to-create-a-reminder-manually" />Slik oppretter du en purring manuelt
...
### <a name="to-replace-reminder-texts" />Slik erstatter du purretekst
...
### <a name="to-issue-a-reminder" />Utstede en purring
...
### <a name="to-cancel-an-issued-reminder" />Avbryte den utstedte purringen
