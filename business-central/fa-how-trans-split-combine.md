...
ms.author: edupont
---
# <a name="transfer-split-or-combine-fixed-assets" />Overføre, dele opp eller kombinere aktiva
...
## <a name="to-transfer-a-fixed-asset-to-a-different-department" />Slik overfører du et aktiva til en annen avdeling:
...
## <a name="to-split-a-fixed-asset-into-three-fixed-assets" />Slik deler du et aktiva inn i tre aktiva:
...
## <a name="to-combine-two-fixed-assets-into-one" />Slik kombinerer du to aktiva til en:
...
## <a name="to-view-changed-depreciation-book-values-due-to-fixed-asset-reclassification" />Slik viser du endret avskrivningstablåverdier på grunn av aktivareklassifisering:
