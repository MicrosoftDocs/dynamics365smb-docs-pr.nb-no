...
---
# Avstemme kundebetalinger med en innbetalingskladd eller fra kundeposter
...
> [!TIP]  
> På siden **Kundeposter** betyr rød skrift at forfallsdatoen for den relaterte betalingen er overskredet. Hvis forfalte betalinger blir et problem, kan vi hjelpe deg med å redusere hyppigheten. Du kan aktivere utvidelsen Oppsett **for** sen betalingsprognose, som bruker en prediktiv modell som vi bygde i Azure Machine Learning for å forutsi tidspunktet for betalinger. Disse forutsigelser hjelper deg med å redusere utestående tilgodehavender og finjustere innkrevingsstrategien. Hvis en betaling er forutsatt å bli sen, kan du justere betalingsbetingelsene eller betalingsmåten for kunden. Hvis du vil ha mer informasjon, kan du se [Forsinkede betalingsprognoser](ui-extensions-late-payment-prediction.md).  

Du kan utligne kundeposter på flere måter:

* Angi informasjon på følgende sider:
   * Siden **Betalingsavstemmingskladder** . Hvis du vil ha mer informasjon, kan du se [Utligne betalinger automatisk og avstemme bankkonti](receivables-apply-payments-auto-reconcile-bank-accounts.md).
   * Siden **Oppsett** av betalingsregistrering. Hvis du vil ha mer informasjon, kan du se [Avstemme kundebetalinger fra en liste over ubetalte salgsdokumenter](receivables-how-reconcile-customer-payments-list-unpaid-sales-documents.md).
   * Siden **Innbetalingskladder** . Hvis du vil ha mer informasjon, kan du se [Fylle ut og bokføre en innbetalingskladd](#to-fill-and-post-a-cash-receipt-journal).
...
8. I kontonummeret **.** -feltet, Velg kunden.
9. Hvis du vil bokføre søknaden samtidig som du bokfører kladden, fyller du ut følgende felt:
   1.  **I feltet Motkontotype** Velg **finanskonto** for kontantbetalinger og **bankkonto** for andre betalinger.
   2. I Motkontonr **.** -feltet, Velg kassakontoen for kontantbetalinger, eller den relevante bankkontoen for andre betalinger.
10. Bokfør kladden.

## Slik utligner du en betaling mot én kundepost

1. Velg ikonet ![Lyspære som åpner funksjonen Fortell meg.](media/ui-search/search_small.png "Fortell hva du vil gjøre") , angi **Innbetalingskladd** og velg det tilknyttede opprette en kobling.
2. Velg handlingen **Rediger kladd**.
...
3. Velg handlingen **Poster** fra Relatert-fanen **·**, og Velg deretter linjen med posten som er den aktuelle posten.
