...
ms.author: edupont
---
# <a name="reconcile-customer-payments-with-the-cash-receipt-journal-or-from-customer-ledger-entries" />Avstem kundebetalinger med innbetalingskladden eller fra kundeposter
...
## <a name="to-fill-and-post-a-cash-receipt-journal" />Fylle ut og bokføre en innbetalingskladd
...
## <a name="to-apply-a-payment-to-a-single-customer-ledger-entry" />Slik utligner du en betaling mot én kundepost
1. Velg ikonet ![Lyspære som åpner funksjonen Fortell meg.](media/ui-search/search_small.png "Fortell hva du vil gjøre") og angi **Innbetalingskladd** og velg den relaterte koblingen.
2. Velg handlingen **Rediger kladd**.
...
## <a name="to-apply-a-payment-to-multiple-customer-ledger-entries" />Slik utligner du en utbetaling mot flere kundeposter
1. Velg ikonet ![Lyspære som åpner funksjonen Fortell meg.](media/ui-search/search_small.png "Fortell hva du vil gjøre") og angi **Innbetalingskladd** og velg den relaterte koblingen.
2. Velg handlingen **Rediger kladd**.
3. På den første kladdelinjen angir du aktuelle opplysninger om posten som skal utlignes.
4. Angi **Betaling** i **Bilagstype**-feltet.
...
## <a name="to-apply-a-credit-memo-to-a-single-customer-ledger-entry" />Slik utligner du en kreditnota mot én kundepost
...
## <a name="to-apply-a-credit-memo-to-multiple-customer-ledger-entries" />Slik utligner du en kreditnota mot flere kundeposter
1. Velg ikonet ![Lyspære som åpner funksjonen Fortell meg.](media/ui-search/search_small.png "Fortell hva du vil gjøre") og angi **Salgskreditnotaer**, og velg deretter den relaterte koblingen.
2. Åpne den aktuelle salgskreditnotaen.
...
## <a name="to-apply-posted-customer-ledger-entries" />Slik utligner du bokførte kundeposter
...
## <a name="to-apply-customer-ledger-entries-in-different-currencies-to-one-another" />Slik utligner du kundeposter i forskjellige valutaer mot hverandre
...
## <a name="to-correct-an-application-of-customer-entries" />Korrigere en utligning av kundeposter
