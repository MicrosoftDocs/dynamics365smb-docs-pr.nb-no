...
---
# <a name="overview-of-ai-powered-item-marketing-text-preview-with-copilot"></a><a name="overview-of-ai-powered-item-marketing-text-preview-with-copilot"></a>Oversikt over varemarkedsføringstekst drevet av kunstig intelligens (forhåndsversjon) med Copilot
...
## <a name="what-is-ai-powered-item-marketing-text-with-copilot"></a><a name="what-is-ai-powered-item-marketing-text-with-copilot"></a>Hva er varemarkedsføringstekst drevet av kunstig intelligens med Copilot
...
## <a name="where-its-used"></a><a name="where-its-used"></a>Hvor det brukes
...
## <a name="why-and-how-to-use-it"></a><a name="why-and-how-to-use-it"></a>Hvorfor og hvordan du bruker den
...
## <a name="current-limitations"></a><a name="current-limitations"></a>Gjeldende begrensninger
