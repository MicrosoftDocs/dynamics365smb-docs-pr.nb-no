...
ms.author: edupont
---
# <a name="track-relations-between-demand-and-supply" />Spore relasjoner mellom behov og forsyning
...
## <a name="to-track-linked-items" />Spore tilknyttede varer
...
## <a name="untracked-planning-elements" />Ikke-sporede planleggingselementer
