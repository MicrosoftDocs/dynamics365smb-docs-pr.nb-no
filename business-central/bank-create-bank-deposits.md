...
# <a name="create-bank-deposits"></a>Opprett bankinnskudd
...
6. Fyll ut feltene som gjenstår, etter behov. [!INCLUDE [tooltip-inline-tip_md](../archive/SetupAndAdministration/includes/tooltip-inline-tip_md.md)]
    ...
    Datoen i **feltet Bokføringsdato** og dimensjonene i feltene **Avdelingskode** og **Kundegruppekode** tilordnes linjene du oppretter for bankinnskuddet. Du kan endre dem ved behov.
