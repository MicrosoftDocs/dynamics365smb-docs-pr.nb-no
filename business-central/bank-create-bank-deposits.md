...
ms.author: bholtorf
---
# <a name="create-bank-deposits" />Opprett bankinnbetalinger
> [!NOTE]
...
### <a name="number-series-and-lump-sum-deposits" />Nummerserie og engangssuminnbetalinger
...
### <a name="general-journal-templates-for-bank-deposits" />Finanskladdemaler for bankinnbetalinger
...
## <a name="dimensions-on-bank-deposit-lines" />Dimensjoner på bankinnbetalingslinjer
...
## <a name="create-a-bank-deposit" />Opprett en ny bankinnbetaling
...
## <a name="finding-posted-bank-deposits" />Finn bokførte bankinnbetalinger
...
## <a name="reversing-a-posted-bank-deposit" />Tilbakefør en bokført bankinnbetaling
