...
ms.author: bholtorf
---
# <a name="create-bank-deposits"></a><a name="create-bank-deposits"></a>Opprett bankinnbetalinger
> [!NOTE]
...
### <a name="number-series-and-lump-sum-deposits"></a><a name="number-series-and-lump-sum-deposits"></a>Nummerserie og engangssuminnbetalinger
...
### <a name="general-journal-templates-for-bank-deposits"></a><a name="general-journal-templates-for-bank-deposits"></a>Finanskladdemaler for bankinnbetalinger
...
## <a name="dimensions-on-bank-deposit-lines"></a><a name="dimensions-on-bank-deposit-lines"></a>Dimensjoner på bankinnbetalingslinjer
...
## <a name="create-a-bank-deposit"></a><a name="create-a-bank-deposit"></a>Opprett en ny bankinnbetaling
...
## <a name="finding-posted-bank-deposits"></a><a name="finding-posted-bank-deposits"></a>Finn bokførte bankinnbetalinger
...
## <a name="reversing-a-posted-bank-deposit"></a><a name="reversing-a-posted-bank-deposit"></a>Tilbakefør en bokført bankinnbetaling
