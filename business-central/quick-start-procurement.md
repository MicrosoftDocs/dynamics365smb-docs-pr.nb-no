...
# <a name="procurement-quick-start" />Hurtigstart for innkjøp
...
## <a name="set-up-vendors" />Definer leverandører
...
### <a name="set-up-a-new-vendor" />Definer en ny leverandør
...
## <a name="create-new-purchase-orders" />Opprett nye bestillinger
...
### <a name="to-create-a-purchase-order" />Slik oppretter du en bestilling
...
## <a name="create-a-purchase-invoice" />Opprett en kjøpsfaktura
...
### <a name="how-to-create-and-post-a-purchase-invoice" />Slik oppretter og bokfører du en kjøpsfaktura
