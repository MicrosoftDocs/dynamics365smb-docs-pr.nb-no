...
ms.author: edupont
---
# <a name="create-bin-contents"></a><a name="create-bin-contents"></a>Opprette hylleinnhold
...
## <a name="to-create-bin-content-manually"></a><a name="to-create-bin-content-manually"></a>Slik oppretter du hylleinnhold manuelt:
...
## <a name="to-create-bin-content-with-a-worksheet"></a><a name="to-create-bin-content-with-a-worksheet"></a>Slik oppretter du hylleinnhold med et forslag:
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/modules/set-up-zones-bins/)
