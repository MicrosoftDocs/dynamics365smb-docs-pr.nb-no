...
ms.author: edupont
---
# <a name="set-up-a-document-exchange-service" />Konfigurere en dokumentutvekslingstjeneste
...
## <a name="connecting-with-trading-partners" />Koble til handelspartnere
...
## <a name="to-connect-to-the-business-central-integration-app-on-tradeshift" />Slik kobler du til Business Central Integration-appen på Tradeshift
...
## <a name="to-connect-to-a-document-exchange-service" />Slik kobler du til en dokumentutvekslingstjeneste
...
## <a name="settings-for-business-central-on-premises" />Innstillinger for Business Central On-Premises
...
## <a name="see-related-microsoft-trainingtrainingmoduleselectronic-documents-dynamics-365-business-central" />Se relatert [Microsoft-opplæring](/training/modules/electronic-documents-dynamics-365-business-central/)
