...
ms.locfileid: "3339949"
---
# <a name="modify-planning-suggestions-in-a-graphical-view"></a><span data-ttu-id="ecaac-104">Endre planleggingsforslag i en grafisk visning</span><span class="sxs-lookup"><span data-stu-id="ecaac-104">Modify Planning Suggestions in a Graphical View</span></span>

<span data-ttu-id="ecaac-105">En typisk planleggingsaktivitet er å endre eller legge til planleggingsforslagslinjer for å endre de foreslåtte forsyningsordrene før du utfører dem, ved å kjøre funksjonen **Utfør handlingsmelding**.</span><span class="sxs-lookup"><span data-stu-id="ecaac-105">A typical planning activity is to change or add planning worksheet lines to modify the suggested supply orders before you commit them by running the **Carry out Action Message** function.</span></span> <span data-ttu-id="ecaac-106">Et alternativ til å gjøre dette i planleggingsforslaget er å bruke en grafisk visning.</span><span class="sxs-lookup"><span data-stu-id="ecaac-106">An alternative to doing this in the planning worksheet is to use a graphical view.</span></span> <span data-ttu-id="ecaac-107">Dette støttes imidlertid ikke i [!INCLUDE [prodshort](includes/prodshort.md)].</span><span class="sxs-lookup"><span data-stu-id="ecaac-107">However, this is currently not supported in [!INCLUDE [prodshort](includes/prodshort.md)].</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="ecaac-108">Se også</span><span class="sxs-lookup"><span data-stu-id="ecaac-108">See Also</span></span>

[<span data-ttu-id="ecaac-109">Planlegging</span><span class="sxs-lookup"><span data-stu-id="ecaac-109">Planning</span></span>](production-planning.md)  
[<span data-ttu-id="ecaac-110">Definere produksjon</span><span class="sxs-lookup"><span data-stu-id="ecaac-110">Setting Up Manufacturing</span></span>](production-configure-production-processes.md)  
[<span data-ttu-id="ecaac-111">Produksjon</span><span class="sxs-lookup"><span data-stu-id="ecaac-111">Manufacturing</span></span>](production-manage-manufacturing.md)  
[<span data-ttu-id="ecaac-112">Lager</span><span class="sxs-lookup"><span data-stu-id="ecaac-112">Inventory</span></span>](inventory-manage-inventory.md)  
[<span data-ttu-id="ecaac-113">Innkjøp</span><span class="sxs-lookup"><span data-stu-id="ecaac-113">Purchasing</span></span>](purchasing-manage-purchasing.md)  
[<span data-ttu-id="ecaac-114">Designdetaljer: Forsyningsplanlegging</span><span class="sxs-lookup"><span data-stu-id="ecaac-114">Design Details: Supply Planning</span></span>](design-details-supply-planning.md)  
[<span data-ttu-id="ecaac-115">Anbefalte fremgangsmåter for oppsett: Forsyningsplanlegging</span><span class="sxs-lookup"><span data-stu-id="ecaac-115">Setup Best Practices: Supply Planning</span></span>](setup-best-practices-supply-planning.md)  
<span data-ttu-id="ecaac-116">[Arbeide med [!INCLUDE[d365fin](includes/d365fin_md.md)]](ui-work-product.md)</span><span class="sxs-lookup"><span data-stu-id="ecaac-116">[Working with [!INCLUDE[d365fin](includes/d365fin_md.md)]](ui-work-product.md)</span></span>
