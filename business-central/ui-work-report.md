...
ms.author: jswymer
---
# <a name="run-and-print-reports" />Kjør og skriv ut rapporter
...
## <a name="a-namesavedsettingsausing-default-valuesmdashpredefined-settings" /><a name="SavedSettings"></a>Bruk standardverdier – forhåndsdefinerte innstillinger
...
## <a name="specifying-the-data-to-include-in-a-report" />Spesifisere dataene som skal inkluderes i en rapport
...
## <a name="previewing-a-report" />Forhåndsvise en rapport
...
### <a name="work-with-the-preview" />Arbeid med forhåndsvisningen
...
## <a name="saving-a-report-to-a-file" />Lagre en rapport i en fil
...
## <a name="a-nameschedulereporta-scheduling-a-report-to-run-later-or-periodically" /><a name="ScheduleReport"></a> Planlegg en rapport for kjøring senere eller regelmessig
...
### <a name="manage-scheduled-recurring-reports" />Administrer planlagte gjentatte rapporter
...
## <a name="a-nameprintreportaprinting-a-report" /><a name="PrintReport"></a>Skriv ut en rapport
...
### <a name="a-nameprinteraprinter" /><a name="Printer"></a>Skriver
...
### <a name="printing-reports-in-thai" />Skrive ut rapporter på thailandsk
...
## <a name="switching-the-report-layout" />Bytt rapportoppsettet
...
## <a name="change-language-and-format-of-numbers-dates-and-times" />Endre språk og format for tall, datoer og klokkeslett
...
## <a name="advanced-options" />Avanserte alternativer
