...
# <a name="keyboard-quick-reference---pc-only"></a><a name="keyboard-quick-reference---pc-only"></a><a name="keyboard-quick-reference---pc-only"></a>Hurtigreferanse for tastatursnarveier – bare PC
...
#### <a name="navigate--select-rows"></a><a name="navigate--select-rows"></a><a name="navigate--select-rows"></a>Navigere og velge rader
...
#### <a name="copy--paste"></a><a name="copy--paste"></a><a name="copy--paste"></a>Kopier og lim inn
...
#### <a name="search-filter--sort"></a><a name="search-filter--sort"></a><a name="search-filter--sort"></a>Søk, filtrer og sorter
...
#### <a name="quick-entry"></a><a name="quick-entry"></a><a name="quick-entry"></a>Hurtigoppføring
...
##### <a name="report-preview"></a><a name="report-preview"></a><a name="report-preview"></a>Forhåndsvisning av rapport
