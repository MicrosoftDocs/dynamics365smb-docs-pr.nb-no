...
# <a name="add-marketing-text-to-items" />Legg til markedsføringstekst i varer
...
### <a name="create-first-draft-with-copilot" />Opprett første utkast med Copilot
...
### <a name="review-edit-and-save-text" />Se gjennom, rediger og lagre teksten
...
### <a name="improve-and-tailor-text-suggestions" />Forbedre og skreddersy tekstforslag
...
## <a name="create-marketing-text-from-scratch" />Opprett markedsføringstekst fra grunnen av
