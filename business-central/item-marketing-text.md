...
# <a name="add-marketing-text-to-items"></a><a name="add-marketing-text-to-items"></a>Legg til markedsføringstekst i varer
...
## <a name="create-ai-generated-marketing-text-preview-with-copilot"></a><a name="create-ai-generated-marketing-text-preview-with-copilot"></a><a name=copilot></a>Opprett markedsføringstekst generert av kunstig intelligens (forhåndsversjon) med Copilot
...
- Attributter som er definert for varen, for eksempel som beskrivelse, farge, dimensjoner, materiale og så videre.
...
### <a name="create-first-draft-with-copilot"></a><a name="create-first-draft-with-copilot"></a>Opprett første utkast med Copilot
...
1. Åpne varen du vil endre, i Business Central. Gjør følgende for å åpne en vare:
   ...
   [![Viser og varekort med ruten Markedsføringstekst](media/create-with-copilot.png)](media/create-with-copilot.png#lightbox)

2. Fra varekortet kan du komme i gang med å skrive markedsføringstekst med Copilot på to måter:

   - En måte er å bruke ruten **Markedsføringstekst** i faktaboksen til høyre på siden. Følg denne fremgangsmåten:
      ...
      2. Hvis du vil ha et annet forslag, velger du **Opprett med Copilot** på nytt. Hvis du ikke liker et forslag, velger du **Lukk** for å tømme ruten.
         ...
         Du kan gjøre dette trinnet flere ganger til du får et forslag du tror er et godt nok utgangspunkt. Husk at det nåværende forslaget overskrives, og at du ikke nødvendigvis får det tilbake. Hvis du liker det nåværende forslaget, går du til neste trinn. Du vil fortsatt ha mulighet til å hente flere forslag, og til og med forbedre forslagene senere hvis du vil.
   ...
   - En annen måte er å velge handlingen **Markedsføringstekst** øverst på varekortsiden for å gå direkte til siden **Opprett med Copilot**.
...
### <a name="review-edit-and-save-text"></a><a name="review-edit-and-save-text"></a>Se gjennom, rediger og lagre teksten
...
3. Hvis du ikke er fornøyd med forslagene, kan du forbedre forslagene basert på innstillingene.
...
### <a name="improve-and-tailor-text-suggestions"></a><a name="improve-and-tailor-text-suggestions"></a>Forbedre og skreddersy tekstforslag
...
## <a name="create-marketing-text-from-scratch"></a><a name="create-marketing-text-from-scratch"></a>Opprett markedsføringstekst fra grunnen av

1. I Business Central åpner du varen du vil endre, slik:

    1. Velg ikonet ![Lyspære som åpner Fortell meg-funksjonen 22.](media/ui-search/search_small.png "Fortell hva du vil gjøre") øverst til høyre og angi **Varer**, og velg deretter relatert kobling for å vise en liste over tilgjengelige varer.
    2. Hvis du vil åpne varen, dobbeltklikker du på den eller velger nummeret i **Nr.** -feltet.
