...
ms.author: solsen
---
# <a name="run-batch-jobs-and-xmlports"></a><a name="run-batch-jobs-and-xmlports"></a>Kjøre satsvise jobber og XML-porter
...
## <a name="to-run-a-batch-job"></a><a name="to-run-a-batch-job"></a>Slik kjører du en satsvis jobb
