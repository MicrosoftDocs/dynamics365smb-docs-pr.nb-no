...
ms.author: jswymer
---
# <a name="entering-data" />Skrive inn data
...
## <a name="work-with-editable-fields" />Arbeid med felter som kan redigeres
...
### <a name="modifying-a-field-value" />Endre en feltverdi
...
### <a name="how-quick-entry-works" />Hvordan Hurtigoppføring fungerer
...
#### <a name="tips-and-tricks" />Tips og triks
...
### <a name="to-change-quick-entry-fields" />Endre Hurtigoppføring-felt
...
## <a name="mandatory-fields" />Obligatoriske felt
...
## <a name="finding-data-as-you-type" />Finne data mens du skriver
...
## <a name="copying-and-pasting-faq-fields-and-lines" />Vanlige spørsmål om kopiere og lime inn felt og linjer
...
## <a name="filtering-line-items" />Filtrere linjeelementer
...
### <a name="switching-the-focus-on-and-off" />Bytte fokus på og av
...
## <a name="multitasking-across-multiple-pages" />Multitaske på tvers av flere sider
...
## <a name="entering-quantities-by-calculation" />Angi antall ved beregning
...
## <a name="entering-negative-numbers" />Skrive inn negative tall
...
## <a name="entering-dates-and-times" />Angi datoer og klokkeslett
...
## <a name="entering-combined-datetimes" />Angi kombinerte datoer og klokkeslett
