...
description: Lære hvordan planlegging bruker behovs- og forsyningsdata til å foreslå hvordan forsyningen balanseres for å dekke behovet.
author: brentholtorf
ms.author: bholtorf
...
- Behov er alle typer bruttobehov, for eksempel en salgsordre, serviceordre eller et komponentbehov for montering eller en produksjonsordre, utgående overføring, rammeordre eller prognose. I tillegg finnes det andre tekniske typer behov, for eksempel negativ produksjon eller bestilling, negativ beholdning og bestillingsretur.  
