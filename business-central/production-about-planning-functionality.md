...
ms.author: bholtorf
---
# <a name="about-planning-functionality" />Om planleggingsfunksjonalitet
...
## <a name="planning-calculation" />Planleggingsberegning
...
## <a name="planning-with-manual-transfer-orders" />Planlegge med manuelle overføringsordrer
...
## <a name="other-important-planning-fields" />Andre viktige felt for planlegging
...
## <a name="planning-worksheets-and-requisition-worksheets" />Planleggingsforslag og bestillingsforslag
...
### <a name="requisition-worksheet" />Bestillingsforslag
...
## <a name="see-related-microsoft-trainingtrainingmodulesplan-items-dynamics--business-central" />Se relatert [Microsoft-opplæring](/training/modules/plan-items-dynamics-365-business-central/)
