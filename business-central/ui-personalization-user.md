...
> [!NOTE]
> Administratorer kan gjøre de samme oppsettendringene som brukere ved å tilpasse en profil (rolle), som kan tilordnes til flere brukere. Hvis du vil vite mer om sider for roller, går du til [Tilpass sider for roller](ui-personalization-manage.md)<br /><br />
...
## <a name="video-and-training"></a>Video og opplæring

Følgende video viser noen av måtene du kan tilpasse rollesenteret på.

> [!Video https://www.microsoft.com/en-us/videoplayer/embed/RE4ArUB?rel=0]

Hvis du vil ha elektronisk opplæring, kan du gå til [Tilpasse Microsoft-brukergrensesnittet Dynamics 365 Business Central](/training/modules/personalize-ui-dynamics-365-business-central/).
