...
ms.author: bholtorf
---
# <a name="personalize-your-workspace"></a><a name="personalize-your-workspace"></a><a name="personalize-your-workspace"></a>Tilpasse arbeidsområdet
...
## <a name="to-change-the-width-of-a-column"></a><a name="to-change-the-width-of-a-column"></a><a name="to-change-the-width-of-a-column"></a>Endre kolonnebredden
...
## <a name="to-start-personalizing-a-page-through-the-personalizing-banner"></a><a name="to-start-personalizing-a-page-through-the-personalizing-banner"></a><a name="to-start-personalizing-a-page-through-the-personalizing-banner"></a>Slik tilpasser du en side med **Tilpasse**-banneret
...
## <a name="what-you-can-personalize"></a><a name="what-you-can-personalize"></a><a name="what-you-can-personalize"></a><a name="What"></a>Hva du kan tilpasse
...
## <a name="personalizing-the-action-bar-and-menus"></a><a name="personalizing-the-action-bar-and-menus"></a><a name="personalizing-the-action-bar-and-menus"></a><a name="Actions"></a>Tilpass handlingsraden og menyene
...
### <a name="to-remove-hide-and-show-actions-and-action-groups"></a><a name="to-remove-hide-and-show-actions-and-action-groups"></a><a name="to-remove-hide-and-show-actions-and-action-groups"></a>Fjerne, skjule og vise handlinger og handlingsgrupper
...
### <a name="to-move-actions-and-action-groups"></a><a name="to-move-actions-and-action-groups"></a><a name="to-move-actions-and-action-groups"></a>Flytte handlinger og handlingsgrupper
...
## <a name="personalizing-parts"></a><a name="personalizing-parts"></a><a name="personalizing-parts"></a><a name="Parts"></a>Tilpasse deler
...
## <a name="to-clear-personalization"></a><a name="to-clear-personalization"></a><a name="to-clear-personalization"></a>Fjerne tilpassing
...
## <a name="other-points-of-interest"></a><a name="other-points-of-interest"></a><a name="other-points-of-interest"></a>Andre interessepunkter
