...
ms.author: bholtorf
---
# <a name="personalize-your-workspace" />Tilpasse arbeidsområdet
...
## <a name="to-change-the-width-of-a-column" />Endre kolonnebredden
...
## <a name="to-start-personalizing-a-page-through-the-personalizing-banner" />Slik tilpasser du en side med **Tilpasse**-banneret
...
### <a name="to-remove-hide-and-show-actions-and-action-groups" />Fjerne, skjule og vise handlinger og handlingsgrupper
...
### <a name="to-move-actions-and-action-groups" />Flytte handlinger og handlingsgrupper
...
## <a name="to-clear-personalization" />Fjerne tilpassing
...
## <a name="other-points-of-interest" />Andre interessepunkter
...
## <a name="see-related-microsoft-trainingtrainingmodulespersonalize-ui-dynamics--business-centralindex" />Se relatert [Microsoft-opplæring](/training/modules/personalize-ui-dynamics-365-business-central/index)
