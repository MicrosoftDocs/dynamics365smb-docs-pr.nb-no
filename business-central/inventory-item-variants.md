...
1. Åpne [siden **Varelister**](https://businesscentral.dynamics.com/?page=31), og åpne deretter den relevante varen.  
2. På siden **Varekort** velger du handlingen **Varianter**.  
