...
## <a name="creating-and-posting-a-project-sales-invoice"></a>Opprette og bokføre en prosjektsalgsfaktura
...
### <a name="to-create-a-project-sales-invoice"></a>Slik oppretter du en prosjektsalgsfaktura:
