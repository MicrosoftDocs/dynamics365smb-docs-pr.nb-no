...
## <a name="minimum-permissions-for-user-accounts-in-includecrmmdincludescrmmdmd"></a>Minimumstillatelser for brukerkontoer i [!INCLUDE[crm_md](includes/crm_md.md)]
