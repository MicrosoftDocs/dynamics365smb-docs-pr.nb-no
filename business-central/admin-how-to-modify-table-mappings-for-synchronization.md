...
### Håndtere forskjeller i feltverdier
...
### Håndtere manglende alternativverdier i Tilordning
...
#### Filtrere poster eller rader for synkronisering  
...
## Bruk konfigurasjonsmaler på tabelltilordninger
...
-   **CDSCUST** brukes til å opprette og synkronisere nye kunder i [!INCLUDE[prod_short](includes/prod_short.md)] basert på en konto i [!INCLUDE[crm_md](includes/crm_md.md)].  
