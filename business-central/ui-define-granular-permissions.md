---
title: Definer detaljerte tillatelser
...
# <a name="assign-permissions-to-users-and-groups"></a>Tildel tillatelser til brukere og grupper
...
## <a name="create-a-permission-set"></a>Opprett et tillatelsessett
...
5. På siden **Tillatelsessett** tar du med eller utelater tillatelsene for objektet i **Type**-feltet som følger:
  ...
  |Alternativ|Beskrivelse|Rangering|
  |------|-----------|-------|
...
## <a name="copy-a-permission-set"></a>Kopier et tillatelsessett
...
## <a name="create-or-modify-permissions-by-recording-your-actions"></a>Opprett eller endre tillatelser ved å angi registrere handlingene
...
## <a name="remove-obsolete-permissions-from-all-permission-sets"></a>Fjern foreldede tillatelser fra alle tillatelsessett

På siden **Tillatelsessett** velger du handlingen **fjern foreldede tillatelsessett**.

## <a name="set-up-time-constraints-for-users"></a>Definer tidsbegrensninger for brukere
...
## <a name="control-access-to-specific-companies"></a>Kontroller tilgangen til bestemte selskaper
...
## <a name="manage-permissions-through-user-groups"></a>Administrer tillatelser ved hjelp av brukergrupper
...
## <a name="assign-permission-sets-to-users"></a>Tildel tillatelsessett til brukere
...
## <a name="get-an-overview-of-a-users-permissions"></a>Få en oversikt over en brukers tillatelser
...
## <a name="view-permission-changes-telemetry"></a>Vis telemetri ved tillatelsesendringer
