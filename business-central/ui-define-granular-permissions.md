...
# <a name="assign-permissions-to-users-and-groups" />Tilordne tillatelser til brukere og grupper
...
## <a name="to-create-a-permission-set" />Slik oppretter du et tillatelsessett
...
### <a name="example---indirect-permission" />Eksempel - indirekte tillatelse
...
### <a name="to-add-other-permission-sets" />Slik legger du til tillatelsessett
...
## <a name="to-copy-a-permission-set" />Slik kopiere du et tillatelsessett
...
## <a name="to-create-or-modify-permissions-by-recording-your-actions" />Slik oppretter eller endrer du tillatelser ved å angi registrere handlingene
...
### <a name="to-export-and-import-a-permission-set" />Slik eksporterer og importerer du et tillatelsessett
...
## <a name="to-remove-obsolete-permissions-from-all-permission-sets" />Slik fjerner du foreldede tillatelser fra alle tillatelsessett

På siden **Tillatelsessett** velger du handlingen **fjern foreldede tillatelsessett**.

## <a name="to-set-up-time-constraints-for-users" />Slik definerer du tidsbegrensninger for brukere
...
## <a name="to-manage-permissions-through-user-groups" />Slik behandler du tillatelser ved hjelp av brukergrupper
...
### <a name="to-add-users-to-a-user-group" />Slik legger du til brukere i en brukergruppe
...
### <a name="to-copy-a-user-group-and-all-its-permission-sets" />Slik kopierer du en brukergruppe og alle tillatelsessettene
...
### <a name="to-assign-permission-sets-to-user-groups" />Slik tilordner du tillatelsessett til brukergrupper
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-group-page" />Slik tilordner du et tillatelsessett på siden **Tillatelsessett etter brukergruppe**
...
## <a name="to-assign-permission-sets-to-users" />Slik tilordner du tillatelsessett til brukere
...
### <a name="to-assign-a-permission-set-on-a-user-card" />Slik tilordner du et tillatelsesett på et brukerkort
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-page" />Slik tilordner du et tillatelsessett på siden Tillatelsessett etter bruker
...
## <a name="to-get-an-overview-of-a-users-permissions" />For å få en oversikt over en brukers tillatelser
...
### <a name="security-filters-limit-a-users-access-to-specific-records-in-a-table" />Sikkerhetsfiltre begrenser brukerens tilgang til bestemte poster i en tabell
...
## <a name="viewing-permission-changes-telemetry" />Vise telemetri ved tillatelsesendringer
...
## <a name="delegated-admin-users" />Delegerte administratorbrukere
