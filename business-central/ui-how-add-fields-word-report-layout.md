...
# <a name="work-with-word-layouts" />Arbeid med Word-oppsett
...
## <a name="embedding-fonts-in-word-layouts-for-consistency" />Bygge inn skrifter i Word-oppsett for konsekvens
...
## <a name="adding-data-fields" />Legge til datafelt
...
### <a name="to-add-a-label-or-data-field" />Legge til en etikett eller et datafelt
...
### <a name="to-add-repeating-rows-of-data-fields-to-create-a-list" />Legge til gjentatte rader med datafelt til å opprette en liste
...
## <a name="adding-image-fields" />Legg til bildefelter
...
### <a name="to-add-an-image" />Legge til et bilde
...
### <a name="to-remove-a-label-or-data-field" />Fjerne en etikett eller et datafelt
...
## <a name="custom-xml-part-overview" />Oversikt over tilpassing av XML-del
...
### <a name="xml-structure-of-custom-xml-part" />XML-struktur for egendefinert XML-del
...
### <a name="custom-xml-part-in-word" />Egendefinert XML-del i Word
