...
---
# <a name="walkthrough-picking-and-shipping-in-basic-warehouse-configurations" />Gjennomgang: Plukking og levering i enkle lageroppsett
...
### <a name="setting-up-the-bin-codes" />Definere hyllekodene

Når lokasjonen er definert, må du legge til to hyller.

#### <a name="to-setup-the-bin-codes" />Slik definerer du hyllekodene

1. Velg handlingen **Hyller**.
2. Opprett to hyller med kodene *S-01-0001* og *S-01-0002*.

### <a name="making-yourself-a-warehouse-employee-at-location-south" />Opprette deg selv som en lageransatt på lokasjon SØR

For å kunne bruke denne funksjonaliteten må du legge deg selv til på lokasjonen som en lagerarbeider. 

#### <a name="to-make-yourself-a-warehouse-employee" />Slik oppretter du deg selv som en lageransatt
...
## <a name="creating-the-sales-order" />Opprette ordren
...
## <a name="picking-and-shipping-items" />Plukke og levere varer
...
### <a name="to-pick-and-ship-items" />Slik plukker og leverer du varer:
