...
# <a name="sales-quick-start"></a><a name="sales-quick-start"></a><a name="sales-quick-start"></a>Hurtigstart for salg
...
## <a name="set-up-items-to-sell"></a><a name="set-up-items-to-sell"></a><a name="set-up-items-to-sell"></a>Definer varer som skal selges
...
### <a name="set-up-a-new-item"></a><a name="set-up-a-new-item"></a><a name="set-up-a-new-item"></a>Definer en ny vare
...
## <a name="set-up-customers"></a><a name="set-up-customers"></a><a name="set-up-customers"></a>Definer kunder
...
### <a name="set-up-a-new-customer"></a><a name="set-up-a-new-customer"></a><a name="set-up-a-new-customer"></a>Definer en ny kunde
...
### <a name="to-create-a-sales-order"></a><a name="to-create-a-sales-order"></a><a name="to-create-a-sales-order"></a>Opprette en ordre
...
## <a name="create-a-sales-invoice"></a><a name="create-a-sales-invoice"></a><a name="create-a-sales-invoice"></a>Opprett en salgsfaktura
...
### <a name="to-create-and-post-a-sales-invoice"></a><a name="to-create-and-post-a-sales-invoice"></a><a name="to-create-and-post-a-sales-invoice"></a>Slik oppretter og bokfører du en salgsfaktura
