...
# <a name="basic-reports-and-documents-output-quick-start"></a><a name="basic-reports-and-documents-output-quick-start"></a>Hurtigstart for standardrapporter og dokumentutdata
...
## <a name="add-your-company-logo-to-documents"></a><a name="add-your-company-logo-to-documents"></a>Legg til selskapslogoen på dokumenter
...
## <a name="run-reports"></a><a name="run-reports"></a>Kjør rapporter
...
## <a name="save-reports-as-pdf-excel-or-word-documents"></a><a name="save-reports-as-pdf-excel-or-word-documents"></a>Lagre rapporter som PDF-, Excel- eller Word-dokumenter
...
### <a name="change-report-and-document-layouts"></a><a name="change-report-and-document-layouts"></a>Endre rapport- og dokumentoppsett
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Se relatert opplæring på [Microsoft Learn](/learn/modules/work-with-reports/).
