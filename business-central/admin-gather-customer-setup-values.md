...
description: Hvis du vil bruke RapidStart Services, bidrar konfigurasjonsspørreskjemaet til å redusere implementeringen ved å effektivisere oppsettet av nye selskaper og tilby kunder en Excel- eller XML-fil.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
ms.locfileid: "8518392"
---
# <a name="gather-customer-setup-values-with-rapidstart-services"></a>Samle oppsettsverdier for kunde med RapidStart Services
