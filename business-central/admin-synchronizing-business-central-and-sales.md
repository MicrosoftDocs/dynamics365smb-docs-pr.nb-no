...
# Synkronisere data i Business Central med Microsoft Dataverse
...
## Standard tabelltilordning for synkronisering
...
### Tips for administratorer: vise tabelltilordninger
...
## Bruke virtuelle tabeller til å hente mer data
...
* [Business Central Virtual Table for Microsoft Dataverse-administratorreferanse](/business-central/dev-itpro/powerplatform/powerplat-admin-reference) ([!INCLUDE [prod_short](includes/prod_short.md)]-dokumentasjon)
...
## Synkronisere data fra flere selskaper eller miljøer
