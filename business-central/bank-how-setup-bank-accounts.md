...
ms.author: edupont
---
# <a name="set-up-bank-accounts" />Opprette bankkonti
...
## <a name="to-set-up-bank-accounts" />Slik setter du opp bankkonti
...
## <a name="to-enter-an-opening-balance" />Slik angir du en startsaldo
...
## <a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files" />Opprette din bankkonto for import eller eksport av bankfilene
...
## <a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files" />Opprette dine leverandørbankkonti for import eller eksport av bankfilene
...
## <a name="changing-your-bank-account" />Endre bankkontoen
