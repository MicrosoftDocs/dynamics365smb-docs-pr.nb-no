...
ms.author: edupont
---
# <a name="set-up-bank-accounts"></a><a name="set-up-bank-accounts"></a>Opprette bankkonti
...
## <a name="to-set-up-bank-accounts"></a><a name="to-set-up-bank-accounts"></a>Slik setter du opp bankkonti
...
## <a name="to-enter-an-opening-balance"></a><a name="to-enter-an-opening-balance"></a>Slik angir du en startsaldo
...
## <a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files"></a><a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files"></a>Opprette din bankkonto for import eller eksport av bankfilene
...
## <a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files"></a><a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files"></a>Opprette dine leverandørbankkonti for import eller eksport av bankfilene
...
## <a name="changing-your-bank-account"></a><a name="changing-your-bank-account"></a>Endre bankkontoen
