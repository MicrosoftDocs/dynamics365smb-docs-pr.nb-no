...
# <a name="set-up-company-consolidation"></a><a name="set-up-company-consolidation"></a><a name="set-up-company-consolidation"></a>Konfigurere selskapskonsolidering
...
## <a name="simple-consolidation-setup"></a><a name="simple-consolidation-setup"></a><a name="simple-consolidation-setup"></a>Enkelt konsolideringsoppsett
...
## <a name="advanced-consolidation-setup"></a><a name="advanced-consolidation-setup"></a><a name="advanced-consolidation-setup"></a>Avansert konsolideringsoppsett
...
### <a name="set-up-the-consolidated-company"></a><a name="set-up-the-consolidated-company"></a><a name="set-up-the-consolidated-company"></a>Konfigurer det konsoliderte selskapet
...
### <a name="add-business-units"></a><a name="add-business-units"></a><a name="add-business-units"></a><a name="busunit"></a>Legge til konsern
...
### <a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="glacc"></a>Klargjøre finanskonti for konsolidering
...
### <a name="specify-exchange-rates-for-consolidations"></a><a name="specify-exchange-rates-for-consolidations"></a><a name="specify-exchange-rates-for-consolidations"></a><a name="exchrates"></a>Angi valutakurser for konsolideringer
...
### <a name="include-or-exclude-dimensions"></a><a name="include-or-exclude-dimensions"></a><a name="include-or-exclude-dimensions"></a><a name="dim"></a>Inkludere eller utelate dimensjoner
...
### <a name="exclude-a-company-from-consolidation"></a><a name="exclude-a-company-from-consolidation"></a><a name="exclude-a-company-from-consolidation"></a><a name="exclude"></a>Utelate et selskap fra konsolidering
...
### <a name="include-a-partially-owned-company-in-consolidation"></a><a name="include-a-partially-owned-company-in-consolidation"></a><a name="include-a-partially-owned-company-in-consolidation"></a><a name="include"></a>Inkludere et delvis eid selskap i konsolideringen
