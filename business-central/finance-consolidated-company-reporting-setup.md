...
# <a name="set-up-company-consolidation" />Konfigurere selskapskonsolidering
...
## <a name="simple-consolidation-setup" />Enkelt konsolideringsoppsett
...
## <a name="advanced-consolidation-setup" />Avansert konsolideringsoppsett
...
### <a name="set-up-the-consolidated-company" />Konfigurer det konsoliderte selskapet
