...
ms.author: edupont
---
# <a name="create-incoming-document-records-directly-from-documents-and-entries" />Opprette innkommende dokumentposter direkte fra dokumenter og poster
...
## <a name="create-and-connect-an-incoming-document-record-from-a-purchase-invoice" />Slik oppretter og kobler du en innkommende dokumentpost fra en kjøpsfaktura:
...
## <a name="create-and-connect-an-incoming-document-record-from-a-vendor-ledger-entry" />Slik oppretter og kobler du en innkommende dokumentpost fra en leverandørpost:
...
## <a name="remove-a-connection-from-an-incoming-document-record-to-a-posted-document" />Slik fjerner du tilkoblingen fra en innkommende dokumentpost til et bokført dokument:
