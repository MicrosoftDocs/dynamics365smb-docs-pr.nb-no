...
ms.author: edupont
---
# <a name="update-currency-exchange-rates" />Oppdatere valutakurser
...
### <a name="effect-on-customers-and-vendors" />Innvirkning på kunder og leverandører
...
#### <a name="dimensions-on-customer-and-vendor-ledger-entries" />Dimensjoner på kunde- og leverandørposter
...
### <a name="effect-on-bank-accounts" />Innvirkning på bankkonti
...
#### <a name="dimensions-on-bank-account-entries" />Dimensjoner på bankkontoposter

Justeringspostene for bankkontoens finanskonto, og for tap/vinning-kontoen tilordnes bankkontoens standarddimensjon.

### <a name="effect-on-gl-accounts" />Innvirkning på finanskonti
...
##### <a name="dimensions-on-gl-account-entries" />Dimensjoner på finanskontoposter
...
## <a name="to-set-up-a-currency-exchange-rate-service" />Slik konfigurerer du en valutakurstjeneste
...
## <a name="to-update-currency-exchange-rates-through-a-service" />Oppdatere valutakurser via en tjeneste
...
## <a name="see-related-microsoft-trainingtrainingpathsuse-multiple-currencies-dynamics--business-central" />Se relatert [Microsoft-opplæring](/training/paths/use-multiple-currencies-dynamics-365-business-central/)
