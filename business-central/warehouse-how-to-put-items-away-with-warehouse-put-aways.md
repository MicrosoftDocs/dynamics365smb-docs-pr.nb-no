...
---
# <a name="put-items-away-with-warehouse-put-aways" />Plassere varer med lagerplasseringer
...
## <a name="to-create-put-away-documents-in-bulk-with-the-put-away-worksheet" />Slik oppretter du plasseringsdokumenter i bulk med plasseringsforslaget
...
## <a name="to-create-a-put-away-from-a-posted-receipt" />Slik oppretter du en plassering fra et bokførte mottak:
...
## <a name="to-put-items-away" />Slik plasserer du varer
