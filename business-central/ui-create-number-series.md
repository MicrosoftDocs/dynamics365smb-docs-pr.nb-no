...
ms.author: edupont
---
# <a name="create-number-series" />Opprette nummerserier
...
## <a name="gaps-in-number-series" />Tomrom i nummerserier
...
## <a name="behavior-of-the-no-field-on-documents-and-cards" />Virkemåte for feltet Nr. på dokumenter og kort
...
## <a name="to-create-a-new-number-series" />Opprette en ny nummerserie
...
## <a name="to-create-relationships-between-number-series" />Slik oppretter du forbindelser mellom nummerserier
...
## <a name="to-set-up-where-a-number-series-is-used" />Slik definerer du der det brukes en nummerserie
...
## <a name="see-related-microsoft-trainingtrainingmodulesnumber-series-trail-codes-dynamics-365-business-centralindex" />Se relatert [Microsoft-opplæring](/training/modules/number-series-trail-codes-dynamics-365-business-central/index)
