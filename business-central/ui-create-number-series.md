...
ms.author: edupont
---
# <a name="create-number-series"></a><a name="create-number-series"></a>Opprette nummerserier
...
## <a name="gaps-in-number-series"></a><a name="gaps-in-number-series"></a>Tomrom i nummerserier
...
## <a name="behavior-of-the-no-field-on-documents-and-cards"></a><a name="behavior-of-the-no-field-on-documents-and-cards"></a>Virkemåte for feltet Nr. på dokumenter og kort
...
## <a name="to-create-a-new-number-series"></a><a name="to-create-a-new-number-series"></a>Opprette en ny nummerserie
...
## <a name="to-create-relationships-between-number-series"></a><a name="to-create-relationships-between-number-series"></a>Slik oppretter du forbindelser mellom nummerserier
...
## <a name="to-set-up-where-a-number-series-is-used"></a><a name="to-set-up-where-a-number-series-is-used"></a>Slik definerer du der det brukes en nummerserie
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/modules/number-series-trail-codes-dynamics-365-business-central/index)
