...
ms.author: edupont
---
# <a name="combine-shipments-on-a-single-invoice" />Kombinere leveringer på én faktura
...
## <a name="to-manually-combine-shipments-on-a-single-invoice" />Kombinere leveringer på én faktura manuelt
...
## <a name="to-automatically-combine-shipments-on-a-single-invoice" />Slik kombinerer du leveringer på én enkelt faktura automatisk:
...
## <a name="to-remove-open-sales-orders-after-combined-shipment-posting" />Fjerne åpne ordrer etter kombinert leveringsbokføring
...
## <a name="see-related-microsoft-trainingtrainingmodulesinvoicing-customers-dynamics-365-business-central" />Se relatert [Microsoft-opplæring](/training/modules/invoicing-customers-dynamics-365-business-central/)
