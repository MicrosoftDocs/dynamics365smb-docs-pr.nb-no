...
ms.author: edupont
---
# <a name="register-employees"></a><a name="register-employees"></a>Registrere ansatte
...
## <a name="adding-new-employees"></a><a name="adding-new-employees"></a>Legg til nye ansatte
...
## <a name="to-set-up-an-employee"></a><a name="to-set-up-an-employee"></a>Slik konfigurerer du ansatte
...
## <a name="to-insert-a-picture-of-an-employee"></a><a name="to-insert-a-picture-of-an-employee"></a>Slik setter du inn et bilde av en ansatt
...
## <a name="to-register-various-information-about-an-employee"></a><a name="to-register-various-information-about-an-employee"></a>Slik registrerer du informasjon om en ansatt
