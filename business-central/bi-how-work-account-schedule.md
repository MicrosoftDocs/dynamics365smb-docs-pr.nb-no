...
---
# <a name="prepare-financial-reporting-with-financial-data-and-account-categories" />Klargjøre Financial Reporting med finansdata og kontokategorier
...
## <a name="financial-reports" />Finansrapporter
...
## <a name="create-a-new-financial-report" />Opprette en ny finansrapport
...
### <a name="edit-a-column-definition" />Redigere en kolonnedefinisjon
...
### <a name="create-a-column-that-calculates-percentages" />Opprette en kolonne som beregner prosentdeler
...
## <a name="set-up-financial-reports-with-overviews" />Definere finansrapporter med oversikter
...
## <a name="comparing-accounting-periods-using-period-formulas" />Sammenligne regnskapsperioder ved hjelp av periodeformler
...
## <a name="print-and-save-financial-reports" />Skrive ut og lagre finansrapporter
...
### <a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document" />Planlegge en finansrapport eller lagre som PDF-, Word- eller Excel-dokument
...
## <a name="importing-or-exporting-financial-reports" />Importere eller eksportere finansrapporter
...
### <a name="import-and-export-financial-reports" />Importere og eksportere finansrapporter
...
## <a name="see-related-microsoft-training" />Se relatert [Microsoft-opplæring](/training/modules/configure-financial-reports-dynamics-365-business-central/index).
