...
---
# <a name="prepare-financial-reporting-with-financial-data-and-account-categories"></a><a name="prepare-financial-reporting-with-financial-data-and-account-categories"></a><a name="prepare-financial-reporting-with-financial-data-and-account-categories"></a>Klargjøre Financial Reporting med finansdata og kontokategorier
...
## <a name="financial-reports"></a><a name="financial-reports"></a><a name="financial-reports"></a>Finansrapporter
...
## <a name="create-a-new-financial-report"></a><a name="create-a-new-financial-report"></a><a name="create-a-new-financial-report"></a>Opprette en ny finansrapport
...
> [!NOTE]
> Når du åpner en finansrapport i visnings- eller redigeringsmodus, er filtreringsruten tilgjengelig. Du må imidlertid ikke bruke ruten til å definere filtre for dataene i rapporten. Filtrene kan føre til feil eller kanskje ikke filtrere dataene. Bruk i stedet filtreringsfeltene på hurtigfanene **Alternativer** og **Dimensjoner**.
...
7. På siden for **Finansrapporter** velger du **Rediger økonomisk rapport** for å få tilgang til den resulterende finansrapporten.
...
### <a name="edit-a-column-definition"></a><a name="edit-a-column-definition"></a><a name="edit-a-column-definition"></a>Redigere en kolonnedefinisjon
...
### <a name="create-a-column-that-calculates-percentages"></a><a name="create-a-column-that-calculates-percentages"></a><a name="create-a-column-that-calculates-percentages"></a>Opprette en kolonne som beregner prosentdeler
...
## <a name="set-up-financial-reports-with-overviews"></a><a name="set-up-financial-reports-with-overviews"></a><a name="set-up-financial-reports-with-overviews"></a>Definere finansrapporter med oversikter
...
## <a name="comparing-accounting-periods-using-period-formulas"></a><a name="comparing-accounting-periods-using-period-formulas"></a><a name="comparing-accounting-periods-using-period-formulas"></a>Sammenligne regnskapsperioder ved hjelp av periodeformler
...
## <a name="print-and-save-financial-reports"></a><a name="print-and-save-financial-reports"></a><a name="print-and-save-financial-reports"></a>Skrive ut og lagre finansrapporter
...
### <a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document"></a><a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document"></a><a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document"></a>Planlegge en finansrapport eller lagre som PDF-, Word- eller Excel-dokument
...
## <a name="importing-or-exporting-financial-reports"></a><a name="importing-or-exporting-financial-reports"></a><a name="importing-or-exporting-financial-reports"></a>Importere eller eksportere finansrapporter
...
### <a name="import-and-export-financial-reports"></a><a name="import-and-export-financial-reports"></a><a name="import-and-export-financial-reports"></a>Importere og eksportere finansrapporter
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/modules/configure-financial-reports-dynamics-365-business-central/index).
