---
title: Bruk C5-utvidelse for dataoverføring | Microsoft Docs
...
# C5-utvidelsen for dataoverføring
...
For å korrigere en feil kan du velge en feilmelding på siden **Datamigreringsfeil** og deretter velge **Rediger post** for å vise de migrerte dataene for enheten. Hvis du har flere feil som må løses, kan du velge **Massereparasjon av feil** for å redigere enhetene i en liste. Du må fortsatt åpne enkeltposter hvis årsaken til feilen blir forårsaket av en relatert post. For eksempel overføres en leverandør ikke hvis en e-postadresse til en av kontaktene har ugyldig format.
...
## Kontroller dataene etter overføring
