...
ms.author: edupont
---
# <a name="set-up-standard-routing-lines" />Definere standard rutelinjer
...
## <a name="to-set-up-a-standard-task" />Slik definerer du en standardoppgave
...
## <a name="to-add-a-standard-task-to-an-operation" />Slik legger du til en standardoppgave i en operasjon
