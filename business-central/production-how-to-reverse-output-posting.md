...
ms.author: edupont
---
# <a name="reverse-output-posting"></a><a name="reverse-output-posting"></a>Tilbakeføre avgangsbokføring
...
## <a name="to-reverse-an-output-posting"></a><a name="to-reverse-an-output-posting"></a>Tilbakeføre en avgangsbokføring
