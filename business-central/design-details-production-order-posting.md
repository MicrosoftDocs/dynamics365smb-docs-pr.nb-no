...
ms.author: edupont
---
# <a name="design-details-production-order-posting"></a><a name="design-details-production-order-posting"></a><a name="design-details-production-order-posting"></a>Designdetaljer: Bokføre produksjonsordre
...
## <a name="posting-structure"></a><a name="posting-structure"></a><a name="posting-structure"></a>Bokføringsstruktur
...
## <a name="capacity-posting"></a><a name="capacity-posting"></a><a name="capacity-posting"></a>Kapasitetsbokføring
...
## <a name="production-order-costing"></a><a name="production-order-costing"></a><a name="production-order-costing"></a>Produksjonsordrekostnad
