...
|Avdempingsperiode|Angi i forhold til leverandørens fleksibilitet.<br /><br /> En lengre periode gjør det mulig å gi bedre kundeservice, men fører også til flere handlinger med ny planlegging.|Hvis leverandøren godtar endringer i siste øyeblikk i ordrer, bruker du en lengre periode, men vær forberedt på flere handlinger med ny planlegging. Hvis leverandøren krever fast planlegging, reduserer du perioden så mye som mulig.<br /><br /> Hvis du vil ha informasjon om **Avdempingsperiode**-feltet, kan du se [Designdetaljer: Planleggingsparametere](design-details-planning-parameters.md).|  
