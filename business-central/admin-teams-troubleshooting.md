...
## <a name="the-sign-in-link-doesnt-work" />Påloggingskoblingen fungerer ikke
...
## <a name="the-settings-page-is-empty" />Siden Innstillinger er derfor tom
...
## <a name="i-changed-company-but-it-didnt-seem-to-work" />Jeg endret selskap, men det ser ikke ut til å fungere
...
## <a name="something-went-wrong-error-when-searching-for-contacts" />Feil meldingen "Noe gikk galt" under Søk etter kontakter
...
## <a name="cannot-find-the-contactcontact-summary-api-error-when-searching-for-contacts" />Feilmeldingen «Finner ikke API-en for kontakten/kontaktsammendraget» når du søker etter kontakter
...
## <a name="none-of-my-links-expand-into-a-card" />Ingen av koblingene utvides til et kort
...
## <a name="my-link-sometimes-doesnt-expand-into-a-card" />Koblingen utvides noen ganger ikke til et kort
...
## <a name="the-details-window-opens-but-shows-an-error-before-details-are-shown" />Detaljer-vinduet åpnes, men viser en feil før detaljene vises
...
## <a name="im-having-problems-with-the-camera-or-location-in-teams" />Jeg har problemer med kameraet eller plasseringen i Teams
...
## <a name="teams-displays-mixed-languages-for-my-cards-and-card-details" />Teams viser blandede språk for kort og kortdetaljer
...
## <a name="i-edited-a-field-in-the-details-window-but-my-change-wasnt-saved" />Jeg redigerte et felt i detaljvinduet, men endringen ble ikke lagret
...
## <a name="a-new-tile-appeared-in-the-app-launcher-how-do-i-remove-it" />En ny flis ble vist i appstarteren. Hvordan fjerner jeg den?
...
## <a name="duplicate-text-in-the-share-to-teams-window" />Dupliser tekst i vinduet Del til Teams
...
## <a name="unable-to-sign-into-the-share-to-teams-window" />Kan ikke logge på vinduet Del til Teams
...
## <a name="my-cards-no-longer-have-a-popout-button" />Kortene mine har ikke lenger popout-knapp
...
## <a name="cant-pin-a-card-to-tab" />Kan ikke feste et kort til fane
...
## <a name="someone-added-a-tab-but-the-tab-doesnt-show-up-for-me" />Noen har lagt til en fane, men jeg ser ikke fanen
...
## <a name="others-see-different-sorting-or-column-layout-than-what-the-tab-author-sees" />Andre ser forskjellige sorterings- eller kolonneoppsett enn det faneforfatteren ser
