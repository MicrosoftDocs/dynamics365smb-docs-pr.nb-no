...
---
# <a name="selling-inventory-items-in-assemble-to-order-flows" />Salg av lagervarer i montere til ordre-flyter
...
## <a name="to-sell-inventory-items-in-assemble-to-order-flows" />Selge lagervarer i montere til ordre-flyter
