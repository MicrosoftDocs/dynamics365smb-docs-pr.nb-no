...
ms.author: edupont
---
# <a name="subcontract-manufacturing" />Underleveranse av produksjon
...
## <a name="subcontract-work-centers" />Arbeidssentre for underleveranse
...
### <a name="subcontract-work-center-fields" />Felt i arbeidssentre for underleveranse
...
### <a name="routings-that-use-subcontract-work-centers" />Ruter som bruker arbeidssentre for underleveranse
...
## <a name="calculate-subcontracting-worksheets-and-create-subcontract-purchase-orders" />Beregne underleveranseforslag og opprette underleverandørbestillinger
...
### <a name="to-calculate-the-subcontracting-worksheet" />Slik beregner du underleveranseforslaget
...
### <a name="to-create-the-subcontract-purchase-order" />Slik oppretter du underleverandørbestillingen
1.  Velg ikonet ![Lyspære som åpner funksjonen Fortell meg.](media/ui-search/search_small.png "Fortell hva du vil gjøre") og angi **Underleveranseforslag**, og velg deretter den relaterte koblingen.  
...
## <a name="posting-subcontract-purchase-orders" />Bokføre underleverandørbestillinger
...
## <a name="to-post-a-subcontract-purchase-order" />Slik bokfører du en underleverandørbestilling
