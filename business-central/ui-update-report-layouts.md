...
ms.author: edupont
---
# <a name="legacy-update-custom-report-layouts"></a><a name="legacy-update-custom-report-layouts"></a>(Eldre) Oppdater egendefinerte rapportoppsett
...
## <a name="to-update-one-or-more-custom-report-layouts"></a><a name="to-update-one-or-more-custom-report-layouts"></a>Slik oppdaterer du én eller flere egendefinerte rapportoppsett
...
## <a name="to-test-custom-report-layout-updates"></a><a name="to-test-custom-report-layout-updates"></a>Slik tester du oppdateringer for egendefinert rapportoppsett:
...
## <a name="limitations-of-the-custom-report-layout-update"></a><a name="limitations-of-the-custom-report-layout-update"></a><a name="UpdateLimitations"></a> Begrensninger i oppdateringen for egendefinert rapportoppsett
...
## <a name="fixing-errors"></a><a name="fixing-errors"></a><a name="FixErrors"></a> Rette feil
