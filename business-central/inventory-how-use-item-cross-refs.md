...
ms.author: edupont
---
# <a name="use-item-references" />Bruk varereferanser
...
## <a name="to-start-using-item-references" />Slik begynner du å bruke varereferanser
...
## <a name="to-set-up-an-item-reference" />Slik definerer du en varereferanse
...
## <a name="to-enter-a-vendors-item-description-on-a-document" />Slik angir du en leverandørs varebeskrivelse på et dokument
