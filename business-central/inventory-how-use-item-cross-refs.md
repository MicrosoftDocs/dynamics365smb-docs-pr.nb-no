...
ms.author: edupont
---
# <a name="use-item-references"></a><a name="use-item-references"></a>Bruk varereferanser
...
## <a name="to-start-using-item-references"></a><a name="to-start-using-item-references"></a>Slik begynner du å bruke varereferanser
...
## <a name="to-set-up-an-item-reference"></a><a name="to-set-up-an-item-reference"></a>Slik definerer du en varereferanse
...
## <a name="to-enter-a-vendors-item-description-on-a-document"></a><a name="to-enter-a-vendors-item-description-on-a-document"></a>Slik angir du en leverandørs varebeskrivelse på et dokument
