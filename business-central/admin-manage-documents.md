...
ms.author: edupont
---
# <a name="manage-storage-by-deleting-documents-or-compressing-data"></a><a name="manage-storage-by-deleting-documents-or-compressing-data"></a>Behandle lagring ved å slette dokumenter eller komprimere data
...
## <a name="posting-compressed-entries"></a><a name="posting-compressed-entries"></a>Bokføre komprimerte poster
...
### <a name="to-run-a-date-compression"></a><a name="to-run-a-date-compression"></a>Slik kjører du en datokomprimering
