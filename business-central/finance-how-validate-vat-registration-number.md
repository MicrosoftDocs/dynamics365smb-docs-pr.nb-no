...
# <a name="validate-vat-registration-numbers" />Valider organisasjonsnumre
...
## <a name="configure-the-service-to-verify-vat-registration-numbers-automatically" />Konfigurer tjenesten til å bekrefte mva-registreringsnummer automatisk
...
## <a name="validation-templates" />Valideringsmaler
