...
ms.author: edupont
---
# <a name="assign-default-bins-to-items" />Tilordne standardhyller til varer
...
## <a name="to-assign-a-default-bin-to-an-item" />Tilordne en standardhylle til en vare
...
## <a name="to-change-the-default-bin-for-an-item" />Slik endrer du standardhyllen for en vare
