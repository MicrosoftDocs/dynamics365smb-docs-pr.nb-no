...
## <a name="advanced-user-experience"></a><a name="advanced-user-experience"></a>Avansert brukeropplevelse
...
### <a name="complete-sample-data"></a><a name="complete-sample-data"></a>Fullstendige eksempeldata
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/modules/admin-online-dynamics-365-business-central/)
