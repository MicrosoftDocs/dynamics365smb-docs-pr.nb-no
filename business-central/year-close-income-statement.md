...
ms.author: jswymer
---
# <a name="closing-income-statement-accounts" />Lukking av resultatregnskapskonti
...
## <a name="to-run-the-close-income-statement-batch-job" />Kjøre den satsvise jobben Lukk resultatregnskapet
...
## <a name="about-the-close-income-statement-batch-job" />Den satsvise jobben Lukk resultatregnskapet
