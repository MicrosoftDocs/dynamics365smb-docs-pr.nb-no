...
description: Denne artikkelen forklarer hvordan Business Central samsvarer med internasjonale finansrapporteringsstandarder og personvernlover og -bestemmelser.
...
Denne artikkelen gir informasjon om hvordan [!INCLUDE [prod_short](../includes/prod_short.md)] gir selskaper muligheten til å effektivisere forretningsprosesser og samtidig kosteffektivt overholde økte regulerings- og rapporteringskrav.

## <a name="data-privacy"></a>Datavern

[!INCLUDE [prod_short](../includes/prod_short.md)] støtter personvernlover og -regler. [Finn ut hvordan du svarer på forespørsler om registrert samsvar i Business Central](../admin-responding-to-requests-about-personal-data.md).

Hvis du utvikler [!INCLUDE [prod_short](../includes/prod_short.md)]-utvidelser, må du vite [hvordan data klassifiseres i Dynamics 365](/dynamics365/business-central/dev-itpro/developer/devenv-classifying-data).

[Finn ut mer om datapersonvern i Dynamics 365](https://privacy.microsoft.com/en-us/privacystatement).
...
[!INCLUDE [prod_short](../includes/prod_short.md)] leverer integrert drifts- og økonomiinformasjon i sanntid fra hele organisasjonen, slik at du kan:
...
[!INCLUDE [prod_short](../includes/prod_short.md)] forbedrer kontrollen av viktige funksjoner og informasjon som er viktig for den vellykkede økonomiske driften av virksomheten.
...
#### <a name="sarbanes-oxley-validating-data-and-processes"></a>Sarbanes-Oxley: Validere data og prosesser
...
#### <a name="iasifrs-recognition-and-measurement-standards"></a>IAS/IFRS: Føring og mål av standarder
...
#### <a name="basel-ii-implications-for-reporting-and-analysis"></a>Basel II: Implikasjoner for rapportering og analyse
