...
ms.author: edupont
---
# <a name="revalue-inventory"></a><a name="revalue-inventory"></a>Revaluere beholdning
Hvis du vil endre lagerverdien for en vare eller en bestemt varepost, må du bruke revalueringskladden.

## <a name="to-revalue-inventory"></a><a name="to-revalue-inventory"></a>Slik revaluerer du beholdning
