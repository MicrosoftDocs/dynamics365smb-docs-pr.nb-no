...
ms.author: edupont
---
# <a name="set-up-service-items-and-service-item-components" />Definere servicevarer og servicevarekomponenter
Hvis du vil arbeide med servicevarer, må du definere følgende

* Servicevaregrupper.
* Valgfritt

## <a name="to-set-up-service-item-groups" />Definere servicevaregrupper
...
## <a name="to-set-up-service-item-components" />Slik definerer du servicevarekomponenter
...
## <a name="to-set-up-service-item-components-from-a-bom" />Slik definerer du servicevarekomponenter fra stykklister
1.  Velg ikonet ![Lyspære som åpner funksjonen Fortell meg.](media/ui-search/search_small.png "Fortell hva du vil gjøre") og angi **Servicevarer**, og velg deretter den relaterte koblingen.  
...
## <a name="to-set-up-a-service-shelf" />Slik definerer du servicehyller
