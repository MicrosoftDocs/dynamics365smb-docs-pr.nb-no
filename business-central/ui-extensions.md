...
ms.author: edupont
---
# <a name="customizing-business-central-online-with-apps"></a><a name="customizing-business-central-online-with-apps"></a>Tilpasse Business Central Online med apper
...
## <a name="manage-apps"></a><a name="manage-apps"></a>Administrer apper
...
## <a name="apps-and-data-transfer"></a><a name="apps-and-data-transfer"></a>Apper og dataoverføring
...
## <a name="connect-your-business"></a><a name="connect-your-business"></a>Koble til virksomheten
...
## <a name="recommended-apps"></a><a name="recommended-apps"></a>Anbefalte apper
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/modules/customize-dynamics-365-business-central/)
