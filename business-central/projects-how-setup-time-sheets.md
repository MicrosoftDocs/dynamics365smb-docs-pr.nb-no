...
ms.author: edupont
---
# <a name="set-up-time-sheets" />Definere timelister
...
## <a name="set-up-time-sheets-with-the-assisted-setup-guide" />Definer timelister med den assisterte oppsettveiledningen
...
## <a name="set-up-time-sheets-manually" />Definer timelister manuelt
...
### <a name="to-set-up-general-information-for-time-sheets-manually" />Slik definerer du generell informasjon for timelister manuelt
...
### <a name="to-assign-a-time-sheet-administrator-manually" />Slik tilordner du en timelisteadministrator manuelt
...
### <a name="to-assign-a-time-sheets-owner-and-approver-manually" />Slik tilordner du en timelisteeier og -godkjenner manuelt
