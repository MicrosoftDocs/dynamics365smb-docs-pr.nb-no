...
ms.author: edupont
---
# <a name="design-details-inventory-posting"></a><a name="design-details-inventory-posting"></a>Designdetaljer: Lagerbokføring
...
### <a name="item-application-entries-1"></a><a name="item-application-entries-1"></a>Vareutligningsposter (1)
...
### <a name="item-application-entries-2"></a><a name="item-application-entries-2"></a>Vareutligningsposter (2)
...
### <a name="value-entries-3"></a><a name="value-entries-3"></a>Verdiposter (3)
...
### <a name="relation-entries-in-the-gl--item-ledger-relation-table-3"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-3"></a>Relasjonsposter i tabellen Finans – varepostrelasjon (3)
...
## <a name="assembly-and-production-posting"></a><a name="assembly-and-production-posting"></a>Monterings- og produksjonsbokføring
