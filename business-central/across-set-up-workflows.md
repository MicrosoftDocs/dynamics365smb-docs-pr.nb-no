...
ms.author: edupont
---
# <a name="set-up-approval-workflows" />Konfigurere arbeidsflyter for godkjenning
...
## <a name="example-of-an-approval-workflow" />Eksempel på en godkjenningsarbeidsflyt
