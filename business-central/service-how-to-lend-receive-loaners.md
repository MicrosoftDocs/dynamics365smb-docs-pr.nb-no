...
ms.author: bholtorf
---
# <a name="lend-and-receive-loaners" />Låne ut og mottar utlånsobjekter
Du kan låne ut utlånsobjekter til kunder for å midlertidig erstatte servicevarer som du har mottatt for vedlikehold.  
  
## <a name="to-lend-a-loaner-item" />Slik låner du ut en utlånsvare
...
## <a name="to-receive-a-loaner" />Slik mottar du utlånsobjekter
...
## <a name="to-register-loaner-comments" />Slik registrerer du merknader om utlånsobjekt
