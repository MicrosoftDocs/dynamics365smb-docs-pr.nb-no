...
---
# <a name="monitor-job-progress-and-performance" />Overvåke prosjektfremdrift og -ytelse
...
## <a name="create-a-job-wip-method" />Opprett en VIA-metode for prosjekt
...
## <a name="define-a-wip-method-for-a-job" />Definer en VIA-metode for et prosjekt
...
### <a name="define-a-wip-method-for-a-job-task" />Definer en VIA-metode for en prosjektoppgave
...
## <a name="calculate-and-post-job-completion-entries" />Beregn og bokfør prosjektferdiggjørelsesposter
...
## <a name="view-job-ledger-entries" />Vis prosjektposter
