...
---
# <a name="monitor-job-progress-and-performance"></a><a name="monitor-job-progress-and-performance"></a>Overvåke prosjektfremdrift og -ytelse
...
## <a name="create-a-job-wip-method"></a><a name="create-a-job-wip-method"></a>Opprett en VIA-metode for prosjekt
...
## <a name="define-a-wip-method-for-a-job"></a><a name="define-a-wip-method-for-a-job"></a>Definer en VIA-metode for et prosjekt
...
### <a name="define-a-wip-method-for-a-job-task"></a><a name="define-a-wip-method-for-a-job-task"></a>Definer en VIA-metode for en prosjektoppgave
...
## <a name="post-wip"></a><a name="post-wip"></a>Bokfør VIA
...
## <a name="calculate-and-post-job-completion-entries"></a><a name="calculate-and-post-job-completion-entries"></a>Beregn og bokfør prosjektferdiggjørelsesposter
...
## <a name="view-job-ledger-entries"></a><a name="view-job-ledger-entries"></a>Vis prosjektposter
...
## <a name="find-related-microsoft-training"></a><a name="find-related-microsoft-training"></a>Finn relatert [Microsoft-opplæring](/training/paths/calculate-post-job-wip/)
