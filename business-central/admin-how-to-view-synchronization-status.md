...
# <a name="view-the-status-of-synchronization-jobs" />Vise statusen til synkroniseringsjobber
...
## <a name="to-view-and-resolve-synchronization-errors-for-coupled-records" />Slik viser du og løser synkroniseringsfeil for koblede poster
...
## <a name="to-view-the-synchronization-log-for-a-specific-manually-synchronized-record" />Slik viser du synkroniseringsloggen for en bestemt (manuelt synkronisert) post
...
## <a name="remove-couplings-between-records" />Fjerne koblinger mellom poster
