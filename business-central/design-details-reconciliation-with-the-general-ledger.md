...
ms.author: edupont
---
# <a name="design-details-reconciliation-with-the-general-ledger" />Designdetaljer: Avstemming med konti i Finans
...
## <a name="post-inventory-cost-to-gl-batch-job" />Kjørselen Bokfør lagerkost i Finans
...
## <a name="automatic-cost-posting" />Automatisk kostbokføring
