...
---
# <a name="set-up-intercompany-transactions" />Sett opp konserninterne transaksjoner
...
## <a name="overview-of-the-steps-to-get-started" />Oversikt over trinnene for å komme i gang
...
## <a name="set-up-a-synchronization-partner" />Konfigurer en synkroniseringspartner
...
## <a name="set-up-the-intercompany-charts-of-accounts" />Definer den konserninterne kontoplanen
...
### <a name="import-or-export-an-intercompany-chart-of-accounts" />Importer eller eksporter en konsernintern kontoplan
...
## <a name="map-the-intercompany-chart-of-accounts-to-your-companys-chart-of-accounts" />Tildel den konserninterne kontoplanen til selskapets kontoplan
...
## <a name="set-up-intercompany-dimensions" />Definer konserninterne dimensjoner
...
### <a name="import-or-export-intercompany-dimensions" />Importer eller eksporter konserninterne dimensjoner
...
### <a name="map-intercompany-dimensions-to-your-companys-dimensions" />Tildel konserninterne dimensjoner til selskapets dimensjoner
...
## <a name="set-up-intercompany-general-journal-templates-and-batches" />Definer konserninterne finanskladdemaler og -bunker
...
## <a name="set-up-a-company-for-intercompany-transactions" />Definer et selskap for konserninterne transaksjoner
...
## <a name="set-up-intercompany-partners" />Konfigurer konserninterne partnere
...
### <a name="set-up-intercompany-partners-as-customers-and-vendors" />Definer konserninterne partnere som leverandører og kunder
...
### <a name="set-up-default-intercompany-partner-general-ledger-accounts" />Sett opp standard finanskontoer for konsernintern partner
...
### <a name="auto-accept-transactions-from-intercompany-partners" />Godta transaksjoner automatisk fra konserninterne partnere
...
### <a name="specify-the-bank-accounts-to-use-for-intercompany-partners" />Angi hvilke bankkontoer som skal brukes for konserninterne partnere
...
## <a name="troubleshoot-your-intercompany-setup" />Feilsøk det konserninterne oppsettet
