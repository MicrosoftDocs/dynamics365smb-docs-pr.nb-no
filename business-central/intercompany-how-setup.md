...
---
# <a name="set-up-intercompany-transactions"></a><a name="set-up-intercompany-transactions"></a><a name="set-up-intercompany-transactions"></a>Sett opp konserninterne transaksjoner
...
## <a name="overview-of-the-steps-to-get-started"></a><a name="overview-of-the-steps-to-get-started"></a><a name="overview-of-the-steps-to-get-started"></a>Oversikt over trinnene for å komme i gang
...
## <a name="set-up-a-synchronization-partner"></a><a name="set-up-a-synchronization-partner"></a><a name="set-up-a-synchronization-partner"></a>Konfigurer en synkroniseringspartner
...
Når du er klar til å synkronisere data med synkroniseringspartneren din, må du velge handlingen **Synkroniseringsoppsett**.
...
## <a name="set-up-the-intercompany-charts-of-accounts"></a><a name="set-up-the-intercompany-charts-of-accounts"></a><a name="set-up-the-intercompany-charts-of-accounts"></a>Definer den konserninterne kontoplanen
...
### <a name="import-or-export-an-intercompany-chart-of-accounts"></a><a name="import-or-export-an-intercompany-chart-of-accounts"></a><a name="import-or-export-an-intercompany-chart-of-accounts"></a>Importer eller eksporter en konsernintern kontoplan
...
## <a name="set-up-intercompany-dimensions"></a><a name="set-up-intercompany-dimensions"></a><a name="set-up-intercompany-dimensions"></a>Definer konserninterne dimensjoner
...
### <a name="import-or-export-intercompany-dimensions"></a><a name="import-or-export-intercompany-dimensions"></a><a name="import-or-export-intercompany-dimensions"></a>Importer eller eksporter konserninterne dimensjoner
...
### <a name="map-intercompany-dimensions-to-your-companys-dimensions"></a><a name="map-intercompany-dimensions-to-your-companys-dimensions"></a><a name="map-intercompany-dimensions-to-your-companys-dimensions"></a>Tildel konserninterne dimensjoner til selskapets dimensjoner
...
## <a name="set-up-intercompany-general-journal-templates-and-batches"></a><a name="set-up-intercompany-general-journal-templates-and-batches"></a><a name="set-up-intercompany-general-journal-templates-and-batches"></a>Definer konserninterne finanskladdemaler og -bunker
...
## <a name="set-up-a-company-for-intercompany-transactions"></a><a name="set-up-a-company-for-intercompany-transactions"></a><a name="set-up-a-company-for-intercompany-transactions"></a>Definer et selskap for konserninterne transaksjoner
...
## <a name="set-up-intercompany-partners"></a><a name="set-up-intercompany-partners"></a><a name="set-up-intercompany-partners"></a>Konfigurer konserninterne partnere
...
### <a name="set-up-intercompany-partners-as-customers-and-vendors"></a><a name="set-up-intercompany-partners-as-customers-and-vendors"></a><a name="set-up-intercompany-partners-as-customers-and-vendors"></a>Definer konserninterne partnere som leverandører og kunder
...
### <a name="set-up-default-intercompany-partner-general-ledger-accounts"></a><a name="set-up-default-intercompany-partner-general-ledger-accounts"></a><a name="set-up-default-intercompany-partner-general-ledger-accounts"></a>Sett opp standard finanskontoer for konsernintern partner
...
### <a name="auto-accept-transactions-from-intercompany-partners"></a><a name="auto-accept-transactions-from-intercompany-partners"></a><a name="auto-accept-transactions-from-intercompany-partners"></a>Godta transaksjoner automatisk fra konserninterne partnere
...
### <a name="specify-the-bank-accounts-to-use-for-intercompany-partners"></a><a name="specify-the-bank-accounts-to-use-for-intercompany-partners"></a><a name="specify-the-bank-accounts-to-use-for-intercompany-partners"></a>Angi hvilke bankkontoer som skal brukes for konserninterne partnere
...
## <a name="troubleshoot-your-intercompany-setup"></a><a name="troubleshoot-your-intercompany-setup"></a><a name="troubleshoot-your-intercompany-setup"></a>Feilsøk det konserninterne oppsettet
