...
# <a name="work-with-calendar-dates-and-times"></a><a name="work-with-calendar-dates-and-times"></a>Arbeid med datoer og klokkeslett i kalenderen
...
## <a name="check-your-region-and-language-settings"></a><a name="check-your-region-and-language-settings"></a>Kontrollere innstillinger for region og språk
...
### <a name="picking-dates-from-the-calendar"></a><a name="picking-dates-from-the-calendar"></a>Plukke datoer fra kalenderen
...
### <a name="day-week-year-pattern"></a><a name="day-week-year-pattern"></a>Mønsteret dag\-uke\-årn
...
### <a name="digit-patterns"></a><a name="digit-patterns"></a>Tallmønstre
...
### <a name="closing-date"></a><a name="closing-date"></a>Avslutningsdato
...
## <a name="setting-ranges"></a><a name="setting-ranges"></a><a name="BKMK_SettingDateRanges"></a> Angi intervaller
...
## <a name="use-date-formulas"></a><a name="use-date-formulas"></a>Bruk datoformler
...
## <a name="entering-combined-dates-and-times"></a><a name="entering-combined-dates-and-times"></a>Angi kombinerte datoer og klokkeslett
