...
ms.author: bholtorf
---
# <a name="use-dynamics-365-sales-from-business-central" />Bruk Dynamics 365 Sales fra Business Central
...
## <a name="coupling-records" />Koblingsposter
...
## <a name="fully-synchronizing-records" />Fullstendig synkronisering av oppføringer
...
## <a name="handling-sales-order-data" />Håndtere ordredata
...
## <a name="handling-sales-quotes-data" />Håndtere tilbudsdata
...
## <a name="handling-posted-sales-invoices-customer-payments-and-statistics" />Håndtere bokførte salgsfakturaer, kundebetalinger og statistikk
...
## <a name="handling-sales-prices" />Håndtere salgspriser
> [!NOTE]
