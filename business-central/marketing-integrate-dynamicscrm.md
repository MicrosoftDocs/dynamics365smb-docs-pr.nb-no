...
ms.author: bholtorf
---
# <a name="use-dynamics-365-sales-from-business-central"></a><a name="use-dynamics-365-sales-from-business-central"></a>Bruk Dynamics 365 Sales fra Business Central
...
## <a name="coupling-records"></a><a name="coupling-records"></a>Koblingsposter
...
## <a name="fully-synchronizing-records"></a><a name="fully-synchronizing-records"></a>Fullstendig synkronisering av oppføringer
...
## <a name="handling-sales-order-data"></a><a name="handling-sales-order-data"></a>Håndtere ordredata
...
## <a name="handling-sales-quotes-data"></a><a name="handling-sales-quotes-data"></a>Håndtere tilbudsdata
...
## <a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a><a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a>Håndtere bokførte salgsfakturaer, kundebetalinger og statistikk
...
## <a name="handling-sales-prices"></a><a name="handling-sales-prices"></a>Håndtere salgspriser
> [!NOTE]
