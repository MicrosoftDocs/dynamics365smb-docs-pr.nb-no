...
ms.author: edupont
---
# <a name="defining-and-allocating-costs" />Definere og fordele kostnader
...
## <a name="setting-up-allocation-source-and-targets" />Definere fordelingskilde og -mål
...
### <a name="to-set-up-cost-allocations" />Definere kostfordelinger
...
## <a name="setting-filters-for-dynamic-allocation-bases" />Angi filtre for dynamisk fordelingsgrunnlag
...
### <a name="setting-filters" />Angi filtre
...
### <a name="to-define-the-allocation-source-prod-cost-center-on-the-general-fasttab" />Slik definerer du PROD-kostsenteret for fordelingskilden i hurtigfanen Generelt:
...
### <a name="to-define-the-allocation-target-cost-objects-on-the-lines-fasttab" />Slik definerer du kostobjekter for fordelingsmålene i hurtigfanen Linjer:
...
### <a name="to-define-dynamic-allocations-based-on-items-sold-in-the-previous-year" />Slik definerer du dynamisk fordelinger basert på varer solgt i fjoråret:
