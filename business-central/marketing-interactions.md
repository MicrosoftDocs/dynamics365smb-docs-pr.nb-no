...
ms.author: jswymer
---
# <a name="record-interactions-with-contacts"></a><a name="record-interactions-with-contacts"></a>Registrere samhandlinger med kontakter
...
## <a name="setting-up-interaction-templates"></a><a name="setting-up-interaction-templates"></a>Definere samhandlingsmaler
...
## <a name="creating-interactions"></a><a name="creating-interactions"></a>Opprette samhandlinger
...
## <a name="viewing-and-managing-recorded-interactions"></a><a name="viewing-and-managing-recorded-interactions"></a>Vise og administrere registrerte samhandlinger
