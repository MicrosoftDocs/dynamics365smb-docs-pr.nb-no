...
ms.author: edupont
---
# <a name="record-and-reimburse-employees-expenses"></a><a name="record-and-reimburse-employees-expenses"></a>Registrere og refundere ansattes utgifter
...
## <a name="to-record-an-employees-expense"></a><a name="to-record-an-employees-expense"></a>Slik registrerer du utgifter for en ansatt
...
## <a name="to-reimburse-an-employee"></a><a name="to-reimburse-an-employee"></a>Slik refunderer du en ansatt
...
## <a name="to-reconcile-reimbursements-with-employee-ledger-entries"></a><a name="to-reconcile-reimbursements-with-employee-ledger-entries"></a>Slik avstemmer du refusjoner med finansposter for ansatte
