...
---
# Fordel kost til konserninterne partnere
...
## Slik fordeles kost ved hjelp av en konsernintern finanskladd
...
## Slik fordeles kostnader ved hjelp av et kjøpsdokument
...
> [!NOTE]
> Du må tilpasse siden **Kjøpsfaktura** ved å legge til feltene **KI-partnerkode**, **Referansetype for KI-partner** og **KI-partner**. Hvis du vil ha mer informasjon, kan du se [Slik tilpasser du en side med Tilpasse-banneret](ui-personalization-user.md#start-personalizing-by-using-the-personalization-mode).
...
## Slik sender du fordelte kostnader til konserninterne partnere
...
## Beregne mva. for kostnadsdistribusjoner
