...
---
# <a name="count-adjust-and-reclassify-inventory-using-journals" />Telle, justere og reklassifisere lagerbeholdning ved hjelp av kladder
...
## <a name="to-count-physical-inventory" />Vareopptelling
...
### <a name="to-calculate-expected-inventory-in-basic-warehouse-configurations" />Slik beregner du den forventede beholdningen i enkle lagerkonfigurasjoner
...
### <a name="to-print-the-report-to-be-used-when-counting" />Slik skriver du ut rapporten som skal brukes ved telling
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-basic-warehouse-configurations" />Slik angir og bokfører du den faktiske opptalte beholdningen i et enkelt lageroppsett
...
### <a name="to-calculate-the-expected-inventory-in-advanced-warehouse-configurations" />Slik beregner du den forventede beholdningen i avanserte lagerkonfigurasjoner
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-advanced-warehouse-configurations" />Slik angir og bokfører du den faktiske opptalte beholdningen i et avansert lageroppsett
...
## <a name="to-do-cycle-counting" />Utfør syklustelling
...
### <a name="to-set-up-counting-periods" />Slik definerer du opptellingsperioder
...
### <a name="to-assign-a-counting-period-to-an-item" />Tilordne en opptellingsperiode til en vare
...
### <a name="to-start-a-count-based-on-counting-periods-in-basic-warehouse-configurations" />Slik starter du en opptelling basert på opptellingsperioder i enkle lageroppsett
...
### <a name="to-start-a-count-based-on-counting-periods-in-advanced-warehouse-configurations" />Slik starter du en opptelling basert på opptellingsperioder i avanserte lageroppsett
...
## <a name="to-adjust-the-quantity-of-one-item" />Juster antallet for én vare
...
### <a name="to-adjust-the-quantities-of-multiple-items-in-basic-warehouse-configurations" />Slik justerer du antall for flere varer i enkle lageroppsett
...
### <a name="to-adjust-bin-quantities-in-advanced-warehouse-configurations" />Slik justerer du hylleantall i avanserte lageroppsett.
...
## <a name="to-synchronize-the-adjusted-warehouse-entries-with-the-related-item-ledger-entries" />Slik synkroniserer du de justerte lagerpostene med de tilhørende varepostene
