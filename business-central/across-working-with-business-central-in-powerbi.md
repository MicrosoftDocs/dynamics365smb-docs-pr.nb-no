...
ms.author: jswymer
---
# <a name="work-with--data-in-power-bi" />Arbeid med [!INCLUDE [prod_short](includes/prod_short.md)]-data i Power BI
...
## <a name="upload-reports-from-files" /><a name="upload"></a>Laste opp rapporter fra filer
