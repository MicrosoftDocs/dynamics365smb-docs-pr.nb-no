...
# <a name="cash-flow-overview"></a><a name="cash-flow-overview"></a>Oversikt over kontantstrøm
...
## <a name="definition-of-cash-flow"></a><a name="definition-of-cash-flow"></a>Definisjon av kontantstrøm
...
## <a name="work-with-cash-flow"></a><a name="work-with-cash-flow"></a>Arbeide med kontantstrøm
...
## <a name="making-a-cash-flow-forecast"></a><a name="making-a-cash-flow-forecast"></a>Lage en kontantstrømprognose
