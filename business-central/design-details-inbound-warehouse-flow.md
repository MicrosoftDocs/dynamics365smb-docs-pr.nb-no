...
ms.author: bholtorf
---
# <a name="design-details-inbound-warehouse-flow"></a><a name="design-details-inbound-warehouse-flow"></a>Designdetaljer: Inngående lagerflyt
...
## <a name="no-dedicated-warehouse-activity"></a><a name="no-dedicated-warehouse-activity"></a>Ingen dedikert lageraktivitet
...
## <a name="basic-warehouse-configurations"></a><a name="basic-warehouse-configurations"></a>Enkle lageroppsett
...
### <a name="1-release-a-source-document-to-create-a-request-for-an-inventory-put-away"></a><a name="1-release-a-source-document-to-create-a-request-for-an-inventory-put-away"></a>1: Frigi et kildedokument for å opprette en forespørsel om en lagerplassering
...
### <a name="2-create-an-inventory-put-away"></a><a name="2-create-an-inventory-put-away"></a>2: Opprett en lagerplassering
...
### <a name="3-post-an-inventory-put-away"></a><a name="3-post-an-inventory-put-away"></a>3: Bokfør en lagerplassering
...
### <a name="1-release-the-source-document"></a><a name="1-release-the-source-document"></a>1: Frigi kildedokumentet
...
### <a name="2-create-a-warehouse-receipt"></a><a name="2-create-a-warehouse-receipt"></a>2: Opprett et lagermottak
...
### <a name="3-post-the-warehouse-receipt"></a><a name="3-post-the-warehouse-receipt"></a>3: Bokfør lagermottaket
...
### <a name="4-optional-generate-put-away-worksheet-lines"></a><a name="4-optional-generate-put-away-worksheet-lines"></a>4: (Valgfritt) Generer plasseringsforslagslinjer
...
### <a name="5-create-a-warehouse-put-away-document"></a><a name="5-create-a-warehouse-put-away-document"></a>5: Opprett et lagerplasseringsdokument
...
### <a name="6-register-a-warehouse-put-away"></a><a name="6-register-a-warehouse-put-away"></a>6: Registrer en lagerplassering
...
## <a name="related-tasks"></a><a name="related-tasks"></a>Beslektede oppgaver
