...
---
# <a name="pick-items-for-warehouse-shipment" />Plukke varer for lagerlevering
...
## <a name="to-pick-items-for-a-warehouse-shipment" />Plukke varer for en lagerlevering
