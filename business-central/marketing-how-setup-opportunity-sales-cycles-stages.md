...
ms.author: jswymer
---
# <a name="set-up-opportunity-sales-cycles-and-cycle-stages" />Definere salgssykluser for salgsmuligheter og syklusfaser
...
## <a name="to-set-up-opportunity-sales-cycle-codes" />Definere salgssykluskoder for salgsmuligheter
...
## <a name="to-define-opportunity-sales-cycle-stages" />Definere salgssyklusfaser for salgsmulighet
...
## <a name="to-assign-stage-cycles-to-opportunities" />Tilordne fasesykluser til salgsmuligheter
...
## <a name="to-set-up-activities-with-tasks" />Definere aktiviteter med oppgaver
...
## <a name="to-assign-tasks-or-activities-of-tasks-to-opportunities" />Tilordne oppgaver eller aktiviteter med oppgaver til salgsmuligheter
