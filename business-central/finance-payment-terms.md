...
ms.author: edupont
---
# <a name="set-up-payment-terms"></a><a name="set-up-payment-terms"></a>Definer betalingsbetingelser
...
## <a name="to-set-up-payment-terms"></a><a name="to-set-up-payment-terms"></a>Slik definerer du betalingsbetingelser
