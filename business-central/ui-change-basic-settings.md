...
ms.author: jswymer
---
# <a name="change-basic-settings"></a><a name="change-basic-settings"></a>Endre grunnleggende innstillinger
...
### <a name="change-the-role"></a><a name="change-the-role"></a>Endre rollen
...
## <a name="company"></a><a name="company"></a><a name="company"></a>Selskap
...
### <a name="work-date-indication"></a><a name="work-date-indication"></a>Arbeidsdatoindikasjon
...
## <a name="time-zone"></a><a name="time-zone"></a>Tidssone
...
## <a name="notifications"></a><a name="notifications"></a>Varslinger
...
## <a name="teaching-tips"></a><a name="teaching-tips"></a>Læringstips
