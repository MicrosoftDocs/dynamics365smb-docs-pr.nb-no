...
ms.author: bholtorf
---
# <a name="design-details-average-cost" />Utformingsdetaljer: Gjennomsnittskost
...
## <a name="setting-up-average-cost-calculation" />Konfigurere beregning av gjennomsnittskost
...
## <a name="calculating-average-cost" />Beregne gjennomsnittskost
...
### <a name="example-average-cost-period--day" />Eksempel: Gjennomsnittskostperiode = Dag
...
### <a name="example-average-cost-period--month" />Eksempel: Gjennomsnittskostperiode = Måned
...
## <a name="setting-the-valuation-date" />Angi datoen for verdisetting
...
## <a name="recalculating-average-cost" />Beregne gjennomsnittskost på nytt
...
### <a name="example-of-recalculated-average-cost" />Eksempel på omberegnet gjennomsnittskost
