...
ms.author: jswymer
---
# <a name="get-started-creating-report-layouts"></a><a name="get-started-creating-report-layouts"></a>Kom i gang med å opprette rapportoppsett
...
## <a name="decide-what-type-of-layout-you-want"></a><a name="decide-what-type-of-layout-you-want"></a><a name="decide"></a>Bestem hvilken type oppsett du vil bruke
...
## <a name="create-a-new-layout"></a><a name="create-a-new-layout"></a><a name="create"></a>Opprett et nytt oppsett
...
## <a name="modify-a-layout"></a><a name="modify-a-layout"></a><a name="modify"></a>Endre et oppsett
...
## <a name="replace-a-layout"></a><a name="replace-a-layout"></a><a name="replace"></a>Erstatt et oppsett
...
## <a name="rename-a-layout"></a><a name="rename-a-layout"></a><a name="rename"></a>Gi et oppsett nytt navn
