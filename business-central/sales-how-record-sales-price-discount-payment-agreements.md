...
> [!Note]
> Når du åpner vinduene **Salgspriser** og **Salgslinjerabatter** fra en bestemt kunde, angis feltene **Salgstypefilter** og **Salgskodefilter** for kunden, og de kan ikke endres eller fjernes, angitt av den grå verdien i feltet **Salgskodefilter**.
>
