...
---
# <a name="walkthrough-set-up-and-use-a-purchase-approval-workflow"></a>Gjennomgang: Konfigurer og bruk en arbeidsflyt for kjøpsgodkjenning
...
## <a name="create-the-approval-workflow"></a>Opprett arbeidsflyten for godkjenning
