...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-using-a-purchase-approval-workflow" />Gjennomgang: Definere og bruke en arbeidsflyt for kjøpsgodkjenning
...
### <a name="setting-up-approval-users" />Definere godkjenningsbrukere
...
#### <a name="to-set-up-yourself-and-alicia-as-approval-users" />Slik definerer du deg selv og Charlotte som godkjenningsbrukere
...
### <a name="setting-up-notifications" />Definer varsler
...
#### <a name="to-set-up-how-and-when-you-are-notified" />Slik definerer du hvordan og når du blir varslet
...
## <a name="creating-the-approval-workflow" />Opprette arbeidsflyten for godkjenning
...
### <a name="to-create-and-enable-a-purchase-order-approval-workflow" />Slik oppretter og aktiverer du en arbeidsflyt for bestillingsgodkjenning:
...
## <a name="use-the-approval-workflow" />Bruk arbeidsflyten for godkjenning
...
### <a name="to-request-approval-of-a-purchase-order-as-alicia" />Slik ber du om godkjenning av en bestilling som Charlotte:
...
### <a name="to-approve-the-purchase-order-as-sean" />Slik godkjenner du bestillingen som Stig:
