...
Når du oppretter et nytt selskap, gir en guide for assistert oppsett deg det grunnleggende. Deretter kan du importere data fra det gamle systemet eller et annet selskap i [!INCLUDE[prod_short](includes/prod_short.md)].  
...
Veiledningen for oppsett har tre maler og et tomt alternativ:

- **Evaluering – eksempeldata**  
    Opprett et selskap som ligner på demoselskapet, med eksempeldata og oppsettsdata. Denne typen selskap er tilgjengelig for deg uten å bytte til en 30-dagers prøveperiode, som de andre typene har.  
- **Avansert evaluering – komplette eksempeldata** Opprett et selskap med omfanget av avansert funksjonalitet, som har alt du trenger for å evaluere produktet for selskaper med avanserte prosesser. Denne typen selskap er tilgjengelig for deg uten å bytte til en 30-dagers prøveperiode, som de andre typene har.
- **Produksjon – bare konfigurasjonsdata**  
    Opprett et selskap som ligner på **Mitt selskap**, med oppsettsdata som kontoplan, betalingsmåter og definisjoner av finansrapporter, men uten eksempeldata. Du kan bruke dette selskapet i en 30-dagers prøveperiode.
- **Opprett ny – ingen data**  
    Opprett et tomt selskap uten oppsettsdata. Du kan bruke dette selskapet i en 30-dagers prøveperiode.  
...
På siden **Selskaper** kan du bruke **Kopier**-handlingen til å opprette et annet selskap basert på innholdet i et eksisterende selskap. Kopiering av et selskap er nyttig når du vil teste et selskap uten å forstyrre produksjonsdata.
...
Når du logger deg på et nytt selskap, hjelper veiledningen for assistert oppsett **Selskapsoppsett** deg med å komme i gang. Veiledningen ber om informasjon om selskapet, for eksempel adressen, bankdetaljer og lagerkostmetoden. Denne informasjonen danner grunnlaget for mange områder i [!INCLUDE[prod_short](includes/prod_short.md)], slik at du ikke trenger å definere dem manuelt.  
...
Når det grunnleggende er på plass, kan du definere de gjenstående kjerneområdene. Deretter er du klar til å legge til forretningsdataene, for eksempel kunder og leverandører. Hvis du vil ha mer informasjon, kan du se [Konfigurer [!INCLUDE[prod_short](includes/prod_short.md)]](setup.md).  
...
Når du har opprettet et selskap, kan du ikke endre navnet på det. Du kan imidlertid endre **visningsnavnet**, som er tekst som vises for selskapet i programmet.  
