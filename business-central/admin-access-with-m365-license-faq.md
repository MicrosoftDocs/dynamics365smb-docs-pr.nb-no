...
## <a name="permissions"></a>[Tillatelser](#tab/permissions) 
...
## <a name="setup-and-configuration"></a>[Oppsett og konfigurasjon](#tab/setup)
...
## <a name="licensing"></a>[Lisensiering](#tab/license)
...
## <a name="usage"></a>[Forbruk](#tab/usage)
