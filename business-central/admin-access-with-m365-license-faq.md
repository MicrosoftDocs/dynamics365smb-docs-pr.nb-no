...
---
# <a name="access-with-microsoft-365-licenses-faq" />Vanlige spørsmål om tilgang med Microsoft 365-lisenser
...
### <a name="can-i-proactively-configure-different-starting-permissions-for-different-groups-of-users" />Kan jeg proaktivt konfigurere forskjellige oppstartstillatelser for ulike brukergrupper?
...
### <a name="can-i-proactively-configure-permissions-profiles-and-settings-for-individual-users-before-they-sign-in" />Kan jeg konfigurere tillatelser, profiler og innstillinger for individuelle brukere på en proaktiv måte før de logger seg på?
...
### <a name="after-a-user-signs-in-can-i-change-which-objects-they-have-access-to" />Når en bruker har logget seg på, kan jeg endre hvilke objekter de har tilgang til?
...
### <a name="how-do-i-prevent-access-to-sensitive-tables" />Hvordan hindrer jeg tilgang til sensitive tabeller?
...
### <a name="instead-of-customizing-the-license-configuration-can-i-customize-a-user-group" />Kan jeg tilpasse en brukergruppe i stedet for å tilpasse lisenskonfigurasjonen?
...
### <a name="when-a-business-central-user-shares-a-record-in-teams-do-they-grant-new-permissions" />Når en Business Central-bruker deler en post i Teams, gir de nye tillatelser?
...
### <a name="does-this-feature-support-row-level-security" />Støtter denne funksjonen sikkerhet på radnivå?
...
### <a name="if-i-configure-permissions-that-include-write-access-will-users-be-able-to-write-in-teams" />Hvis jeg konfigurerer tillatelser som omfatter skrivetilgang, kan brukere skrive i Teams?
...
### <a name="why-is-the-setting-to-enable-access-not-available-for-my-environment" />Hvorfor er innstillingen for å aktivere tilgang ikke tilgjengelig for miljøet mitt?
...
### <a name="can-i-access-business-central-on-premises-with-microsoft-365-licenses" />Kan jeg åpne Business Central lokalt med Microsoft 365-lisenser?
...
### <a name="what-is-the-employee-profile" />Hva er ansattprofilen?
...
### <a name="what-is-the-teams-users-user-group" />Hva er Teams-brukergruppen?
...
### <a name="do-users-that-only-have-a-microsoft-365-license-show-up-in-the-users-list-in-business-central" />Vises brukere som bare har en Microsoft 365-lisens, i brukerlisten i Business Central?
...
### <a name="does-this-feature-work-for-embed-isv-solutions" />Fungerer denne funksjonen for å bygge inn ISV-løsninger?
...
### <a name="can-a-customer-use-this-feature-if-they-dont-have-business-central" />Kan en kunde bruke denne funksjonen hvis de ikke har Business Central?
...
### <a name="how-does-this-help-me-manage-subscription-costs-in-my-organization" />Hvordan kan dette hjelpe meg å administrere abonnementskostnader i organisasjonen min?
...
### <a name="is-this-100-free-of-charge" />Er dette 100 % kostnadsfritt?
...
### <a name="does-this-work-with-microsoft-365-trials-and-business-central-trials" />Fungerer dette med prøveversjoner av Microsoft 365 og Business Central?
...
### <a name="the-list-of-licenses-in-business-central-shows-a-microsoft-365-license-whats-that" />Listen over lisenser i Business Central viser en Microsoft 365-lisens. Hva er det?
...
### <a name="do-i-need-to-acquire-a-new-type-of-microsoft-365-license-for-this-feature-to-work" />Må jeg anskaffe en ny type Microsoft 365-lisens for at denne funksjonen skal fungere?
...
### <a name="how-do-i-find-out-which-users-have-only-a-microsoft-365-license" />Hvordan finner jeg ut hvilke brukere som bare har en Microsoft 365-lisens?
...
### <a name="how-do-i-filter-the-users-list-in-business-central-to-see-users-that-only-have-a-microsoft-365-license" />Hvordan filtrerer jeg brukerlisten i Business Central for å se brukere som bare har en Microsoft 365-lisens?
...
### <a name="what-about-users-that-have-both-a-microsoft-365-license-and-a-business-central-license" />Hva med brukere som både har en Microsoft 365-lisens og en Business Central-lisens?
...
### <a name="is-this-licensing-related-to-the-business-central-team-member-license" />Er denne lisensieringen knyttet til Business Central Team Member-lisensen?
...
### <a name="does-business-central-enforce-any-of-the-constraints" />Håndhever Business Central noen av begrensningene?
...
### <a name="can-i-access-records-on-teams-for-ios-and-teams-for-android" />Får jeg tilgang til poster på Teams for iOS og Teams for Android?
...
### <a name="how-do-users-change-their-personal-settings-in-my-settings" />Hvordan endrer brukerne sine personlige innstillinger i Mine innstillinger?
...
### <a name="what-determines-the-choice-of-language-when-you-sign-in-for-the-first-time" />Hvilket bestemmer valget av språk når du logger deg på første gang?
...
### <a name="why-cant-i-activate-some-of-the-colored-links-in-tabs-and-card-details" />Hvorfor kan jeg ikke aktivere noen av de fargede koblingene i faner og kortdetaljer?
...
### <a name="why-cant-i-activate-page-notification-actions" />Hvorfor kan jeg ikke aktivere sidevarslingshandlinger?
...
### <a name="can-microsoft-365-users-remove-tabs" />Kan Microsoft 365-brukere fjerne faner?
...
### <a name="if-i-cant-filter-will-i-still-see-a-filtered-list-that-was-created-by-others" />Hvis jeg ikke kan filtrere, kan jeg fortsatt se en filtrert liste som ble opprettet av andre?
