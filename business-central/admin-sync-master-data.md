...
---
# <a name="manage-master-data-synchronization" />Administrer synkronisering av hoveddata
...
## <a name="investigate-the-status-of-synchronization" />Undersøk statusen til synkroniseringen
...
## <a name="synchronize-modified-records" />Synkroniser endrede oppføringer
...
## <a name="update-table-schemas" />Oppdater tabellskjemaer
...
## <a name="enable-or-disable-couplings-between-records" />Aktiver eller deaktiver kobling mellom oppføringer
...
## <a name="adding-extensions" />Legg til utvidelser
...
## <a name="clean-up-old-entries" />Rydd opp i gamle oppføringer
