...
# <a name="set-up-taxes-for-the-shopify-connection" />Definere avgifter for Shopify-forbindelse
...
## <a name="if-you-sell-domestically" />Hvis du selger hjemme
...
## <a name="if-you-sell-internationally" />Hvis du selger internasjonalt
...
## <a name="dynamic-tax-inclusive-pricing" />Dynamisk mva-inklusiv pris
...
## <a name="if-you-sell-to-eu-customers" />Hvis du selger til EU-kunder
...
### <a name="collect-vat-set-to-one-stop-shop-registration" />Samle inn mva-registrering til registrering på ett sentralt sted
...
### <a name="collect-vat-set-to-micro-business-exemption" />Samle inn mva-sett til Micro-Business-fritak
...
## <a name="importing-shopify-orders-sold-to-international-customers" />Importere Shopify-bestillinger solgt til internasjonale kunder
...
## <a name="other-tax-remarks" />Andre avgiftsmerknader
