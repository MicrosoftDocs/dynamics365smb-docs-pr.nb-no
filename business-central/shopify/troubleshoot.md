...
Du har kanskje brukt [Bygg inn-appen](/dynamics365/business-central/dev-itpro/deployment/embed-app-overview) der klientnettadressen har formatet: `https://[application name].bc.dynamics.com`. Shopify-koblingen fungerer ikke for innebygde apper. Hvis du vil finne ut mer, kan du gå til [Hvilke Microsoft-produkter fungerer med Shopify-koblingen?](shopify-faq.md#which-microsoft-products-work-with-the-shopify-connector).
