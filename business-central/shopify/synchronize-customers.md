...
# <a name="synchronize-customers" />Synkroniser kunder
...
## <a name="important-settings-when-importing-customers-from-shopify" />Viktige innstillinger når du importerer kunder fra Shopify
...
### <a name="customer-template-per-country" />Kundemal per land
...
## <a name="export-customers-to-shopify" />Eksporter kunder til Shopify
...
### <a name="populate-customer-information-in-shopify" />Fyll ut kundeinformasjon i Shopify
...
## <a name="sync-customers" />Synkroniser kunder
