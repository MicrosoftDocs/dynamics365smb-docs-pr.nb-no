...
# <a name="synchronize-and-fulfill-sales-orders" />Synkroniser og oppfyll salgsordrer
...
## <a name="set-the-import-of-orders-on-the-shopify-shop-card" />Angi importen av ordrer på Shopify-butikkortet
...
I feltet **Avgiftsområdeprioritet** kan du angi prioriteten for hvordan du velger avgiftsområdekode på adresser i rekkefølge. Den importerte Shopify-ordren inneholder informasjon om avgifter. Avgifter beregnes på nytt når du oppretter salgsdokumentet, så det er viktig at mva-/avgiftsinnstillingene er riktige i [!INCLUDE[prod_short](../includes/prod_short.md)]. Hvis du vil ha mer informasjon om avgifter, kan du se [Definer avgifter for Shopify-koblingen](setup-taxes.md).
...
### <a name="shipment-method-mapping" />Tildeling av leveringsmåte
...
### <a name="location-mapping" />Lokasjonstildeling
...
## <a name="run-the-order-synchronization" />Kjør ordresynkroniseringen
...
## <a name="review-imported-orders" />Se gjennom importerte ordrer
...
## <a name="create-sales-documents-in-business-central" />Opprett salgsdokumenter i Business Central
...
### <a name="to-create-sales-documents" />Slik oppretter du salgsdokumenter
...
### <a name="how-the-connector-chooses-which-customer-to-use" />Slik velger koblingen hvilken kunde som skal brukes
...
### <a name="different-processing-rules-for-orders" />Ulike behandlingsregler for ordrer
...
>![Viktig!] Hvis du vil unngå konflikter under behandling av ordrer, må du huske å bruke samme prosjektkøkategori for begge prosjektkøoppføringene.

### <a name="impact-of-order-editing" />Virkningen av ordreredigering
...
## <a name="synchronize-shipments-to-shopify" />Synkroniser leveringer til Shopify
...
### <a name="shipping-agents-and-tracking-url" />Transportører og sporingsnettadresse
...
## <a name="returns-and-refunds" />Returer og refusjoner
