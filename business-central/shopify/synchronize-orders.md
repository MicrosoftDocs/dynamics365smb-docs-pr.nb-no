...
>[!NOTE]
>Salgsdokumentet i [!INCLUDE[prod_short](../includes/prod_short.md)] kobles til Shopify-ordren, og du kan legge til feltet **Shopify-ordrenr.** til oversikten eller kortsidene for salgsordrer, fakturaer og levering. Hvis du vil ha mer informasjon om hvordan du legger til et felt, går du til [Slik begynner du å tilpasse en side gjennom **Tilpasning**-banneret](../ui-personalization-user.md#to-start-personalizing-a-page-through-the-personalizing-banner). 
