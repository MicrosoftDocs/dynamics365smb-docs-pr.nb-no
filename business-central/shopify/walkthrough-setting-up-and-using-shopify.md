...
# <a name="walkthrough-set-up-and-use-the-shopify-connector"></a><a name="walkthrough-set-up-and-use-the-shopify-connector"></a>Gjennomgang: Konfigurer og bruk Shopify-koblingen
...
## <a name="connect-business-central-to-the-shopify-shop"></a><a name="connect-business-central-to-the-shopify-shop"></a>Koble Business Central til Shopify-butikken
...
## <a name="walkthrough-start-selling-products-online"></a><a name="walkthrough-start-selling-products-online"></a>Gjennomgang: Begynn å selge produkter på nettet
...
## <a name="walkthrough-invite-your-customers-to-your-new-online-store"></a><a name="walkthrough-invite-your-customers-to-your-new-online-store"></a>Gjennomgang: Inviter kunder til den nye nettbutikken
...
### <a name="steps-1"></a><a name="steps-1"></a>Trinn
...
## <a name="walkthrough-fine-tuning-of-item-management"></a><a name="walkthrough-fine-tuning-of-item-management"></a>Gjennomgang: Finjustering av varestyring
...
### <a name="steps-2"></a><a name="steps-2"></a>Trinn
...
## <a name="walkthrough-import-items-from-shopify"></a><a name="walkthrough-import-items-from-shopify"></a>Gjennomgang: Importer varer fra Shopify
...
### <a name="steps-3"></a><a name="steps-3"></a>Trinn
...
#### <a name="prepare-data"></a><a name="prepare-data"></a>Klargjør data
...
#### <a name="run-the-synchronization"></a><a name="run-the-synchronization"></a>Kjør synkroniseringen
