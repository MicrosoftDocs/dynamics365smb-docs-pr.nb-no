...
# <a name="walkthrough-set-up-and-use-the-shopify-connector" />Gjennomgang: Konfigurer og bruk Shopify-koblingen
...
## <a name="connect-business-central-to-the-shopify-shop" />Koble Business Central til Shopify-butikken
...
## <a name="walkthrough-start-selling-products-online" />Gjennomgang: Begynn å selge produkter på nettet
...
#### <a name="prepare-data" />Klargjør data
...
#### <a name="run-the-synchronization" />Kjør synkroniseringen
