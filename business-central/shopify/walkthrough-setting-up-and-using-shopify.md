...
5. Velg *Beregnet disponibel saldo i dag* i feltet **Lagerberegning** for å aktivere en lagersynkronisering for en valgt Shopify-lokasjon.
...
6. Velg **Synkroniser produktbilder**.
7. Velg **Synkroniser lager**.
...
Du vil legge til mer fleksibelt og kontroll i prosessene rundt varestyring. Du ønsker å forbedre produktbeskrivelsene og vil legge til flere gjennomgangstrinn før produkter blir tilgjengelig for kundene.
...
Velg vare **1896-S, Athens Desk** og følg denne fremgangsmåten:
...
2. Velg handlingen **Utvidet tekst**, og opprett deretter en ny utvidet tekst som gjelder alle språkkoder. Angi `Shopify` i **Beskrivelse**-feltet. 
...
Velg varen **1920-S, ANTWERP Conference Table** og følg denne fremgangsmåten:
...
1. Deaktiver vekslebryteren **Tillat bakgrunnssynkroniseringer**.
1. Velg *Fra Shopify* velger du **Synkroniser vare**-feltet.
1. Aktiver vekslebryteren **Opprett ukjente varer automatisk**.
1. Fyll ut feltet **Varemalkode** med riktig mal.
1. Velg *Fra Shopify* velger du **Synkroniser varebilder**-feltet.
1. Velg *Alle kunder* i **Kundeimport fra Shopify**.
1. Aktiver vekslebryteren **Opprett ukjente kunder automatisk**.
