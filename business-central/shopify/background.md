...
# <a name="run-tasks-in-the-background" />Kjør oppgaver i bakgrunnen
...
## <a name="run-tasks-in-the-background-for-a-specific-shop" />Kjør oppgaver i bakgrunnen for en bestemt butikk
...
## <a name="to-schedule-recurring-tasks" />Slik planlegger du regelmessige oppgaver
