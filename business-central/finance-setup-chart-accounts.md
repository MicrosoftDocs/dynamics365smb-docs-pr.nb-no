...
ms.author: edupont
---
# <a name="set-up-or-change-the-chart-of-accounts"></a><a name="set-up-or-change-the-chart-of-accounts"></a>Definere eller endre kontoplanen
...
## <a name="add-or-change-accounts"></a><a name="add-or-change-accounts"></a>Legg til eller endre kontoer
...
## <a name="delete-accounts"></a><a name="delete-accounts"></a>Slett kontoer
...
## <a name="block-deletion-of-gl-accounts"></a><a name="block-deletion-of-gl-accounts"></a>Blokker sletting av finanskontoer
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/modules/chart-accounts-dynamics-365-business-central/index)
