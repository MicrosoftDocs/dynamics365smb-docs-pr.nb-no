...
ms.author: edupont
---
# <a name="set-up-units-of-measure" />Definere enheter
...
## <a name="to-set-up-units-of-measure" />Slik definerer du enheter
...
## <a name="to-set-up-multiple-item-units-of-measure" />Slik definerer du flere vareenheter
...
## <a name="to-set-up-unit-of-measure-translations" />Slik definerer du enhetsoversettelser
...
## <a name="to-enter-a-default-unit-of-measure-code-for-sales-and-purchasing-transactions" />Angi en standardenhetskode for kjøpstransaksjoner
