...
ms.author: edupont
---
# <a name="add-extended-text" />Legge til utvidet tekst
...
## <a name="to-define-extended-text-for-an-description" />Slik definerer du utvidet tekst for en beskrivelse
...
## <a name="to-add-an-extended-item-text-on-a-sales-order-line" />Legge til teksten for utvidet vare på en ordrelinje
