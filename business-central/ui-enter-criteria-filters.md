...
ms.author: jswymer
---
# <a name="sorting-searching-and-filtering" />Sortere, søke etter og filtrere
...
### <a name="fine-tuning-the-search-with-filter-criteria" />Finjustere søket med filterkriterier
...
### <a name="filtering-with-option-fields" />Filtrere med alternativfelt
...
### <a name="setting-filters-on-lists" />Definere filtre på oversikter
...
### <a name="setting-filters-in-reports-batch-jobs-and-xmlports" />Definere filtre i rapporter, kjørsler og XMLport-er
...
## <a name="entering-filter-criteria" />Angi filtervilkår
...
#### <a name="-not-equal-to" />(<>) Ikke lik med
...
#### <a name="-greater-than" />(>) Større enn

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`>1200`|Tall som er større enn 1200|  

#### <a name="-greater-than-or-equal-to" />(>=) Større enn eller lik med

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`>=1200`|Tall som er større enn eller lik 1200|  

#### <a name="-less-than" />(<) Mindre enn

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`<1200`|Tall som er mindre enn 1200|  

#### <a name="-less-than-or-equal-to" />(<=) Mindre enn eller lik med
...
#### <a name="-an-exact-character-match" />('') Finne et nøyaktig tegntreff
...
#### <a name="-case-insensitive" />(@) Skiller ikke mellom små og store bokstaver

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`@man*`|Tekst som begynner med **man** og skiller mellom store og små bokstaver.|  

#### <a name="-an-indefinite-number-of-unknown-characters" />(*) Et ubegrenset antall ukjente tegn
...
#### <a name="-one-unknown-character" />(?) Ett ukjent tegn

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`Hans?n`|Tekst som for eksempel **Hansen** eller **Hanson**|  

#### <a name="combined-format-expressions" />Kombinerte formatuttrykk
...
### <a name="filtering-on-values-that-contain-symbols" /><a name="symbols"></a>Filtrere etter verdier som inneholder symboler
...
### <a name="a-namefiltertokens-afilter-tokens" /><a name="FilterTokens"> </a>Filtersymboler
...
#### <a name="me-or-userid-records-assigned-to-you" />(%me eller %userid) Poster som er tilordnet til deg
...
#### <a name="mycustomers-customers-in-my-customers" />(%mycustomers) Kunder i Mine kunder
...
#### <a name="myvendors-vendors-in-my-vendors" />(%myvendors) Leverandører i Mine leverandører
...
## <a name="see-related-microsoft-training" />Se relatert [Microsoft-opplæring](/training/modules/search-filter-sort-data-dynamics-365-business-central/)
