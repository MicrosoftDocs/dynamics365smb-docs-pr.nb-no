...
ms.author: jswymer
---
# <a name="sorting-searching-and-filtering"></a><a name="sorting-searching-and-filtering"></a>Sortere, søke etter og filtrere
...
## <a name="searching"></a><a name="searching"></a>Søke
...
### <a name="fine-tuning-the-search-with-filter-criteria"></a><a name="fine-tuning-the-search-with-filter-criteria"></a>Finjustere søket med filterkriterier
...
### <a name="filtering-with-option-fields"></a><a name="filtering-with-option-fields"></a>Filtrere med alternativfelt
...
### <a name="setting-filters-on-lists"></a><a name="setting-filters-on-lists"></a>Definere filtre på oversikter
...
### <a name="setting-filters-in-reports-batch-jobs-and-xmlports"></a><a name="setting-filters-in-reports-batch-jobs-and-xmlports"></a>Definere filtre i rapporter, kjørsler og XMLport-er
...
## <a name="entering-filter-criteria"></a><a name="entering-filter-criteria"></a>Angi filtervilkår
...
#### <a name="-not-equal-to"></a><a name="-not-equal-to"></a>(<>) Ikke lik med
...
#### <a name="-greater-than"></a><a name="-greater-than"></a>(>) Større enn

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`>1200`|Tall som er større enn 1200|  

#### <a name="-greater-than-or-equal-to"></a><a name="-greater-than-or-equal-to"></a>(>=) Større enn eller lik med

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`>=1200`|Tall som er større enn eller lik 1200|  

#### <a name="-less-than"></a><a name="-less-than"></a>(<) Mindre enn

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`<1200`|Tall som er mindre enn 1200|  

#### <a name="-less-than-or-equal-to"></a><a name="-less-than-or-equal-to"></a>(<=) Mindre enn eller lik med
...
#### <a name="-an-exact-character-match"></a><a name="-an-exact-character-match"></a>('') Finne et nøyaktig tegntreff
...
#### <a name="-case-insensitive"></a><a name="-case-insensitive"></a>(@) Skiller ikke mellom små og store bokstaver

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`@man*`|Tekst som begynner med **man** og skiller mellom store og små bokstaver.|  

#### <a name="-an-indefinite-number-of-unknown-characters"></a><a name="-an-indefinite-number-of-unknown-characters"></a>(*) Et ubegrenset antall ukjente tegn
...
#### <a name="-one-unknown-character"></a><a name="-one-unknown-character"></a>(?) Ett ukjent tegn

|Eksempel|Viste poster|  
|-----------------------|-----------------------|  
|`Hans?n`|Tekst som for eksempel **Hansen** eller **Hanson**|  

#### <a name="combined-format-expressions"></a><a name="combined-format-expressions"></a>Kombinerte formatuttrykk
...
### <a name="filtering-on-values-that-contain-symbols"></a><a name="filtering-on-values-that-contain-symbols"></a><a name="symbols"></a>Filtrere etter verdier som inneholder symboler
...
### <a name="a-namefiltertokens-afilter-tokens"></a><a name="a-namefiltertokens-afilter-tokens"></a><a name="FilterTokens"> </a>Filtersymboler
...
#### <a name="me-or-userid-records-assigned-to-you"></a><a name="me-or-userid-records-assigned-to-you"></a>(%me eller %userid) Poster som er tilordnet til deg
...
#### <a name="mycustomers-customers-in-my-customers"></a><a name="mycustomers-customers-in-my-customers"></a>(%mycustomers) Kunder i Mine kunder
...
#### <a name="myvendors-vendors-in-my-vendors"></a><a name="myvendors-vendors-in-my-vendors"></a>(%myvendors) Leverandører i Mine leverandører
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/modules/search-filter-sort-data-dynamics-365-business-central/)
