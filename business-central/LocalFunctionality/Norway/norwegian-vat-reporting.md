...
ms.author: edupont
---
# <a name="norwegian-vat-reporting-in-the-norwegian-version"></a><a name="norwegian-vat-reporting-in-the-norwegian-version"></a>Norsk mva-rapportering i den norske versjonen
...
## <a name="set-up-business-central-to-generate-and-submit-electronic-vat-returns"></a><a name="set-up-business-central-to-generate-and-submit-electronic-vat-returns"></a>Konfigurere Business Central for å generere og sende inn elektroniske omsetningsoppgaver
...
### <a name="register-your-company-with-id-porten"></a><a name="register-your-company-with-id-porten"></a>Registrere selskapet i ID-porten
...
### <a name="set-up-the-integration-point"></a><a name="set-up-the-integration-point"></a>Konfigurere integrasjonspunktet
...
### <a name="set-up-electronic-vat-reporting"></a><a name="set-up-electronic-vat-reporting"></a>Konfigurer elektronisk mva-rapportering
...
### <a name="vat-report-setup"></a><a name="vat-report-setup"></a>Mva-rapportoppsett
...
## <a name="create-and-submit-a-vat-return"></a><a name="create-and-submit-a-vat-return"></a>Opprett og send en mva-retur
...
## <a name="troubleshoot-your-connection-to-id-porten"></a><a name="troubleshoot-your-connection-to-id-porten"></a>Feilsøk tilkoblingen til ID-porten
...
## <a name="close-vat-periods"></a><a name="close-vat-periods"></a><a name="vat-periods"></a>Avslutt mva-perioder
...
## <a name="tradesettlement-report"></a><a name="tradesettlement-report"></a>Rapport for omsetningsoppgave
