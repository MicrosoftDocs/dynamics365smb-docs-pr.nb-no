...
ms.author: edupont
---
# <a name="norwegian-vat-reporting-in-the-norwegian-version" />Norsk mva-rapportering i den norske versjonen
...
## <a name="set-up-business-central-to-generate-and-submit-electronic-vat-returns" />Konfigurere Business Central for å generere og sende inn elektroniske omsetningsoppgaver
...
### <a name="register-your-company-with-id-porten" />Registrere selskapet i ID-porten
...
### <a name="set-up-the-integration-point" />Konfigurere integrasjonspunktet
...
### <a name="set-up-electronic-vat-reporting" />Konfigurer elektronisk mva-rapportering
...
### <a name="vat-report-setup" />Mva-rapportoppsett
...
## <a name="create-and-submit-a-vat-return" />Opprett og send en mva-retur
...
## <a name="troubleshoot-your-connection-to-id-porten" />Feilsøk tilkoblingen til ID-porten
...
## <a name="tradesettlement-report" />Rapport for omsetningsoppgave
