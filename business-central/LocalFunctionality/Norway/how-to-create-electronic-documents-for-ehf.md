...
ms.author: edupont
---
# <a name="create-electronic-documents-for-ehf"></a><a name="create-electronic-documents-for-ehf"></a><a name="create-electronic-documents-for-ehf"></a>Opprette elektroniske dokumenter for EHF
...
## <a name="to-post-a-sales-invoice"></a><a name="to-post-a-sales-invoice"></a><a name="to-post-a-sales-invoice"></a>Slik bokfører du en salgsfaktura:
...
## <a name="to-create-an-electronic-sales-invoice"></a><a name="to-create-an-electronic-sales-invoice"></a><a name="to-create-an-electronic-sales-invoice"></a>Slik oppretter du en elektronisk salgsfaktura:
