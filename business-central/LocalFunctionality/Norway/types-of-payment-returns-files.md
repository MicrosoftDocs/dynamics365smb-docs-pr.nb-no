...
ms.author: edupont
---
# <a name="types-of-payment-returns-files-in-the-norwegian-version" />Typer betalingsreturfiler i den norske versjonen
...
## <a name="receipt-returns" />Mottaksreturer
...
## <a name="settlement-returns" />Avregningsreturer
...
## <a name="exchange-rates-by-settlement" />Valutakurser ved oppgjør
...
## <a name="warnings-on-settlement-returns" />Advarsler i avregningsreturer
