...
ms.author: edupont
---
# <a name="set-up-ehf-in-the-norwegian-version" />Konfigurer EHF i den norske versjonen
...
## <a name="to-set-up-ehf-file-locations-for-sales-and-receivables" />Slik definerer du EHF-filplasseringer for salg:
...
## <a name="to-set-up-ehf-file-locations-for-service-management" />Slik definerer du EHF-filplasseringer for servicestyring:
