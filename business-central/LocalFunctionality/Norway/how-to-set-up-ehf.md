...
ms.author: edupont
---
# <a name="set-up-ehf-in-the-norwegian-version"></a><a name="set-up-ehf-in-the-norwegian-version"></a><a name="set-up-ehf-in-the-norwegian-version"></a>Konfigurer EHF i den norske versjonen
...
## <a name="to-set-up-ehf-file-locations-for-sales-and-receivables"></a><a name="to-set-up-ehf-file-locations-for-sales-and-receivables"></a><a name="to-set-up-ehf-file-locations-for-sales-and-receivables"></a>Slik definerer du EHF-filplasseringer for salg:
...
## <a name="to-set-up-ehf-file-locations-for-service-management"></a><a name="to-set-up-ehf-file-locations-for-service-management"></a><a name="to-set-up-ehf-file-locations-for-service-management"></a>Slik definerer du EHF-filplasseringer for servicestyring:
