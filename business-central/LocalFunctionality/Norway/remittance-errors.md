...
ms.author: edupont
---
# <a name="remittance-errors-in-the-norwegian-version" />Remitteringsfeil i den norske versjonen
...
## <a name="types-of-errors" />Feiltyper
Det finnes to typer remitteringsfeil:  

- Overføringsfeil  
- Avvisning  

## <a name="transfer-errors" />Overføringsfeil
