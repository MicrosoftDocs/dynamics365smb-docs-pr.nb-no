...
ms.author: edupont
---
# <a name="remittance-errors-in-the-norwegian-version"></a><a name="remittance-errors-in-the-norwegian-version"></a>Remitteringsfeil i den norske versjonen
...
## <a name="types-of-errors"></a><a name="types-of-errors"></a>Feiltyper
Det finnes to typer remitteringsfeil:  

- Overføringsfeil  
- Avvisning  

## <a name="transfer-errors"></a><a name="transfer-errors"></a>Overføringsfeil
...
## <a name="rejections"></a><a name="rejections"></a>Avslag
