...
ms.author: edupont
---
# <a name="apply-general-ledger-entries-in-closed-periods" />Utligne finansposter i lukkede perioder
...
## <a name="to-apply-an-entry-in-a-closed-period" />Slik utligner du en post i en lukket periode
