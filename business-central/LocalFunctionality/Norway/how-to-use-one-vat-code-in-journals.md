...
ms.author: edupont
---
# <a name="use-one-vat-code-in-journals-in-norway"></a><a name="use-one-vat-code-in-journals-in-norway"></a>Bruk én mva-kode i kladder i Norge
...
## <a name="to-create-a-vat-code"></a><a name="to-create-a-vat-code"></a>Slik oppretter du en mva-kode:
...
## <a name="to-set-up-vat-posting"></a><a name="to-set-up-vat-posting"></a>Slik definerer du mva-bokføring:
