...
ms.author: edupont
---
# <a name="norwegian-vat-codes" />Norske mva-koder
...
## <a name="set-up-of-norwegian-vat-codes" />Definere norske mva-koder
...
## <a name="use-of-vat-codes" />Bruk av mva-koder
...
### <a name="example-using-vat-codes" />Eksempel: Bruke mva-koder
...
### <a name="example-restricting-the-use-of-vat-codes" />Eksempel: Begrense bruken av mva-koder
