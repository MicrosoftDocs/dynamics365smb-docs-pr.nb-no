...
ms.author: edupont
---
# <a name="norwegian-vat-codes"></a><a name="norwegian-vat-codes"></a>Norske mva-koder
...
## <a name="set-up-of-norwegian-vat-codes"></a><a name="set-up-of-norwegian-vat-codes"></a>Definere norske mva-koder
...
## <a name="use-of-vat-codes"></a><a name="use-of-vat-codes"></a>Bruk av mva-koder
...
### <a name="example-using-vat-codes"></a><a name="example-using-vat-codes"></a>Eksempel: Bruke mva-koder
...
### <a name="example-restricting-the-use-of-vat-codes"></a><a name="example-restricting-the-use-of-vat-codes"></a>Eksempel: Begrense bruken av mva-koder
