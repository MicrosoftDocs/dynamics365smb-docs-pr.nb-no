...
Fra januar 2019 vil kravene for å sende elektroniske fakturaer være basert på PEPPOL BIS Billing 3.0-standarden. Hvis du vil ha mer informasjon, kan du se siden [EHF Billing 3.0](https://anskaffelser.dev/postaward/g3/spec/current/billing-3.0/norway/) fra Direktoratet for forvaltning og ikt. Selskaper som allerede sender elektroniske dokumenter i før-2019-format, kan fortsette å gjøre dette i 2019.

> [MERK!] Du kan bruke [Anskaffelser.dev-validatoren](https://anskaffelser.dev/service/validator) til å validere EHF-faktureringsformatene dine.  
...
## <a name="vat-treatment"></a>Mva-behandling
...
|K|Mva-fritak for intra-EØS-levering av varer og tjenester|
...
[Konfigurer kunder for EHF](how-to-set-up-customers-for-ehf.md)
