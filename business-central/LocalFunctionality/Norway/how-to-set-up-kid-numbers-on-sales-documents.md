...
ms.author: edupont
---
# <a name="set-up-kid-numbers-on-sales-documents" />Opprette KID-numre på salgsdokumenter
...
## <a name="to-set-up-kid-numbers-on-sales-documents" />Slik oppretter du KID-numre på salgsdokumenter
