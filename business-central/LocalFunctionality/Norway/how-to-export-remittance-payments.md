...
ms.author: edupont
---
# <a name="export-remittance-payments-in-the-norwegian-version"></a><a name="export-remittance-payments-in-the-norwegian-version"></a>Eksporter remitteringsoppdrag i den norske versjonen
...
## <a name="to-export-remittance-payments-using-the-remittance---export-batch-jobs"></a><a name="to-export-remittance-payments-using-the-remittance---export-batch-jobs"></a>Slik eksporterer du remitteringsoppdrag ved hjelp av Eksporter remittering-kjørsler:
