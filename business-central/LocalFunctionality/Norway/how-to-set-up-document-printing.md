...
ms.author: edupont
---
# <a name="set-up-document-printing"></a><a name="set-up-document-printing"></a><a name="set-up-document-printing"></a>Definere dokumentutskrift
...
## <a name="to-set-up-paper-trays"></a><a name="to-set-up-paper-trays"></a><a name="to-set-up-paper-trays"></a>Slik definerer du papirskuffer:
