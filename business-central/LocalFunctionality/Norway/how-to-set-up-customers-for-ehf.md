...
ms.author: edupont
---
# <a name="set-up-customers-for-ehf"></a><a name="set-up-customers-for-ehf"></a><a name="set-up-customers-for-ehf"></a>Sette opp kunder for EHF
...
## <a name="to-set-up-a-customer-that-uses-elektronisk-handelsformat"></a><a name="to-set-up-a-customer-that-uses-elektronisk-handelsformat"></a><a name="to-set-up-a-customer-that-uses-elektronisk-handelsformat"></a>Slik definerer du en kunde som bruker Elektronisk Handelsformat:
