...
ms.author: edupont
---
# <a name="set-up-vendors-for-remittance-in-the-norwegian-version" />Sett opp leverandører for remittering i den norske versjonen
...
## <a name="to-set-up-a-vendor-for-remittance" />Slik angir du en leverandør for remittering
