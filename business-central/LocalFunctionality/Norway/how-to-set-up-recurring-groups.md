...
ms.author: edupont
---
# <a name="set-up-recurring-groups"></a><a name="set-up-recurring-groups"></a><a name="set-up-recurring-groups"></a>Opprette gjentakelsesgrupper
...
## <a name="to-set-up-recurring-groups"></a><a name="to-set-up-recurring-groups"></a><a name="to-set-up-recurring-groups"></a>Slik oppretter du gjentakelsesgrupper:
