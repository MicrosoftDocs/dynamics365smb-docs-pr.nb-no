...
ms.author: edupont
---
# <a name="set-up-ocr-payments"></a><a name="set-up-ocr-payments"></a>Opprette OCR-betalinger
...
## <a name="to-set-up-ocr-payments"></a><a name="to-set-up-ocr-payments"></a>Slik oppretter du OCR-betalinger
