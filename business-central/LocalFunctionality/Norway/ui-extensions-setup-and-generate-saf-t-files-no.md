...
# <a name="standard-audit-files---tax" />Standard revisjonsfiler – avgift
...
## <a name="what-does-this-extension-handle" />Hva håndterer denne utvidelsen?
...
## <a name="setup-of-the-norwegian-saf-t-extension" />Oppsett av norsk SAF-T-utvidelse
...
## <a name="exporting-saf-t-files" />Eksportere SAF-T-filer
...
### <a name="to-create-an-export-of-saf-t-files" />Opprette eksport av SAF-T-filer
...
### <a name="saf-t-files-and-data-quality" />SAF-T-filer og datakvalitet
