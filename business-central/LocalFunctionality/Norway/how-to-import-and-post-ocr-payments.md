...
ms.author: edupont
---
# <a name="import-and-post-ocr-payments" />Importere og bokføre OCR-betalinger
...
## <a name="to-import-ocr-payments" />Slik leser du inn OCR-betalinger
...
## <a name="to-post-ocr-payments" />Slik bokfører du OCR-betalinger
