...
ms.author: edupont
---
# <a name="set-up-recurring-orders"></a><a name="set-up-recurring-orders"></a>Definere gjentakelsesordrer
...
## <a name="to-set-up-a-recurring-order"></a><a name="to-set-up-a-recurring-order"></a>Slik definerer du en gjentakelsesordre
