...
ms.author: edupont
---
# <a name="set-up-remittance-agreements-in-the-norwegian-version"></a><a name="set-up-remittance-agreements-in-the-norwegian-version"></a>Sett opp remitteringsavtaler i den norske versjonen
...
## <a name="to-set-up-a-remittance-agreement"></a><a name="to-set-up-a-remittance-agreement"></a>Slik setter du opp en remitteringsavtale
