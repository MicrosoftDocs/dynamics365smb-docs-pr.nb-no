...
# <a name="set-up-customer-price-groups" />Definer kundeprisgrupper
...
## <a name="how-to-create-sales-prices-for-a-group-of-customers" />Opprett salgspriser for en kundegruppe
...
### <a name="to-create-sales-prices-for-a-group-of-customers" />Slik oppretter du salgspriser for en kundegruppe
...
## <a name="how-to-enter-customer-price-group-codes-on-customer-cards" />Angi kundeprisgruppekoder på kundekort

Når du har definert kundeprisgruppene, kan du angi kundeprisgruppekodene på kundekortene.

### <a name="to-enter-customer-price-group-codes-on-a-customer-card" />Slik angir du kundeprisgruppekoder på et kundekort
