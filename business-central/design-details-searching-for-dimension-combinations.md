...
ms.author: edupont
---
# <a name="design-details-searching-for-dimension-combinations"></a><a name="design-details-searching-for-dimension-combinations"></a><a name="design-details-searching-for-dimension-combinations"></a>Designdetaljer: Søke etter dimensjonskombinasjoner
...
## <a name="building-search-tree"></a><a name="building-search-tree"></a><a name="building-search-tree"></a>Bygge søketre
...
### <a name="finding-dimension-set-id"></a><a name="finding-dimension-set-id"></a><a name="finding-dimension-set-id"></a>Finne dimensjonssett-ID
