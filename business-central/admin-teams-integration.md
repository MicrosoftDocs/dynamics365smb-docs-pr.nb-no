...
> [!NOTE]
> Hvis du vil konfigurere sentralisert distribusjon, må Teams-kontoen minst ha rollen [Teams-administrator](/entra/identity/role-based-access-control/permissions-reference#teams-administrator].
