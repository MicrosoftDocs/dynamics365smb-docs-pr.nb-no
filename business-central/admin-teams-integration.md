...
## <a name="installing-the-business-central-app-by-using-centralized-deployment" />Installer Business Central-appen ved hjelp av sentralisert distribusjon
...
## <a name="managing-privacy-and-compliance" />Administrere personvern og samsvar
...
### <a name="restricting-sharing-of-cards" />Begrense deling av kort
...
### <a name="responding-to-data-requests" />Svare på dataforespørsler
...
## <a name="show-or-hide-record-data-on-cards" />Vis eller skjul oppføringsdata på kort
