...
ms.author: jswymer
---
# <a name="viewing-database-locks"></a><a name="viewing-database-locks"></a>Visning av databaselåser
...
## <a name="to-view-database-locks"></a><a name="to-view-database-locks"></a>Slik viser du databaselåser
