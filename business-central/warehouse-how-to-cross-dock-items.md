...
ms.author: edupont
---
# <a name="cross-dock-items" />Kryssoverføringsvarer
...
## <a name="cross-dock-bins-and-zones" />Kryssoverføringshyller og -soner
...
## <a name="cross-dock-select-lines-for-a-receipt" />Kryssoverføring velg linjer for et mottak
...
## <a name="about-the-put-away-worksheet-page" />Om plasseringsforslaget
...
## <a name="to-set-up-the-warehouse-for-cross-docking" />Slik definerer du lageret for kryssoverføring
...
## <a name="to-cross-dock-items-without-viewing-the-opportunities" />Slik kryssoverfører du varer uten å vise mulighetene
...
## <a name="to-cross-dock-items-after-viewing-the-opportunities" />Slik kryssoverfører du varer etter å ha vist mulighetene
1.  Velg ikonet ![Lyspære som åpner funksjonen Fortell meg.](media/ui-search/search_small.png "Fortell hva du vil gjøre") og angi **Lagermottak** og velg den relaterte koblingen.  
2.  Opprett et lagermottak for en vare som er ankommet, og som kanskje kan kryssoverføres. Hvis du vil ha mer informasjon, kan du se [Motta varer](warehouse-how-receive-items.md).  
...
## <a name="to-view-cross-docked-items-in-a-shipment-or-pick-worksheet" />Slik viser du kryssoverførte varer i en følgeseddel eller et plukkforslag
