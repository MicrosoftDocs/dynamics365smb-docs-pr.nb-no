...
## <a name="cross-dock-bins-and-zones"></a>Kryssoverføringshyller og -soner
...
## <a name="cross-dock-select-lines-for-a-receipt"></a>Kryssoverføring velg linjer for et mottak
...
## <a name="about-the-put-away-worksheet-page"></a>Om siden Plasseringsforslag
...
1. Hvis du bruker hyller, må du sette opp minst én kryssoverføringshylle. Hvis du bruker lagerstyring, setter du opp en kryssoverføringssone.  
    ...
    En kryssoverføringshylle har feltet **Kryssoverføringshylle** valgt. Hvis du vil finne ut mer om hyller, kan du gå til [Opprett hyller](warehouse-how-to-create-individual-bins.md).  

    Hvis du bruker soner, oppretter du en sone for kryssoverføringshyllene og velger feltet **Kryssoverføringshyllesone**. Hvis du bruker lagerstyring, velger du hylletype med **Plukk** valgt, du kan for eksempel bruke *PICK* eller *PUTPICK.* Hvis du vil finne ut mer om soner og hylletyper, kan du gå til [Konfigurer lokasjoner for bruk å bruke hyller](warehouse-how-to-set-up-locations-to-use-bins.md) og [Definer hylletyper](warehouse-how-to-set-up-bin-types.md).  
