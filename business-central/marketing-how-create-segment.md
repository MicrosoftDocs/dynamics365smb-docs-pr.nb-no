...
ms.author: jswymer
---
# <a name="create-segments"></a><a name="create-segments"></a><a name="create-segments"></a>Opprette segmenter.
...
## <a name="to-create-a-segment"></a><a name="to-create-a-segment"></a><a name="to-create-a-segment"></a>Slik oppretter du et segment
...
3. I inndelingen **Generelt**, i **Nr.** -feltet, angir du et nummer på segmentet.
    ...
    Hvis du har definert en nummerserie for segmenter på siden **Markedsføringsoppsett**, kan du eventuelt velge <kbd>Enter</kbd> for å velge neste tilgjengelige segmentnummer.
