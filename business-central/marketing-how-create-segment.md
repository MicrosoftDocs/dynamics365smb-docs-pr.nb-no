...
ms.author: jswymer
---
# <a name="create-segments"></a><a name="create-segments"></a>Opprette segmenter.
...
## <a name="to-create-a-segment"></a><a name="to-create-a-segment"></a>Slik oppretter du et segment
