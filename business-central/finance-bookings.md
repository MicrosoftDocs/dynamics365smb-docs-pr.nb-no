...
## <a name="connect-to-bookings"></a><a name="connect-to-bookings"></a>Koble til Bookings
...
## <a name="invoice-appointments"></a><a name="invoice-appointments"></a>Fakturaavtaler
