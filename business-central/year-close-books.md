...
ms.author: jswymer
---
# <a name="closing-the-books"></a><a name="closing-the-books"></a><a name="closing-the-books"></a>Lukke tablåene
...
## <a name="closing-book-process"></a><a name="closing-book-process"></a><a name="closing-book-process"></a>Prosess for avslutning av tablå
...
## <a name="what-happens-when-you-close"></a><a name="what-happens-when-you-close"></a><a name="what-happens-when-you-close"></a>Dette skjer når du avslutter
