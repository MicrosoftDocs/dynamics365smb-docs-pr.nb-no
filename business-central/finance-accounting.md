...
ms.author: edupont
---
# <a name="accountant-experiences-in-"></a><a name="accountant-experiences-in-"></a><a name="accountant-experiences-in-"></a>Regnskapsføreropplevelser i [!INCLUDE[prod_long](includes/prod_long.md)]
...
## <a name="accountant-role-center"></a><a name="accountant-role-center"></a><a name="accountant-role-center"></a>Rollesenter for regnskapsfører
...
## <a name="company-hub"></a><a name="company-hub"></a><a name="company-hub"></a>Selskapshub
...
## <a name="inviting-your-external-accountant-to-your-"></a><a name="inviting-your-external-accountant-to-your-"></a><a name="inviting-your-external-accountant-to-your-"></a><a name="inviteaccountant"></a>Invitere den eksterne regnskapsføreren til [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="adding-your-accountant-to-your-microsoft-365-in-the-azure-portal"></a><a name="adding-your-accountant-to-your-microsoft-365-in-the-azure-portal"></a><a name="adding-your-accountant-to-your-microsoft-365-in-the-azure-portal"></a>Legge til regnskapsføreren din i Microsoft 365 i Azure Portal
...
#### <a name="to-add-your-accountant-as-a-guest-user"></a><a name="to-add-your-accountant-as-a-guest-user"></a><a name="to-add-your-accountant-as-a-guest-user"></a>Slik legger du til regnskapsføreren din som gjestebruker
...
#### <a name="to-give-your-accountant-access-to-your-"></a><a name="to-give-your-accountant-access-to-your-"></a><a name="to-give-your-accountant-access-to-your-"></a>Slik gir du regnskapsføreren tilgang til [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="importing-the-new-user-into-"></a><a name="importing-the-new-user-into-"></a><a name="importing-the-new-user-into-"></a>Importere den nye brukeren til [!INCLUDE[prod_short](includes/prod_short.md)]
...
#### <a name="to-add-the-accountant-to-the-right-company"></a><a name="to-add-the-accountant-to-the-right-company"></a><a name="to-add-the-accountant-to-the-right-company"></a>Slik legger du til regnskapsføreren i det rette selskapet
