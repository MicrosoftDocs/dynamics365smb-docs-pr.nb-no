...
ms.author: edupont
---
# <a name="manage-employee-absence" />Håndtere ansattes fravær
...
## <a name="to-register-employee-absence" />Slik registrerer du ansattes fravær
...
## <a name="to-view-an-individual-employees-absence" />Slik viser du fraværet til én ansatt
...
## <a name="to-view-an-employees-absence-by-categories" />Slik viser du fraværet til en ansatt etter kategorier
1. I øvre høyre hjørne velger du ikonet **Søk etter side eller rapport**, angir **Ansatte** og velger deretter den relaterte koblingen.
...
## <a name="to-view-all-employee-absences-by-category" />Slik viser du alt ansattfravær etter kategori:
1. I øvre høyre hjørne velger du ikonet **Søk etter side eller rapport**, angir **Fraværsregistrering** og velger deretter den relaterte koblingen.
...
## <a name="to-view-all-employee-absences-by-period" />Slik viser du alt ansattfravær etter periode:
1. I øvre høyre hjørne velger du ikonet **Søk etter side eller rapport**, angir **Fraværsregistrering** og velger deretter den relaterte koblingen.
