...
# <a name="the-basic-experience-extension"></a><a name="the-basic-experience-extension"></a>Grunnleggende opplevelse-utvidelsen
...
## <a name="whats-available"></a><a name="whats-available"></a>Hva som er tilgjengelig
...
## <a name="getting-started"></a><a name="getting-started"></a>Komme i gang
...
## <a name="migrating-data"></a><a name="migrating-data"></a>Overføring av data
