...
# <a name="consolidating-financial-data-from-multiple-companies" />Konsolidere finansielle data fra flere selskaper
...
## <a name="use-the-consolidated-trial-balance-report" />Råbalanse
...
### <a name="to-test-the-data-before-you-consolidate" />Slik tester du dataene før konsolidering
...
### <a name="run-the-consolidation" />Kjøre konsolideringen
...
## <a name="eliminate-repeated-transactions" />Fjerne gjentatte transaksjoner
...
## <a name="export-and-import-consolidated-data-between-databases" />Eksportere og importere konsoliderte data mellom databaser
