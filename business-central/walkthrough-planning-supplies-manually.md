...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-manually" />Gjennomgang: planlegge forsyninger manuelt
...
## <a name="setting-up-the-sample-data" />Konfigurere eksempeldataene
...
## <a name="use-the-order-planning-page" />Bruk siden Ordreplanlegging
...
### <a name="to-use-the-order-planning-page" />Slik bruker du siden Ordreplanlegging:
...
## <a name="planning-a-purchase-order-to-fulfill-component-demand" />Planlegge en bestilling for å dekke komponentbehov
 I denne fremgangsmåten oppretter du en bestilling for produksjonskomponenter det er behov for.  

### <a name="to-plan-a-purchase-order-to-fulfill-component-need-in-production" />Slik planlegger du en bestilling for å dekke et komponentbehov i produksjon:
...
## <a name="planning-a-transfer-order-to-fulfill-sales-demand" />Planlegge en overføringsordre for å dekke salgsbehov
...
### <a name="to-plan-a-transfer-order-to-fulfill-sales-demand" />Slik planlegger du en overføringsordre for å dekke salgsbehov:
...
## <a name="planning-a-multilevel-production-order-to-fulfill-sales-demand" />Planlegge en produksjonsordre med flere nivåer for å dekke et salgsbehov
...
### <a name="to-plan-multilevel-production-to-fulfill-sales-demand" />Slik planlegger du produksjon med flere nivåer for å dekke salgsbehov:
...
### <a name="to-plan-a-specific-production-order" />Slik planlegger du en bestemt produksjonsordre:
