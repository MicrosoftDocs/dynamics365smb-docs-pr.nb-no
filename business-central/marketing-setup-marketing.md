...
ms.author: edupont
---
# <a name="setting-up-relationship-management" />Sette opp forbindelser
...
## <a name="automatically-recording-interactions" />Registrere samhandlinger automatisk
...
## <a name="synchronizing-contacts-with-customers-and-more" />Synkronisere kontakter med kunder og mer
...
## <a name="assigning-a-number-series-to-contacts-and-opportunities" />Tilordne en nummerserie til kontakter og salgsmuligheter
...
## <a name="searching-for-duplicate-contacts-when-contacts-are-created" />Søke etter duplikatkontakter når kontakter opprettes
