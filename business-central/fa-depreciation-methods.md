...
ms.author: edupont
---
# <a name="depreciation-methods-for-fixed-assets" />Avskrivningsmetoder for aktiva
...
## <a name="straight-line-depreciation" />Lineær avskrivning
...
### <a name="depreciation-period" />Avskrivningsperiode
...
### <a name="fixed-yearly-percentage" />Fast årlig prosentsats
...
### <a name="fixed-yearly-amount" />Fast årlig beløp
...
### <a name="example---straight-line-depreciation" />Eksempel – lineær avskrivning
...
## <a name="half-year-convention-depreciation" />Halvårsavskrivning
...
### <a name="example---half-year-convention-depreciation" />Eksempel: Halvårsavskrivning
...
## <a name="duplicating-entries-to-more-depreciation-books" />Duplisere poster til flere avskrivningstablåer
