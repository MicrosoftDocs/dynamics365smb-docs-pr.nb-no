...
ms.author: edupont
---
# <a name="create-a-demand-forecast"></a><a name="create-a-demand-forecast"></a>Opprette en behovsprognose
...
## <a name="sales-forecasts-and-production-forecasts"></a><a name="sales-forecasts-and-production-forecasts"></a>Salgsprognoser og produksjonsprognoser
...
## <a name="component-forecast"></a><a name="component-forecast"></a>Komponentprognose
...
## <a name="forecasting-periods"></a><a name="forecasting-periods"></a>Prognoseperioder
...
## <a name="forecast-by-locations"></a><a name="forecast-by-locations"></a>Prognose etter lokasjoner

På siden **Produksjonsoppsett** kan du angi om du vil vurdere lokasjonene som er definert i prognoser når du beregner planer. 

### <a name="use-forecast-by-locations"></a><a name="use-forecast-by-locations"></a>Bruk prognose etter lokasjoner
...
### <a name="do-not-use-forecast-by-locations"></a><a name="do-not-use-forecast-by-locations"></a>Ikke bruk prognose etter lokasjoner
...
## <a name="to-create-a-demand-forecast"></a><a name="to-create-a-demand-forecast"></a>Slik oppretter du en behovsprognose:
