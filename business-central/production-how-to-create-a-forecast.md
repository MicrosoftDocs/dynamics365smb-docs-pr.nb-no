...
ms.author: edupont
---
# <a name="create-a-demand-forecast" />Opprette en behovsprognose
...
## <a name="sales-forecasts-and-production-forecasts" />Salgsprognoser og produksjonsprognoser
...
## <a name="component-forecast" />Komponentprognose
...
## <a name="forecasting-periods" />Prognoseperioder
...
### <a name="do-not-use-forecast-by-locations" />Ikke bruk prognose etter lokasjoner
...
## <a name="to-create-a-demand-forecast" />Slik oppretter du en behovsprognose:
