...
ms.author: bholtorf
---
# <a name="register-new-vendors" />Registrere nye leverandører
...
## <a name="adding-new-vendors" />Legge til nye leverandører
...
### <a name="to-create-a-new-vendor" />Slik oppretter du en ny leverandør
...
### <a name="deleting-and-editing-vendor-information" />Slette og redigere leverandøropplysninger
...
## <a name="to-save-the-vendor-card-as-a-template" />Lagre leverandørkortet som en mal
