...
ms.author: bholtorf
---
# <a name="register-new-vendors"></a><a name="register-new-vendors"></a><a name="register-new-vendors"></a>Registrere nye leverandører
...
## <a name="adding-new-vendors"></a><a name="adding-new-vendors"></a><a name="adding-new-vendors"></a>Legge til nye leverandører
...
### <a name="to-create-a-new-vendor"></a><a name="to-create-a-new-vendor"></a><a name="to-create-a-new-vendor"></a>Slik oppretter du en ny leverandør
...
### <a name="deleting-and-editing-vendor-information"></a><a name="deleting-and-editing-vendor-information"></a><a name="deleting-and-editing-vendor-information"></a>Slette og redigere leverandøropplysninger
...
## <a name="to-save-the-vendor-card-as-a-template"></a><a name="to-save-the-vendor-card-as-a-template"></a><a name="to-save-the-vendor-card-as-a-template"></a>Lagre leverandørkortet som en mal
