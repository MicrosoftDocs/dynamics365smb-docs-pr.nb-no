...
ms.author: bholtorf
---
# <a name="record-special-purchase-prices-and-discounts"></a><a name="record-special-purchase-prices-and-discounts"></a>Registrere spesielle kjøpspriser og rabatter
...
## <a name="to-set-up-a-special-purchase-price-for-a-vendor"></a><a name="to-set-up-a-special-purchase-price-for-a-vendor"></a>Definere en spesialkjøpspris for en leverandør
...
## <a name="to-set-up-a-line-discount-for-a-vendor"></a><a name="to-set-up-a-line-discount-for-a-vendor"></a>Definere en linjerabatt for en leverandør
...
## <a name="to-set-up-an-invoice-discount-for-a-vendor"></a><a name="to-set-up-an-invoice-discount-for-a-vendor"></a>Definere en fakturarabatt for en leverandør
...
## <a name="to-choose-a-principle-for-posting-purchase-discounts"></a><a name="to-choose-a-principle-for-posting-purchase-discounts"></a>Slik velger du et prinsipp for bokføring av kjøpsrabatter
...
## <a name="purchase-invoice-discounts-and-service-charges"></a><a name="purchase-invoice-discounts-and-service-charges"></a>Kjøpsfakturarabatter og servicegebyrer
...
## <a name="best-price-calculation"></a><a name="best-price-calculation"></a>Beregning av beste pris
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/modules/set-up-prices-discounts-dynamics-365-business-central/index)
