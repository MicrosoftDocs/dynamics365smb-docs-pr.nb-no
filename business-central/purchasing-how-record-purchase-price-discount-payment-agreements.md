...
ms.author: bholtorf
---
# <a name="record-special-purchase-prices-and-discounts" />Registrere spesielle kjøpspriser og rabatter
...
## <a name="to-set-up-a-special-purchase-price-for-a-vendor" />Definere en spesialkjøpspris for en leverandør
...
## <a name="to-set-up-a-line-discount-for-a-vendor" />Definere en linjerabatt for en leverandør
...
## <a name="to-set-up-an-invoice-discount-for-a-vendor" />Definere en fakturarabatt for en leverandør
...
## <a name="to-choose-a-principle-for-posting-purchase-discounts" />Slik velger du et prinsipp for bokføring av kjøpsrabatter
...
## <a name="purchase-invoice-discounts-and-service-charges" />Kjøpsfakturarabatter og servicegebyrer
...
## <a name="see-related-microsoft-trainingtrainingmodulesset-up-prices-discounts-dynamics-365-business-centralindex" />Se relatert [Microsoft-opplæring](/training/modules/set-up-prices-discounts-dynamics-365-business-central/index)
