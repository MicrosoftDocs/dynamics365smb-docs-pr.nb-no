---
title: Gjør deg klar for virksomhet
description: 'Skisserer de assisterte oppsettsveiledningene, videoene, hjelpeartiklene og sidene du bruker til å bli klar til å gjøre forretninger i Business Central.'
author: brentholtorf
ms.author: bholtorf
...
---
# Gjør deg klar for virksomhet

Gratulerer, du har fått ditt første selskap i [!INCLUDE[prod_short](includes/prod_short.md)].

For å hjelpe deg med å få klar for å gjøre forretninger, kan du gå til siden **Assistert oppsett** der du kan starte assistert oppsett, videoer eller hjelpeartikler for utvalgte oppsettoppgaver. Du får tilgang til siden ved å velge [denne koblingen](https://businesscentral.dynamics.com/?page=1801).  
...
>
> Første gang du logger på, bruker du **Essential**-opplevelsen. Hvis du vil ha mer informasjon, kan du se [Endre hvilke funksjoner som vises](ui-experiences.md).

Når du har kjørt en assistert oppsettsveiledning, merkes den som **Fullført**.  

## Læringstips og innføringer
...
## Rollespesifikke startsider

Avhengig av rollen din så finnes det en oversikt over virksomheten på startsiden. I navigasjonsfeltet får du enkel tilgang til kunder, leverandører, varer og så videre. **Aktiviteter**-flisene viser gjeldende data og gir enkel tilgang til det valgte dokumentet.
...
Bruk pilene for å skjule en del av siden og få mer plass til å vise bestemte data. Øverst på startsiden finner du alle handlingene du kan bruke i gjeldende innhold. Du kan også skjule dette området. Hvis du vil vise det på nytt, velger du det eller trykker i det skjulte området.
...
Under **Selskapsinnstillinger** kan du vise og redigere oppsettsinformasjon om gjeldende selskap. Mye av denne informasjonen ble forhåndsutfylt hvis du fullførte det assisterte oppsettet **Konfigurer selskap** da du registrerte deg for [!INCLUDE[prod_short](includes/prod_short.md)]. Hvis du vil endre firmalogo, kontaktinformasjon, innstillinger for banken eller mva-informasjon, kan du gjøre det fra denne siden.  

## Legge til brukere og tillatelser

[!INCLUDE [2023rw1-sec-group-short](includes/2023rw1-sec-group-short.md)]

Du legger til brukere i administrasjonssenteret for Microsoft 365. Hvis du vil ha mer informasjon, se [Opprette brukere i henhold til lisenser](ui-how-users-permissions.md).

Når brukere opprettes i Microsoft 365, kan du importere dem til **Brukere**-siden i ved å bruke handlingen **Få oppdateringer fra Office 365**. Du kan deretter tildele tillatelser til brukere og ordne dem i brukergrupper. Hvis du vil ha mer informasjon, kan du se [Tilordne tillatelser til brukere og grupper](ui-define-granular-permissions.md).  
...
### Konfigurere selskapet i [!INCLUDE[prod_short](includes/prod_short.md)]
...
Siden **Assistert oppsett** kan inneholde andre oppføringer. Når du er ferdig med et oppsett, er statusen **Fullført**. Du kan definere andre områder i selskapet ved hjelp av manuelt oppsett. Hvis du vil ha mer informasjon, kan du se [Definer [!INCLUDE[prod_short](includes/prod_short.md)]](setup.md).  
