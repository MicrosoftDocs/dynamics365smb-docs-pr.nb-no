...
ms.author: solsen
---
# <a name="preview-posting-results" />Forhåndsvise bokføringsresultater
...
## <a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice" />Forhåndsvise finansposter som opprettes ved bokføring av en kjøpsfaktura
