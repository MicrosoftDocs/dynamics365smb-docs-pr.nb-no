...
ms.author: solsen
---
# <a name="preview-posting-results"></a><a name="preview-posting-results"></a><a name="preview-posting-results"></a>Forhåndsvise bokføringsresultater
...
## <a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice"></a><a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice"></a><a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice"></a>Forhåndsvise finansposter som opprettes ved bokføring av en kjøpsfaktura
