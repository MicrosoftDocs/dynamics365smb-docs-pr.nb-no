...
ms.author: edupont
---
# <a name="walkthrough-making-cash-flow-forecasts-using-financial-reports" />Gjennomgang: Lage kontantstrømprognoser ved å bruke finansrapporter
...
## <a name="setting-up-a-new-financial-report-name" />Definer et nytt navn for finansrapporten
...
### <a name="set-up-a-new-financial-report-name" />Definer et nytt navn for finansrapporten
...
## <a name="setting-up-row-definition-lines" />Definer raddefinisjonslinjer
...
### <a name="set-up-row-definition-lines" />Definer raddefinisjonslinjer
...
## <a name="setting-up-a-new-column-definition" />Definer en ny kolonnedefinisjon
...
### <a name="set-up-a-new-column-definition" />Definer en ny kolonnedefinisjon
...
## <a name="assigning-the-column-definition-to-the-financial-report-name" />Tildel kolonnedefinisjonen til finansrapportnavnet

Ken er nå klar til å tildele kolonnedefinisjonen til finansrapportnavnet.  

### <a name="assign-the-column-definition-to-the-financial-report-name" />Tildel kolonnedefinisjonen til finansrapportnavnet
...
## <a name="view-and-print-the-cash-flow-forecast" />Vis og skriv ut kontantstrømprognosen
...
## <a name="see-related-microsoft-trainingtrainingmodulesforecast-cash-flow-dynamics--business-central" />Se relatert [Microsoft-opplæring](/training/modules/forecast-cash-flow-dynamics-365-business-central/)
