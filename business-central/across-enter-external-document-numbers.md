...
ms.author: edupont
---
# <a name="enter-external-document-numbers" />Angi eksterne dokumentnumre
...
## <a name="to-enter-external-document-numbers-in-a-sales-order" />Slik angir du eksterne dokumentnumre i en ordre
