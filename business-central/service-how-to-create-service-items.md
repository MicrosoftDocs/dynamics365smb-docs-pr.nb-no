...
ms.author: edupont
---
# <a name="create-service-items" />Opprette servicevarer
...
## <a name="to-create-a-service-item" />Slik oppretter du en servicevare
...
## <a name="to-create-service-items-within-a-service-order" />Slik oppretter du servicevarer i en serviceordre
...
## <a name="to-create-a-service-item-when-shipping-items" />Slik oppretter du en servicevare når du leverer varer
...
## <a name="to-insert-a-starting-fee-for-a-service-item" />Slik setter du inn et startgebyr for en servicevare
