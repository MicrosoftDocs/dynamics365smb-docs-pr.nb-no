...
ms.author: jswymer
---
# <a name="viewing-and-editing-in-excel-from-business-central" />Vise og redigere i Excel fra Business Central
...
## <a name="open-in-excel" />Åpne i Excel
...
### <a name="first-time-sign-in" />Første pålogging
...
### <a name="work-across-environments-and-companies" />Arbeide på tvers av miljøer og selskaper
...
### <a name="limits-when-using-excel-for-the-web" />Begrensninger når du bruker Excel for nettet
...
## <a name="see-the-differences-between-the-options" />Se forskjellene mellom alternativene
<br><br>  
