...
10. Velg en kladdelinje med opphevet utligning for en gjentakende innbetaling eller utgift, for eksempel kjøp av drivstoff til en bil, og velg deretter **Tilordne tekst til konto**. Hvis du vil ha mer informasjon, kan du se [Tilordne tekst om regelmessige betalinger til kontoer for automatisk avstemming](receivables-how-map-text-recurring-payments-accounts-auto-reconcilliation.md).
...
12. Hvis ingen flere linjer krever gjennomgang, og feltet **Differanse** er tomt på alle linjer, velger du **Bokfør**-handlingen og velger deretter ett av følgende alternativer:
    ...
    - **Bokfør bare betalinger** - Bokfører bare betalingene som utlignet, og lar de relaterte bankkontopostene være åpne. Påkrevd at du avstemmer bankkontoen separat, for eksempel: Hvis du vil ha mer informasjon, kan du se [Avstemme bankkonti](bank-how-reconcile-bank-accounts-separately.md).
...
> [!NOTE]  
>   Hvis du ikke vil avstemme bankkontoen fra **siden Betalingsavstemmingskladd**, må du bruke **siden Bankkontoavstemming** . Hvis du vil ha mer informasjon, kan du se [Avstemme bankkonti](bank-how-reconcile-bank-accounts-separately.md).
