...
ms.author: edupont
---
# <a name="post-capacities"></a><a name="post-capacities"></a><a name="post-capacities"></a>Bokføre kapasiteter
...
## <a name="to-post-capacities"></a><a name="to-post-capacities"></a><a name="to-post-capacities"></a>Slik bokfører du kapasiteter
...
## <a name="to-view-work-center-ledger-entries"></a><a name="to-view-work-center-ledger-entries"></a><a name="to-view-work-center-ledger-entries"></a>Slik viser du arbeidssenterposter:
