...
---
# <a name="design-details-transfers-in-planning"></a><a name="design-details-transfers-in-planning"></a>Designdetaljer: Overføringer i planlegging
...
## <a name="why-is-a-transfer-a-special-case"></a><a name="why-is-a-transfer-a-special-case"></a>Hvorfor er overføring et spesialtilfelle?
...
## <a name="transfers-are-dependent-demand"></a><a name="transfers-are-dependent-demand"></a>Overføringer er avhengig av behov
...
## <a name="planning-sequence"></a><a name="planning-sequence"></a>Planleggingsrekkefølge
...
## <a name="transfer-level-code"></a><a name="transfer-level-code"></a>Overføringsnivåkode
...
## <a name="planning-transfers-without-sku"></a><a name="planning-transfers-without-sku"></a>Planleggingsoverføringer uten lagerføringsenhet
...
## <a name="changing-quantity-with-reservations"></a><a name="changing-quantity-with-reservations"></a>Endre antall med reservasjoner
...
## <a name="changing-quantity-in-a-transfer-chain"></a><a name="changing-quantity-in-a-transfer-chain"></a>Endre antall i en overføringskjede
...
## <a name="safety-lead-time"></a><a name="safety-lead-time"></a>Sikkerhetsleveringstid
...
## <a name="reschedule"></a><a name="reschedule"></a>Tidsplanlegg på nytt
...
## <a name="serial-and-lot-numbers-in-transfer-chains"></a><a name="serial-and-lot-numbers-in-transfer-chains"></a>Serie- og partinumrene i overføringskjeder
