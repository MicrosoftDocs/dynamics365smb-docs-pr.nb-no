...
---
# <a name="design-details-transfers-in-planning" />Designdetaljer: Overføringer i planlegging
...
## <a name="why-is-a-transfer-a-special-case" />Hvorfor er overføring et spesialtilfelle?
...
## <a name="transfers-are-dependent-demand" />Overføringer er avhengig av behov
...
## <a name="planning-sequence" />Planleggingsrekkefølge
...
## <a name="transfer-level-code" />Overføringsnivåkode
...
## <a name="planning-transfers-without-sku" />Planleggingsoverføringer uten lagerføringsenhet
...
## <a name="changing-quantity-with-reservations" />Endre antall med reservasjoner
...
## <a name="changing-quantity-in-a-transfer-chain" />Endre antall i en overføringskjede
...
## <a name="lead-time-calculation" />Beregning av leveringstid
...
## <a name="safety-lead-time" />Sikkerhetsleveringstid
...
## <a name="reschedule" />Tidsplanlegg på nytt
...
## <a name="serial-and-lot-numbers-in-transfer-chains" />Serie- og partinumrene i overføringskjeder
