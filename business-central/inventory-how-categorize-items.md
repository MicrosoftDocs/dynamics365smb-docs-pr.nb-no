...
## <a name="to-create-an-item-category"></a><a name="to-create-an-item-category"></a><a name="to-create-an-item-category"></a>Slik oppretter du en varekategori:
...
## <a name="to-assign-an-item-category-to-an-item"></a><a name="to-assign-an-item-category-to-an-item"></a><a name="to-assign-an-item-category-to-an-item"></a>Slik tilordner du en varekategori til en vare:
