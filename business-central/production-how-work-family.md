...
ms.author: edupont
---
# <a name="work-with-production-families" />Arbeide med produksjonsfamilier
...
## <a name="to-set-up-a-production-family" />Slik konfigurerer du produksjonsfamilier
...
## <a name="to-produce-based-on-a-production-family" />Produsere basert på en produksjonsfamilie
