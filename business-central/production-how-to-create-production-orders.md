...
ms.author: edupont
---
# <a name="create-production-order-headers" />Opprette produksjonsordrehoder
...
## <a name="to-create-a-production-order-header" />Slik oppretter du et produksjonsordrehode
