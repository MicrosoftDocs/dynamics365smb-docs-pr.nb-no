...
ms.author: edupont
---
# <a name="design-details-expected-cost-posting" />Designdetaljer: Bokføre forventet kost
...
## <a name="prerequisites-for-posting-expected-costs" />Forutsetninger for bokføring av forventede kostnader
