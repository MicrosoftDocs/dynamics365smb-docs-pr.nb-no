...
## <a name="release-process" />Frigivelsesprosess
...
### <a name="approval-procedures" />Godkjenningsprosedyrer
...
## <a name="reopen-a-released-order" />Åpne en frigitt ordre på nytt
