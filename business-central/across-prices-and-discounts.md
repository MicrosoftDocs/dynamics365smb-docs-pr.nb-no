...
ms.author: bholtorf
---
# <a name="set-up-prices-and-discounts" />Konfigurer priser og rabatter
...
## <a name="setting-up-prices-and-discounts" />Konfigurasjon av priser og rabatter
...
## <a name="set-up-prices" />Definer priser
...
## <a name="work-with-invoice-discounts-and-service-charges" />Arbeid med fakturarabatter og servicegebyrer
...
## <a name="calculating-the-best-price" />Beregning av beste pris
...
## <a name="see-related-microsoft-trainingtrainingmodulescustomer-discounts-dynamics-365-business-central" />Se relatert [Microsoft-opplæring](/training/modules/customer-discounts-dynamics-365-business-central/)
