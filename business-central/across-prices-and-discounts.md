...
ms.author: bholtorf
---
# <a name="set-up-prices-and-discounts"></a><a name="set-up-prices-and-discounts"></a><a name="set-up-prices-and-discounts"></a>Konfigurer priser og rabatter
...
## <a name="setting-up-prices-and-discounts"></a><a name="setting-up-prices-and-discounts"></a><a name="setting-up-prices-and-discounts"></a>Konfigurasjon av priser og rabatter
...
## <a name="set-up-prices"></a><a name="set-up-prices"></a><a name="set-up-prices"></a>Definer priser
...
## <a name="to-set-up-a-sales-line-discount-for-a-customer"></a><a name="to-set-up-a-sales-line-discount-for-a-customer"></a><a name="to-set-up-a-sales-line-discount-for-a-customer"></a>Definere en salgslinjerabatt for en kunde
...
## <a name="work-with-invoice-discounts-and-service-charges"></a><a name="work-with-invoice-discounts-and-service-charges"></a><a name="work-with-invoice-discounts-and-service-charges"></a>Arbeid med fakturarabatter og servicegebyrer
...
### <a name="to-set-up-an-invoice-discount-for-a-customer"></a><a name="to-set-up-an-invoice-discount-for-a-customer"></a><a name="to-set-up-an-invoice-discount-for-a-customer"></a>Definere en fakturarabatt for en kunde
...
## <a name="to-copy-sales-prices"></a><a name="to-copy-sales-prices"></a><a name="to-copy-sales-prices"></a>Slik kopierer du salgspriser
...
## <a name="to-bulk-update-item-prices"></a><a name="to-bulk-update-item-prices"></a><a name="to-bulk-update-item-prices"></a>Slik samleoppdaterer du varepriser
...
## <a name="calculating-the-best-price"></a><a name="calculating-the-best-price"></a><a name="calculating-the-best-price"></a>Beregning av beste pris
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/modules/customer-discounts-dynamics-365-business-central/)
