...
## <a name="setting-up-prices-and-discounts"></a>Definisjon av priser og rabatter
...
## <a name="set-up-prices"></a>Definer priser

Denne fremgangsmåten varierer avhengig av om systemansvarlig har aktivert funksjonsoppdateringen **Ny salgsprisopplevelse**. 
...
## <a name="calculating-the-best-price"></a>Beregning av beste pris
