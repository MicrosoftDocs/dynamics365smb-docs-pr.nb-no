...
ms.author: bholtorf
---
# <a name="set-up-a-loaner-program"></a><a name="set-up-a-loaner-program"></a><a name="set-up-a-loaner-program"></a>Konfigurere et program for utlånsobjekter
...
## <a name="to-set-up-a-loaner"></a><a name="to-set-up-a-loaner"></a><a name="to-set-up-a-loaner"></a>Slik definerer du utlånsobjekter
