...
Dette emnet beskriver hvordan administratorer kan opprette brukere og definere hvem som kan logge på [!INCLUDE[d365fin](includes/d365fin_md.md)], og hvilke tillatelser som gis til ulike brukertyper i henhold til lisensene.
...
> [!NOTE]
> Prosessen med å behandle brukere og lisenser varierer avhengig av om [!INCLUDE[d365fin](includes/d365fin_md.md)] er distribuert elektronisk eller lokalt. I nettbaserte distribusjoner kan du for eksempel bare administrere brukere etter at de er lagt til [!INCLUDE[d365fin](includes/d365fin_md.md)] fra Office 365. I lokale distribusjoner kan du opprette, redigere og slette brukere direkte.  
...
Når brukere får tilordnet en [!INCLUDE[d365fin](includes/d365fin_md.md)]-lisens i Office 365, kan du importere dem til **Brukere**-siden i [!INCLUDE[d365fin](includes/d365fin_md.md)] ved å bruke handlingen **Hent nye brukere fra Office 365**.
...
2. Avhengig av hva du vil gjøre, velger du handlingen **Hent nye brukere fra Office 365** eller **Oppdater brukere fra Office 365**.

De nye brukerne og brukerinformasjonen i Office 365-abonnementet legges til på **Brukere**-siden i [!INCLUDE[d365fin](includes/d365fin_md.md)]. Hvis du vil ha mer informasjon om å synkronisere brukerinformasjon med Office 365, kan du se [Synkronisering med Office 365](ui-how-users-permissions.md#synchronization-with-office-365).
...
Når du tilordner en lisens for [!INCLUDE[d365fin](includes/d365fin_md.md)] til en bruker i Office 365, kan du opprette brukeren i [!INCLUDE[d365fin](includes/d365fin_md.md)] på to måter. 

* Administratoren kan legge til brukeren ved å velge handlingen **Oppdater brukere fra Office 365** på **Brukere**-siden.
...
Hvis du endrer brukerinformasjon i Office 365, kan du oppdatere [!INCLUDE[d365fin](includes/d365fin_md.md)] for å gjenspeile endringen. Avhengig av hva du vil oppdatere, kan du bruke én av handlingene på **Brukere**-siden. Handlingene beskrives i de tre siste kolonnene i tabellen nedenfor.

|Hva skjer når:|Første bruker, første pålogging|Hent brukere fra Office Office 365|Oppdater brukere fra Office 365|Gjenopprett brukerens standardbrukergrupper|Oppdater brukergrupper|
|-|-|-|-|-|-|
...
Selskapets Office 365-administrator eller Microsoft-partner kan opprette gruppen Enhetsbrukere for Dynamics 365 Business Central og legge til enhetsbrukere som medlemmer i [administrasjonssenteret for Microsoft 365](https://admin.microsoft.com/) eller i [Azure Portal](https://portal.azure.com/).
...
> [!NOTE]
> For lokale distribusjoner kan en administrator angi hvordan brukerlegitimasjoner skal godkjennes i [!INCLUDE[server](includes/server.md)]-forekomsten. Når du oppretter en bruker, angir du legitimasjonstypen du bruker.<br /><br />
> Hvis du vil ha mer informasjon, kan du se [Godkjenning og legitimasjonstyper](/dynamics365/business-central/dev-itpro/administration/users-credential-types) i Administrasjon-delen av innholdet for utviklere og IT-eksperter for [!INCLUDE[d365fin](includes/d365fin_md.md)].
