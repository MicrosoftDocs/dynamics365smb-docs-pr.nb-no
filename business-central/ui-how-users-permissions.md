...
ms.reviewer: jswymer
---
# <a name="create-users-according-to-licenses"></a><a name="create-users-according-to-licenses"></a>Opprette brukere i henhold til lisenser
...
## <a name="manage-users-and-licenses-in-online-tenants"></a><a name="manage-users-and-licenses-in-online-tenants"></a>Behandle brukere og lisenser i nettleietakere
...
### <a name="configure-permissions-based-on-licenses"></a><a name="configure-permissions-based-on-licenses"></a><a name="licensespermissions"></a>Konfigurer tillatelser basert på lisenser
...
### <a name="to-add-users-or-update-user-information-and-license-assignments-in-business-central"></a><a name="to-add-users-or-update-user-information-and-license-assignments-in-business-central"></a><a name="adduser"></a>Slik legger du til brukere eller oppdaterer brukerinformasjon og lisenstilordninger i Business Central
...
### <a name="to-remove-a-users-access-to-the-system"></a><a name="to-remove-a-users-access-to-the-system"></a>Fjerne en brukers tilgang til systemet
...
### <a name="synchronization-with-microsoft-365"></a><a name="synchronization-with-microsoft-365"></a><a name="m365"></a>Synkronisere med Microsoft 365
...
## <a name="manage-users-and-licenses-in-on-premises-deployments"></a><a name="manage-users-and-licenses-in-on-premises-deployments"></a>Behandle brukere og lisenser i lokale distribusjoner
...
### <a name="to-edit-or-delete-a-user-in-an-on-premises-deployment"></a><a name="to-edit-or-delete-a-user-in-an-on-premises-deployment"></a>Slik redigerer eller sletter du en bruker i en lokal distribusjon
