...
ms.reviewer: jswymer
---
# <a name="create-users-according-to-licenses" />Opprette brukere i henhold til lisenser
...
## <a name="manage-users-and-licenses-in-online-tenants" />Behandle brukere og lisenser i nettleietakere
...
### <a name="to-remove-a-users-access-to-the-system" />Fjerne en brukers tilgang til systemet
...
### <a name="a-namemasynchronization-with-microsoft-" /><a name="m365"></a>Synkronisere med Microsoft 365
...
## <a name="manage-users-and-licenses-in-on-premises-deployments" />Behandle brukere og lisenser i lokale distribusjoner
...
### <a name="to-edit-or-delete-a-user-in-an-on-premises-deployment" />Slik redigerer eller sletter du en bruker i en lokal distribusjon
