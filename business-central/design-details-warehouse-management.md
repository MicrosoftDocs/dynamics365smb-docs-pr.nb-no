...
|Grunnleggende|Ordre for ordre.|Kjøp, salg, service og overføring: Krever plassering eller Plukk kreves. </br><br/> Produksjon, Montering, Prosjekter: Lagerplukk, Lagerflytting, Lagerplassering </br></br>**MERK:** Du kan fortsatt bokføre kvitteringer, forsendelser, forbruk og utdata direkte fra kildedokumentene på steder der du aktiverte disse innstillingene.|Valgfritt. Kontrollert av vekslebryteren **Hyllekode er obligatorisk**.|Bestilling -> Lagerplassering|Ordre -> Lagerplukk|Produksjonsordre-> Lagerplukk|
|Avansert|Konsolidert mottak/levering for flere ordrer.<br /><br />Konsoliderte plukk-/plasseringsaktiviteter for flere kildedokumenter.|Kjøp, salg, service og overføring: krever mottak + krever plassering,</br> Forsendelse nødv. + Plukk nødv.</br></br> Produksjon, Montering, Prosjekter: Plukk |Valgfritt. Kontrollert av vekslebryteren Hyllekode er obligatorisk|Bestillinger -> lagermottak -> lagerplassering|Ordrer -> lagerleveringer -> plukkforslag -> lagerplukk| Produksjonsordre -> Plukkforslag -> Lagerplukk -> Forbrukskladd|
...
#### <a name="first-expired-first-out"></a>Først utløpt, først ut (FEFO)
...
Finn ut mer på [Aktiver plukking av varer etter FEFO](warehouse-picking-by-fefo.md).
