...
# <a name="warehouse-management-overview"></a><a name="warehouse-management-overview"></a><a name="warehouse-management-overview"></a>Oversikt over lagerstyring
...
## <a name="overview-of-different-configuration-options"></a><a name="overview-of-different-configuration-options"></a><a name="overview-of-different-configuration-options"></a>Oversikt over ulike konfigurasjonsalternativer
...
|Avansert|Samme som over + lagerstyringsaktiviteter|Lagerstyring (avhengig av vekslebrytere blir aktivert automatisk)|Obligatorisk|Samme som ovenfor.|Samme som ovenfor.| Produksjonsordre -> Plukkforslag -> Lagerplukk Forbrukskladd|
...
## <a name="modeling-the-physical-warehouse"></a><a name="modeling-the-physical-warehouse"></a><a name="modeling-the-physical-warehouse"></a>Modellering av det fysiske lageret
...
### <a name="locations-and-bins"></a><a name="locations-and-bins"></a><a name="locations-and-bins"></a>Lokasjoner og hyller
...
### <a name="shelves-and-bins"></a><a name="shelves-and-bins"></a><a name="shelves-and-bins"></a>Hyller
...
## <a name="typical-warehouse-workflow"></a><a name="typical-warehouse-workflow"></a><a name="typical-warehouse-workflow"></a>Vanlig arbeidsflyt for lager
...
## <a name="terminology-related-to-warehouse-management"></a><a name="terminology-related-to-warehouse-management"></a><a name="terminology-related-to-warehouse-management"></a>Terminologi relatert til lagerstyring

### <a name="complexity-levels"></a><a name="complexity-levels"></a><a name="complexity-levels"></a>Kompleksitetsnivåer
...
### <a name="warehouse-flows"></a><a name="warehouse-flows"></a><a name="warehouse-flows"></a>Lagerflyter
...
### <a name="basic-documents"></a><a name="basic-documents"></a><a name="basic-documents"></a>Grunnleggende dokumenter
...
### <a name="advanced-documents"></a><a name="advanced-documents"></a><a name="advanced-documents"></a>Avanserte dokumenter
...
### <a name="pages-and-settings"></a><a name="pages-and-settings"></a><a name="pages-and-settings"></a>Sider og innstillinger

Denne delen beskriver begrepene bak nøkkelsidene og innstillingene for lagerstyring.

#### <a name="bins-and-bin-content"></a><a name="bins-and-bin-content"></a><a name="bins-and-bin-content"></a>Hyller og hylleinnhold
...
#### <a name="bin-type"></a><a name="bin-type"></a><a name="bin-type"></a>Hylletype
...
#### <a name="bin-ranking"></a><a name="bin-ranking"></a><a name="bin-ranking"></a>Hylleprioritering
...
#### <a name="bin-setup"></a><a name="bin-setup"></a><a name="bin-setup"></a>Hylleoppsett
...
#### <a name="zone"></a><a name="zone"></a><a name="zone"></a>Sone
...
#### <a name="location"></a><a name="location"></a><a name="location"></a>Lokasjon
...
#### <a name="first-expired-first-out"></a><a name="first-expired-first-out"></a><a name="first-expired-first-out"></a>FEFO (First Expired First Out)
...
#### <a name="put-away-template"></a><a name="put-away-template"></a><a name="put-away-template"></a>Plasseringsmal
