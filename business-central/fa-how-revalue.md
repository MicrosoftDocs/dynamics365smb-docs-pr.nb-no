...
## <a name="to-post-appreciation-from-the-fixed-asset-gl-journal"></a>Slik bokfører du en oppskrivning fra aktivafinanskladden:
...
## <a name="to-post-other-acquisition-costs"></a>Slik bokfører du flere anskaffelseskostnader:
...
### <a name="example---posting-other-acquisition-costs"></a>Eksempel – bokføre tilleggsanskaffelseskostnader
