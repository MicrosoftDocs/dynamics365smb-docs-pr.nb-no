...
ms.author: edupont
---
# <a name="revalue-fixed-assets" />Revaluere aktiva
...
## <a name="to-post-an-appreciation-from-the-fixed-asset-gl-journal" />Slik bokfører du en oppskrivning fra aktivafinanskladden:
...
## <a name="to-post-a-write-down-from-the-fixed-asset-gl-journal" />Slik bokfører du en nedskrivning fra aktivafinanskladden:
...
## <a name="to-perform-general-revaluation-of-fixed-assets" />Slik utfører du generell revaluering av aktiva:
...
## <a name="to-post-additional-acquisition-costs" />Slik bokfører du flere anskaffelseskostnader:
...
### <a name="example---posting-additional-acquisition-costs" />Eksempel – bokføre tilleggsanskaffelseskostnader
...
## <a name="see-related-microsoft-trainingtrainingpathsmanage-advanced-fixed-assets-transactions" />Se relatert [Microsoft-opplæring](/training/paths/manage-advanced-fixed-assets-transactions/)
