...
ms.author: edupont
---
# <a name="set-up-put-away-templates"></a><a name="set-up-put-away-templates"></a>Definere plasseringsmaler
...
## <a name="to-set-up-put-away-templates"></a><a name="to-set-up-put-away-templates"></a>Slik setter du opp plasseringsmaler
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/modules/put-away-templates/)
