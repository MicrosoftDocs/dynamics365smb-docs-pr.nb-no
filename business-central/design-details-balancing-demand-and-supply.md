...
---
# Designdetaljer: Balanser tilbud og etterspørsel
...
## Behandle ordrer før den planlagte startdatoen
...
### Serie- og partinumre og ordre-til-ordre-koblinger er fritatt fra den forrige perioden  
...
### Serie- og partinumre lastes inn etter spesifikasjonsnivå  
...
### Ordre-til-ordre-koblinger brytes aldri
...
### Komponentbehov blir lastet inn i henhold til produksjonsordreendringer
...
### Prognosebehov blir redusert av ordrer
...
### Rammebestillingsbehov blir redusert av ordrer
...
### Prioritet som er knyttet til statusen for behov og forsyning  
...
### Regler for handlinger for forsyningshendelser
...
### Sporingskoblinger under planlegging  
...
## Lukk balansert tilbud og etterspørsel
...
### Opprett planleggingslinjen (foreslått handling)  
