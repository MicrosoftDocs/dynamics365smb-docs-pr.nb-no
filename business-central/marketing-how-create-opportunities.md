...
ms.author: jswymer
---
# <a name="create-sales-opportunities"></a><a name="create-sales-opportunities"></a>Opprette salgsmuligheter
...
## <a name="to-create-an-opportunity-from-a-salesperson"></a><a name="to-create-an-opportunity-from-a-salesperson"></a>Opprette en salgsmulighet fra en selger
...
## <a name="to-create-an-opportunity-from-a-contact"></a><a name="to-create-an-opportunity-from-a-contact"></a>Opprette en salgsmulighet fra en kontakt
