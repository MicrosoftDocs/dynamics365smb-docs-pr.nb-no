...
ms.author: edupont
---
# <a name="set-up-general-fixed-assets-information" />Definere generell aktivainformasjon
...
## <a name="to-set-up-general-default-values-for-fixed-assets" />Slik definerer du generelle standardverdier for aktiva
...
## <a name="to-set-up-fixed-asset-posting-groups" />Slik definerer du bokføringsgrupper for aktiva:
...
## <a name="to-set-up-fixed-asset-allocation-keys" />Slik definerer du aktivafordelingsnøkler:
...
## <a name="to-set-up-fixed-asset-journal-templates" />Slik definerer du aktivakladdemaler:
...
## <a name="to-set-up-fixed-asset-journal-batches" />Slik definerer du aktivakladder:
...
## <a name="to-set-up-fixed-asset-reclassification-journal-templates" />Slik definerer du aktivareklassifiseringskladdemaler:
...
## <a name="to-set-up-fixed-asset-reclassification-journal-batches" />Slik definerer du aktivareklassifiseringskladder:
...
## <a name="to-set-up-fixed-asset-class-codes" />Slik definerer du aktivaklassekoder:
...
## <a name="to-set-up-fixed-asset-subclass-codes" />Slik definerer du aktivaunderklassekoder:
...
## <a name="to-set-up-fixed-asset-location-codes" />Slik definerer du aktivalokasjonskoder:
...
## <a name="to-register-opening-entries" />Slik registrerer du åpningsposter
