...
ms.author: edupont
---
# <a name="work-on-service-tasks"></a><a name="work-on-service-tasks"></a><a name="work-on-service-tasks"></a>Arbeide med serviceoppgaver
...
## <a name="to-work-on-a-service-task"></a><a name="to-work-on-a-service-task"></a><a name="to-work-on-a-service-task"></a>Slik arbeider du med en serviceoppgave
...
## <a name="to-register-service-operations"></a><a name="to-register-service-operations"></a><a name="to-register-service-operations"></a>Slik registrerer du serviceoperasjoner
...
## <a name="to-register-spare-parts"></a><a name="to-register-spare-parts"></a><a name="to-register-spare-parts"></a>Slik registrerer du reservedeler
...
## <a name="to-register-spare-parts-from-a-service-order"></a><a name="to-register-spare-parts-from-a-service-order"></a><a name="to-register-spare-parts-from-a-service-order"></a>Registrere reservedeler fra en serviceordre
...
## <a name="to-replace-a-service-item-or-a-service-item-component"></a><a name="to-replace-a-service-item-or-a-service-item-component"></a><a name="to-replace-a-service-item-or-a-service-item-component"></a>Erstatte en servicevare eller servicevarekomponent
...
## <a name="to-change-the-response-time-for-a-service-item-line"></a><a name="to-change-the-response-time-for-a-service-item-line"></a><a name="to-change-the-response-time-for-a-service-item-line"></a>Slik endrer du responstiden for en servicevarelinje
...
## <a name="to-register-faultresolution-codes"></a><a name="to-register-faultresolution-codes"></a><a name="to-register-faultresolution-codes"></a>Slik registrerer du feil-/løsningskoder
