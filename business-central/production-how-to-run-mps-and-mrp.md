...
ms.author: edupont
---
# <a name="run-full-planning-mps-or-mrp"></a><a name="run-full-planning-mps-or-mrp"></a><a name="run-full-planning-mps-or-mrp"></a>Kjøre full planlegging, MPS eller MRP

Uttrykket "kjøre planleggingsforslaget" eller "kjøre MRP" henviser til beregningen av hovedproduksjonsplanen og materialbehovene basert på faktisk og prognostisert behov. Planleggingssystemet kan beregne enten MPS (Master Production Schedule) eller MRP (Material Requirements Planning) ved forespørsel, eller det kan beregne begge samtidig.  
...
## <a name="methods-for-generating-a-plan"></a><a name="methods-for-generating-a-plan"></a><a name="methods-for-generating-a-plan"></a>Metoder for å generere en plan
...
-   **Beregn bevegelsesplan**: Denne funksjonen behandler en bevegelsesplan. Varer behandles i bevegelsesplanlegging fra to typer endringer:  
    - **Behovs-/forsyningsendringer**: Dette inkluderer endringer av antall i ordrer, behovsprognoser, monteringsordrer, produksjonsordrer eller bestillinger. En endring i beholdningsnivået som ikke er planlagt, regnes også for å være en endring av antall.  
...
## <a name="to-calculate-the-planning-worksheet"></a><a name="to-calculate-the-planning-worksheet"></a><a name="to-calculate-the-planning-worksheet"></a>Slik beregner du planleggingsforslaget
...
## <a name="to-perform-action-messages"></a><a name="to-perform-action-messages"></a><a name="to-perform-action-messages"></a>Utføre handlingsmeldinger
...
## <a name="action-messages"></a><a name="action-messages"></a><a name="action-messages"></a>Handlingsmeldinger
