...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-invoicing-sales-prepayments" />Gjennomgang: konfigurere og fakturere salgsforskudd
...
### <a name="to-set-up-number-series-for-prepayments" />Slik definerer du en nummerserie for forskuddsbetalinger:
...
### <a name="to-block-shipments-for-unpaid-prepayment" />Slik sperrer du leveringer ved ubetalt forskudd
...
### <a name="to-assign-default-prepayment-percentages-to-customers-and-items" />Slik tilordner du standard forskuddsprosenter til kunder og varer:
...
### <a name="to-specify-an-account-for-sales-prepayments-in-general-posting-setup" />Slik angir du en konto for salgsforskudd i generelt bokføringsoppsett:
...
## <a name="create-an-order-that-requires-a-prepayment" />Opprett en ordre der det kreves et forskudd
...
### <a name="to-create-a-sales-order-with-a-prepayment" />Slik oppretter du en ordre med et forskudd:
...
## <a name="create-a-prepayment-invoice" />Opprett en forskuddsfaktura
...
## <a name="create-an-additional-prepayment-invoice" />Opprett en ekstra forskuddsfaktura
...
### <a name="to-create-an-additional-prepayment-invoice" />Slik oppretter du en ekstra forskuddsfaktura:
...
## <a name="apply-the-prepayments" />Utlign forskuddsbetalingene
...
### <a name="to-apply-a-payment-to-the-prepayment-invoices" />Slik utligner du en betaling mot forskuddsfakturaene:
...
## <a name="invoice-the-remaining-amount" />Fakturer restbeløpet
...
### <a name="to-invoice-the-remaining-amount" />Slik fakturerer du restbeløpet:
...
## <a name="see-related-microsoft-trainingtrainingmodulesprepayment-invoices-dynamics-365-business-central" />Se relatert [Microsoft-opplæring](/training/modules/prepayment-invoices-dynamics-365-business-central/)
