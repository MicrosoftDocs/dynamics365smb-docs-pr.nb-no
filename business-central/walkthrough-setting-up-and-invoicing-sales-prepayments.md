...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-invoicing-sales-prepayments"></a><a name="walkthrough-setting-up-and-invoicing-sales-prepayments"></a>Gjennomgang: konfigurere og fakturere salgsforskudd
...
## <a name="set-up-prepayments"></a><a name="set-up-prepayments"></a>Definerer forskudd
...
### <a name="to-set-up-number-series-for-prepayments"></a><a name="to-set-up-number-series-for-prepayments"></a>Slik definerer du en nummerserie for forskuddsbetalinger:
...
### <a name="to-block-shipments-for-unpaid-prepayment"></a><a name="to-block-shipments-for-unpaid-prepayment"></a>Slik sperrer du leveringer ved ubetalt forskudd
...
### <a name="to-assign-default-prepayment-percentages-to-customers-and-items"></a><a name="to-assign-default-prepayment-percentages-to-customers-and-items"></a>Slik tilordner du standard forskuddsprosenter til kunder og varer:
...
### <a name="to-specify-an-account-for-sales-prepayments-in-general-posting-setup"></a><a name="to-specify-an-account-for-sales-prepayments-in-general-posting-setup"></a>Slik angir du en konto for salgsforskudd i generelt bokføringsoppsett:
...
## <a name="create-an-order-that-requires-a-prepayment"></a><a name="create-an-order-that-requires-a-prepayment"></a>Opprett en ordre der det kreves et forskudd
...
### <a name="to-create-a-sales-order-with-a-prepayment"></a><a name="to-create-a-sales-order-with-a-prepayment"></a>Slik oppretter du en ordre med et forskudd:
...
## <a name="create-a-prepayment-invoice"></a><a name="create-a-prepayment-invoice"></a>Opprett en forskuddsfaktura
...
### <a name="to-create-a-prepayment-invoice"></a><a name="to-create-a-prepayment-invoice"></a>Slik oppretter du en forskuddsfaktura:
...
## <a name="create-an-additional-prepayment-invoice"></a><a name="create-an-additional-prepayment-invoice"></a>Opprett en ekstra forskuddsfaktura
...
### <a name="to-create-an-additional-prepayment-invoice"></a><a name="to-create-an-additional-prepayment-invoice"></a>Slik oppretter du en ekstra forskuddsfaktura:
...
## <a name="apply-the-prepayments"></a><a name="apply-the-prepayments"></a>Utlign forskuddsbetalingene
...
### <a name="to-apply-a-payment-to-the-prepayment-invoices"></a><a name="to-apply-a-payment-to-the-prepayment-invoices"></a>Slik utligner du en betaling mot forskuddsfakturaene:
...
## <a name="invoice-the-remaining-amount"></a><a name="invoice-the-remaining-amount"></a>Fakturer restbeløpet
...
### <a name="to-invoice-the-remaining-amount"></a><a name="to-invoice-the-remaining-amount"></a>Slik fakturerer du restbeløpet:
...
## <a name="update-the-status-of-prepaid-orders-and-invoices-automatically"></a><a name="update-the-status-of-prepaid-orders-and-invoices-automatically"></a>Oppdater statusen for forhåndsbetalte bestillinger og fakturaer automatisk
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/modules/prepayment-invoices-dynamics-365-business-central/)
