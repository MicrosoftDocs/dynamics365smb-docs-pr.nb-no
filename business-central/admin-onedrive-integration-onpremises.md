...
ms.author: jswymer
---
# <a name="configuring-onedrive-integration-with-business-central-on-premises" />Konfigurere OneDrive-integrasjon med Business Central On-premises
...
### <a name="run-onedrive-setup" />Kjøre OneDrive-oppsett
...
## <a name="switching-from-legacy-sharepoint-to-new-onedrive-integration" />Bytte fra eldre SharePoint til ny OneDrive-integrasjon
...
#### <a name="how-the-changes-affect-the-integration" />Hvordan endringene påvirker integreringen
...
### <a name="run-onedrive-setup-to-switch-to-the-new-onedrive-integration" />Kjør OneDrive-oppsettet for å bytte til den nye OneDrive-integreringen
