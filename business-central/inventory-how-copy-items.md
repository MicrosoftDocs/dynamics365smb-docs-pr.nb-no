...
ms.author: edupont
---
# <a name="copy-existing-items-to-create-new-items" />Kopiere eksisterende varer for å opprette nye varer
...
## <a name="to-copy-an-existing-item-to-a-new-item" />Slik kopierer du en eksisterende vare til en ny vare
