...
Nå har du koblet til Business Central-dataene og er klar til å begynne å bygge din flyt. Hvis du ønsker mer informasjon, se [Flow-dokumentasjonen](https://flow.microsoft.com/documentation/getting-started/).
