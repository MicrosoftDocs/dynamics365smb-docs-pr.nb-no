...
# <a name="managing-vat-rate-changes" />Håndtere endringer i mva-satser
...
## <a name="changing-vat-rates" />Endre mva-satser
...
## <a name="the-vat-rate-change-tool" />Bruke verktøyet for endring av mva-sats
...
## <a name="understanding-the-vat-rate-conversion-process-and-limitations" />Forstå prosesser og begrensninger for konvertering av mva-sats
...
### <a name="to-prepare-vat-rate-change-conversions" />Klargjøre konverteringer av mva-satsendring
...
### <a name="to-set-up-the-vat-rate-change-tool" />Slik konfigurerer du verktøyet for endring av mva-sats:
...
### <a name="to-set-up-product-posting-group-conversion" />Slik definerer du omregning av varebokføringsgruppe:
...
### <a name="to-perform-vat-rate-change-conversion" />Utføre konverteringer av mva-sats
...
## <a name="see-related-microsoft-training" />Se relatert [Microsoft-opplæring](/training/modules/rate-change-dynamics-365-business-central/)
