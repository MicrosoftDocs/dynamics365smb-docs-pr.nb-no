...
# <a name="managing-vat-rate-changes"></a><a name="managing-vat-rate-changes"></a>Håndtere endringer i mva-satser
...
## <a name="changing-vat-rates"></a><a name="changing-vat-rates"></a>Endre mva-satser
...
## <a name="the-vat-rate-change-tool"></a><a name="the-vat-rate-change-tool"></a>Bruke verktøyet for endring av mva-sats
...
## <a name="understanding-the-vat-rate-conversion-process-and-limitations"></a><a name="understanding-the-vat-rate-conversion-process-and-limitations"></a>Forstå prosesser og begrensninger for konvertering av mva-sats
...
### <a name="to-prepare-vat-rate-change-conversions"></a><a name="to-prepare-vat-rate-change-conversions"></a>Klargjøre konverteringer av mva-satsendring
...
### <a name="to-set-up-the-vat-rate-change-tool"></a><a name="to-set-up-the-vat-rate-change-tool"></a>Slik konfigurerer du verktøyet for endring av mva-sats:
...
### <a name="to-set-up-product-posting-group-conversion"></a><a name="to-set-up-product-posting-group-conversion"></a>Slik definerer du omregning av varebokføringsgruppe:
...
### <a name="to-perform-vat-rate-change-conversion"></a><a name="to-perform-vat-rate-change-conversion"></a>Utføre konverteringer av mva-sats
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/modules/rate-change-dynamics-365-business-central/)
