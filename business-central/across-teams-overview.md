...
# <a name="business-central-and-microsoft-teams-integration"></a><a name="business-central-and-microsoft-teams-integration"></a>Business Central og Microsoft Teams-integrering
...
## <a name="features-overview"></a><a name="features-overview"></a>Oversikt over funksjoner

[!INCLUDE [prod_short](includes/prod_short.md)]-appen for Teams har følgende funksjoner.

### <a name="look-up-details-of-customers-vendors-and-other-contacts"></a><a name="look-up-details-of-customers-vendors-and-other-contacts"></a>Slå opp opplysninger om kunder, leverandører og andre kontakter
...
### <a name="share-records-in-conversations"></a><a name="share-records-in-conversations"></a>Dele poster i diskusjoner
...
### <a name="share-links-from-pages-in-business-central-to-teams"></a><a name="share-links-from-pages-in-business-central-to-teams"></a>Del koblinger fra sider i Business Central til Teams
...
### <a name="add-a-business-central-tab-to-teams-channel-or-chat"></a><a name="add-a-business-central-tab-to-teams-channel-or-chat"></a>Legg til en Business Central-fane i Teams-kanal eller -nettprat
