...
# <a name="business-central-and-microsoft-teams-integration" />Business Central og Microsoft Teams-integrering
...
## <a name="features-overview" />Oversikt over funksjoner

[!INCLUDE [prod_short](includes/prod_short.md)]-appen for Teams har følgende funksjoner.

### <a name="look-up-details-of-customers-vendors-and-other-contacts" />Slå opp opplysninger om kunder, leverandører og andre kontakter
...
### <a name="share-records-in-conversations" />Dele poster i diskusjoner
...
### <a name="share-links-from-pages-in-business-central-to-teams" />Del koblinger fra sider i Business Central til Teams
...
### <a name="add-a-business-central-tab-to-teams-channel-or-chat" />Legg til en Business Central-fane i Teams-kanal eller -nettprat
