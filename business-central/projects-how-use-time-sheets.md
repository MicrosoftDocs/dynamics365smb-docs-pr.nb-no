...
ms.author: edupont
---
# <a name="use-time-sheets" />Bruk timelister
...
## <a name="to-create-time-sheets" />Slik oppretter du timelister
...
## <a name="to-reuse-time-sheet-lines-in-other-time-sheets" />Slik bruker du timelistelinjer på nytt i andre timelister
...
## <a name="to-copy-job-planning-lines-to-a-time-sheet" />Slik kopierer du prosjektplanleggingslinjer til en timeliste:
...
## <a name="to-define-work-types-and-add-one-to-a-time-sheet" />Slik definerer du arbeidstyper og legger til en til en timeliste
...
## <a name="to-fill-in-time-sheet-lines-and-submit-for-approval" />Slik fyller du ut timelistelinjer og sender til godkjenning
...
## <a name="to-approve-or-reject-a-time-sheet" />Slik godkjenner eller avviser du timelister:
...
## <a name="to-reopen-a-time-sheet" />Åpne en timeliste på nytt
...
## <a name="to-view-and-approve-time-sheets-by-job" />Slik viser og godkjenner du timelister etter prosjekt
...
### <a name="to-approve-or-reject-a-time-sheet-by-job" />Slik godkjenner eller avviser du timelister etter prosjekt:
...
## <a name="to-post-time-sheet-lines-in-a-resource-journal" />Slik bokfører du timelistelinjer i en ressurskladd
...
## <a name="to-post-time-sheet-lines-in-a-job-journal" />Slik bokfører du timelistelinjer i en prosjektkladd
...
## <a name="to-archive-time-sheets" />Slik arkiverer du timelister:
