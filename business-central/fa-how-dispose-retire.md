...
---
# Avhend eller trekk tilbake aktiva

Når du selger eller på annen måte avhender et aktiva, må du bokføre salgsverdien for å beregne og registrere tap eller vinning. En salgspost må være den siste posten som bokføres for et aktiva. Du kan bokføre mer enn én salgspost for aktiva som er delvis solgt. Summen av alle bokførte salgsbeløp må være et kreditbeløp.  
...
Følgende fremgangsmåte forutsetter at bokføringsgruppene er konfigurert på siden **Bokføringsgruppe for aktiva**. Hvis du vil ha mer informasjon, kan du se [Slik definerer du bokføringsgrupper for aktiva](fa-how-setup-general.md#to-set-up-fixed-asset-posting-groups).  

## Slik bokfører du et salg fra aktivafinanskladden:
