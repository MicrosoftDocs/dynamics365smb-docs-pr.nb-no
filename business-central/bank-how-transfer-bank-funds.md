...
ms.author: edupont
---
# <a name="transfer-bank-funds" />Overføre bankkapital
...
## <a name="to-post-a-transfer-between-bank-accounts-with-the-same-currency-code" />Bokføre en overføring mellom bankkonti med samme valutakode
...
## <a name="to-post-a-transfer-between-bank-accounts-with-different-currency-codes" />Slik bokfører du en overføring mellom bankkonti med ulike valutakoder
