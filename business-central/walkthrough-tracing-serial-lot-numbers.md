...
ms.author: bholtorf
---
# <a name="walkthrough-tracing-seriallot-numbers"></a><a name="walkthrough-tracing-seriallot-numbers"></a>Gjennomgang: spore serie-/partinumre
...
### <a name="to-create-the-items"></a><a name="to-create-the-items"></a>Slik oppretter du varene
...
### <a name="to-purchase-components"></a><a name="to-purchase-components"></a>Kjøpe komponenter
...
### <a name="to-produce-end-items"></a><a name="to-produce-end-items"></a>Produsere sluttvarer
...
### <a name="to-sell-the-end-items"></a><a name="to-sell-the-end-items"></a>Selge sluttvarer
...
## <a name="tracing-from-usage-to-origin"></a><a name="tracing-from-usage-to-origin"></a>Spore fra forbruk til opprinnelse
...
### <a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it"></a><a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it"></a>Slik finner du ut hvilket parti den defekte rammen var i, og hvem som leverte den:
...
## <a name="tracing-from-origin-to-usage"></a><a name="tracing-from-origin-to-usage"></a>Spore fra opprinnelse til forbruk
...
### <a name="to-find-all-usage-of-the-faulty-lot"></a><a name="to-find-all-usage-of-the-faulty-lot"></a>Slik finner du alt forbruk for det defekte partiet:
...
## <a name="finding-all-records-of-a-seriallot-number"></a><a name="finding-all-records-of-a-seriallot-number"></a>Søke etter alle poster for et serie-/partinummer
...
### <a name="to-find-all-occurrences-of-lot1-in-non-posted-records-such-as-open-orders"></a><a name="to-find-all-occurrences-of-lot1-in-non-posted-records-such-as-open-orders"></a>Slik finner du alle forekomster av PARTI1 i poster som ikke er bokført, for eksempel åpne ordrer:
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/paths/use-serial-lot-numbers/)
