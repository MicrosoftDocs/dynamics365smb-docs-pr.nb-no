...
ms.author: bholtorf
---
# <a name="walkthrough-tracing-seriallot-numbers" />Gjennomgang: spore serie-/partinumre
...
### <a name="to-create-the-items" />Slik oppretter du varene
...
### <a name="to-purchase-components" />Kjøpe komponenter
...
### <a name="to-produce-end-items" />Produsere sluttvarer
...
### <a name="to-sell-the-end-items" />Selge sluttvarer
...
## <a name="tracing-from-usage-to-origin" />Spore fra forbruk til opprinnelse
...
### <a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it" />Slik finner du ut hvilket parti den defekte rammen var i, og hvem som leverte den:
...
## <a name="tracing-from-origin-to-usage" />Spore fra opprinnelse til forbruk
...
### <a name="to-find-all-usage-of-the-faulty-lot" />Slik finner du alt forbruk for det defekte partiet:
...
## <a name="finding-all-records-of-a-seriallot-number" />Søke etter alle poster for et serie-/partinummer
