...
ms.author: edupont
---
# <a name="combine-receipts-on-a-single-invoice" />Kombinere mottak på én faktura
...
## <a name="to-combine-receipts" />Slik kombinerer du mottak
...
## <a name="to-remove-open-purchase-orders-after-combined-receipt-posting" />Fjerne åpne bestillinger etter kombinert mottaksbokføring
...
## <a name="see-related-microsoft-trainingtrainingmodulesprocessing-invoices-dynamics-365-business-central" />Se relatert [Microsoft-opplæring](/training/modules/processing-invoices-dynamics-365-business-central/)
