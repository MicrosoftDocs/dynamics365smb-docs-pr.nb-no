...
ms.author: bholtorf
---
# <a name="integrating-with-dynamics-365-sales"></a><a name="integrating-with-dynamics-365-sales"></a>Integrere med Dynamics 365 Sales.
...
## <a name="integrating-through-dataverse"></a><a name="integrating-through-dataverse"></a>Integrasjon via Dataverse
...
## <a name="integration-settings-that-are-specific-to-a--integration"></a><a name="integration-settings-that-are-specific-to-a--integration"></a>Integrasjonsinnstillinger som er spesifikke for en [!INCLUDE[crm_md](includes/crm_md.md)]-integrering
...
## <a name="permissions-and-security-roles-for-user-accounts-in-sales"></a><a name="permissions-and-security-roles-for-user-accounts-in-sales"></a>Tillatelser og sikkerhetsroller for brukerkontoer i Sales
...
### <a name="connection-settings-in-the-setup-guide"></a><a name="connection-settings-in-the-setup-guide"></a>Tilkoblingsinnstillinger i installasjonsveiledningen
...
### <a name="connection-settings-on-the-microsoft-dynamics-365-connection-setup-page"></a><a name="connection-settings-on-the-microsoft-dynamics-365-connection-setup-page"></a>Tilkoblingsinnstillinger på siden Konfigurere Microsoft Dynamics 365-tilkobling
...
### <a name="standard-sales-entity-mapping-for-synchronization"></a><a name="standard-sales-entity-mapping-for-synchronization"></a>Standard Sales-enhetstilordning for synkronisering
...
## <a name="synchronizing-items-and-resources-with-products-with-different-units-of-measure"></a><a name="synchronizing-items-and-resources-with-products-with-different-units-of-measure"></a>Synkronisering av varer og ressurser med produkter i ulike enheter
...
### <a name="mapping-items-and-resources-to-products"></a><a name="mapping-items-and-resources-to-products"></a>Tilordning av varer og ressurser til produkter
...
### <a name="synchronization-jobs-for-a-sales-integration"></a><a name="synchronization-jobs-for-a-sales-integration"></a>Synkroniseringsjobber for en Sales-integrasjon
...
## <a name="connecting-to-on-premises-versions-of-business-central-2019-release-wave-1-and-microsoft-dynamics-nav-2018"></a><a name="connecting-to-on-premises-versions-of-business-central-2019-release-wave-1-and-microsoft-dynamics-nav-2018"></a>Tilkobling til lokale versjoner av Business Central 2019 lanseringsbølge 1 og Microsoft Dynamics NAV 2018
...
### <a name="to-connect-business-central-2019-release-wave-1-and-dynamics-nav-2018"></a><a name="to-connect-business-central-2019-release-wave-1-and-dynamics-nav-2018"></a>Slik kobler du til Business Central 2019 lanseringsbølge 1 og Dynamics NAV 2018
