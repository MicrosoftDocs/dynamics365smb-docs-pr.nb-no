...
ms.author: bholtorf
---
# <a name="integrating-with-dynamics-365-sales" />Integrere med Dynamics 365 Sales.
...
## <a name="integrating-through-dataverse" />Integrasjon via Dataverse
...
## <a name="integration-settings-that-are-specific-to-a-includecrmmdincludescrmmdmd-integration" />Integrasjonsinnstillinger som er spesifikke for en [!INCLUDE[crm_md](includes/crm_md.md)]-integrering
...
## <a name="permissions-and-security-roles-for-user-accounts-in-sales" />Tillatelser og sikkerhetsroller for brukerkontoer i Sales
...
### <a name="connection-settings-in-the-setup-guide" />Tilkoblingsinnstillinger i installasjonsveiledningen
...
### <a name="connection-settings-on-the-microsoft-dynamics-365-connection-setup-page" />Tilkoblingsinnstillinger på siden Konfigurere Microsoft Dynamics 365-tilkobling
...
### <a name="standard-sales-entity-mapping-for-synchronization" />Standard Sales-enhetstilordning for synkronisering
...
## <a name="synchronizing-items-and-resources-with-products-with-different-units-of-measure" />Synkronisering av varer og ressurser med produkter i ulike enheter
...
### <a name="mapping-items-and-resources-to-products" />Tilordning av varer og ressurser til produkter
...
### <a name="synchronization-jobs-for-a-sales-integration" />Synkroniseringsjobber for en Sales-integrasjon
...
## <a name="connecting-to-on-premises-versions-of-business-central-2019-release-wave-1-and-microsoft-dynamics-nav-2018" />Tilkobling til lokale versjoner av Business Central 2019 lanseringsbølge 1 og Microsoft Dynamics NAV 2018
...
### <a name="to-connect-business-central-2019-release-wave-1-and-dynamics-nav-2018" />Slik kobler du til Business Central 2019 lanseringsbølge 1 og Dynamics NAV 2018
