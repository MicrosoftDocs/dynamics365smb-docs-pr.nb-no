...
### <a name="how-do-i-sign-out-of-the--app-in-teams"></a>Hvordan logger jeg av [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen i Teams?
...
### <a name="does-the-app-for-teams-connect-to--on-premises"></a>Kobles appen for Teams til [!INCLUDE [prod_short.md](includes/prod_short.md)] lokalt?
...
### <a name="in-which-countries-or-regions-is-the--app-available"></a>I hvilke land eller områder er [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen tilgjengelig?
...
### <a name="does-the--app-work-with-any-localization-of-include-prod_shortmd"></a>Fungerer [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen sammen med en hvilken som helst lokalisering av [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="which-languages-does-the--app-support"></a><a name="language"></a>Hvilke språk støtter [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen?
...
### <a name="does-the--app-work-with-industry-solutions"></a>Fungerer [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen med bransjeløsninger?
...
### <a name="does--work-with-the-teams-mobile-app"></a>Fungerer [!INCLUDE [prod_short.md](includes/prod_short.md)] med Teams-mobilappen?
...
### <a name="is-the--app-for-teams-the-same-as-the-include-prod_shortmd-app-for-ios-and-android"></a>Er [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams det samme som [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for iOS og Android?
...
### <a name="which-teams-client-is-best-for-"></a>Hvilke Teams-klienter er best for [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="what-is-the-best-way-for-me-to-demonstrate--and-microsoft-teams-to-prospective-customers"></a>Hva er den beste måten for meg å vise frem [!INCLUDE [prod_short.md](includes/prod_short.md)] og Microsoft Teams til potensielle kunder?
...
### <a name="does-the--app-for-teams-cater-to-my-customization-and-personalization"></a>Kan [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams tilpasses og personaliseres?
...
### <a name="how-do-i-uninstall-the--app-for-teams"></a>Hvordan avinstallerer jeg [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams?
...
### <a name="will-microsoft-continue-to-improve-the--app-for-teams"></a>Vil Microsoft fortsette å forbedre [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams?
...
### <a name="where-can-i-find-teams-integration-inside-the-business-central-web-client"></a>Hvor finner jeg Teams-integrering i Business Central-nettklienten?
...
### <a name="can-i-call-a-contact-from-the--app-for-teams"></a>Kan jeg ringe en kontakt fra [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams?
...
### <a name="are--contacts-different-than-the-ones-in-the-teams-contacts-screen"></a>Er [!INCLUDE [prod_short.md](includes/prod_short.md)]-kontakter annerledes enn dem på skjermen for Teams-kontakter?
...
### <a name="what-is-the-minimum-version-of--for-contact-search"></a>Hva er minimumsversjonen av [!INCLUDE [prod_short.md](includes/prod_short.md)] for kontaktsøk?
...
### <a name="why-dont-cards-show-more-information-instead-of-just-the-page-name-and-details-button"></a>Hvorfor viser ikke kort mer informasjon i stedet for bare sidenavnet og detaljer-knappen?
...
### <a name="will-others-see-my-card-if-they-dont-have-the--app-for-teams"></a>Vil andre se kortet mitt hvis de ikke har [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams?
...
### <a name="how-do-i-open-the-details-in-a-new-window"></a>Hvordan åpner jeg detaljene i et nytt vindu?
...
### <a name="how-does-a-guest-user-install-the--app"></a>Hvordan installerer en gjestebruker [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen?
...
### <a name="does-share-to-teams-send-a-compact-card"></a>Sender Del til Teams et kompaktkort?

Ja. Koblingen utvides automatisk til et kort hvis du har installert Business Central-appen for Teams. 

### <a name="will-recipients-receive-the-message-from-me-or-from-a-business-central-service-account"></a>Skal mottakerne motta meldingen fra meg eller fra en Business Central-tjenestekonto?
...
### <a name="is-share-to-teams-available-in-business-central-on-premises"></a>Er Del til Teams tilgjengelig i Business Central lokalt?
...
### <a name="does-share-to-teams-grant-permissions-to-recipients"></a>Gir Del til Teams tillatelser til mottakerne?
...
### <a name="must-i-have-the-teams-desktop-app-installed-to-use-share-to-teams"></a>Må jeg ha Teams-skrivebordsappen installert for å bruke Del til Teams?

Nei. Alt du trenger, er en gyldig konto som har tilgang til Microsoft Teams. 

### <a name="is-share-to-teams-available-in-all-business-central-clients"></a>Er Del til Teams tilgjengelig i alle Business Central-klienter?
...
### <a name="where-do-i-find-share-to-teams-in-business-central"></a>Hvor finner jeg Del til Teams i Business Central?
