...
---
# <a name="teams-faq"></a><a name="teams-faq"></a>Vanlige spørsmål om Teams
...
### <a name="how-do-i-sign-out-of-the--app-in-teams"></a><a name="how-do-i-sign-out-of-the--app-in-teams"></a>Hvordan logger jeg av [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen i Teams?
...
### <a name="does-the-app-for-teams-connect-to--on-premises"></a><a name="does-the-app-for-teams-connect-to--on-premises"></a>Kobles appen for Teams til [!INCLUDE [prod_short.md](includes/prod_short.md)] lokalt?
...
### <a name="does-the-app-work-with-multiple-companies-and-environments"></a><a name="does-the-app-work-with-multiple-companies-and-environments"></a>Fungerer appen med flere selskaper og miljøer?
...
### <a name="in-which-countries-or-regions-is-the--app-available"></a><a name="in-which-countries-or-regions-is-the--app-available"></a>I hvilke land eller områder er [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen tilgjengelig?
...
### <a name="does-the--app-work-with-any-localization-of-include-prod_shortmd"></a><a name="does-the--app-work-with-any-localization-of-include-prod_shortmd"></a>Fungerer [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen sammen med en hvilken som helst lokalisering av [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="which-languages-does-the--app-support"></a><a name="which-languages-does-the--app-support"></a><a name="language"></a>Hvilke språk støtter [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen?
...
### <a name="does-the--app-work-with-industry-solutions"></a><a name="does-the--app-work-with-industry-solutions"></a>Fungerer [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen med bransjeløsninger?
...
### <a name="does--work-with-the-teams-mobile-app"></a><a name="does--work-with-the-teams-mobile-app"></a>Fungerer [!INCLUDE [prod_short.md](includes/prod_short.md)] med Teams-mobilappen?
...
### <a name="which-teams-client-is-best-for-"></a><a name="which-teams-client-is-best-for-"></a>Hvilke Teams-klienter er best for [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="what-is-the-best-way-for-me-to-demonstrate--and-microsoft-teams-to-prospective-customers"></a><a name="what-is-the-best-way-for-me-to-demonstrate--and-microsoft-teams-to-prospective-customers"></a>Hva er den beste måten for meg å vise frem [!INCLUDE [prod_short.md](includes/prod_short.md)] og Microsoft Teams til potensielle kunder?
...
### <a name="does-the--app-for-teams-cater-to-my-customization-and-personalization"></a><a name="does-the--app-for-teams-cater-to-my-customization-and-personalization"></a>Kan [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams tilpasses og personaliseres?
...
### <a name="how-do-the-permissions-required-by-the-app-affect-my-privacy"></a><a name="how-do-the-permissions-required-by-the-app-affect-my-privacy"></a>Hvordan påvirker tillatelsene som kreves av appen, personvernet mitt?
...
### <a name="where-can-i-learn-about-my-privacy"></a><a name="where-can-i-learn-about-my-privacy"></a>Hvor kan jeg finne ut mer om personvernet mitt?
...
### <a name="how-do-i-uninstall-the--app-for-teams"></a><a name="how-do-i-uninstall-the--app-for-teams"></a>Hvordan avinstallerer jeg [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams?
...
### <a name="will-microsoft-continue-to-improve-the--app-for-teams"></a><a name="will-microsoft-continue-to-improve-the--app-for-teams"></a>Vil Microsoft fortsette å forbedre [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams?
...
### <a name="where-can-i-find-teams-integration-inside-the-business-central-web-client"></a><a name="where-can-i-find-teams-integration-inside-the-business-central-web-client"></a>Hvor finner jeg Teams-integrering i Business Central-nettklienten?
...
### <a name="who-can-see-the-content-of-a-tab"></a><a name="who-can-see-the-content-of-a-tab"></a><a name="who-can-view"></a>Hvem kan vise innholdet i en fane?
...
### <a name="where-does-the-recommended-content-come-from"></a><a name="where-does-the-recommended-content-come-from"></a><a name=#recommended-content></a>Hvor kommer det anbefalte innholdet fra?
...
### <a name="when-i-create-a-tab-does-it-grant-permissions-to-the-people-in-the-channel-or-chat"></a><a name="when-i-create-a-tab-does-it-grant-permissions-to-the-people-in-the-channel-or-chat"></a>Når jeg oppretter en fane, gir den tillatelser til personene i kanalen eller nettpraten?

Nei. Oppretting av faner påvirker ikke tillatelser, og brukere må allerede ha tilgang til dataene når de åpner fanen.

### <a name="can-i-chat-alongside-a-tab"></a><a name="can-i-chat-alongside-a-tab"></a>Kan jeg nettprate ved siden av en fane?

Ja. Bruk nettpratikonet når du vil starte samtalen. Denne nettprattråden knyttes deretter til fanen. 

### <a name="if-i-remove-a-tab-from-a-chat-or-channel-is-any-business-central-data-deleted"></a><a name="if-i-remove-a-tab-from-a-chat-or-channel-is-any-business-central-data-deleted"></a>Hvis jeg fjerner en fane fra en nettprat eller kanal, slettes eventuelle Business Central-data?

Nei.

### <a name="can-i-safely-rename-a-tab"></a><a name="can-i-safely-rename-a-tab"></a>Kan jeg trygt endre navn på en fane?

Ja. Innholdet i fanen er ikke relatert til det faktiske navnet på fanen. Endre navn hvis du vil. 

### <a name="i-need-to-work-across-tasks-in-different-windows-can-i-do-this"></a><a name="i-need-to-work-across-tasks-in-different-windows-can-i-do-this"></a>Jeg trenger å arbeide på tvers av oppgaver i forskjellige vinduer. Kan jeg gjøre det?

Ja. Du kan vise fanen til et eget nettleservindu for å vise Business Central-nettklienten for virksomheten. 

### <a name="can-i-add-or-pin-tab-in-team-meetings"></a><a name="can-i-add-or-pin-tab-in-team-meetings"></a>Kan jeg legge til eller feste fanen i Teams-møter?

Nei. Business Central-appen for Teams støtter ikke faner i møter.

### <a name="cant-add-a-tab-if-using-isv-urls-like-bcdynamicscom-but-can-pin"></a><a name="cant-add-a-tab-if-using-isv-urls-like-bcdynamicscom-but-can-pin"></a>Kan ikke legge til en fane hvis du bruker ISV-nettadresser som *.bc.dynamics.com (men kan feste)
...
### <a name="does-the-tab-content-refresh-automatically-if-not-how-do-i-refresh-it"></a><a name="does-the-tab-content-refresh-automatically-if-not-how-do-i-refresh-it"></a>Oppdateres faneinnholdet i automatisk? Hvis ikke hvordan oppdaterer jeg den?
...
### <a name="does-this-show-lists-and-records-from-my-customizations-and-add-ons"></a><a name="does-this-show-lists-and-records-from-my-customizations-and-add-ons"></a>Viser dette lister og poster fra tilpasninger og tillegg?

Ja. 

### <a name="when-i-add-a-tab-will-people-see-it-in-my-language"></a><a name="when-i-add-a-tab-will-people-see-it-in-my-language"></a>Når jeg legger til en fane, ser andre den på språket mitt?

Nei. Hver bruker viser innholdet i fanen med innstillingene for språk, område og tidssone fra Business Central. 

### <a name="can-i-have-multiple-tabs-pointing-to-different-content"></a><a name="can-i-have-multiple-tabs-pointing-to-different-content"></a>Kan jeg ha flere faner som peker til annet innhold?

Ja.

### <a name="can-i-also-add-tabs-to-chat-with-a-single-person"></a><a name="can-i-also-add-tabs-to-chat-with-a-single-person"></a>Kan jeg også legge til faner for å nettprate med én person?
...
### <a name="can-i-switch-companies-within-a-tab"></a><a name="can-i-switch-companies-within-a-tab"></a>Kan jeg bytte selskap i en fane?

Nei. 

### <a name="is-this-different-than-using-teams-generic-ability-to-create-a-tab-that-hosts-a-website"></a><a name="is-this-different-than-using-teams-generic-ability-to-create-a-tab-that-hosts-a-website"></a>Er dette forskjellig fra den generelle muligheten i Teams til å opprette en fane som er vert for et nettsted?
...
### <a name="which-tables-does-the-app-search-in"></a><a name="which-tables-does-the-app-search-in"></a>Hvilke tabeller søker i programmet i?
...
### <a name="which-fields-in-the-contacts-table-can-i-search"></a><a name="which-fields-in-the-contacts-table-can-i-search"></a>Hvilke felt i tabellen Kontakter kan jeg søke i?
...
### <a name="do-search-results-include-companies-and-persons"></a><a name="do-search-results-include-companies-and-persons"></a>Inkluderer søkeresultater selskaper og personer?
...
### <a name="do-contacts-of-any-business-relationship-appear-in-the-results"></a><a name="do-contacts-of-any-business-relationship-appear-in-the-results"></a>Vises det kontakter for forretningsforbindelser i resultatet?
...
### <a name="can-i-look-up-contact-details-during-meetings"></a><a name="can-i-look-up-contact-details-during-meetings"></a>Kan jeg slå opp kontaktdetaljer under møter?
...
### <a name="how-do-i-view-my-last-interactions-with-a-contact"></a><a name="how-do-i-view-my-last-interactions-with-a-contact"></a>Hvordan viser jeg min siste samhandling med en kontakt?
...
### <a name="how-do-i-register-a-teams-call-or-meeting-as-an-interaction"></a><a name="how-do-i-register-a-teams-call-or-meeting-as-an-interaction"></a>Hvordan registrerer jeg en Teams-samtale eller et møte som en samhandling?
...
### <a name="can-i-call-a-contact-from-the--app-for-teams"></a><a name="can-i-call-a-contact-from-the--app-for-teams"></a>Kan jeg ringe en kontakt fra [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams?
...
### <a name="how-do-i-view-recent-documents-for-a-customer-or-vendor"></a><a name="how-do-i-view-recent-documents-for-a-customer-or-vendor"></a>Hvordan viser jeg nylig brukte dokumenter for en kunde eller leverandør?
...
### <a name="how-do-i-search-for-contacts-using-special-characters"></a><a name="how-do-i-search-for-contacts-using-special-characters"></a>Hvordan søker jeg etter kontakter ved hjelp av spesialtegn?
...
### <a name="how-can-i-search-contacts-stored-in-a-different-company"></a><a name="how-can-i-search-contacts-stored-in-a-different-company"></a>Hvordan kan jeg søke etter kontakter som er lagret i et annet selskap?
...
### <a name="are--contacts-different-than-the-ones-in-the-teams-contacts-screen"></a><a name="are--contacts-different-than-the-ones-in-the-teams-contacts-screen"></a>Er [!INCLUDE [prod_short.md](includes/prod_short.md)]-kontakter annerledes enn dem på skjermen for Teams-kontakter?
...
### <a name="what-is-the-minimum-version-of--for-contact-search"></a><a name="what-is-the-minimum-version-of--for-contact-search"></a>Hva er minimumsversjonen av [!INCLUDE [prod_short.md](includes/prod_short.md)] for kontaktsøk?
...
### <a name="can-i-search-from-my-mobile-device"></a><a name="can-i-search-from-my-mobile-device"></a>Kan jeg søke fra min mobile enhet?

Kontaktsøk er ikke tilgjengelig fra Teams for iOS og Teams for Android for øyeblikket.

### <a name="which-permissions-do-i-need-for-contact-search"></a><a name="which-permissions-do-i-need-for-contact-search"></a>Hvilke tillatelser trenger jeg for kontaktsøk?
...
### <a name="can-i-use-contact-search-if-im-a-delegated-admin"></a><a name="can-i-use-contact-search-if-im-a-delegated-admin"></a>Kan jeg bruke kontaktsøk hvis jeg er delegert administrator?

Ja. Du kan også slå opp kontakter og kontaktopplysninger hvis du har en delegert administratorrolle i en organisasjon.

### <a name="is-contact-search-affected-by-api-limits"></a><a name="is-contact-search-affected-by-api-limits"></a>Påvirkes kontaktsøket av API-begrensninger?
...
### <a name="why-does-it-sometimes-ask-me-to-set-up-the-app"></a><a name="why-does-it-sometimes-ask-me-to-set-up-the-app"></a>Hvorfor blir jeg noen ganger bedt om å konfigurere appen?
...
### <a name="id-like-to-search-for-items-or-records-from-other-tables-can-i-do-this-from-teams"></a><a name="id-like-to-search-for-items-or-records-from-other-tables-can-i-do-this-from-teams"></a>Jeg vil gjerne søke etter varer eller poster fra andre tabeller. Kan jeg gjøre dette fra Teams?
...
### <a name="which-types-of-links-does-the-app-support"></a><a name="which-types-of-links-does-the-app-support"></a>Hvilke typer koblinger støtter appen?
...
### <a name="do-cards-always-show-up-to-date-information"></a><a name="do-cards-always-show-up-to-date-information"></a>Viser kort alltid oppdatert informasjon?
...
### <a name="why-dont-cards-show-more-information-instead-of-just-the-page-name-and-details-button"></a><a name="why-dont-cards-show-more-information-instead-of-just-the-page-name-and-details-button"></a>Hvorfor viser ikke kort mer informasjon i stedet for bare sidenavnet og detaljer-knappen?
...
### <a name="will-others-see-my-card-if-they-dont-have-the--app-for-teams"></a><a name="will-others-see-my-card-if-they-dont-have-the--app-for-teams"></a>Vil andre se kortet mitt hvis de ikke har [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams?
...
### <a name="how-do-i-find-out-which-company-a-card-in-teams-belongs-to"></a><a name="how-do-i-find-out-which-company-a-card-in-teams-belongs-to"></a>Hvordan finner jeg ut hvilket selskap et kort i Teams tilhører?
...
### <a name="where-is-the-save-button-in-the-details-window-in-teams"></a><a name="where-is-the-save-button-in-the-details-window-in-teams"></a>Hvor er Lagre-knappen i detaljvinduet i Teams?
...
### <a name="if-i-choose-to-view-details-for-a-card-will-other-users-see-my-details-window"></a><a name="if-i-choose-to-view-details-for-a-card-will-other-users-see-my-details-window"></a>Hvis jeg velger å vise detaljer for et kort, kan andre brukere se detaljvinduet mitt?
...
### <a name="can-i-start-a-teams-call-from-the-details-window-in-teams"></a><a name="can-i-start-a-teams-call-from-the-details-window-in-teams"></a>Kan jeg starte et Teams-anrop fra detaljvinduet i Teams?
...
### <a name="can-i-print-documents-from-the-details-window-in-teams"></a><a name="can-i-print-documents-from-the-details-window-in-teams"></a>Kan jeg skrive ut dokumenter fra detaljvinduet i Teams?
...
### <a name="can-i-access-the-camera-from-the-details-window-in-teams"></a><a name="can-i-access-the-camera-from-the-details-window-in-teams"></a>Får jeg tilgang til kameraet fra detaljvinduet i Teams?
...
### <a name="can-i-access-my-location-from-the-details-window-in-teams"></a><a name="can-i-access-my-location-from-the-details-window-in-teams"></a><a name="location"></a>Får jeg tilgang plasseringen min fra detaljvinduet i Teams?
...
### <a name="how-do-i-open-the-details-in-a-new-window"></a><a name="how-do-i-open-the-details-in-a-new-window"></a>Hvordan åpner jeg detaljene i et nytt vindu?
...
### <a name="can-i-share-cards-with-users-outside-my-organization"></a><a name="can-i-share-cards-with-users-outside-my-organization"></a>Kan jeg dele kort med brukere utenfor organisasjonen min?
...
### <a name="is-the-experience-any-different-for-users-that-are-guests"></a><a name="is-the-experience-any-different-for-users-that-are-guests"></a>Er funksjonene annerledes for brukere som er gjester?
...
### <a name="how-does-a-guest-user-install-the--app"></a><a name="how-does-a-guest-user-install-the--app"></a>Hvordan installerer en gjestebruker [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen?
...
### <a name="does-share-to-teams-send-a-compact-card"></a><a name="does-share-to-teams-send-a-compact-card"></a>Sender Del til Teams et kompaktkort?

Ja. Koblingen utvides automatisk til et kort hvis du har installert Business Central-appen for Teams. 

### <a name="will-recipients-receive-the-message-from-me-or-from-a-business-central-service-account"></a><a name="will-recipients-receive-the-message-from-me-or-from-a-business-central-service-account"></a>Skal mottakerne motta meldingen fra meg eller fra en Business Central-tjenestekonto?
...
### <a name="is-share-to-teams-available-in-business-central-on-premises"></a><a name="is-share-to-teams-available-in-business-central-on-premises"></a>Er Del til Teams tilgjengelig i Business Central lokalt?
...
### <a name="does-share-to-teams-grant-permissions-to-recipients"></a><a name="does-share-to-teams-grant-permissions-to-recipients"></a>Gir Del til Teams tillatelser til mottakerne?
...
### <a name="must-i-have-the-teams-desktop-app-installed-to-use-share-to-teams"></a><a name="must-i-have-the-teams-desktop-app-installed-to-use-share-to-teams"></a>Må jeg ha Teams-skrivebordsappen installert for å bruke Del til Teams?

Nei. Alt du trenger, er en gyldig konto som har tilgang til Microsoft Teams. 

### <a name="is-share-to-teams-available-in-all-business-central-clients"></a><a name="is-share-to-teams-available-in-all-business-central-clients"></a>Er Del til Teams tilgjengelig i alle Business Central-klienter?
...
### <a name="where-do-i-find-share-to-teams-in-business-central"></a><a name="where-do-i-find-share-to-teams-in-business-central"></a>Hvor finner jeg Del til Teams i Business Central?
