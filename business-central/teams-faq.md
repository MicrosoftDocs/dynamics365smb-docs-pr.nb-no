...
### Hvordan logger jeg av [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen i Teams?
...
### I hvilke land eller områder er [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen tilgjengelig? 
...
### Fungerer [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen sammen med en hvilken som helst lokalisering av [!INCLUDE [prod_short.md](includes/prod_short.md)]? 
...
### <a name="language"></a>Hvilke språk støtter [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen?
...
### Fungerer [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen med bransjeløsninger?
...
### Fungerer [!INCLUDE [prod_short.md](includes/prod_short.md)] med Teams-mobilappen?
...
### Er [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams det samme som [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for iOS og Android?

Nei. Appen for Teams er et tillegg til Microsoft Teams og eksklusivt utformet for samarbeid i Teams. Alternativt leverer [!INCLUDE [prod_short.md](includes/prod_short.md)]-mobilappen en flott opplevelse der du kan arbeide med [!INCLUDE [prod_short.md](includes/prod_short.md)]-data på mobile enheter.
...
Nei. [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams støttes ikke når den er installert som en pakke for macOS eller Linux. På disse plattformene får du tilgang til Teams ved hjelp av en støttet nettleser i stedet.
...
### Hvilke Teams-klienter er best for [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### Hva er den beste måten for meg å vise frem [!INCLUDE [prod_short.md](includes/prod_short.md)] og Microsoft Teams til potensielle kunder?
...
### Kan [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams tilpasses og personaliseres?
...
### Hvordan påvirker tillatelsene som kreves av appen, personvernet mitt?
...
### Hvor kan jeg finne ut mer om personvernet mitt? 
...
### Hvordan avinstallerer jeg [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams?
...
### Vil Microsoft fortsette å forbedre [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams?
...
### Hvor finner jeg Teams-integrering i Business Central-nettklienten? 
...
### <a name="who-can-view"></a>Hvem kan vise innholdet i en fane?
...
### <a name=#recommended-content></a>Hvor kommer det anbefalte innholdet fra?
...
### Når jeg oppretter en fane, gir den tillatelser til personene i kanalen eller nettpraten?

Nei. Oppretting av faner påvirker ikke tillatelser, og brukere må allerede ha tilgang til dataene når de åpner fanen.

### Kan jeg nettprate ved siden av en fane?

Ja. Bruk nettpratikonet når du vil starte samtalen. Denne nettprattråden knyttes deretter til fanen. 

### Hvis jeg fjerner en fane fra en nettprat eller kanal, slettes eventuelle Business Central-data?

Nei.

### Kan jeg trygt endre navn på en fane?

Ja. Innholdet i fanen er ikke relatert til det faktiske navnet på fanen. Endre navn hvis du vil. 

### Jeg trenger å arbeide på tvers av oppgaver i forskjellige vinduer. Kan jeg gjøre det?

Ja. Du kan vise fanen til et eget nettleservindu for å vise Business Central-nettklienten for virksomheten. 

### Kan jeg legge til eller feste fanen i Teams-møter?

Nei. Business Central-appen for Teams støtter ikke faner i møter.

### Kan ikke legge til en fane hvis du bruker ISV-nettadresser som *.bc.dynamics.com (men kan feste)

Støttes ikke.

### Når jeg er ting i fane, for eksempel navigering, som å navigere, sortere på nytt, bruke et filter eller søke, ser andre endringene mine?

Nei. Bare feltendringer eller handling som kjører, påvirker hvordan andre ser innholdet i fanen.

### Oppdateres faneinnholdet i automatisk? Hvis ikke hvordan oppdaterer jeg den?
...
### Viser dette lister og poster fra tilpasninger og tillegg?

Ja. 

### Når jeg legger til en fane, ser andre den på språket mitt?

Nei. Hver bruker viser innholdet i fanen med innstillingene for språk, område og tidssone fra Business Central. 

### Kan jeg ha flere faner som peker til annet innhold?

Ja.

### Kan jeg også legge til faner for å nettprate med én person?
...
### Kan jeg bytte selskap i en fane?

Nei. 

### Er dette forskjellig fra den generelle muligheten i Teams til å opprette en fane som er vert for et nettsted?
...
### Hvilke tabeller søker i programmet i?
...
### Hvilke felt i tabellen Kontakter kan jeg søke i?
...
### Inkluderer søkeresultater selskaper og personer?
...
### Vises det kontakter for forretningsforbindelser i resultatet?
...
### Kan jeg slå opp kontaktdetaljer under møter?
...
### Hvordan viser jeg min siste samhandling med en kontakt?
...
### Hvordan registrerer jeg en Teams-samtale eller et møte som en samhandling?
...
### Kan jeg ringe en kontakt fra [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams?
...
### Hvordan viser jeg nylig brukte dokumenter for en kunde eller leverandør?
...
### Hvordan søker jeg etter kontakter ved hjelp av spesialtegn?
...
### Hvordan kan jeg søke etter kontakter som er lagret i et annet selskap?
...
### Er [!INCLUDE [prod_short.md](includes/prod_short.md)]-kontakter annerledes enn dem på skjermen for Teams-kontakter?
...
Nei. Kontakter som er lagret i [!INCLUDE [prod_short.md](includes/prod_short.md)], er atskilt fra kontakter som er lagret i Teams.
Det er for tiden ingen planer om å synkronisere de to listene sammen.

### Hva er minimumsversjonen av [!INCLUDE [prod_short.md](includes/prod_short.md)] for kontaktsøk?
...
### Hvorfor blir jeg noen ganger bedt om å konfigurere appen?
...
### Jeg vil gjerne søke etter varer eller poster fra andre tabeller. Kan jeg gjøre dette fra Teams?
...
### Hvilke typer koblinger støtter appen?
...
### Viser kort alltid oppdatert informasjon?

Nei. Feltverdiene på et kort i Teams, deriblant bilder, er basert på dataene som er tilgjengelige når kortet ble sendt til chatten. [!INCLUDE [prod_short.md](includes/prod_short.md)]-kort oppdateres ikke automatisk i Teams. 
...
### Hvordan finner jeg ut hvilket selskap et kort i Teams tilhører?
...
### Hvor er Lagre-knappen i detaljvinduet i Teams?
...
### Hvis jeg velger å vise detaljer for et kort, kan andre brukere se detaljvinduet mitt?

Nei. Selv om alle i chatten eller på møtet kan vise selve kortet, vises detaljvinduet bare for deg på enheten når du velger **Detaljer**. Andre brukere må velge **Detaljer** hvis de vil se detaljvinduet på enheten sin.

### Kan jeg starte et Teams-anrop fra detaljvinduet i Teams?
...
### Kan jeg skrive ut dokumenter fra detaljvinduet i Teams?
...
### Får jeg tilgang til kameraet fra detaljvinduet i Teams?
...
### <a name="location"></a>Får jeg tilgang plasseringen min fra detaljvinduet i Teams?
...
### Hvordan åpner jeg detaljene i et nytt vindu?
...
### Kan jeg dele kort med brukere utenfor organisasjonen min?
...
### Er funksjonene annerledes for brukere som er gjester?
...
### Hvordan installerer en gjestebruker [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen? 
...
### Sender Del til Teams et kompaktkort? 

Ja. Koblingen utvides automatisk til et kort hvis du har installert Business Central-appen for Teams. 

### Skal mottakerne motta meldingen fra meg eller fra en Business Central-tjenestekonto? 
...
### Er Del til Teams tilgjengelig i Business Central lokalt? 
...
### Gir Del til Teams tillatelser til mottakerne? 
...
### Må jeg ha Teams-skrivebordsappen installert for å bruke Del til Teams? 

Nei. Alt du trenger, er en gyldig konto som har tilgang til Microsoft Teams. 

### Er Del til Teams tilgjengelig i alle Business Central-klienter? 
...
### Hvor finner jeg Del til Teams i Business Central? 
