...
---
# <a name="teams-faq" />Vanlige spørsmål om Teams
...
### <a name="how-do-i-sign-out-of-the-include-prodshortmdincludesprodshortmd-app-in-teams" />Hvordan logger jeg av [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen i Teams?
...
### <a name="does-the-app-for-teams-connect-to-include-prodshortmdincludesprodshortmd-on-premises" />Kobles appen for Teams til [!INCLUDE [prod_short.md](includes/prod_short.md)] lokalt?
...
### <a name="does-the-app-work-with-multiple-companies-and-environments" />Fungerer appen med flere selskaper og miljøer?
...
### <a name="in-which-countries-or-regions-is-the-include-prodshortmdincludesprodshortmd-app-available" />I hvilke land eller områder er [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen tilgjengelig?
...
### <a name="does-the-include-prodshortmdincludesprodshortmd-app-work-with-any-localization-of-include-prodshortmdincludesprodshortmd" />Fungerer [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen sammen med en hvilken som helst lokalisering av [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="a-namelanguageawhich-languages-does-the-include-prodshortmdincludesprodshortmd-app-support" /><a name="language"></a>Hvilke språk støtter [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen?
...
### <a name="does-the-include-prodshortmdincludesprodshortmd-app-work-with-industry-solutions" />Fungerer [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen med bransjeløsninger?
...
### <a name="does-include-prodshortmdincludesprodshortmd-work-with-the-teams-mobile-app" />Fungerer [!INCLUDE [prod_short.md](includes/prod_short.md)] med Teams-mobilappen?
...
### <a name="is-the-include-prodshortmdincludesprodshortmd-app-for-teams-the-same-as-the-include-prodshortmdincludesprodshortmd-app-for-ios-and-android" />Er [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams det samme som [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for iOS og Android?
...
### <a name="which-teams-client-is-best-for-include-prodshortmdincludesprodshortmd" />Hvilke Teams-klienter er best for [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="what-is-the-best-way-for-me-to-demonstrate-include-prodshortmdincludesprodshortmd-and-microsoft-teams-to-prospective-customers" />Hva er den beste måten for meg å vise frem [!INCLUDE [prod_short.md](includes/prod_short.md)] og Microsoft Teams til potensielle kunder?
...
### <a name="does-the-include-prodshortmdincludesprodshortmd-app-for-teams-cater-to-my-customization-and-personalization" />Kan [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams tilpasses og personaliseres?
...
### <a name="how-do-the-permissions-required-by-the-app-affect-my-privacy" />Hvordan påvirker tillatelsene som kreves av appen, personvernet mitt?
...
### <a name="where-can-i-learn-about-my-privacy" />Hvor kan jeg finne ut mer om personvernet mitt?
...
### <a name="how-do-i-uninstall-the-include-prodshortmdincludesprodshortmd-app-for-teams" />Hvordan avinstallerer jeg [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams?
...
### <a name="will-microsoft-continue-to-improve-the-include-prodshortmdincludesprodshortmd-app-for-teams" />Vil Microsoft fortsette å forbedre [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams?
...
### <a name="where-can-i-find-teams-integration-inside-the-business-central-web-client" />Hvor finner jeg Teams-integrering i Business Central-nettklienten?
...
### <a name="a-namewho-can-viewawho-can-see-the-content-of-a-tab" /><a name="who-can-view"></a>Hvem kan vise innholdet i en fane?
...
### <a name="a-namerecommended-contentawhere-does-the-recommended-content-come-from" /><a name=#recommended-content></a>Hvor kommer det anbefalte innholdet fra?
...
### <a name="when-i-create-a-tab-does-it-grant-permissions-to-the-people-in-the-channel-or-chat" />Når jeg oppretter en fane, gir den tillatelser til personene i kanalen eller nettpraten?

Nei. Oppretting av faner påvirker ikke tillatelser, og brukere må allerede ha tilgang til dataene når de åpner fanen.

### <a name="can-i-chat-alongside-a-tab" />Kan jeg nettprate ved siden av en fane?

Ja. Bruk nettpratikonet når du vil starte samtalen. Denne nettprattråden knyttes deretter til fanen. 

### <a name="if-i-remove-a-tab-from-a-chat-or-channel-is-any-business-central-data-deleted" />Hvis jeg fjerner en fane fra en nettprat eller kanal, slettes eventuelle Business Central-data?

Nei.

### <a name="can-i-safely-rename-a-tab" />Kan jeg trygt endre navn på en fane?

Ja. Innholdet i fanen er ikke relatert til det faktiske navnet på fanen. Endre navn hvis du vil. 

### <a name="i-need-to-work-across-tasks-in-different-windows-can-i-do-this" />Jeg trenger å arbeide på tvers av oppgaver i forskjellige vinduer. Kan jeg gjøre det?

Ja. Du kan vise fanen til et eget nettleservindu for å vise Business Central-nettklienten for virksomheten. 

### <a name="can-i-add-or-pin-tab-in-team-meetings" />Kan jeg legge til eller feste fanen i Teams-møter?

Nei. Business Central-appen for Teams støtter ikke faner i møter.

### <a name="cant-add-a-tab-if-using-isv-urls-like-bcdynamicscom-but-can-pin" />Kan ikke legge til en fane hvis du bruker ISV-nettadresser som *.bc.dynamics.com (men kan feste)

Støttes ikke.

### <a name="when-i-do-things-in-the-tab-like-navigate-resort-apply-a-filter-or-search-do-others-see-my-changes" />Når jeg er ting i fane, for eksempel navigering, som å navigere, sortere på nytt, bruke et filter eller søke, ser andre endringene mine?

Nei. Bare feltendringer eller handling som kjører, påvirker hvordan andre ser innholdet i fanen.

### <a name="does-the-tab-content-refresh-automatically-if-not-how-do-i-refresh-it" />Oppdateres faneinnholdet i automatisk? Hvis ikke hvordan oppdaterer jeg den?
...
### <a name="does-this-show-lists-and-records-from-my-customizations-and-add-ons" />Viser dette lister og poster fra tilpasninger og tillegg?

Ja. 

### <a name="when-i-add-a-tab-will-people-see-it-in-my-language" />Når jeg legger til en fane, ser andre den på språket mitt?

Nei. Hver bruker viser innholdet i fanen med innstillingene for språk, område og tidssone fra Business Central. 

### <a name="can-i-have-multiple-tabs-pointing-to-different-content" />Kan jeg ha flere faner som peker til annet innhold?

Ja.

### <a name="can-i-also-add-tabs-to-chat-with-a-single-person" />Kan jeg også legge til faner for å nettprate med én person?
...
### <a name="can-i-switch-companies-within-a-tab" />Kan jeg bytte selskap i en fane?

Nei. 

### <a name="is-this-different-than-using-teams-generic-ability-to-create-a-tab-that-hosts-a-website" />Er dette forskjellig fra den generelle muligheten i Teams til å opprette en fane som er vert for et nettsted?
...
### <a name="which-tables-does-the-app-search-in" />Hvilke tabeller søker i programmet i?
...
### <a name="which-fields-in-the-contacts-table-can-i-search" />Hvilke felt i tabellen Kontakter kan jeg søke i?
...
### <a name="do-search-results-include-companies-and-persons" />Inkluderer søkeresultater selskaper og personer?
...
### <a name="do-contacts-of-any-business-relationship-appear-in-the-results" />Vises det kontakter for forretningsforbindelser i resultatet?
...
### <a name="can-i-look-up-contact-details-during-meetings" />Kan jeg slå opp kontaktdetaljer under møter?
...
### <a name="how-do-i-view-my-last-interactions-with-a-contact" />Hvordan viser jeg min siste samhandling med en kontakt?
...
### <a name="how-do-i-register-a-teams-call-or-meeting-as-an-interaction" />Hvordan registrerer jeg en Teams-samtale eller et møte som en samhandling?
...
### <a name="can-i-call-a-contact-from-the-include-prodshortmdincludesprodshortmd-app-for-teams" />Kan jeg ringe en kontakt fra [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams?
...
### <a name="how-do-i-view-recent-documents-for-a-customer-or-vendor" />Hvordan viser jeg nylig brukte dokumenter for en kunde eller leverandør?
...
### <a name="how-do-i-search-for-contacts-using-special-characters" />Hvordan søker jeg etter kontakter ved hjelp av spesialtegn?
...
### <a name="how-can-i-search-contacts-stored-in-a-different-company" />Hvordan kan jeg søke etter kontakter som er lagret i et annet selskap?
...
### <a name="are-include-prodshortmdincludesprodshortmd-contacts-different-than-the-ones-in-the-teams-contacts-screen" />Er [!INCLUDE [prod_short.md](includes/prod_short.md)]-kontakter annerledes enn dem på skjermen for Teams-kontakter?
...
### <a name="what-is-the-minimum-version-of-include-prodshortmdincludesprodshortmd-for-contact-search" />Hva er minimumsversjonen av [!INCLUDE [prod_short.md](includes/prod_short.md)] for kontaktsøk?
...
### <a name="can-i-search-from-my-mobile-device" />Kan jeg søke fra min mobile enhet?

Kontaktsøk er ikke tilgjengelig fra Teams for iOS og Teams for Android for øyeblikket.

### <a name="which-permissions-do-i-need-for-contact-search" />Hvilke tillatelser trenger jeg for kontaktsøk?
...
### <a name="can-i-use-contact-search-if-im-a-delegated-admin" />Kan jeg bruke kontaktsøk hvis jeg er delegert administrator?

Ja. Du kan også slå opp kontakter og kontaktopplysninger hvis du har en delegert administratorrolle i en organisasjon.

### <a name="is-contact-search-affected-by-api-limits" />Påvirkes kontaktsøket av API-begrensninger?
...
### <a name="why-does-it-sometimes-ask-me-to-set-up-the-app" />Hvorfor blir jeg noen ganger bedt om å konfigurere appen?
...
### <a name="id-like-to-search-for-items-or-records-from-other-tables-can-i-do-this-from-teams" />Jeg vil gjerne søke etter varer eller poster fra andre tabeller. Kan jeg gjøre dette fra Teams?
...
### <a name="which-types-of-links-does-the-app-support" />Hvilke typer koblinger støtter appen?
...
### <a name="do-cards-always-show-up-to-date-information" />Viser kort alltid oppdatert informasjon?
...
### <a name="why-dont-cards-show-more-information-instead-of-just-the-page-name-and-details-button" />Hvorfor viser ikke kort mer informasjon i stedet for bare sidenavnet og detaljer-knappen?
...
### <a name="will-others-see-my-card-if-they-dont-have-the-include-prodshortmdincludesprodshortmd-app-for-teams" />Vil andre se kortet mitt hvis de ikke har [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen for Teams?
...
### <a name="how-do-i-find-out-which-company-a-card-in-teams-belongs-to" />Hvordan finner jeg ut hvilket selskap et kort i Teams tilhører?
...
### <a name="where-is-the-save-button-in-the-details-window-in-teams" />Hvor er Lagre-knappen i detaljvinduet i Teams?
...
### <a name="if-i-choose-to-view-details-for-a-card-will-other-users-see-my-details-window" />Hvis jeg velger å vise detaljer for et kort, kan andre brukere se detaljvinduet mitt?
...
### <a name="can-i-start-a-teams-call-from-the-details-window-in-teams" />Kan jeg starte et Teams-anrop fra detaljvinduet i Teams?
...
### <a name="can-i-print-documents-from-the-details-window-in-teams" />Kan jeg skrive ut dokumenter fra detaljvinduet i Teams?
...
### <a name="can-i-access-the-camera-from-the-details-window-in-teams" />Får jeg tilgang til kameraet fra detaljvinduet i Teams?
...
### <a name="a-namelocationacan-i-access-my-location-from-the-details-window-in-teams" /><a name="location"></a>Får jeg tilgang plasseringen min fra detaljvinduet i Teams?
...
### <a name="how-do-i-open-the-details-in-a-new-window" />Hvordan åpner jeg detaljene i et nytt vindu?
...
### <a name="can-i-share-cards-with-users-outside-my-organization" />Kan jeg dele kort med brukere utenfor organisasjonen min?
...
### <a name="is-the-experience-any-different-for-users-that-are-guests" />Er funksjonene annerledes for brukere som er gjester?
...
### <a name="how-does-a-guest-user-install-the-include-prodshortmdincludesprodshortmd-app" />Hvordan installerer en gjestebruker [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen?
...
### <a name="does-share-to-teams-send-a-compact-card" />Sender Del til Teams et kompaktkort?

Ja. Koblingen utvides automatisk til et kort hvis du har installert Business Central-appen for Teams. 

### <a name="will-recipients-receive-the-message-from-me-or-from-a-business-central-service-account" />Skal mottakerne motta meldingen fra meg eller fra en Business Central-tjenestekonto?
...
### <a name="is-share-to-teams-available-in-business-central-on-premises" />Er Del til Teams tilgjengelig i Business Central lokalt?
...
### <a name="does-share-to-teams-grant-permissions-to-recipients" />Gir Del til Teams tillatelser til mottakerne?
...
### <a name="must-i-have-the-teams-desktop-app-installed-to-use-share-to-teams" />Må jeg ha Teams-skrivebordsappen installert for å bruke Del til Teams?

Nei. Alt du trenger, er en gyldig konto som har tilgang til Microsoft Teams. 

### <a name="is-share-to-teams-available-in-all-business-central-clients" />Er Del til Teams tilgjengelig i alle Business Central-klienter?
...
### <a name="where-do-i-find-share-to-teams-in-business-central" />Hvor finner jeg Del til Teams i Business Central?
