...
ms.author: edupont
---
# <a name="post-service-orders-and-credit-memos"></a><a name="post-service-orders-and-credit-memos"></a><a name="post-service-orders-and-credit-memos"></a>Bokføre serviceordrer og kreditnotaer
...
## <a name="to-post-a-service-order"></a><a name="to-post-a-service-order"></a><a name="to-post-a-service-order"></a>Slik bokfører du en serviceordre
...
## <a name="to-batch-post-service-orders"></a><a name="to-batch-post-service-orders"></a><a name="to-batch-post-service-orders"></a>Slik massebokfører du serviceordrer
1. Velg ikonet ![Lyspære som åpner funksjonen Fortell meg.](media/ui-search/search_small.png "Fortell hva du vil gjøre") og angi **Serviceordrer**, og velg deretter den relaterte koblingen.  
...
## <a name="to-post-a-service-credit-memo"></a><a name="to-post-a-service-credit-memo"></a><a name="to-post-a-service-credit-memo"></a>Slik bokfører du en servicekreditnota
...
2. Opprett en servicekreditnota. Velg handlingen **Ny**.  
3. Fyll ut de nødvendige feltene.  
4. Velg handlingen **Bokfør**. Hvis du vil skrive ut kreditnotaen samtidig som du bokfører, velger du i stedet **Bokfør og skriv ut**.  
...
## <a name="to-post-consumption-from-a-service-order"></a><a name="to-post-consumption-from-a-service-order"></a><a name="to-post-consumption-from-a-service-order"></a>Slik bokfører du forbruk fra en serviceordre
...
3. Velg servicevaren. Velg handlingen **Servicelinjer**.  
...
## <a name="to-post-shipments-from-service-orders"></a><a name="to-post-shipments-from-service-orders"></a><a name="to-post-shipments-from-service-orders"></a>Slik bokfører du følgesedler fra serviceordrer
...
1. Velg ikonet ![Lyspære som åpner funksjonen Fortell meg.](media/ui-search/search_small.png "Fortell hva du vil gjøre") og angi **Serviceordre**, og velg deretter den relaterte koblingen. 2. På siden for den valgte serviceordren velger du **Handlinger**, **Ordre**, **Servicelinjer**.  
...
Hvis du vil finne ut mer om leveringsservicelinjevarer i avanserte lagerkonfigurasjoner, går du til plukkvarer for lagerlevering](warehouse-how-to-pick-items-for-warehouse-shipment.md).  

## <a name="to-undo-posted-consumption"></a><a name="to-undo-posted-consumption"></a><a name="to-undo-posted-consumption"></a>Slik angrer du bokført forbruk
Du kan annullere forbruket i serviceordrene. For eksempel fordi det er bokført ved en feil.  

1. Velg ikonet ![Lyspære som åpner funksjonen Fortell meg.](media/ui-search/search_small.png "Fortell hva du vil gjøre") og angi **Bokførte servicefølgesedler**, og velg deretter den relaterte koblingen.  
2. Åpne den bokførte servicefølgeseddelen som det feilaktige forbruket er bokført for.  
3. Velg handlingen **Servicefølgeseddellinjer**.  
...
## <a name="to-post-service-lines"></a><a name="to-post-service-lines"></a><a name="to-post-service-lines"></a>Slik bokfører du servicelinjer
