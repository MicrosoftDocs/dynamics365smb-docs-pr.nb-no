...
ms.author: edupont
---
# <a name="post-service-orders-and-credit-memos" />Bokføre serviceordrer og kreditnotaer
...
## <a name="to-post-a-service-order" />Slik bokfører du en serviceordre
...
## <a name="to-batch-post-service-orders" />Slik massebokfører du serviceordrer
1. Velg ikonet ![Lyspære som åpner funksjonen Fortell meg.](media/ui-search/search_small.png "Fortell hva du vil gjøre") og angi **Serviceordrer**, og velg deretter den relaterte koblingen.  
...
## <a name="to-post-a-service-credit-memo" />Slik bokfører du en servicekreditnota
...
## <a name="to-post-consumption-from-a-service-order" />Slik bokfører du forbruk fra en serviceordre
...
## <a name="to-post-shipments-from-service-orders" />Slik bokfører du følgesedler fra serviceordrer
...
## <a name="to-undo-posted-consumption" />Slik angrer du bokført forbruk
...
## <a name="to-post-service-lines" />Slik bokfører du servicelinjer
