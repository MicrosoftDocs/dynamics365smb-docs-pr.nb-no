...
ms.author: edupont
---
# <a name="post-service-orders-and-credit-memos"></a><a name="post-service-orders-and-credit-memos"></a>Bokføre serviceordrer og kreditnotaer
...
## <a name="to-post-a-service-order"></a><a name="to-post-a-service-order"></a>Slik bokfører du en serviceordre
...
## <a name="to-batch-post-service-orders"></a><a name="to-batch-post-service-orders"></a>Slik massebokfører du serviceordrer
1. Velg ikonet ![Lyspære som åpner funksjonen Fortell meg.](media/ui-search/search_small.png "Fortell hva du vil gjøre") og angi **Serviceordrer**, og velg deretter den relaterte koblingen.  
...
## <a name="to-post-a-service-credit-memo"></a><a name="to-post-a-service-credit-memo"></a>Slik bokfører du en servicekreditnota
...
## <a name="to-post-consumption-from-a-service-order"></a><a name="to-post-consumption-from-a-service-order"></a>Slik bokfører du forbruk fra en serviceordre
...
## <a name="to-post-shipments-from-service-orders"></a><a name="to-post-shipments-from-service-orders"></a>Slik bokfører du følgesedler fra serviceordrer
...
## <a name="to-undo-posted-consumption"></a><a name="to-undo-posted-consumption"></a>Slik angrer du bokført forbruk
...
## <a name="to-post-service-lines"></a><a name="to-post-service-lines"></a>Slik bokfører du servicelinjer
