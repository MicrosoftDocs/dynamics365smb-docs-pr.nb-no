...
ms.author: edupont
---
# <a name="find-posted-documents-without-incoming-document-records" />Finne bokførte dokumenter uten innkommende dokumentposter
...
## <a name="to-find-posted-documents-without-incoming-document-records" />Slik finner du bokførte dokumenter uten innkommende dokumentposter:
...
## <a name="to-connect-found-documents-to-existing-incoming-document-records" />Slik kobler du dokumenter som blir funnet, til eksisterende innkommende dokumentposter:
