...
---
# <a name="move-items-internally-in-basic-warehouse-configurations"></a><a name="move-items-internally-in-basic-warehouse-configurations"></a>Flytt varer internt i grunnleggende lageroppsett
...
## <a name="internal-movements"></a><a name="internal-movements"></a>Interne flyttinger
...
### <a name="to-move-items-as-an-internal-movement"></a><a name="to-move-items-as-an-internal-movement"></a>Flytte varer som en intern flytting
...
## <a name="to-move-items-with-the-item-reclassification-journal"></a><a name="to-move-items-with-the-item-reclassification-journal"></a>Flytte varer med varereklassifiseringskladden
