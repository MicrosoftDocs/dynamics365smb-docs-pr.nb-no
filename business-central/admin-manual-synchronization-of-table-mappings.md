...
# <a name="manually-synchronize-table-mappings" />Synkronisere tabelltilordninger manuelt
...
## <a name="run-a-full-synchronization" />Kjøre en full synkronisering
...
### <a name="to-run-a-full-synchronization" />Kjøre en full synkronisering
...
## <a name="synchronizing-all-modified-records" />Synkronisere alle endrede poster
...
### <a name="to-synchronize-data-for-all-tables" />Synkronisere data for alle tabeller
...
## <a name="synchronize-individual-table-mappings" />Synkronisere individuelle tabelltilordninger
...
### <a name="to-synchronize-records-of-an-integration-table-mapping" />Synkronisere poster i en integrasjonstabelltilordning
