...
ms.author: edupont
---
# <a name="service-posting"></a><a name="service-posting"></a><a name="service-posting"></a>Servicebokføring
...
## <a name="ship"></a><a name="ship"></a><a name="ship"></a>Levere
...
## <a name="invoice"></a><a name="invoice"></a><a name="invoice"></a>Fakturere
...
## <a name="ship-and-consume"></a><a name="ship-and-consume"></a><a name="ship-and-consume"></a>Lever og forbruk
...
## <a name="to-view-information-about-a-posted-service-document"></a><a name="to-view-information-about-a-posted-service-document"></a><a name="to-view-information-about-a-posted-service-document"></a>Slik viser du informasjon om bokførte servicedokumenter
