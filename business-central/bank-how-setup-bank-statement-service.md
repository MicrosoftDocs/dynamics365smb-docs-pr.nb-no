...
ms.author: edupont
---
# <a name="set-up-the-envestnet-yodlee-bank-feeds-service"></a><a name="set-up-the-envestnet-yodlee-bank-feeds-service"></a><a name="set-up-the-envestnet-yodlee-bank-feeds-service"></a>Sette opp Envestnet Yodlee Bank Feeds-tjenesten
...
## <a name="to-enable-the-bank-feed-service"></a><a name="to-enable-the-bank-feed-service"></a><a name="to-enable-the-bank-feed-service"></a>Aktivere bankfeedservicen
...
## <a name="to-create-a-new-linked-bank-account"></a><a name="to-create-a-new-linked-bank-account"></a><a name="to-create-a-new-linked-bank-account"></a>Opprette ny tilknyttet bankkonto
1. Velg ikonet ![Lyspære som åpner funksjonen Fortell meg.](media/ui-search/search_small.png "Fortell hva du vil gjøre") og angi **Bankkonti**, og velg deretter den relaterte koblingen.
...
## <a name="to-link-a-bank-account-to-an-online-bank-account"></a><a name="to-link-a-bank-account-to-an-online-bank-account"></a><a name="to-link-a-bank-account-to-an-online-bank-account"></a>Knytte en bankkonto til en nettbankkonto
1. Velg ikonet ![Lyspære som åpner funksjonen Fortell meg.](media/ui-search/search_small.png "Fortell hva du vil gjøre") og angi **Bankkonti**, og velg deretter den relaterte koblingen.
...
## <a name="to-edit-the-credentials-for-an-online-bank-account"></a><a name="to-edit-the-credentials-for-an-online-bank-account"></a><a name="to-edit-the-credentials-for-an-online-bank-account"></a>Slik redigerer du legitimasjon for en bankkonto på nettet
...
## <a name="to-unlink-a-bank-account"></a><a name="to-unlink-a-bank-account"></a><a name="to-unlink-a-bank-account"></a>Fjerne tilknytning for en bankkonto
1. Velg ikonet ![Lyspære som åpner funksjonen Fortell meg.](media/ui-search/search_small.png "Fortell hva du vil gjøre") og angi **Bankkonti**, og velg deretter den relaterte koblingen.  
...
## <a name="to-update-bank-account-linking"></a><a name="to-update-bank-account-linking"></a><a name="to-update-bank-account-linking"></a>Oppdatere bankkontotilknytning
1. Velg ikonet ![Lyspære som åpner funksjonen Fortell meg.](media/ui-search/search_small.png "Fortell hva du vil gjøre") og angi **Bankkonti**, og velg deretter den relaterte koblingen.
...
## <a name="to-enable-automatic-import-of-bank-statements"></a><a name="to-enable-automatic-import-of-bank-statements"></a><a name="to-enable-automatic-import-of-bank-statements"></a>Aktivere automatisk import av bankkontoutdrag
1. Velg ikonet ![Lyspære som åpner funksjonen Fortell meg.](media/ui-search/search_small.png "Fortell hva du vil gjøre") og angi **Bankkonti**, og velg deretter den relaterte koblingen.
