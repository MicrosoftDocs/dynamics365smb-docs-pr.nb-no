...
ms.author: edupont
---
# <a name="add-comments-to-cards-and-documents" />Legge til kommentarer i kort og dokumenter
...
## <a name="to-add-a-comments-to-an-item-card" />Legge til merknader på varekort
