...
---
# <a name="use-job-queues-to-schedule-tasks"></a><a name="use-job-queues-to-schedule-tasks"></a>Bruke jobbkøer til å planlegge oppgaver
...
## <a name="monitor-status-or-errors-in-the-job-queue"></a><a name="monitor-status-or-errors-in-the-job-queue"></a>Overvåk status eller feil i jobbkøen
...
### <a name="to-view-status-for-any-job"></a><a name="to-view-status-for-any-job"></a>Slik viser du statusen for en jobb
...
## <a name="view-scheduled-tasks"></a><a name="view-scheduled-tasks"></a>Vis planlagte oppgaver
...
## <a name="the-my-job-queue-part"></a><a name="the-my-job-queue-part"></a>Delen Min jobbkø
...
### <a name="to-view-an-error-from-the-my-job-queue-part"></a><a name="to-view-an-error-from-the-my-job-queue-part"></a>Slik viser du en feil fra delen Min jobbkø:

1. I en oppføring med statusen **Feil** velger du **Vis feil**-handlingen.
2. Les feilmeldingen og løs problemet.

## <a name="examples-of-what-you-can-schedule-using-job-queue-entries"></a><a name="examples-of-what-you-can-schedule-using-job-queue-entries"></a>Eksempler på hva du kan planlegge med prosjektkøoppføringer

### <a name="schedule-reports"></a><a name="schedule-reports"></a>Planlegg rapporter
...
### <a name="schedule-synchronization-between--and-includeprod_short"></a><a name="schedule-synchronization-between--and-includeprod_short"></a>Planlegg synkronisering mellom [!INCLUDE[prod_short](includes/prod_short.md)] og [!INCLUDE[prod_short](includes/cds_long_md.md)]
...
### <a name="schedule-when-to-post-sales-and-purchase-orders"></a><a name="schedule-when-to-post-sales-and-purchase-orders"></a>Planlegg når ordrer og bestillinger skal bokføres
...
## <a name="handle-job-queue-entry-issues"></a><a name="handle-job-queue-entry-issues"></a>Behandle problemer med prosjektkøoppføring
...
## <a name="monitor-the-job-queue-with-telemetry"></a><a name="monitor-the-job-queue-with-telemetry"></a>Overvåk jobbkøen med telemetri
