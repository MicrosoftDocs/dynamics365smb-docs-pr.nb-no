...
---
# <a name="use-job-queues-to-schedule-tasks" />Bruke jobbkøer til å planlegge oppgaver
...
## <a name="monitor-status-or-errors-in-the-job-queue" />Overvåk status eller feil i jobbkøen
...
### <a name="to-view-status-for-any-job" />Slik viser du statusen for en jobb
...
## <a name="view-scheduled-tasks" />Vis planlagte oppgaver
...
## <a name="the-my-job-queue-part" />Delen Min jobbkø
...
### <a name="to-view-an-error-from-the-my-job-queue-part" />Slik viser du en feil fra delen Min jobbkø:

1. I en oppføring med statusen **Feil** velger du **Vis feil**-handlingen.
2. Les feilmeldingen og løs problemet.

## <a name="examples-of-what-you-can-schedule-using-job-queue-entries" />Eksempler på hva du kan planlegge med prosjektkøoppføringer

### <a name="schedule-reports" />Planlegg rapporter
...
### <a name="schedule-when-to-post-sales-and-purchase-orders" />Planlegg når ordrer og bestillinger skal bokføres
...
## <a name="handle-job-queue-entry-issues" />Behandle problemer med prosjektkøoppføring
...
## <a name="monitor-the-job-queue-with-telemetry" />Overvåk jobbkøen med telemetri
