...
---
# <a name="use-automated-data-capture-systems-adcs"></a><a name="use-automated-data-capture-systems-adcs"></a><a name="use-automated-data-capture-systems-adcs"></a>Bruk ADCS (Se automatisk datahentesystem)
...
## <a name="to-enable-web-services-for-adcs"></a><a name="to-enable-web-services-for-adcs"></a><a name="to-enable-web-services-for-adcs"></a>Slik aktiverer du webtjenester for ADFS

Du må aktivere ADFS-webtjenesten for å kunne bruke automatisisk datafangstsystem.  

## <a name="to-enable-and-publish-the-adcs-web-service"></a><a name="to-enable-and-publish-the-adcs-web-service"></a><a name="to-enable-and-publish-the-adcs-web-service"></a>Slik aktiverer og publiserer du ADFS-webtjenesten
...
## <a name="to-set-up-a-warehouse-to-use-adcs"></a><a name="to-set-up-a-warehouse-to-use-adcs"></a><a name="to-set-up-a-warehouse-to-use-adcs"></a>Slik konfigurerer du et lager til å bruke ADFS
...
## <a name="to-specify-an-item-to-use-adcs"></a><a name="to-specify-an-item-to-use-adcs"></a><a name="to-specify-an-item-to-use-adcs"></a>Slik angir du at en vare skal bruke ADFS:
...
## <a name="to-add-an-adcs-user"></a><a name="to-add-an-adcs-user"></a><a name="to-add-an-adcs-user"></a>Slik legger du til en ADFS-bruker:
...
### <a name="to-specify-that-a-warehouse-employee-is-an-adcs-user"></a><a name="to-specify-that-a-warehouse-employee-is-an-adcs-user"></a><a name="to-specify-that-a-warehouse-employee-is-an-adcs-user"></a>Slik angir du at en lageransatt er ADFS-bruker:
...
## <a name="to-create-and-customize-miniforms"></a><a name="to-create-and-customize-miniforms"></a><a name="to-create-and-customize-miniforms"></a>Slik oppretter og tilpasser du miniformer:
...
### <a name="to-create-a-miniform-for-adcs"></a><a name="to-create-a-miniform-for-adcs"></a><a name="to-create-a-miniform-for-adcs"></a>Slik oppretter du Miniform for ADFS:
...
### <a name="to-customize-miniform-functions"></a><a name="to-customize-miniform-functions"></a><a name="to-customize-miniform-functions"></a>Slik tilpasser du Miniform-funksjoner:
