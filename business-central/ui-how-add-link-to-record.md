...
---
# <a name="manage-attachments-links-and-notes-on-cards-and-documents" />Behandle vedlegg, koblinger og notater på kort og dokumenter
...
## <a name="to-view-an-attached-file" />for å vise en vedlagt fil
