...
Du kan avbryte alle tilpasninger du har gjort for en profil. Egendefineringer som er innført med en utvidelse, og egendefinering gjort av en bruker, slettes ikke. Du kan slette alle personlige tilpasninger med en annen handling. Hvis du vil ha mer informasjon, kan du se [Slik sletter du alle tilpasninger som er gjort av en bruker](admin-users-profiles-roles.md#delete-all-personalizations-made-by-a-specific-user).
...
Du kan slette individuelle sidetilpasninger som du har gjort for en profil. Egendefineringer som er innført med en utvidelse, og egendefinering gjort av en bruker, slettes ikke. Du kan slette spesifikke sidetilpasninger med en annen handling. Hvis du vil ha mer informasjon, kan du se [Slik sletter du tilpasninger for bestemte sider](admin-users-profiles-roles.md#delete-personalizations-for-specific-pages).
...
Hvis du vil gjøre et rent tabellfelt tilgjengelig for brukere på en side, må du først legge det til på siden. Når du har lagt til feltet, kan brukerne velge å vise eller skjule feltet ved hjelp av tilpasning. Du kan legge til et felt på flere måter.
...
Når feltet er lagt til, endres verktøytipset for feltet i ruten **Legg til i side** til **Definert av siden**.

> [!NOTE]
> Det tilføyde feltet er låst for redigering og kan ikke låses opp.
