...
ms.author: edupont
---
# <a name="count-and-adjust-inventory-using-documents" />Telle og justere lagerbeholdning ved hjelp av dokumenter
...
## <a name="to-create-a-physical-inventory-order" />Slik opprettes en vareopptellingsordre
...
## <a name="to-create-a-physical-inventory-recording" />Slik opprettes en vareopptellingsregistrering
...
## <a name="to-finish-a-physical-inventory-recording" />Slik avsluttes vareopptellingsregistrering
...
## <a name="to-complete-a-physical-inventory-order" />Slik fullføres en vareopptellingsordre
...
### <a name="to-find-duplicate-physical-inventory-order-lines" />Slik finner du duplikate vareopptellingsordrelinjer
...
### <a name="to-post-a-physical-inventory-order" />Slik bokføres en vareopptellingsordre
...
### <a name="to-view-posted-physical-inventory-orders" />Slik viser du bokførte vareopptellingsordrer
...
## <a name="handling-item-tracking-when-counting-inventory" />Håndtering av varesporing ved telling av varelager
...
### <a name="example---prepare-a-physical-inventory-recording-for-an-item-tracked-item" />Eksempel: Forberede en registrering for vareopptelling for en varesporet vare
...
### <a name="example---record-and-post-counted-lot-number-differences" />Eksempel – Registrere og bokføre talte partinummerforskjeller
...
## <a name="inventory-documents" />Lagerdokumenter
...
### <a name="to-set-up-numbering-for-inventory-documents" />Definere nummerering for lagerdokumenter
...
### <a name="to-create-and-post-an-inventory-document" />Opprette og bokføre et lagerdokument
...
## <a name="printing-inventory-documents" />Skrive ut lagerdokumenter
