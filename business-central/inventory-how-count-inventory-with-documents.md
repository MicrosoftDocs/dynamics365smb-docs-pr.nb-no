...
ms.author: edupont
---
# <a name="count-and-adjust-inventory-using-documents"></a><a name="count-and-adjust-inventory-using-documents"></a>Telle og justere lagerbeholdning ved hjelp av dokumenter
...
## <a name="to-create-a-physical-inventory-order"></a><a name="to-create-a-physical-inventory-order"></a>Slik opprettes en vareopptellingsordre
...
## <a name="to-create-a-physical-inventory-recording"></a><a name="to-create-a-physical-inventory-recording"></a>Slik opprettes en vareopptellingsregistrering
...
## <a name="to-finish-a-physical-inventory-recording"></a><a name="to-finish-a-physical-inventory-recording"></a>Slik avsluttes vareopptellingsregistrering
...
## <a name="to-complete-a-physical-inventory-order"></a><a name="to-complete-a-physical-inventory-order"></a>Slik fullføres en vareopptellingsordre
...
### <a name="to-find-duplicate-physical-inventory-order-lines"></a><a name="to-find-duplicate-physical-inventory-order-lines"></a>Slik finner du duplikate vareopptellingsordrelinjer
...
### <a name="to-post-a-physical-inventory-order"></a><a name="to-post-a-physical-inventory-order"></a>Slik bokføres en vareopptellingsordre
...
### <a name="to-view-posted-physical-inventory-orders"></a><a name="to-view-posted-physical-inventory-orders"></a>Slik viser du bokførte vareopptellingsordrer
...
## <a name="handling-item-tracking-when-counting-inventory"></a><a name="handling-item-tracking-when-counting-inventory"></a>Håndtering av varesporing ved telling av varelager
...
### <a name="example---prepare-a-physical-inventory-recording-for-an-item-tracked-item"></a><a name="example---prepare-a-physical-inventory-recording-for-an-item-tracked-item"></a>Eksempel: Forberede en registrering for vareopptelling for en varesporet vare
...
### <a name="example---record-and-post-counted-lot-number-differences"></a><a name="example---record-and-post-counted-lot-number-differences"></a>Eksempel – Registrere og bokføre talte partinummerforskjeller
...
## <a name="inventory-documents"></a><a name="inventory-documents"></a>Lagerdokumenter
...
### <a name="to-set-up-numbering-for-inventory-documents"></a><a name="to-set-up-numbering-for-inventory-documents"></a>Definere nummerering for lagerdokumenter
...
### <a name="to-create-and-post-an-inventory-document"></a><a name="to-create-and-post-an-inventory-document"></a>Opprette og bokføre et lagerdokument
...
## <a name="printing-inventory-documents"></a><a name="printing-inventory-documents"></a>Skrive ut lagerdokumenter
