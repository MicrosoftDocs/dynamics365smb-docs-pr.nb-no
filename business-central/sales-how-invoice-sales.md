...
## <a name="create-sales-invoices"></a><a name="create-sales-invoices"></a>Opprette salgsfakturaer
...
### <a name="to-create-a-sales-invoice"></a><a name="to-create-a-sales-invoice"></a>Slik oppretter du en salgsfaktura
...
### <a name="calculating-invoice-discounts-on-sales"></a><a name="calculating-invoice-discounts-on-sales"></a>Beregning av fakturarabatter på salg

[!INCLUDE [sales-invoice-discounts](includes/sales-invoice-discounts.md)]

## <a name="posted-invoices"></a><a name="posted-invoices"></a>Bokførte fakturaer
...
## <a name="registering-payments"></a><a name="registering-payments"></a>Registrering av betalinger
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/modules/invoicing-customers-dynamics-365-business-central/index).
