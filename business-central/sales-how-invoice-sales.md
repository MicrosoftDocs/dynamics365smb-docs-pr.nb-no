...
## <a name="create-sales-invoices" />Opprette salgsfakturaer
...
### <a name="to-create-a-sales-invoice" />Slik oppretter du en salgsfaktura
...
## <a name="posted-invoices" />Bokførte fakturaer
...
## <a name="registering-payments" />Registrering av betalinger
...
## <a name="external-document-numbers" />Eksterne dokumentnumre

[!INCLUDE [ext-doc-no-sales](includes/ext-doc-no-sales.md)]

## <a name="see-related-microsoft-trainingtrainingmodulesinvoicing-customers-dynamics-365-business-centralindex" />Se relatert [Microsoft-opplæring](/training/modules/invoicing-customers-dynamics-365-business-central/index).
