...
ms.author: edupont
---
# <a name="record-purchases-with-purchase-invoices-and-orders" />Registrere kjøp med kjøpsfakturaer og ordrer
...
## <a name="record-purchases-with-purchase-invoices" />Registrere kjøp med kjøpsfakturaer
...
### <a name="create-a-and-post-purchase-invoice" />Opprett en og bokfør kjøpsfaktura
...
## <a name="purchasing-non-inventory-items" />Kjøp av ikke-lagervarer
...
## <a name="when-to-use-purchase-orders" />Når du bør bruke bestillinger
...
## <a name="receive-items-with-a-purchase-order" />Motta varer med bestilling
...
## <a name="receive-more-items-than-ordered" />Motta flere varer enn bestilt
...
### <a name="set-up-over-receipts" />Sett opp overmottak
...
### <a name="assign-the-over-receipt-code-to-an-item" />Tildel overmottakskoden til en vare
...
### <a name="over-receive-an-order" />Overmottak av en ordre
...
## <a name="posting-purchases" />Bokføre kjøp
...
## <a name="viewing-ledger-entries" />Vis poster
...
## <a name="editing-ledger-entries" />Rediger poster
...
## <a name="see-related-microsoft-trainingtrainingmodulesprocessing-invoices-dynamics--business-centralindex" />Se relatert [Microsoft-opplæring](/training/modules/processing-invoices-dynamics-365-business-central/index)
