...
ms.author: edupont
---
# <a name="record-purchases-with-purchase-invoices-and-orders"></a><a name="record-purchases-with-purchase-invoices-and-orders"></a><a name="record-purchases-with-purchase-invoices-and-orders"></a>Registrere kjøp med kjøpsfakturaer og ordrer
...
## <a name="record-purchases-with-purchase-invoices"></a><a name="record-purchases-with-purchase-invoices"></a><a name="record-purchases-with-purchase-invoices"></a>Registrere kjøp med kjøpsfakturaer
...
### <a name="create-a-and-post-purchase-invoice"></a><a name="create-a-and-post-purchase-invoice"></a><a name="create-a-and-post-purchase-invoice"></a>Opprett en og bokfør kjøpsfaktura
...
## <a name="posted-invoices"></a><a name="posted-invoices"></a><a name="posted-invoices"></a>Bokførte fakturaer
...
## <a name="purchasing-non-inventory-items"></a><a name="purchasing-non-inventory-items"></a><a name="purchasing-non-inventory-items"></a>Kjøp av ikke-lagervarer
...
## <a name="when-to-use-purchase-orders"></a><a name="when-to-use-purchase-orders"></a><a name="when-to-use-purchase-orders"></a>Når du bør bruke bestillinger
...
## <a name="receive-items-with-a-purchase-order"></a><a name="receive-items-with-a-purchase-order"></a><a name="receive-items-with-a-purchase-order"></a>Motta varer med bestilling
...
## <a name="receive-more-items-than-ordered"></a><a name="receive-more-items-than-ordered"></a><a name="receive-more-items-than-ordered"></a>Motta flere varer enn bestilt
...
### <a name="set-up-over-receipts"></a><a name="set-up-over-receipts"></a><a name="set-up-over-receipts"></a>Sett opp overmottak
...
### <a name="assign-the-over-receipt-code-to-an-item"></a><a name="assign-the-over-receipt-code-to-an-item"></a><a name="assign-the-over-receipt-code-to-an-item"></a>Tildel overmottakskoden til en vare
...
### <a name="over-receive-an-order"></a><a name="over-receive-an-order"></a><a name="over-receive-an-order"></a>Overmottak av en ordre
...
## <a name="posting-purchases"></a><a name="posting-purchases"></a><a name="posting-purchases"></a>Bokføre kjøp
...
Du kan alltid se gjennom forskjellige poster som blir opprettet med resultat av bokføringer. Velg **Forhåndsvis bokføring** for å validere dokument og kontrollere forventede poster.
...
## <a name="viewing-ledger-entries"></a><a name="viewing-ledger-entries"></a><a name="viewing-ledger-entries"></a>Vis poster
...
## <a name="editing-ledger-entries"></a><a name="editing-ledger-entries"></a><a name="editing-ledger-entries"></a>Rediger poster
...
## <a name="see-related-microsoft-training-1"></a><a name="see-related-microsoft-training-1"></a><a name="see-related-microsoft-training-1"></a>Se relatert [Microsoft-opplæring](/training/modules/processing-invoices-dynamics-365-business-central/index)
