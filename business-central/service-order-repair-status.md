...
ms.author: edupont
---
# <a name="set-up-statuses-for-service-orders-and-repairs" />Definere statuser for serviceordrer og reparasjoner
...
## <a name="to-set-up-service-status-priorities" />Slik definerer du servicestatusprioritet
...
## <a name="to-set-up-a-repair-status" />Slik definerer du reparasjonsstatus
