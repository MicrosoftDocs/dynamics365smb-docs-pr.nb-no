...
ms.author: bholtorf
---
# <a name="the-troubleshooting-fa-ledger-entries-extension" />Utvidelsen for feilsøking av aktivaposter
...
## <a name="troubleshooting-fixed-asset-ledger-entries" />Feilsøking av aktivaposter
