...
ms.author: bholtorf
---
# <a name="connect-to-microsoft-dataverse" />Koble til Microsoft Dataverse
...
## <a name="set-up-a-connection-to-includecdslongmdincludescdslongmdmd" />Konfigurer en tilkobling til [!INCLUDE[cds_long_md](includes/cds_long_md.md)]
...
### <a name="to-use-the-dataverse-connection-setup-assisted-setup-guide" />Slik bruker du den assisterte oppsettsveiledningen for Konfigurasjon for Dataverse-tilkobling
...
### <a name="to-create-or-maintain-the-connection-manually" />Opprette eller vedlikeholde tilkoblingen manuelt
...
## <a name="customize-the-match-based-coupling" />Tilpass samsvarsbasert kobling
...
### <a name="view-the-results-of-the-coupling-job" />Vis resultatene av koblingsjobben
...
## <a name="upgrade-connections-from-business-central-online-to-use-certificate-based-authentication" />Oppgrader tilkoblinger fra Business Central Online for å bruke sertifikatbasert godkjenning
...
### <a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication" />Slik oppgraderer du tilkoblinger for Business Central online til å bruke sertifikatbasert godkjenning
...
## <a name="connecting-on-premises-versions" />Koble til lokale versjoner
...
### <a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-dataverse" />Slik registrerer du et program i Azure AD for tilkobling fra Business Central til Dataverse
...
### <a name="to-disconnect-from-includecdslongmdincludescdslongmdmd" />For å koble fra [!INCLUDE[cds_long_md](includes/cds_long_md.md)]
