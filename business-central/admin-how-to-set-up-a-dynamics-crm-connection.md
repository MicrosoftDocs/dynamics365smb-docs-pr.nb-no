...
ms.author: bholtorf
---
# <a name="connect-to-microsoft-dataverse"></a><a name="connect-to-microsoft-dataverse"></a>Koble til Microsoft Dataverse
...
## <a name="set-up-a-connection-to-"></a><a name="set-up-a-connection-to-"></a>Konfigurer en tilkobling til [!INCLUDE[cds_long_md](includes/cds_long_md.md)]
...
### <a name="to-use-the-dataverse-connection-setup-assisted-setup-guide"></a><a name="to-use-the-dataverse-connection-setup-assisted-setup-guide"></a>Slik bruker du den assisterte oppsettsveiledningen for Konfigurasjon for Dataverse-tilkobling
...
### <a name="to-create-or-maintain-the-connection-manually"></a><a name="to-create-or-maintain-the-connection-manually"></a>Opprette eller vedlikeholde tilkoblingen manuelt
...
## <a name="customize-the-match-based-coupling"></a><a name="customize-the-match-based-coupling"></a>Tilpass samsvarsbasert kobling
...
### <a name="view-the-results-of-the-coupling-job"></a><a name="view-the-results-of-the-coupling-job"></a>Vis resultatene av koblingsjobben
...
## <a name="upgrade-connections-from-business-central-online-to-use-certificate-based-authentication"></a><a name="upgrade-connections-from-business-central-online-to-use-certificate-based-authentication"></a>Oppgrader tilkoblinger fra Business Central Online for å bruke sertifikatbasert godkjenning
...
### <a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication"></a><a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication"></a>Slik oppgraderer du tilkoblinger for Business Central online til å bruke sertifikatbasert godkjenning
...
## <a name="connecting-on-premises-versions"></a><a name="connecting-on-premises-versions"></a>Koble til lokale versjoner
...
### <a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-dataverse"></a><a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-dataverse"></a>Slik registrerer du et program i Azure AD for tilkobling fra Business Central til Dataverse
...
### <a name="to-disconnect-from-"></a><a name="to-disconnect-from-"></a>For å koble fra [!INCLUDE[cds_long_md](includes/cds_long_md.md)]
