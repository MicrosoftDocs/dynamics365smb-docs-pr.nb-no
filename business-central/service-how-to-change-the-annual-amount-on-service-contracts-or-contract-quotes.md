...
ms.author: bholtorf
---
# <a name="change-the-annual-amount-on-service-contracts-or-contract-quotes" />Endre årlig beløp på servicekontrakter eller kontrakttilbud
Du kan endre årlig beløp i servicekontrakten eller kontrakttilbudet for å rette beløpet som skal faktureres hvert år.  

## <a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote" />Slik endrer du årlig beløp på servicekontrakten eller kontrakttilbudet
...
## <a name="distributing-differences-between-new-and-calculated-annual-amounts" />Distribuere forskjeller mellom nye og beregnede årlige beløp
...
### <a name="even-distribution" />Jevn distribusjon
...
### <a name="distribution-based-on-line-amount" />Distribusjon basert på linjebeløp
...
### <a name="distribution-based-on-profit" />Distribusjon basert på fortjeneste
