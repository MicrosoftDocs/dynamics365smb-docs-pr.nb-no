...
ms.author: edupont
---
# <a name="close-open-item-ledger-entries-resulting-from-fixed-application-in-the-item-journal" />Lukke åpne vareposter som er resultat av fast utligning i varekladden
...
## <a name="to-close-open-item-ledger-entries-that-result-from-a-fixed-application-in-the-item-journal" />Slik lukker du åpne vareposter som er resultater fra en fast utligning i varekladden:
