...
ms.author: edupont
---
# <a name="calculate-order-promising-dates" />Beregne ordrebekreftelsesdatoer
...
## <a name="about-order-promising" />Om ordrebekreftelse
...
### <a name="available-to-promise" />Tilgjengelig for ordre (ATP)
...
### <a name="capable-to-promise" />Første mulige forsendelsesdato (CTP)
...
## <a name="to-set-up-order-promising" />Slik angir du ordrebekreftelser
...
### <a name="inbound-and-outbound-warehouse-handling-times-in-order-promising" />Inngående og utgående lagerhåndteringstider for ordrebekreftelse
...
#### <a name="to-enter-default-inbound-and-outbound-warehouse-handling-times-for-sales-and-purchase-documents" />Angi standard inngående og utgående lagerhåndteringstider for salgs- og kjøpsdokumenter
...
#### <a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations" />Angi inngående og utgående lagerhåndteringstider på lokasjoner
...
## <a name="to-make-an-item-critical" />Slik gjør du en vare kritisk
...
## <a name="to-calculate-an-order-promising-date" />Slik beregner du en ordrebekreftelsesdato
...
## <a name="see-related-microsoft-trainingtrainingmodulespromising-sales-order-delivery-dynamics--business-central" />Se relatert [Microsoft-opplæring](/training/modules/promising-sales-order-delivery-dynamics-365-business-central/)
