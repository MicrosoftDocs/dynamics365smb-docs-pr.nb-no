...
## <a name="use-rights" />Bruk rettigheter
...
 
### <a name="client-access" />Klienttilgang
...
### <a name="data-access" />Datatilgang
...
### <a name="use-of-objects" />Bruk av objekter
...
## <a name="simplified-user-interface" />Forenklet brukergrensesnitt
...
### <a name="requirements-to-enable-access" />Krav for å gi tilgang

- [!INCLUDE [prod_short](includes/prod_short.md)] online (SaaS).

- Miljøer må være av plattformversjon 21.1 eller nyere.

### <a name="requirements-for-individual-users-to-access-data-in-teams" />Krav for individuelle brukere som skal ha tilgang til data i Teams
