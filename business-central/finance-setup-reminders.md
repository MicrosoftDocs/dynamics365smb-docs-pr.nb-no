...
ms.author: edupont
---
# <a name="set-up-reminder-terms-and-levels"></a><a name="set-up-reminder-terms-and-levels"></a>Definer betingelser og grader for purringer

Du kan bruke purringer til å minne kunder på forfalte beløp. [!INCLUDE [reminder-terms](includes/reminder-terms.md)]

## <a name="reminder-terms"></a><a name="reminder-terms"></a>Purrebetingelser
...
### <a name="to-set-up-reminder-terms"></a><a name="to-set-up-reminder-terms"></a>Slik definerer du purrebetingelser
...
## <a name="reminder-levels"></a><a name="reminder-levels"></a>Purregrader
...
### <a name="to-set-up-reminder-levels"></a><a name="to-set-up-reminder-levels"></a>Slik definerer du purregrader
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/modules/send-reminders-dynamics-365-business-central/)
