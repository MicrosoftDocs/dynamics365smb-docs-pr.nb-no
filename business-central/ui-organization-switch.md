...
# <a name="switching-to-another-company-or-environment" />Bytte til et annet selskap eller miljø
...
## <a name="about-companies-and-environments" />Om selskaper og miljøer
...
## <a name="features-for-switching-company-or-environment" />Funksjoner for å bytte selskap eller miljø
...
## <a name="use-the-company-switcher" />Bruk bytting av selskap
...
## <a name="use-the-app-launcher" />Bruk startprogrammet for appen
...
-->
## <a name="use-my-settings" />Bruk Mine innstillinger
...
## <a name="use-company-hub" />Bruk selskapssenter
