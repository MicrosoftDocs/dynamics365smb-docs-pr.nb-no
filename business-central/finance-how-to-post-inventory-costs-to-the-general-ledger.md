---
title: Avstemme lagerkost mot Finans
...
## Slik bokfører du lagerkost manuelt
...
Hvis du vil ha en oversikt over hvilke verdier som kan bokføres i Finans, uten faktisk å utføre bokføringen **, kan du kjøre kjørselen Bokfør lagerkost i Finans** uten faktisk å bokføre verdiene i Finans. Du gjør dette ved å fjerne merket i **Bokfør**-feltet på forespørselssiden. På denne måten produseres rapporten som viser verdiene som er klare til bokføring i Finans, men som ikke bokføres.

## Spore avstemmingen mellom lagerposten og Finans
...
- Viser ikke-avstemte kostbeløp i verdipostene i lagerposten som om de var tilordnet til tilsvarende lagerrelaterte konti i finans, og sammenligner disse med totalbeløpene som er registrert i de samme kontiene i finans.
...
Kolonnene **Beholdning**, **Lager (midlertidig)** og **VIA - beholdning** viser fakturert beløp, ufakturert beløp og VIA-beløp for hver finanskontotype. Disse beregnes fra verdiposter, det vil si at de projiseres til finanskontotypene der de vil havne når de til slutt bokføres i finans.
