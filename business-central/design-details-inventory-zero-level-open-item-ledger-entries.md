...
ms.author: edupont
---
# <a name="design-details-known-item-application-issue"></a><a name="design-details-known-item-application-issue"></a>Designdetaljer: Kjent vareutligningsproblem
...
## <a name="basics-of-item-application"></a><a name="basics-of-item-application"></a>Grunnleggende om vareutligning
...
### <a name="quantity-application"></a><a name="quantity-application"></a>Antallsutligning
...
### <a name="cost-application"></a><a name="cost-application"></a>Kostutligning
...
## <a name="illustration-of-a-basic-cost-flow"></a><a name="illustration-of-a-basic-cost-flow"></a>Bilde av en grunnleggende kostnadsflyt
...
## <a name="reasons-for-the-issue"></a><a name="reasons-for-the-issue"></a>Årsaker til problemet
...
## <a name="identifying-the-issue"></a><a name="identifying-the-issue"></a>Identifisere problemet
...
## <a name="workaround-for-the-issue"></a><a name="workaround-for-the-issue"></a>Løsning for problemet
