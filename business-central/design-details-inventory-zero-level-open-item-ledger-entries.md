...
ms.author: edupont
---
# <a name="design-details-known-item-application-issue" />Designdetaljer: Kjent vareutligningsproblem
...
## <a name="basics-of-item-application" />Grunnleggende om vareutligning
...
### <a name="quantity-application" />Antallsutligning
...
### <a name="cost-application" />Kostutligning
...
## <a name="illustration-of-a-basic-cost-flow" />Bilde av en grunnleggende kostnadsflyt
...
## <a name="reasons-for-the-issue" />Årsaker til problemet
...
## <a name="identifying-the-issue" />Identifisere problemet
...
## <a name="workaround-for-the-issue" />Løsning for problemet
