...
ms.author: edupont
---
# <a name="correct-or-cancel-unpaid-sales-invoices" />Korrigere eller annullere ubetalte salgsfakturaer
...
## <a name="to-cancel-a-posted-sales-invoice" />Slik annullerer du en bokført salgsfaktura:
...
## <a name="to-correct-a-posted-sales-invoice" />Slik korrigerer du en bokført salgsfaktura:
