...
# <a name="handling-missing-option-values"></a><a name="handling-missing-option-values"></a>Håndtere manglende alternativverdier
> [!NOTE]
...
### <a name="extending-option-sets-in-"></a><a name="extending-option-sets-in-"></a>Utvide alternativsett i [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="update--option-mapping"></a><a name="update--option-mapping"></a>Oppdater Tilordning av [!INCLUDE[prod_short](includes/cds_long_md.md)]-alternativ
