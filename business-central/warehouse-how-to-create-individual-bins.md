...
ms.author: edupont
---
# <a name="create-bins" />Opprette hyller
...
## <a name="to-create-a-bin-from-the-location-card" />Slik oppretter du en hylle fra lokasjonskortet
...
### <a name="the-dedicated-field" />Feltet Dedikert
...
## <a name="to-create-bins-individually-in-the-bin-creation-worksheet" />Slik oppretter du hyller individuelt i hylleopprettingsforslaget
...
## <a name="to-make-bins-automatically-in-the-bin-creation-worksheet" />Slik lager du hyller automatisk i hylleopprettingsforslaget
...
## <a name="see-related-microsoft-trainingtrainingmodulescreate-new-bins" />Se relatert [Microsoft-opplæring](/training/modules/create-new-bins/)
