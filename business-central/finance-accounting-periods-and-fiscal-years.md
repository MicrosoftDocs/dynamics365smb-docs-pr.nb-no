...
ms.author: bholtorf
---
# <a name="work-with-accounting-periods-and-fiscal-years" />Arbeid med regnskapsperioder og regnskapsår
...
## <a name="creating-a-new-fiscal-year" />Opprette et nytt regnskapsår

Du kan masseopprette regnskapsperioder ved å bruke kjørselen **Opprett regnskapsår** eller gjøre det manuelt.

### <a name="how-to-create-accounting-periods-in-bulk" />Slik masseoppretter du regnskapsperioder
...
### <a name="how-to-create-accounting-periods-manually" />Slik oppretter du regnskapsperioder manuelt
...
## <a name="closing-a-fiscal-year" />Lukke et regnskapsår
...
## <a name="posting-entries-to-a-closed-fiscal-year" />Bokføre poster til et lukket regnskapsår
