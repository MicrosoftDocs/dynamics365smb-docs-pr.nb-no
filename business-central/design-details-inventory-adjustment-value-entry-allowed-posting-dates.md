...
## <a name="change-the-user-setup"></a><a name="change-the-user-setup"></a><a name="change-the-user-setup"></a>Endre brukeroppsettet
...
### <a name="overview-of-involved-posting-date-setup"></a><a name="overview-of-involved-posting-date-setup"></a><a name="overview-of-involved-posting-date-setup"></a>Oversikt over involvert oppsett for bokføringsdato
...
#### <a name="user-setup"></a><a name="user-setup"></a><a name="user-setup"></a>Brukeroppsett
