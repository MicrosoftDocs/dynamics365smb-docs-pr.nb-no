...
---
# <a name="about-unit-cost-calculation" />Om beregning av enhetskost
...
## <a name="when-is-the-unit-cost-field-updated" />Når enhetskostfeltet oppdateres
...
## <a name="unit-cost-calculation-for-purchases" />Beregning av enhetskost for kjøp
...
### <a name="costing-method-fifo-lifo-specific-or-average" />Lagermetoden FIFU, LIFO, Serienummer eller Gjennomsnitt
...
## <a name="unit-cost-calculation-for-sales" />Beregning av enhetskost for salg
