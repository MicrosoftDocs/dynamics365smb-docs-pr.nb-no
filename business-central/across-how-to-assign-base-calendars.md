...
ms.author: edupont
---
# <a name="set-up-base-calendars" />Definere hovedkalendere
...
## <a name="to-set-up-a-base-calendar" />Slik definerer du en hovedkalender
...
## <a name="to-customize-a-calendar" />Slik tilpasser du en kalender
...
## <a name="to-assign-a-base-calendar" />Slik tilordner du en hovedkalender
