...
ms.author: jswymer
---
# <a name="managing-onedrive-integration-with-business-central" />Administrer OneDrive-integrering med Business Central
...
## <a name="configure-onedrive-for-integration-with-business-central" />Konfigurere OneDrive for integrering med Business Central
...
### <a name="managing-privacy" />Administrer personvern
...
### <a name="configure-onedrive-using-onedrive-setup" />Konfigurer OneDrive ved hjelp av OneDrive-oppsett
...
### <a name="switching-to-new-onedrive-integration-after-upgrade" />Bytte til ny OneDrive-integrering etter oppgraderingen
