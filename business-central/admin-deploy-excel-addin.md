...
ms.author: jswymer
---
# <a name="get-the-business-central-add-in-for-excel" />Hent Business Central-tillegget for Excel
...
### <a name="about-the-add-in" />Om tillegget
...
### <a name="about-deployment-as-an-admin" />Om distribusjon som administrator
...
### <a name="a-nameswitchaswitching-from-individual-acquisition-to-centralized-deployment-or-the-other-way-around" /><a name="switch"></a>Bytt fra individuell anskaffelse til sentralisert distribusjon, eller omvendt
...
## <a name="preparation-on-premises-only" />Klargjøring (bare lokalt)
...
## <a name="deploy-the-add-in-by-using-centralized-deployment" />Distribuer tillegget ved hjelp av sentralisert distribusjon
...
### <a name="before-you-begin" />Før du starter
...
### <a name="set-up-centralized-deployment-of-the-add-in" />Konfigurer sentral. distribusjon for tillegget
...
## <a name="a-nameinstallaindividual-acquisition-install-the-add-in-manually-for-your-own-use" /><a name="install"></a>Individuell anskaffelse: Installer tillegget manuelt for egen bruk
...
### <a name="configure-the-business-central-connection" />Konfigurer Business Central-tilkoblingen
...
## <a name="prepare-devices-and-network-for-the-excel-add-in" />Klargjør enheter og nettverk for Excel-tillegget
