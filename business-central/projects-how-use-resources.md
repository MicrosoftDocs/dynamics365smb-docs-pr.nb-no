...
ms.author: edupont
---
# <a name="use-resources-for-jobs" />Bruke ressurser for prosjekter
...
## <a name="to-assign-resources-to-jobs" />Slik tilordner du ressurser til prosjekter
...
## <a name="to-record-resource-usage-for-a-job" />Slik registrerer du ressursforbruk for et prosjekt
...
## <a name="to-adjust-resource-prices" />Slik justerer du ressurspriser
...
## <a name="to-get-resource-price-change-suggestions-based-on-existing-alternate-prices" />Slik får du forslag til ressursprisendringer på bakgrunn av eksisterende alternative priser
...
## <a name="to-get-resource-price-change-suggestions-based-on-standard-prices" />Slik får du forslag til ressursprisendringer på bakgrunn av standardpriser
...
## <a name="to-get-resource-price-change-suggestions-based-on-alternate-prices" />Slik får du forslag til ressursprisendringer på bakgrunn av alternative priser
