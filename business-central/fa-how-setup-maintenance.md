...
ms.author: edupont
---
# <a name="set-up-fixed-asset-maintenance" />Definere aktivavedlikehold
...
## <a name="to-set-up-general-maintenance-information" />Slik definerer du generelle vedlikeholdsopplysninger:
...
## <a name="to-set-up-maintenance-codes" />Slik definerer du vedlikeholdskoder
...
## <a name="to-set-up-maintenance-expense-accounts" />Slik definerer du utgiftskonti for vedlikehold
