...
---
# <a name="analyze-list-page-and-query-data-using-data-analysis-feature"></a>Analyser listesiden og spørringsdata ved hjelp av dataanalysefunksjon
...
2. I handlingsfeltet øverst på siden velger du knappen **Gå inn i analysemodus** ![Viser knappen for å aktivere analysemodus](media/analysis-mode-icon.png).
...
## <a name="work-with-analysis-mode"></a>Arbeid med analysemodus
...
**Kolonner**-ruten er en av to ruter som arbeider sammen for å definere analysen. Det andre området er **Analysefiltre**-ruten. **Kolonne**-ruten brukes til å summere dataene. Bruk **Kolonner**-ruten til å definere hvilke kolonner som skal være med i analysen.
...
|Avmerkingsbokser|Dette området inneholder en avmerkingsboks for hvert felt i kildetabellen for listen eller spørringen. Bruk dette området til å endre kolonnene som vises. Merk av i boksen for å vise en kolonne for feltet på siden. Fjern merket i boksen for å skjule kolonnen. |
...
Hvis datasettet du vil analysere, overskrider 100 000 rader, foreslår vi at du angir en analysemodus som er optimalisert for store datasett. Det er for øyeblikket to begrensninger hvis du bytter til denne modusen: 
...
1. Mottakerne kan de velge koblingen og åpne analysen for siden eller spørringen i [!INCLUDE [prod_short](includes/prod_short.md)]. De blir bedt om å angi et navn for den nye analysekategorien de oppretter.  

## <a name="examples-of-how-to-analyze-data"></a>Eksempler på hvordan du analyserer data
...
### <a name="ad-hoc-data-analysis-examples-by-functional-area"></a>Ad hoc-dataanalyseeksempler etter funksjonsområde
...
- Analysemodusvisningen har for øyeblikket en grense på 100 000 rader. Hvis du overskrider denne grensen, får du en melding om dette. Du kan omgå denne begrensningen ved å sette filtrene på siden før du bytter til analysemodus, hvis mulig. Kanskje du vil analysere en bestemt gruppe med kunder, eller kanskje du bare vil ha data fra inneværende år. Du kan også velge en forhåndsdefinert visning hvis det skal brukes i analysen.
