...
---
# <a name="analyze-list-data-using-data-analysis-mode" />Analyser listedata ved hjelp av dataanalysemodus
...
## <a name="prerequisite" />Forutsetninger
...
## <a name="work-with-data-analysis-mode" />Arbeid med dataanalysemodus
...
## <a name="limitations" />Begrensninger
