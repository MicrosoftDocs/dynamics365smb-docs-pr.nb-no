...
ms.author: edupont
---
# <a name="understanding-the-general-ledger-and-chart-of-accounts" />Forstå Finans og kontoplanen
...
## <a name="general-ledger-setup-and-general-posting-setup" />Finansoppsett og generelt bokføringsoppsett
...
## <a name="get-a-quick-overview" />Få en rask oversikt
...
## <a name="access-to-create-and-edit-accounts-and-account-categories" />Tilgang til å opprette og redigere konti og kontokategorier
...
## <a name="see-related-microsoft-trainingtrainingmodulesbusiness-central-configure-general-ledger-setup" />Se relatert [Microsoft-opplæring](/training/modules/business-central-configure-general-ledger-setup/)
