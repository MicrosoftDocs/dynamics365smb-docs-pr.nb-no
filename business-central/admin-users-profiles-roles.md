...
ms.search.form: 9171
---
# <a name="manage-user-profiles"></a><a name="manage-user-profiles"></a><a name="manage-user-profiles"></a>Administrer brukerprofiler
...
## <a name="to-create-a-profile"></a><a name="to-create-a-profile"></a><a name="to-create-a-profile"></a>Slik oppretter du en profil
...
## <a name="to-copy-a-profile"></a><a name="to-copy-a-profile"></a><a name="to-copy-a-profile"></a>Kopiere en profil
...
## <a name="to-edit-a-profile"></a><a name="to-edit-a-profile"></a><a name="to-edit-a-profile"></a>Redigere en profil
...
## <a name="to-assign-a-profile-to-a-user"></a><a name="to-assign-a-profile-to-a-user"></a><a name="to-assign-a-profile-to-a-user"></a>Tilordne en profil til en bruker
...
## <a name="to-define-user-settings-for-a-profile"></a><a name="to-define-user-settings-for-a-profile"></a><a name="to-define-user-settings-for-a-profile"></a>Definere brukerinnstillinger for en profil
...
## <a name="to-activate-a-profile"></a><a name="to-activate-a-profile"></a><a name="to-activate-a-profile"></a>Aktivere en profil
...
## <a name="to-export-profiles"></a><a name="to-export-profiles"></a><a name="to-export-profiles"></a>Slik eksporterer du profiler
...
## <a name="to-import-profiles"></a><a name="to-import-profiles"></a><a name="to-import-profiles"></a>Slik importerer du profiler
...
## <a name="to-delete-a-profile"></a><a name="to-delete-a-profile"></a><a name="to-delete-a-profile"></a>Slette en profil
...
## <a name="to-delete-all-personalizations-made-by-a-user"></a><a name="to-delete-all-personalizations-made-by-a-user"></a><a name="to-delete-all-personalizations-made-by-a-user"></a>Slette alle tilpasninger som er gjort av brukeren
...
## <a name="to-delete-personalizations-for-specific-pages"></a><a name="to-delete-personalizations-for-specific-pages"></a><a name="to-delete-personalizations-for-specific-pages"></a>Slette tilpasninger for bestemte sider
...
## <a name="managing-user-sessions"></a><a name="managing-user-sessions"></a><a name="managing-user-sessions"></a>Behandle brukerøkter
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/modules/users-security-dynamics-365-business-central/)
