...
ms.author: edupont
---
# <a name="post-transactions-directly-to-the-general-ledger" />Bokføre transaksjoner direkte i Finans
...
## <a name="to-post-a-transaction-directly-to-a-general-ledger-account" />Bokføre en transaksjon direkte på en finanskonto
