...
ms.author: edupont
---
# <a name="create-special-orders"></a><a name="create-special-orders"></a><a name="create-special-orders"></a>Opprette spesialbestillinger
...
## <a name="to-create-a-special-order"></a><a name="to-create-a-special-order"></a><a name="to-create-a-special-order"></a>Slik oppretter du en spesialbestilling
