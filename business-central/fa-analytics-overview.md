...
> [!NOTE]
> Analyse for aktive er litt annerledes enn andre områder. Du må analysere data som allerede finnes, for eksempel objektanskaffelser, avskrivninger og forsikring, men også data om fremtiden (forventede data), for eksempel avskrivninger og objektavviklinger. For sistnevnte type analyse har [!INCLUDE[prod_short](includes/prod_short.md)] innebygde rapporter som kan beregne disse tallene.
