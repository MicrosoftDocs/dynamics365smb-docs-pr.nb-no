...
|Lær hvordan du bruker flere valutaer og oppdaterer valutakurser automatisk. |[Oppdater valutakurser](finance-how-update-currencies.md)|
| Fordel inntekter og utgifter i andre perioder enn da transaksjonene faktisk ble bokført. |[Periodiser inntekter og utgifter](finance-how-defer-revenue-expenses.md)|
...
| Tildel ekstra kostnader, for eksempel frakt og fysisk håndtering du pådrar deg i handel, til de involverte varene. På denne måten gjenspeiles kostnaden i lagerverdisetting. |[Bruk varegebyr til å gjøre rede for ekstra handelskostnader](payables-how-assign-item-charges.md) |
...
| Til ... | Se |
| --- | --- |
| Finn ut mer om muligheter for analyse av finansdata. | [Oversikt over økonomisk analyse](bi.md) |
| Konfigurere finansrapportering mellom konsern eller juridiske enheter. | [Håndter finansrapportering mellom konsern eller juridiske enheter](finance-consolidated-company-reporting.md) |
| Konfigurere og bruke finansrapportering til å produsere oppgaver og oversikter. | [Klargjør finansrapportering](bi-how-work-account-schedule.md) |
| Utfør ad hoc-analyse av finansdata direkte på listesider og spørringer. | [Ad hoc-analyse av finansdata](ad-hoc-analysis-finance.md) |
| Analyser finansdata fra kontoplanen | [Analyser finansdata fra kontoplanen](finance-general-ledger.md) |
| Analyser faktiske beløp i forhold til budsjetterte beløp. | [Analyser faktiske beløp kontra budsjetterte beløp](bi-how-analyze-actual-versus-budget.md) |
| Analyser kontantstrøm. | [Analyser kontantstrøm](finance-analyze-cash-flow.md) |
| Utforsk innebygde finansrapporter. | [Innebygde nøkkelfinansrapporter](finance-reports.md) |
| Utforsk innebygde nøkkelrapporter for aktiva. | [Innebygde aktivarapporter](fa-reports.md) |
...
| Til ... | Se |
| --- | --- |
|Analyser kostbeløpene for å kjøre bedriften ved å tildele faktiske og budsjetterte kostbeløpe for operasjoner, avdelinger, produkter og prosjekter til kostsentre.|[Gjør rede for kostnader](finance-manage-cost-accounting.md)|
...
[Arbeid med kjøpsmodulen](purchasing-manage-purchasing.md)  
