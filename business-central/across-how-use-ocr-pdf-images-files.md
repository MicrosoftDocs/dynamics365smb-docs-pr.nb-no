...
ms.author: bholtorf
---
# Bruke OCR til å konvertere PDF- og bildefiler til elektroniske dokumenter
...
## Send en PDF- eller bildefil til OCR-tjenesten fra siden Innkommende dokumenter
...
## Sende en PDF- eller bildefil til OCR-tjenesten via e-post
...
## Slik oppretter du en kjøpsfaktura fra et elektronisk dokument som er mottatt fra OCR-tjenesten:
...
### Slik tilordner du tekst i et inngående dokument til en bestemt leverandørkonto:
...
## Håndtere feil ved mottak av elektroniske dokumenter
...
## Lære opp OCR-tjenesten for å unngå feil
