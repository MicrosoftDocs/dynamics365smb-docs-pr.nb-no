...
---
# <a name="design-details-central-concepts-of-the-planning-system" />Designdetaljer: Sentrale begreper for planleggingssystemet
...
## <a name="planning-parameters" />Planleggingsparametere
...
## <a name="planning-starting-date" />Planlegge startdato
...
## <a name="dynamic-order-tracking-pegging" />Dynamisk sporing (utligning)
...
### <a name="dynamic-order-tracking-versus-the-planning-system" />Dynamisk sporing kontra planleggingssystemet
...
## <a name="sequence-and-priority-in-planning" />Rekkefølge og prioritet i planlegging
...
### <a name="item-priority--low-level-code" />Varens prioritet/lavnivåkode
...
#### <a name="optimizing-performance-for-low-level-calculations" />Optimere ytelse for lavnivåberegninger
...
### <a name="locations--transfer-level-priority" />Lokasjoner / prioritet for overføringsnivå
...
### <a name="order-priority" />Bestillingsprioritet
...
## <a name="planning-assignment" />Planleggingstilordning
...
## <a name="item-dimensions" />Varedimensjoner
...
### <a name="specific-attributes" />Bestemte attributter
...
### <a name="non-specific-attributes" />Ikke-spesifikke attributter
...
## <a name="order-to-order-links" />Odre-til-ordre-koblinger
...
## <a name="reservations" />Reservasjoner
...
## <a name="planning-flexibility" />Planleggingsfleksibilitet
...
## <a name="order-planning" />Ordreplanlegging
...
## <a name="finite-loading" />Begrenset belastning
