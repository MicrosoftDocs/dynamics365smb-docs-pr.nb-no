...
---
# <a name="design-details-central-concepts-of-the-planning-system"></a><a name="design-details-central-concepts-of-the-planning-system"></a>Designdetaljer: Sentrale begreper for planleggingssystemet
...
## <a name="planning-parameters"></a><a name="planning-parameters"></a>Planleggingsparametere
...
## <a name="planning-starting-date"></a><a name="planning-starting-date"></a>Planlegge startdato
...
## <a name="dynamic-order-tracking-pegging"></a><a name="dynamic-order-tracking-pegging"></a>Dynamisk sporing (utligning)
...
### <a name="dynamic-order-tracking-versus-the-planning-system"></a><a name="dynamic-order-tracking-versus-the-planning-system"></a>Dynamisk sporing kontra planleggingssystemet
...
## <a name="sequence-and-priority-in-planning"></a><a name="sequence-and-priority-in-planning"></a>Rekkefølge og prioritet i planlegging
...
### <a name="item-priority--low-level-code"></a><a name="item-priority--low-level-code"></a>Varens prioritet/lavnivåkode
...
#### <a name="optimizing-performance-for-low-level-calculations"></a><a name="optimizing-performance-for-low-level-calculations"></a>Optimere ytelse for lavnivåberegninger
...
### <a name="locations--transfer-level-priority"></a><a name="locations--transfer-level-priority"></a>Lokasjoner / prioritet for overføringsnivå
...
### <a name="order-priority"></a><a name="order-priority"></a>Bestillingsprioritet
...
## <a name="planning-assignment"></a><a name="planning-assignment"></a>Planleggingstilordning
...
## <a name="item-dimensions"></a><a name="item-dimensions"></a>Varedimensjoner
...
### <a name="specific-attributes"></a><a name="specific-attributes"></a>Bestemte attributter
...
### <a name="non-specific-attributes"></a><a name="non-specific-attributes"></a>Ikke-spesifikke attributter
...
## <a name="order-to-order-links"></a><a name="order-to-order-links"></a>Odre-til-ordre-koblinger
...
## <a name="reservations"></a><a name="reservations"></a>Reservasjoner
...
### <a name="emergency"></a><a name="emergency"></a>Kritisk
...
### <a name="exception"></a><a name="exception"></a>Unntak
...
### <a name="attention"></a><a name="attention"></a>Viktig
...
## <a name="error-logs"></a><a name="error-logs"></a>Feillogger
...
## <a name="planning-flexibility"></a><a name="planning-flexibility"></a>Planleggingsfleksibilitet
...
## <a name="order-planning"></a><a name="order-planning"></a>Ordreplanlegging
...
## <a name="finite-loading"></a><a name="finite-loading"></a>Begrenset belastning
