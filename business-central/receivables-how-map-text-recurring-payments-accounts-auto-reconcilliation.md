...
ms.author: edupont
---
# <a name="map-text-on-recurring-payments-to-accounts-for-automatic-reconciliation" />Tilordne tekst på gjentakende betalinger til kontoer for automatisk avstemming
...
## <a name="to-map-text-on-recurring-payments-to-accounts-for-automatic-reconciliation" />Tilordne tekst på gjentakende betalinger til kontoer for automatisk avstemming
...
## <a name="example-text-to-account-mapping-for-bank-fees" />Eksempel: Tekst-til-konto-tilordning for bankgebyrer
...
## <a name="see-related-microsoft-trainingtrainingmodulesuse-journals-dynamics--business-central" />Se relatert [Microsoft-opplæring](/training/modules/use-journals-dynamics-365-business-central/)
