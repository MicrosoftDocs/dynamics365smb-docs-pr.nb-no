---
title: Konfigurere tekst-til-konto-tildeling for regelmessige betalinger
...
---
# <a name="map-text-on-recurring-payments-to-accounts-for-automatic-reconciliation"></a>Tilordne tekst om regelmessige betalinger til kontoer for automatisk avstemming
...
Betalinger som bokføres basert på tekst-til-kontotilordning, utlignes ikke mot åpne poster, men bokføres bare på bestemte konti, i tillegg til at de oppretter bankkontoposter. Følgelig er tekst-til-konto-tildeling egnet for regelmessige kontantinntekter eller utgifter, for eksempel hyppige kjøp av bildrivstoff eller bankgebyrer og renter, som regelmessig forekommer på bankkontoutdraget og ikke trenger et relatert forretningsdokument. Hvis du vil ha mer informasjon, kan du se delen "Eksempel - tekst-til-konto-tildeling for drivstoffutgifter" i denne artikkelen.
...
## <a name="example-text-to-account-mapping-for-bank-fees"></a>Eksempel: Tekst-til-konto-tildeling for bankgebyrer
