...
## <a name="to-restore-a-non-posted-sales-document-or-a-project-from-the-archive"></a>Slik gjenoppretter du salgordrer som ikke er bokført, fra arkivet
...
## <a name="to-delete-archived-versions"></a>Slette arkiverte ordrer
