...
ms.author: edupont
---
# <a name="about-production-orders"></a><a name="about-production-orders"></a>Om produksjonsordrer
...
## <a name="production-order-creation"></a><a name="production-order-creation"></a>Opprette produksjonsordrer
...
## <a name="limitations-on-production-order-creation"></a><a name="limitations-on-production-order-creation"></a>Begrensninger på oppretting av produksjonsordrer
...
## <a name="production-order-status"></a><a name="production-order-status"></a>Produksjonsordrestatus
...
### <a name="simulated-production-order"></a><a name="simulated-production-order"></a>Simulert produksjonsordre
...
### <a name="planned-production-order"></a><a name="planned-production-order"></a>Planlagt produksjonsordre
...
### <a name="firm-planned-production-order"></a><a name="firm-planned-production-order"></a>Fast planlagt produksjonsordre
...
### <a name="released-production-order"></a><a name="released-production-order"></a>Frigitt produksjonsordre
...
### <a name="finished-production-order"></a><a name="finished-production-order"></a>Ferdig produksjonsordre
...
## <a name="production-order-execution"></a><a name="production-order-execution"></a>Produksjonsordreutførelse
...
### <a name="material-consumption"></a><a name="material-consumption"></a>Materialforbruk
...
### <a name="production-output"></a><a name="production-output"></a>Produksjonsavgang
...
### <a name="posting-consumption-and-output"></a><a name="posting-consumption-and-output"></a>Bokføre forbruk og avgang
...
### <a name="production-journal"></a><a name="production-journal"></a>Produksjonskladd
