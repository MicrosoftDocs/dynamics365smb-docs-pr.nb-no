...
ms.author: jswymer
---
# <a name="process-sales-opportunities" />Behandle salgsmuligheter
Når du oppretter en salgsmulighet, er det flere funksjoner for å behandle salgsmuligheten og fullføre den.

## <a name="to-view-opportunities" />Vise salgsmuligheter
...
## <a name="to-close-opportunities" />Lukke salgsmuligheter
...
## <a name="to-create-quotes-for-opportunities" />Opprette tilbud for salgsmuligheter
> [!NOTE]
...
## <a name="to-create-sales-orders-for-opportunities" />Opprette ordrer for salgsmuligheter
...
## <a name="to-delete-opportunities" />Slette salgsmuligheter
...
## <a name="to-move-an-opportunity-through-sales-cycle-stages" />Flytte en salgsmulighet gjennom salgssyklusfaser
