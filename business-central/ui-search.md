...
ms.author: bholtorf
---
# <a name="finding-pages-and-information-with-tell-me" />Finne sider og informasjon med Fortell meg
...
## <a name="find-an-action-on-the-current-page" />Finne en handling på den nåværende siden
...
## <a name="find-a-page-or-a-task" />Finne en side eller en oppgave
...
## <a name="find-a-report-or-archived-information" />Finn en rapport eller arkivert informasjon
...
## <a name="find-information-in-the-help" />Finn informasjon i Hjelp
...
## <a name="get-more-functionality-from-apps" />Få mer funksjonalitet fra apper
...
## <a name="search-for-data" />Søk etter data
