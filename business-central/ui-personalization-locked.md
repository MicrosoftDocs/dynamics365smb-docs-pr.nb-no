...
ms.author: edupont
---
# <a name="why-a-page-is-locked-from-personalization" />Hvorfor en side er låst fra tilpasning
...
## <a name="locked-from-personalizing" />Låst for tilpasning
...
### <a name="unlocking-the-page" />Låse opp siden
...
## <a name="blocked-from-personalizing" />Blokkert for tilpasning
