...
ms.author: edupont
---
# <a name="why-a-page-is-locked-from-personalization"></a><a name="why-a-page-is-locked-from-personalization"></a>Hvorfor en side er låst fra tilpasning
...
## <a name="locked-from-personalizing"></a><a name="locked-from-personalizing"></a>Låst for tilpasning
...
### <a name="unlocking-the-page"></a><a name="unlocking-the-page"></a>Låse opp siden
...
## <a name="blocked-from-personalizing"></a><a name="blocked-from-personalizing"></a>Blokkert for tilpasning
