...
ms.author: bholtorf
---
# <a name="set-up-posting-groups" />Definer bokføringsgrupper
...
## <a name="general-posting-groups" />Generelle bokføringsgrupper
...
## <a name="specific-posting-groups" />Spesifikke bokføringsgrupper
...
### <a name="allowing-substitute-customer-or-vendor-posting-groups-on-documents" />Tillat erstatning av kunde- eller leverandørbokføringsgrupper i dokumenter
...
## <a name="tax-posting-groups" />Avgiftsbokføringsgrupper
...
## <a name="example-of-linking-posting-groups" />Eksempel på kobling av bokføringsgruppe
...
## <a name="copying-posting-setup-lines" />Kopiere linjer for bokføringsoppsett
...
## <a name="set-up-posting-groups-on-the-go" />Definere bokføringsgrupper på farten
...
## <a name="troubleshooting-posting-group-errors" />Feilsøking av feil med bokføringsgruppe
...
## <a name="see-related-microsoft-trainingtrainingmodulesposting-groups-dynamics--business-central" />Se relatert [Microsoft-opplæring](/training/modules/posting-groups-dynamics-365-business-central/)
