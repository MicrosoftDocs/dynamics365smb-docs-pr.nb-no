...
ms.author: edupont
---
# <a name="design-details-item-application" />Designdetaljer: Vareutligning
...
## <a name="inventory-increase" />Lagerøkning
...
## <a name="inventory-decrease" />Lagerreduksjon
...
## <a name="fixed-application" />Fast utligning
...
### <a name="example--fixed-application-in-purchase-return" />Eksempel – fast utligning i bestillingsretur
...
### <a name="example--fixed-application-with-average-cost" />Eksempel – fast utligning med gjennomsnittskost
...
### <a name="example--fixed-application-in-sales-return" />Eksempel – fast utligning i ordreretur
...
## <a name="transfer-application" />Overføringsutligning
...
### <a name="example--average-costing-method" />Eksempel – lagermetoden Gjennomsnitt
...
### <a name="example--standard-costing-method" />Eksempel – lagermetoden Standard
...
## <a name="reapplication" />Utligne på nytt
