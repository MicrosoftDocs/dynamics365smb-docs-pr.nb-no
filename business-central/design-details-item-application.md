...
ms.author: edupont
---
# <a name="design-details-item-application"></a><a name="design-details-item-application"></a>Designdetaljer: Vareutligning
...
## <a name="inventory-increase"></a><a name="inventory-increase"></a>Lagerøkning
...
## <a name="inventory-decrease"></a><a name="inventory-decrease"></a>Lagerreduksjon
...
## <a name="fixed-application"></a><a name="fixed-application"></a>Fast utligning
...
### <a name="example--fixed-application-in-purchase-return"></a><a name="example--fixed-application-in-purchase-return"></a>Eksempel – fast utligning i bestillingsretur
...
### <a name="example--fixed-application-with-average-cost"></a><a name="example--fixed-application-with-average-cost"></a>Eksempel – fast utligning med gjennomsnittskost
...
### <a name="example--fixed-application-in-sales-return"></a><a name="example--fixed-application-in-sales-return"></a>Eksempel – fast utligning i ordreretur
...
## <a name="transfer-application"></a><a name="transfer-application"></a>Overføringsutligning
...
### <a name="example--average-costing-method"></a><a name="example--average-costing-method"></a>Eksempel – lagermetoden Gjennomsnitt
...
### <a name="example--standard-costing-method"></a><a name="example--standard-costing-method"></a>Eksempel – lagermetoden Standard
...
## <a name="reapplication"></a><a name="reapplication"></a>Utligne på nytt
