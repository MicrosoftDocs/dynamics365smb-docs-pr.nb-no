...
---
# <a name="design-details-handling-reordering-policies"></a><a name="design-details-handling-reordering-policies"></a>Designdetaljer: Håndtere gjenbestillingsprinsipper
...
## <a name="the-role-of-the-reorder-point"></a><a name="the-role-of-the-reorder-point"></a>Rollen til gjenbestillingspunktet
...
## <a name="monitoring-the-projected-inventory-level-and-the-reorder-point"></a><a name="monitoring-the-projected-inventory-level-and-the-reorder-point"></a>Overvåking av forventet lagernivå og gjenbestillingspunkt
...
### <a name="projected-inventory"></a><a name="projected-inventory"></a>Beregnet beholdning
...
### <a name="time-buckets"></a><a name="time-buckets"></a>Tidsperioder
...
### <a name="determining-the-projected-inventory-level"></a><a name="determining-the-projected-inventory-level"></a>Fastslå forventet beholdningsnivå
...
## <a name="the-role-of-the-time-bucket"></a><a name="the-role-of-the-time-bucket"></a>Rollen til tidsperioden
...
## <a name="stay-below-the-overflow-level"></a><a name="stay-below-the-overflow-level"></a>Hold deg under overflytnivået
...
### <a name="calculating-the-overflow-level"></a><a name="calculating-the-overflow-level"></a>Beregn overflytnivået

Overflytnivået beregnes på ulike måter avhengig av gjenbestillingsprinsippet.  

#### <a name="maximum-qty"></a><a name="maximum-qty"></a>Maks.ant.
...
#### <a name="fixed-reorder-qty"></a><a name="fixed-reorder-qty"></a>Fast gjenbest.ant.
...
#### <a name="order-multiple"></a><a name="order-multiple"></a>Bestillingsfaktor
...
### <a name="creating-the-planning-line-with-an-overflow-warning"></a><a name="creating-the-planning-line-with-an-overflow-warning"></a>Opprett planleggingslinje med en overflytadvarsel
...
#### <a name="calculating-the-planning-line-quantity"></a><a name="calculating-the-planning-line-quantity"></a>Beregn antall for planleggingslinjen
...
#### <a name="defining-the-action-message-type"></a><a name="defining-the-action-message-type"></a>Angi handlingsmeldingstypen
...
#### <a name="composing-the-warning-message"></a><a name="composing-the-warning-message"></a>Skriv advarselsmeldingen
...
#### <a name="item-setup"></a><a name="item-setup"></a>Vareoppsett
...
#### <a name="situation-before-sales-decrease"></a><a name="situation-before-sales-decrease"></a>Situasjonen før salgsreduksjon
...
#### <a name="situation-after-sales-decrease"></a><a name="situation-after-sales-decrease"></a>Situasjonen etter salgsreduksjon
...
#### <a name="resulting-planning-lines"></a><a name="resulting-planning-lines"></a>Resulterende planleggingslinjer
...
## <a name="handling-projected-negative-inventory"></a><a name="handling-projected-negative-inventory"></a>Håndter forventet negativ lagerbeholdning
...
## <a name="reordering-policies"></a><a name="reordering-policies"></a>Gjenbestillingsprinsipper
...
### <a name="fixed-reorder-quantity"></a><a name="fixed-reorder-quantity"></a>Fast gjenbestillingsantall
...
#### <a name="calculated-per-time-bucket"></a><a name="calculated-per-time-bucket"></a>Beregnet per tidsperiode
...
#### <a name="creates-only-necessary-supply"></a><a name="creates-only-necessary-supply"></a>Oppretter bare nødvendig forsyning
...
#### <a name="combines-with-order-modifiers"></a><a name="combines-with-order-modifiers"></a>Kombineres med ordreendringer
...
#### <a name="shouldnt-be-used-with-forecasts"></a><a name="shouldnt-be-used-with-forecasts"></a>Skal ikke brukes med prognoser
...
#### <a name="must-not-be-used-with-reservations"></a><a name="must-not-be-used-with-reservations"></a>Må ikke brukes med reservasjoner
...
### <a name="maximum-quantity"></a><a name="maximum-quantity"></a>Maksimumsantall
...
#### <a name="calculate-per-time-bucket"></a><a name="calculate-per-time-bucket"></a>Beregn per tidsperiode
...
#### <a name="combine-with-order-modifiers"></a><a name="combine-with-order-modifiers"></a>Kombiner med ordremodifikatorer
...
### <a name="combine-with-calendars"></a><a name="combine-with-calendars"></a>Kombiner med kalendere

Før du foreslår en ny forsyningsordre for å oppfylle et gjenbestillingspunkt, kontrollerer planleggingssystemet om ordren er planlagt for en fridag. Den bruker de kalendere du angir i feltet **Hovedkalenderkode** på sidene **Selskapsopplysninger** og **Lokasjonskort**.  

Hvis den planlagte datoen er en fridag, flytter planleggingssystemet ordren fremover til nærmeste arbeidsdag. Flytting av datoen kan føre til en ordre som oppfyller et gjenbestillingspunkt, men som ikke oppfyller et bestemt behov. For slike ubalanserte behov oppretter planleggingssystemet en ekstra forsyning.

### <a name="order"></a><a name="order"></a>Bestilling
...
#### <a name="order-to-order-links-and-past-due-dates"></a><a name="order-to-order-links-and-past-due-dates"></a>Odre-til-ordre-koblinger og tidligere forfallsdatoer
...
### <a name="lot-for-lot"></a><a name="lot-for-lot"></a>Parti for parti
