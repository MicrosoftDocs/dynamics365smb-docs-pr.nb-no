...
---
# <a name="design-details-handling-reordering-policies" />Designdetaljer: Håndtere gjenbestillingsprinsipper
...
## <a name="the-role-of-the-reorder-point" />Rollen til gjenbestillingspunktet
...
## <a name="monitoring-the-projected-inventory-level-and-the-reorder-point" />Overvåking av forventet lagernivå og gjenbestillingspunkt
...
### <a name="projected-inventory" />Beregnet beholdning
...
### <a name="time-buckets" />Tidsperioder
...
### <a name="determining-the-projected-inventory-level" />Fastslå forventet beholdningsnivå
...
## <a name="the-role-of-the-time-bucket" />Rollen til tidsperioden
...
## <a name="stay-below-the-overflow-level" />Hold deg under overflytnivået
...
### <a name="calculating-the-overflow-level" />Beregn overflytnivået

Overflytnivået beregnes på ulike måter avhengig av gjenbestillingsprinsippet.  

#### <a name="maximum-qty" />Maks.ant.
...
#### <a name="fixed-reorder-qty" />Fast gjenbest.ant.
...
#### <a name="order-multiple" />Bestillingsfaktor
...
### <a name="creating-the-planning-line-with-an-overflow-warning" />Opprett planleggingslinje med en overflytadvarsel
...
#### <a name="calculating-the-planning-line-quantity" />Beregn antall for planleggingslinjen
...
#### <a name="defining-the-action-message-type" />Angi handlingsmeldingstypen
...
#### <a name="composing-the-warning-message" />Skriv advarselsmeldingen
...
### <a name="example-scenario" />Eksempelscenario
...
#### <a name="situation-before-sales-decrease" />Situasjonen før salgsreduksjon
...
#### <a name="situation-after-sales-decrease" />Situasjonen etter salgsreduksjon
...
#### <a name="resulting-planning-lines" />Resulterende planleggingslinjer
...
## <a name="handling-projected-negative-inventory" />Håndter forventet negativ lagerbeholdning
...
## <a name="reordering-policies" />Gjenbestillingsprinsipper
...
### <a name="fixed-reorder-quantity" />Fast gjenbestillingsantall
...
#### <a name="calculated-per-time-bucket" />Beregnet per tidsperiode
...
#### <a name="creates-only-necessary-supply" />Oppretter bare nødvendig forsyning
...
#### <a name="combines-with-order-modifiers" />Kombineres med ordreendringer
...
#### <a name="shouldnt-be-used-with-forecasts" />Skal ikke brukes med prognoser
...
#### <a name="must-not-be-used-with-reservations" />Må ikke brukes med reservasjoner
...
### <a name="maximum-quantity" />Maksimumsantall
...
#### <a name="calculate-per-time-bucket" />Beregn per tidsperiode
...
#### <a name="combine-with-order-modifiers" />Kombiner med ordremodifikatorer
...
### <a name="combine-with-calendars" />Kombiner med kalendere

Før du foreslår en ny forsyningsordre for å oppfylle et gjenbestillingspunkt, kontrollerer planleggingssystemet om ordren er planlagt for en fridag. Den bruker de kalendere du angir i feltet **Hovedkalenderkode** på sidene **Selskapsopplysninger** og **Lokasjonskort**.  

Hvis den planlagte datoen er en fridag, flytter planleggingssystemet ordren fremover til nærmeste arbeidsdag. Flytting av datoen kan føre til en ordre som oppfyller et gjenbestillingspunkt, men som ikke oppfyller et bestemt behov. For slike ubalanserte behov oppretter planleggingssystemet en ekstra forsyning.

### <a name="order" />Bestilling
...
#### <a name="order-to-order-links-and-past-due-dates" />Odre-til-ordre-koblinger og tidligere forfallsdatoer
...
### <a name="lot-for-lot" />Parti for parti
