...
ms.author: edupont
---
# <a name="depreciate-or-amortize-fixed-assets" />Avskrive eller amortisere aktiva
...
## <a name="to-calculate-depreciation-automatically" />Slik beregner du avskrivninger automatisk
...
## <a name="to-post-depreciation-manually-from-the-fixed-asset-gl-journal" />Slik bokfører du avskrivning manuelt fra aktivafinanskladden:
...
## <a name="to-manage-the-ending-book-value" />Slik håndterer du siste bokførte verdi
...
## <a name="to-calculate-allocations-in-the-fixed-asset-gl-journal" />Slik beregner du fordelinger i aktivafinanskladden:
...
## <a name="use-duplication-lists-to-prepare-to-post-to-multiple-depreciation-books" />Bruke duplikatoversikter til å forberede bokføring av flere avskrivningstablåer
...
## <a name="to-post-entries-to-different-depreciation-books" />Slik bokfører du poster i ulike avskrivningstablåer
...
## <a name="to-copy-fixed-asset-ledger-entries-between-depreciation-books" />Slik kopierer du aktivaposter mellom avskrivningstablåer:
...
## <a name="see-related-microsoft-trainingtrainingmodulescalculate-post-depreciations" />Se relatert [Microsoft-opplæring](/training/modules/calculate-post-depreciations/)
