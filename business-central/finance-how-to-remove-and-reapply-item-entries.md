...
ms.author: edupont
---
# <a name="remove-and-reapply-item-ledger-entries" />Fjerne varefinansposter og utligne dem på nytt
...
## <a name="to-remove-an-item-application-by-using-the-application-worksheet" />Slik fjerner du en vareutligning med utligningsforslaget
...
## <a name="to-reapply-an-item-application-by-using-the-application-worksheet" />Slik bruker du en vareutligning på nytt med utligningsforslaget
