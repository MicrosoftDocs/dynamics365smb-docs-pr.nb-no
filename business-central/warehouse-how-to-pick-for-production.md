...
---
# <a name="pick-for-production-assembly-or-jobs-in-basic-warehouse-configurations" />Plukke for produksjon, montering eller jobber i enkle lageroppsett
...
## <a name="inventory-picks" />Lagerplukk
...
## <a name="inventory-movements" />Lagerflyttinger
...
## <a name="pick-or-move-for-production-assembly-and-jobs-in-a-basic-warehouse-configuration" />Plukk eller flytt for produksjon, montering eller prosjekter i et enkelt lageroppsett
...
### <a name="to-create-an-inventory-movement-from-the-source-document" />Slik oppretter du en lagerflytting fra kildedokumentet
...
### <a name="to-create-multiple-inventory-picks-or-movements-with-a-batch-job" />Slik oppretter du flere lagerplukk eller -flyttinger med en kjørsel
...
### <a name="to-create-inventory-picks-or-movements-in-two-steps" />Slik oppretter du lagerplukk eller -flyttinger i to trinn
...
## <a name="to-record-the-inventory-pick" />Slik registrerer du lagerplukk
...
## <a name="flushing-production-components-in-a-basic-warehouse-configuration" />Trekk produksjonskomponenter i et grunnleggende lageroppsett
