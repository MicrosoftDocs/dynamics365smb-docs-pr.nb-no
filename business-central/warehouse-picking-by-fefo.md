...
ms.author: edupont
---
# <a name="enable-picking-items-by-fefo"></a><a name="enable-picking-items-by-fefo"></a><a name="enable-picking-items-by-fefo"></a>Aktivere plukking av varer etter FEFO
