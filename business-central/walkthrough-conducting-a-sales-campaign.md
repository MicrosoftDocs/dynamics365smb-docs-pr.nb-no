...
ms.author: edupont
---
# <a name="walkthrough-conducting-a-sales-campaign" />Gjennomgang: kjøre en salgskampanje
...
## <a name="setting-up-a-campaign" />Opprette en kampanje
...
### <a name="to-set-up-a-campaign" />Slik oppretter du en kampanje:
...
## <a name="selecting-the-target-audience" />Velge målgruppen
...
### <a name="to-create-a-segment-with-the-relevant-contacts" />Slik oppretter du et segment med de relevante kontaktene:
...
### <a name="to-save-your-segmentation-criteria" />Slik lagrer du segmenteringskriteriene
...
## <a name="mining-the-data" />Utvinne dataene
...
### <a name="to-remove-contacts-from-the-segment" />Slik fjerner du kontakter fra segmentet:
...
### <a name="to-bring-back-the-removed-contacts" />Slik henter du tilbake kontakter som er fjernet
...
## <a name="linking-a-segment-to-a-campaign" />Knytte et segment til en kampanje
...
### <a name="to-link-a-segment-to-the-campaign" />Slik knytter du et segment til kampanjen:
...
## <a name="sending-letters-and-email-messages-to-contacts" />Sende brev og e-postmeldinger til kontakter
...
### <a name="to-use-a-segment-to-send-a-letter-to-a-contact" />Slik bruker du et segment til å sende et brev til en kontakt:
...
### <a name="to-send-an-email-message-to-a-contact" />Sende en e-postmelding til en kontakt
...
## <a name="registering-campaign-responses" />Registrere kampanjerespons
...
### <a name="to-register-campaign-responses" />Slik registrerer du kampanjerespons:
