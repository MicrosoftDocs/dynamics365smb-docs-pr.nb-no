...
ms.author: edupont
---
# <a name="convert-existing-locations-to-warehouse-locations" />Konvertere eksisterende lokasjoner til lagerlokasjoner
...
## <a name="to-enable-an-existing-location-to-operate-as-a-warehouse-location" />Slik definerer du en eksisterende lokasjon som lagerlokasjon
