...
> [!NOTE]
> Bruk dette alternativet hvis du ikke vil publisere endringene tilbake til [!INCLUDE[prod_short](includes/prod_short.md)].  
...
Du kan eksportere alle sider, men det kan være mer enn det du virkelig trenger. Vurder å eksportere følgende viktige sider, og husk å legge til alle kolonner:  
...
Hvis du vil eksportere alle finansielle transaksjoner, er dette en stor mengde data, slik at eksporten vil ofte ta mer enn et par minutter. Økonomiske transaksjoner vises på siden **Finansposter**.  
