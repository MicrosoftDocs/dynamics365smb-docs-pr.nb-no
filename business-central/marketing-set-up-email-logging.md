...
---
# Spor utveksling av e-postmeldinger mellom selgere og kontakter
...
## Konfigurer loggføring av e-post

### Definer fellesmapper og regler for e-postpålogging i Exchange Online

[!INCLUDE[admin-setup-email-public-folder](includes/admin-setup-email-public-folder.md)]

Deretter kobler du [!INCLUDE[prod_short](includes/prod_short.md)] til Exchange Online.

### Konfigurer en delt postboks og regler for loggføring av e-post i Exchange Online
...
### Legg til en brukerkonto for medlemmer av den delte postboksen
...
### Tillat andre brukere å se loggførte e-poster
...
## Konfigurer [!INCLUDE[prod_short](includes/prod_short.md)] for å logge e-postmeldinger
...
## Vis utvekslinger av e-postmeldinger i samhandlingsloggen
...
## Postboks- og mappebegrensninger i Exchange Online
...
## Koble lokale versjoner til Microsoft Exchange
...
Du må registrere et program i Microsoft Entra for å kunne koble til Exchange Online ID. Oppgi program-ID-en, hemmeligheten for nøkkelhvelv og nettadressen for registreringen. Nettadressen for omdirigering er forhåndsangitt og skal fungere for de fleste installasjoner. Hvis du vil ha mer informasjon, kan du se [Slik registrerer du et program i Microsoft Entra ID for tilkobling fra Business Central til Exchange Online](#to-register-an-application-in-microsoft-entra-id-for-connecting-from-business-central-to-exchange-online). 

Du må også bruke **OAuth2** som **godkjenningstype**. Du må også registrere et program i Microsoft Entra ID. Oppgi program-ID-en, hemmeligheten for nøkkelhvelv og nettadressen for registreringen. Nettadressen for omdirigering er forhåndsutfylt og skal fungere for de fleste installasjoner. Hvis du vil ha mer informasjon, kan du se Slik registrerer du et program i Microsoft Entra ID for tilkobling fra Business Central til Exchange Online nedenfor.
...
### Slik registrerer du et program i Microsoft Entra ID for tilkobling fra Business Central til Exchange Online

Fremgangsmåten nedenfor forutsetter at du bruker Microsoft Entra ID til å administrere identiteter og tilgang. Hvis du vil ha mer informasjon, kan du se [Hurtigstart: Registrere et program i Microsoft Identity Platform](/azure/active-directory/develop/quickstart-register-app). 
...
## Slik stopper du loggføring av e-post
...
## Slik endrer du brukerkontoen som brukes til loggføring av e-post
