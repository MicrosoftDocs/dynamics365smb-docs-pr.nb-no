...
### Definere fellesmapper og regler for e-postpålogging i Exchange Online
...
### Konfigurer en delt postboks for loggføring av e-post i Exchange Online
...
## Vise utvekslinger av e-postmeldinger i samhandlingsloggen
...
2. Unngå å nå grensene for postboksen og mappen. Hvis du er i ferd med å nå en grense, gjør du følgende:
    1. Opprett en ny, delt postboks (ny opplevelse) eller en ny delt mappe (nåværende opplevelse) i Exchange Online.
...
## Koble til Exchange On-Premises
## [Nåværende opplevelse](#tab/current-experience)
...
### Slik registrerer du et program i Azure AD for tilkobling fra Business Central til Exchange Online
