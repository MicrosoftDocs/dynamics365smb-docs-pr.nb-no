...
### <a name="to-register-an-application-in-microsoft-entra-id-for-connecting-from-business-central-to-exchange-online"></a>Slik registrerer du et program i Microsoft Entra ID for tilkobling fra Business Central til Exchange Online
