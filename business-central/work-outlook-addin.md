...
ms.author: jswymer
---
# <a name="use-business-central-as-your-business-inbox-in-outlook" />Bruk Business Central som forretningsinnboks i Outlook
...
## <a name="work-with-contacts-and-documents-using-the-contact-insights-add-in" />Arbeid med kontakter og dokumenter ved hjelp av Kontaktinnsikt-tillegget
...
### <a name="look-up-a-business-contact-when-composing-an-email" />Slå opp en forretningskontakt når du skriver en e-post
...
### <a name="view-and-change-the-contact-details-or-switch-company" />Vis og endre kontaktdetaljer eller bytte firma
...
### <a name="track-incoming-documents" />Spor innkommende dokumenter
...
### <a name="create-and-send-new-document-to-a-contact" />Opprett og send nytt dokument til en kontakt
...
### <a name="attach-files-to-records" />Legg ved filer i poster
...
#### <a name="how-to-attach-a-file" />Slik legger du ved en fil
...
## <a name="view-a-document-from-an-email-using-the-document-view-add-in" />Vis et dokument fra en e-post ved hjelp av tillegget Dokumentvisning
