...
2. Når tillegget er installert, får du tilgang til **[!INCLUDE[prod_short](includes/prod_short.md)]**-tillegget fra en ny eller eksisterende e-postmelding eller kalenderavtale i Outlook.
    ...
    Begynn med å logge på Outlook og åpne en e-postmelding. Hvis du bruker Outlook-appen, går du til båndet og ser etter **[!INCLUDE[prod_short](includes/prod_short.md)]**.  Hvis du bruker Outlook på nettet, går du til den øverste e-postmeldinger og velger **Apper** ![Viser appknappen i Outlook.](media/apps-icon.png) > **Business Central** ![Ikonet for Business Central-tillegget i Outlook.](media/outlook-business-central-icon.png) eller gå til flere handlinger ![Vis flere handlinger for en e-post i Outlook.](media/outlook-more-actions-button.png) .
...
## Arbeid med kontakter og dokumenter ved hjelp av Kontaktinnsikt-tillegget
...
### Slå opp en forretningskontakt når du skriver en e-post

1. Opprett en ny e-postmelding.
2. På båndet går du til **[!INCLUDE[prod_short](includes/prod_short.md)]** og velger **Kontaktinnsikt**. Hvis du bruker Outlook på nettet, går du til toppen av meldingen og velger **Apper** ![Viser appknappen i Outlook.](media/apps-icon.png) > **Business Central** ![Ikonet for Business Central-tillegget i Outlook.](media/outlook-business-central-icon.png) > **Kontaktinnsikt**.
...
### Vis og endre kontaktdetaljer eller bytte firma
...
### Opprett og send nytt dokument til en kontakt
...
## Vis et dokument fra en e-post ved hjelp av tillegget Dokumentvisning
