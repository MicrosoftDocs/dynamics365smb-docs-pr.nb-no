...
# <a name="troubleshooting-and-correcting-dimensions" />Feilsøke og korrigere dimensjoner
...
## <a name="troubleshooting-dimensions-errors" />Feilsøke dimensjonsfeil
...
## <a name="changing-dimension-assignments-after-posting" />Endre dimensjonstilordninger etter bokføring
...
### <a name="setting-up-dimension-corrections" />Konfigurere dimensjonskorrigeringer
...
### <a name="correcting-a-dimension" />Korrigere en dimensjon
...
### <a name="validating-dimension-corrections" />Validering av dimensjonskorrigeringer
...
### <a name="undoing-a-correction" />Angre en korrigering
...
### <a name="dimension-corrections-on-large-data-sets" />Dimensjonskorrigeringer i store datasett
...
### <a name="use-analysis-views-with-dimension-corrections" />Bruk analysevisninger med dimensjonskorrigeringer
...
### <a name="viewing-historical-dimension-corrections" />Vise historiske dimensjonskorrigeringer
...
### <a name="handling-incomplete-corrections" />Behandle ufullstendige korrigeringer
...
### <a name="use-cost-accounting-with-corrected-gl-entries" />Bruk kostnadsregnskap med korrigerte finansposter
...
## <a name="see-related-microsoft-trainingtrainingmodulesdimensions-dynamics-365-business-central" />Se relatert [Microsoft-opplæring](/training/modules/dimensions-dynamics-365-business-central/)
