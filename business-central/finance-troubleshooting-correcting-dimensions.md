...
# <a name="troubleshoot-and-correct-dimensions"></a>Feilsøke og korrigere dimensjoner
...
## <a name="troubleshooting-dimensions-errors"></a>Feilsøk dimensjonsfeil
...
## <a name="changing-dimension-assignments-after-posting"></a>Endre dimensjonstildelinger etter bokføring
...
### <a name="set-up-dimension-corrections"></a>Definere dimensjonskorrigeringer
...
### <a name="correct-a-dimension"></a>Korrigere en dimensjon
...
1. Bruk én av følgende sider for å starte en dimensjonskorrigering:
    ...
    * På **siden Finansjournaler**, ved å velge en journal og deretter velge **handlingen Rett dimensjoner** . Denne handlingen starter en korrigering for postene i den valgte journalen.
    * På **siden Finansposter**, ved å velge handlingen **Rett dimensjoner** . 
...
### <a name="validate-dimension-corrections"></a>Validere dimensjonskorrigeringer
...
### <a name="undo-a-correction"></a>Angre en korrigering
...
### <a name="view-historical-dimension-corrections"></a>Vise korrigeringer av historiske dimensjoner
...
### <a name="handle-incomplete-corrections"></a>Håndtere ufullstendige korrigeringer
