...
## <a name="to-create-a-sandbox-environment-in-your-include-prodshortincludesprodshortmd"></a>Slik oppretter du et sandkassemiljø i [!INCLUDE [prodshort](includes/prodshort.md)]
