...
ms.author: edupont
---
# <a name="process-sales-returns-or-cancellations" />Behandle ordrereturer eller annulleringer
...
## <a name="to-create-a-sales-credit-memo-from-a-posted-sales-invoice" />Opprette en ny salgskreditnota fra en bokført salgsfaktura
...
## <a name="to-create-a-sales-credit-memo-by-copying-a-posted-sales-invoice" />Opprette en salgskreditnota ved å kopiere en bokført salgsfaktura
...
## <a name="to-create-a-sales-allowance" />Slik oppretter du en salgsrabatt
...
## <a name="to-combine-return-receipts" />Slå sammen retursedler
...
### <a name="to-manually-combine-return-receipts" />Slik slår du sammen retursedler manuelt
...
### <a name="to-automatically-combine-return-receipts" />Slik slår du sammen retursedler automatisk:
...
### <a name="to-remove-a-received-and-invoiced-return-order" />Slik fjerner du mottatte og fakturerte ordrereturer
