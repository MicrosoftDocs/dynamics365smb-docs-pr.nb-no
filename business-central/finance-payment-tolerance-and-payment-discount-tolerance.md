...
description: Denne artikkelen forklarer hvordan du setter opp betalingstoleranse til å lukke en faktura når betalingen ikke fullt ut dekker fakturabeløpet.
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
Scenarioer med alternativ A eller B representerer følgende:  

- **A** – I dette tilfellet er advarselen om rabattoleranse deaktivert, eller brukeren har advarselen aktivert og velger å tillate kontantrabatten ved sen betaling (bokføre saldoen som betalingstoleranse).  
- **B** – I dette tilfellet har brukeren aktivert advarselen og velger ikke å tillate kontantrabatt ved sen betaling (la saldoen stå som restbeløp).  
...
- **A** – I dette tilfellet er advarselen om rabattoleranse deaktivert, eller brukeren har advarselen aktivert og velger å tillate kontantrabatten ved sen betaling (bokføre som toleranse) for alle fakturaer.  
- **B** – I dette tilfellet har brukeren aktivert advarselen og velger ikke å tillate kontantrabatt ved sen betaling, for alle fakturaer.  
- **C** - I dette tilfellet har brukeren varslet påslått, og velger å tillate kontantrabatt ved sen betaling, for første faktura, men ikke den neste.  
- **D** – I dette tilfellet har brukeren varslet påslått, og velger ikke å tillate kontantrabatt ved sen betaling, for første faktura, men tillate det for den neste.  
