...
ms.author: edupont
---
# <a name="work-with-payment-tolerances-and-payment-discount-tolerances"></a><a name="work-with-payment-tolerances-and-payment-discount-tolerances"></a>Arbeide med betalingstoleranser og toleransegrenser for kontantrabatt
...
## <a name="applying-payment-tolerance-to-multiple-documents"></a><a name="applying-payment-tolerance-to-multiple-documents"></a>Bruke betalingstoleranse for flere dokumenter
...
## <a name="to-set-up-tolerances"></a><a name="to-set-up-tolerances"></a>Slik definerer du toleranser
...
## <a name="to-enable-or-disable-payment-tolerance-warnings"></a><a name="to-enable-or-disable-payment-tolerance-warnings"></a>Slik aktiverer eller deaktiverer du advarsler om betalingstoleranse
...
## <a name="to-block-payment-tolerance-for-customers"></a><a name="to-block-payment-tolerance-for-customers"></a>Slik sperrer du for betalingstoleranse for kunder
...
## <a name="example-1---tolerance-calculations-for-a-single-document"></a><a name="example-1---tolerance-calculations-for-a-single-document"></a>Eksempel 1 - toleranseberegninger for ett dokument
...
### <a name="payment-range-diagrams"></a><a name="payment-range-diagrams"></a>Betalingsseriediagrammer

I forhold til scenariet ovenfor, er diagrammene for betalingsserier slik:  

#### <a name="1-payment-date-011503-scenarios-1-3"></a><a name="1-payment-date-011503-scenarios-1-3"></a>(1) Betalingsdato <=15.01.03 (scenariene 1-3)
...
#### <a name="2-payment-date-is-between-011603-and-012003-scenarios-4-9"></a><a name="2-payment-date-is-between-011603-and-012003-scenarios-4-9"></a>(2) Betalingsdato er mellom 16.01.03 og 21.01.03 (scenariene 4-9)
...
#### <a name="3-payment-date-is-after-012003-scenarios-10-15"></a><a name="3-payment-date-is-after-012003-scenarios-10-15"></a>(3) Betalingsdato er etter 20.01.03 (Scenariene 10-15)
...
## <a name="example-2---tolerance-calculations-for-multiple-documents"></a><a name="example-2---tolerance-calculations-for-multiple-documents"></a>Eksempel 2 - toleranseberegninger for flere dokumenter
...
### <a name="payment-range-diagrams-1"></a><a name="payment-range-diagrams-1"></a>Betalingsseriediagrammer

I forhold til scenariet ovenfor, er diagrammene for betalingsserier slik:  

#### <a name="1-payment-date-011503-scenarios-1-3-1"></a><a name="1-payment-date-011503-scenarios-1-3-1"></a>(1) Betalingsdato <=15.01.03 (scenariene 1-3)
...
#### <a name="2-payment-date-is-between-011603-and-011703-scenarios-4-9"></a><a name="2-payment-date-is-between-011603-and-011703-scenarios-4-9"></a>(2) Betalingsdato er mellom 16.01.03 og 17.01.03 (scenariene 4-9)
...
#### <a name="3-payment-date-is-between-011803-and-012003-scenarios-10-21"></a><a name="3-payment-date-is-between-011803-and-012003-scenarios-10-21"></a>(3) Betalingsdato er mellom 18.01.03 og 20.01.03 (scenariene 10-21)
...
#### <a name="4-payment-date-is-between-012103-and-012203-scenarios-22-27"></a><a name="4-payment-date-is-between-012103-and-012203-scenarios-22-27"></a>(4) Betalingsdato er mellom 21.01.03 og 22.01.03 (scenariene 22-27)
...
#### <a name="5-payment-date-is-after-012203-scenarios-28-30"></a><a name="5-payment-date-is-after-012203-scenarios-28-30"></a>(5) Betalingsdato er etter 22.01.03 (scenariene 28-30)
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/modules/enter-payments-dynamics-365-business-central/)
