...
---
# <a name="put-away-production-or-assembly-output" />Plassere produksjonsavgang eller monteringsavgang
...
## <a name="to-put-away-production-output-with-an-inventory-put-away" />Slik plasseres produksjonsavgang med lagerplassering
...
### <a name="to-create-the-inbound-warehouse-request" />Slik oppretter du den inngående lagerforespørselen
...
### <a name="to-put-output-away-with-an-inventory-put-away" />Slik plasseres varer med lagerplassering
...
## <a name="to-put-assembly-and-production-output-away-in-advanced-warehouse-configurations" />Slik plasserer du monterings- og produksavgang i avanserte lagerkonfigurasjoner
