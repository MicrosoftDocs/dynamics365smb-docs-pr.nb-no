...
ms.author: edupont
---
# <a name="troubleshooting-your-company-hub" />Feilsøke selskapshuben
...
## <a name="check-errors" />Sjekk feil
...
## <a name="connection-failed" />Tilkobling mislyktes
...
## <a name="data-does-not-refresh" />Data blir ikke oppdatert
