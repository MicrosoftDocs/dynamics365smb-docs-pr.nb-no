...
ms.author: edupont
---
# <a name="troubleshooting-your-company-hub"></a><a name="troubleshooting-your-company-hub"></a>Feilsøke selskapshuben
...
## <a name="check-errors"></a><a name="check-errors"></a>Sjekk feil
...
## <a name="connection-failed"></a><a name="connection-failed"></a>Tilkobling mislyktes
...
## <a name="data-does-not-refresh"></a><a name="data-does-not-refresh"></a>Data blir ikke oppdatert
