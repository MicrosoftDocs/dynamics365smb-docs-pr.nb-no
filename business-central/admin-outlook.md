...
ms.author: jswymer
---
# <a name="get-the-business-central-add-in-for-outlook" />Hent Business Central-tillegget for Outlook
...
## <a name="about-the-business-central-add-in-for-outlook" />Om Business Central-tillegget for Outlook
...
## <a name="deploy-the-add-in-by-using-centralized-deployment-as-an-admin" />Distribuer tillegget ved hjelp av sentralisert distribusjon som en administrator
...
### <a name="deploy-the-add-in" />Distribuer tillegget
