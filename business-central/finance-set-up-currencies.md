...
ms.author: edupont
---
# <a name="set-up-currencies" />Definere valutaer
...
### <a name="available-currency-functions" />Tilgjengelige valutafunksjoner
...
## <a name="lcy-and-other-currencies" />LV og andre valutaer

[!INCLUDE [finance-currencies-lcy-def](includes/finance-currencies-lcy-def.md)]

## <a name="rounding-currencies" />Runde av valutaer
...
### <a name="unit-amount-rounding" />Prisavrunding
...
### <a name="amount-rounding" />Beløpsavrunding
...
## <a name="general-ledger-accounts" />Finanskontoer
...
## <a name="see-related-microsoft-trainingtrainingmodulescurrencies-exchange-rates-dynamics--business-central" />Se relatert [Microsoft-opplæring](/training/modules/currencies-exchange-rates-dynamics-365-business-central/)
