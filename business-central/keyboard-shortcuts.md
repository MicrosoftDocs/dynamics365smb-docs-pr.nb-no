...
|<kbd>Ctrl</kbd>+<kbd>Alternativ</kbd>+<kbd>Pil ned</kbd>|Åpne kortet eller listesiden for en relatert oppføring filtrert etter verdien i oppslags- eller redigeringsfeltet.|
...
| <kbd>En side ned</kbd><br /><br />(<kbd>Fn</kbd>+<kbd>pil ned</kbd>) | Rulle for å vise de angitte radene under de gjeldende radene i visningen. | Rulle for å vise settet med fliser under de gjeldende flisene i visningen. |
| <kbd>Pil ned</kbd> | Flytte i samme kolonne til feltet i raden nedenfor. | Flytte i samme kolonne til flisen i raden nedenfor. |
...
|<kbd>Skift</kbd>+<kbd>pil ned</kbd>|Utvide valget av rader til å inkludere raden nedenfor.|Ikke i bruk.|
...
|<kbd>Alt</kbd>+<kbd>F6</kbd>|Bytt mellom vis/skjul for gjeldende hurtigfane eller del (underordnet side).|
...
|<kbd>F6</kbd>|Flytt til neste hurtigfane eller del (underordnet side).|
...
|<kbd>Skift</kbd>+<kbd>F6</kbd>|Flytte til forrige hurtigfane eller del (underordnet side).|
...
|Velg disse tastene<br />(i macOS)|Hvis du vil gjøre dette|
|--------------------------------|----------|
|<kbd>Pil ned</kbd>|Rull ned siden.|  
...
|<kbd>Ctrl</kbd>+<kbd>End</kbd><br /><br />(<kbd>Cmd</kbd>+<kbd>End</kbd>)|Gå til den siste siden i rapporten.|
...
|<kbd>Skift</kbd> <kbd>F3</kbd> eller <kbd>Ctrl</kbd>+<kbd>Pil ned</kbd>|Flytter fokus til neste funksjon som ble funnet, i rolleutforskeren. <kbd>F3</kbd> flytter fokus til **Søk etter**-boksen etter funksjonen som ble funnet sist.|
...
Tilgangstaster er snarveier som lar deg velge bestemte handlinger på handlingslinjen og menyen for enklere navigering, på samme måte som tilgangstaster i Excel og Word. De er imidlertid bare tilgjengelige i Business Central-nettklienten når visningsspråket er satt til engelsk.
