...
---
# <a name="set-up-and-publish-kpi-web-services-based-on-financial-reports" />Konfigurere og publisere KPI-webtjenester basert på finansrapporter
...
## <a name="set-up-and-publish-a-kpi-web-service-based-on-financial-reports" />Konfigurere og publisere KPI-webtjenester basert på finansrapporter
