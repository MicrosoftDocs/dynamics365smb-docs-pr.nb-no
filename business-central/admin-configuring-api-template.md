...
# <a name="configure-api-templates"></a><a name="configure-api-templates"></a>Konfigurer API-maler
...
## <a name="setting-up-the-entity-template"></a><a name="setting-up-the-entity-template"></a>Definere enhetsmalen
...
## <a name="assign-the-template-to-an-api"></a><a name="assign-the-template-to-an-api"></a>Tilordne malen til et API
