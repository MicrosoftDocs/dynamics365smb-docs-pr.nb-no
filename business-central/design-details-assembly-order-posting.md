...
ms.author: edupont
---
# <a name="design-details-assembly-order-posting"></a><a name="design-details-assembly-order-posting"></a>Designdetaljer: Bokføre monteringsordre
...
## <a name="posting-sequence"></a><a name="posting-sequence"></a>Bokføringsrekkefølge
...
## <a name="cost-adjustment"></a><a name="cost-adjustment"></a>Kostjustering
...
### <a name="performing-the-adjustment"></a><a name="performing-the-adjustment"></a>Utføre justeringen
...
### <a name="posting-dates"></a><a name="posting-dates"></a>Bokføringsdatoer
