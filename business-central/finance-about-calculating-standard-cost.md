...
ms.author: edupont
---
# <a name="about-calculating-standard-cost" />Om beregning av standardkost
...
## <a name="setting-up-standard-costs" />Definere standardkostnader
...
### <a name="capacity-costs" />Kapasitetskostnader
...
### <a name="subcontractor-costs" />Underleverandørkostnader
...
## <a name="updating-standard-costs" />Oppdatere standardkostnader
