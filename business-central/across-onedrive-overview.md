...
# <a name="business-central-and-onedrive-for-business-integration" />Business Central og OneDrive for Business-integrering
...
## <a name="get-started-with-onedrive-features" />Kom i gang med OneDrive-funksjoner
...
### <a name="open-and-share-in-onedrive" />Åpne og dele i OneDrive
...
### <a name="save-excel-workbooks-and-report-files-in-onedrive" />Lagre Excel-arbeidsbøker og rapport filer i OneDrive
