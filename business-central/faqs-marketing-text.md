...
description: 'Disse vanlige spørsmålene om ansvarlig kunstig intelligens gir informasjon om KI-teknologien som brukes i forslag til markedsføringstekst i Business Central, sammen med viktige vurderinger og detaljer om hvordan kunstig intelligens brukes, hvordan den ble testet og evaluert, og eventuelle spesifikke begrensninger.'
ms.date: 10/07/2023
ms.custom:
  - responsible-ai-faqs
ms.topic: article
