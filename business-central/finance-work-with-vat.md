...
ms.author: bholtorf
---
# <a name="work-with-vat-on-sales-and-purchases" />Arbeide med mva på kjøp og salg
...
## <a name="calculating-and-displaying-vat-amounts-on-sales-and-purchase-documents" />Beregne og vise mva-beløp i salgs- og kjøpsdokumenter
...
### <a name="including-or-excluding-vat-in-prices-and-line-amounts" />Inkluder eller ekskluder mva. i priser og linjebeløp
...
#### <a name="using-vat-business-posting-groups-and-customer-price-groups" />Bruk mva-bokføringsgrupper for firma og kundeprisgrupper
...
## <a name="working-with-vat-date" />Arbeid med mva-dato

### <a name="vat-date-in-documents" />Mva-dato i dokumenter
...
### <a name="modifying-the-vat-date-in-posted-entries" />Endre mva-dato i bokførte poster
...
## <a name="correcting-vat-amounts-manually-on-sales-and-purchase-documents" />Korrigere mva-beløp manuelt i salgs- og kjøpsdokumenter
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-sales-documents" />Slik oppretter du et system for manuell mva-post i salgsdokumenter
...
### <a name="to-adjust-vat-for-a-sales-document" />Slik justerer du mva for et salgsdokument
...
## <a name="calculating-vat-manually-using-journals" />Beregne mva manuelt ved hjelp av kladder
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-general-journals" />Slik konfigurerer du systemet for manuell mva-post i en finanskladd.
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-sales-and-purchase-journals" />Slik konfigurerer du systemet for manuell mva-post i salgs- og kjøpskladder
...
## <a name="posting-import-vat-with-purchase-invoices" />Bokføre import-mva med kjøpsfakturaer
I stedet for å bruke kladder til å bokføre en viktig mva-faktura, kan du bruke en kjøpsfaktura.  

### <a name="to-set-up-purchasing-for-posting-import-vat-invoices" />Slik definerer du kjøp for bokføring av fakturaer med import-mva.:
...
### <a name="to-create-a-new-invoice-for-the-import-authority-vendor-once-you-have-completed-the-setup" />Slik oppretter du en ny faktura for importmyndighetsleverandøren når du har fullført oppsettet
...
## <a name="processing-certificates-of-supply" />Behandle leveringsbekreftelser
...
### <a name="to-view-certificate-of-supply-details" />Slik viser du detaljer om leveringsbekreftelser
...
### <a name="to-print-a-certificate-of-supply" />Slik skriver du ut en leveringsbekreftelse
...
### <a name="to-update-the-status-of-a-certificate-of-supply-for-a-shipment" />Oppdatere statusen til en leveringsbekreftelse for en levering
...
### <a name="to-update-the-status-of-a-group-of-certificates-of-supply" />Oppdatere statusen til en gruppe av leveringsbekreftelser
