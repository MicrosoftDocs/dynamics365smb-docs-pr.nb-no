...
ms.author: edupont
---
# <a name="design-details-cost-adjustment"></a><a name="design-details-cost-adjustment"></a>Designdetaljer: Kostjustering
...
## <a name="detecting-the-adjustment"></a><a name="detecting-the-adjustment"></a>Registrere justeringen
...
### <a name="item-application-entry"></a><a name="item-application-entry"></a>Vareutligningspost
...
### <a name="average-cost-adjustment-entry-point"></a><a name="average-cost-adjustment-entry-point"></a>Inngangspunkt for gjennomsnittlig kostjustering
...
### <a name="order-level"></a><a name="order-level"></a>Ordrenivå
...
## <a name="manual-versus-automatic-cost-adjustment"></a><a name="manual-versus-automatic-cost-adjustment"></a>Manuell kontra automatisk kostjustering
...
## <a name="adjust-cost---item-entries-batch-job"></a><a name="adjust-cost---item-entries-batch-job"></a>Kjørselen Juster kostverdi – vareposter
...
#### <a name="value-entries-1"></a><a name="value-entries-1"></a>Verdiposter (1)
...
#### <a name="relation-entries-in-the-gl--item-ledger-relation-table-1"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-1"></a>Relasjonsposter i tabellen Finans – varepostrelasjon (1)
...
#### <a name="value-entries-2"></a><a name="value-entries-2"></a>Verdiposter (2)
...
#### <a name="relation-entries-in-the-gl--item-ledger-relation-table-2"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-2"></a>Relasjonsposter i tabellen Finans – varepostrelasjon (2)
...
## <a name="automatic-cost-adjustment"></a><a name="automatic-cost-adjustment"></a>Automatisk kostjustering
