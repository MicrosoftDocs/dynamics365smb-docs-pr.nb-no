...
ms.author: edupont
---
# <a name="design-details-cost-adjustment" />Designdetaljer: Kostjustering
...
### <a name="item-application-entry" />Vareutligningspost
...
### <a name="average-cost-adjustment-entry-point" />Inngangspunkt for gjennomsnittlig kostjustering
...
## <a name="manual-versus-automatic-cost-adjustment" />Manuell kontra automatisk kostjustering
...
## <a name="adjust-cost---item-entries-batch-job" />Kjørselen Juster kostverdi – vareposter
...
## <a name="automatic-cost-adjustment" />Automatisk kostjustering
