...
ms.author: edupont
---
# <a name="create-incoming-document-records" />Opprett innkommende dokumentposter
...
## <a name="approve-or-reject-an-incoming-document" />Slik godkjenner eller avviser du et innkommende dokument
...
## <a name="create-an-incoming-document-record-by-taking-a-photo" />Slik oppretter du en innkommende dokumentpost ved å ta et bilde
...
## <a name="attach-an-image-to-an-incoming-document-record-by-taking-a-photo" />Slik legger du ved et bilde i en innkommende dokumentpost ved å ta et bilde
...
## <a name="create-an-incoming-document-record-manually" />Slik oppretter du en innkommende dokumentpost manuelt:
