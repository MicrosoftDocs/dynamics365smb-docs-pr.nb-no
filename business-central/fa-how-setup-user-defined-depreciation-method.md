...
# <a name="set-up-fixed-assets-with-user-defined-depreciation-methods" />Slik definerer du aktiva med brukerdefinerte avskrivningsmetoder
...
## <a name="to-assign-a-depreciation-book-to-a-fixed-asset-with-a-user-defined-depreciation-method" />Slik tilordner du et avskrivningstablå til et aktivum med en brukerdefinert avskrivningsmetode
...
## <a name="to-set-up-user-defined-depreciation-methods" />Slik definerer du brukerdefinerte avskrivningsmetoder
...
### <a name="depreciation-based-on-number-of-units" />Avskrivning etter antall enheter
...
### <a name="example---user-defined-depreciation" />Eksempel – brukerdefinert avskrivning
