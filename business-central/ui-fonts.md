...
ms.author: edupont
---
# <a name="available-fonts"></a><a name="available-fonts"></a>Tilgjengelige skrifter
...
## <a name="document-fonts"></a><a name="document-fonts"></a>Dokumentskrifter
...
## <a name="fonts-for-checks"></a><a name="fonts-for-checks"></a>Skrifter for sjekker
...
## <a name="fonts-for-barcodes"></a><a name="fonts-for-barcodes"></a>Skrifter for strekkoder
