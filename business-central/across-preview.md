...
Du kan registrere deg for en gratis prøveversjon [her](https://go.microsoft.com/fwlink/?linkid=847861). Det anbefales at du arbeider med [en videresalgspartner](across-faq.md#findpartner) for å hjelpe organisasjonen med å komme i gang med [!INCLUDE[prodshort](includes/prodshort.md)].  
...
### <a name="setting-up-your-company-in-prodshort"></a>Sette opp selskapet ditt i [!INCLUDE[prodshort](includes/prodshort.md)]
...
Siden **Assistert oppsett** kan inneholde andre oppføringer. Når du går gjennom et oppsett, merkes konfigurasjonen som **Fullført**. Du kan definere flere områder i selskapet ved hjelp av manuelt oppsett. Hvis du vil ha mer informasjon, kan du se [Definere [!INCLUDE[d365fin](includes/d365fin_md.md)]](setup.md).  

### <a name="resetting-your-prodshort-trial-experience"></a>Tilbakestille [!INCLUDE[prodshort](includes/prodshort.md)]-prøveversjonsopplevelsen
