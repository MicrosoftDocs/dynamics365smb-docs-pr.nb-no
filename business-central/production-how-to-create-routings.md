...
ms.author: edupont
---
# <a name="create-routings"></a><a name="create-routings"></a>Opprette ruter
...
## <a name="to-create-a-routing"></a><a name="to-create-a-routing"></a>Slik oppretter du en rute
...
## <a name="to-create-routing-links"></a><a name="to-create-routing-links"></a>Slik oppretter du rutekoblinger
...
## <a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations"></a><a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations"></a>Slik tilordner du personellet, verktøyene og kvalitetsmålene til ruteoperasjoner
...
## <a name="to-create-a-new-versions-of-a-routing"></a><a name="to-create-a-new-versions-of-a-routing"></a>Slik oppretter du en ny versjon av en rute
