...
ms.author: edupont
---
# <a name="create-routings" />Opprette ruter
...
## <a name="to-create-a-routing" />Slik oppretter du en rute
...
## <a name="to-create-routing-links" />Slik oppretter du rutekoblinger
...
## <a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations" />Slik tilordner du personellet, verktøyene og kvalitetsmålene til ruteoperasjoner
...
## <a name="to-create-a-new-versions-of-a-routing" />Slik oppretter du en ny versjon av en rute
