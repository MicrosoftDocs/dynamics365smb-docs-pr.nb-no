...
# <a name="the-sales-and-inventory-forecast-extension" />Utvidelsen Salgs- og lagerprognose
...
## <a name="setting-up-forecasting" />Sette opp prognoser
...
## <a name="use-the-forecasts" />Bruk prognosene
...
## <a name="a-nameanchortext-acreate-and-use-your-own-predictive-web-service-for-sales-and-inventory-forecasts" /><a name="AnchorText"> </a>Opprette og bruke din egen forutsigbare webtjeneste for salgs- og lagerprognose
...
## <a name="see-related-microsoft-trainingtrainingmodulesuse-sales-inventory-forecast-extension" />Se relatert [Microsoft-opplæring](/training/modules/use-sales-inventory-forecast-extension/)
