...
I denne artikkelen får du grunnleggende informasjon om hvordan du viser Power BI-rapporter, inkludert målstyringer, i [!INCLUDE [prod_short](includes/prod_short.md)].
...
#### <a name="from--on-premises"></a>Fra [!INCLUDE [prod_short](includes/prod_short.md)] lokalt

Tilkoblingen til Power BI fra [!INCLUDE [prod_short](includes/prod_short.md)] er lignende den i Online. Du kan imidlertid bli bedt om, på siden **TILLATELSER FOR MICROSOFT ENTRA-TJENESTEN**, om gi tillatelse til Power BI-tjenester. Du gir tilgang ved å velge **Autoriser Azure-tjenester** og deretter **Godta**.
