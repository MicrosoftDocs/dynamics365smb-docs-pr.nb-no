...
ms.author: jswymer
---
# <a name="work-with-power-bi-reports-in-"></a><a name="work-with-power-bi-reports-in-"></a><a name="work-with-power-bi-reports-in-"></a>Arbeid med Power BI-rapporter i [!INCLUDE [prod_short](includes/prod_short.md)]
...
### <a name="sign-up-power-bi"></a><a name="sign-up-power-bi"></a><a name="sign-up-power-bi"></a>Registrer deg for Power BI
...
## <a name="connect-to-power-bi---one-time-only"></a><a name="connect-to-power-bi---one-time-only"></a><a name="connect-to-power-bi---one-time-only"></a><a name="connect"></a>Koble til Power BI – bare én gang
...
#### <a name="from--on-premises"></a><a name="from--on-premises"></a><a name="from--on-premises"></a>Fra [!INCLUDE [prod_short](includes/prod_short.md)] lokalt
...
## <a name="work-with-power-bi-reports"></a><a name="work-with-power-bi-reports"></a><a name="work-with-power-bi-reports"></a>Arbeid med Power BI-rapporter
...
### <a name="switch-reports"></a><a name="switch-reports"></a><a name="switch-reports"></a>Bytte rapporter
...
### <a name="manage-and-modify-reports"></a><a name="manage-and-modify-reports"></a><a name="manage-and-modify-reports"></a>Behandle og endre rapporter
...
### <a name="upload-reports"></a><a name="upload-reports"></a><a name="upload-reports"></a><a name="upload"></a>Laste opp rapporter
...
### <a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a><a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a><a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a>Melding: Det finnes ingen aktiverte rapporter. Klikk Velg rapport for å se en liste over rapporter du kan vise.
...
#### <a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a><a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a><a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a>Du kan ikke se en rapport på Velg rapport-siden på en listeside
