...
ms.author: jswymer
---
# <a name="managing-database-access-intent"></a><a name="managing-database-access-intent"></a>Administrere databasetilgangsformål
...
## <a name="to-change-the-database-access-intent"></a><a name="to-change-the-database-access-intent"></a>Slik endrer du databasetilgangsformålet
