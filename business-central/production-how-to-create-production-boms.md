...
ms.author: bholtorf
---
# <a name="create-production-boms" />Opprette produksjonsstykklister
...
## <a name="to-create-a-production-bom" />Slik oppretter du en produksjonsstykkliste
...
## <a name="to-create-a-new-version-of-a-production-bom" />Slik oppretter du en ny versjon av en produksjonsstykkliste
...
## <a name="quantity-calculation-formula-on-production-boms" />Formelen for beregning av antallet på produksjonsstykklister
