...
---
# <a name="work-with-general-journals" />Arbeid med finanskladder
...
## <a name="use-journal-templates-and-batches" />Bruk kladder og kladdemaler
...
### <a name="validating-general-journal-batches" />Validere finanskladder
...
## <a name="understanding-main-accounts-and-balancing-accounts" />Forstå hovedkontoer og motkontoer
...
## <a name="work-with-recurring-journals" />Arbeid med gjentakelseskladder
...
### <a name="recurring-method-field" />Feltet Gjentakelsesprinsipp
...
### <a name="recurring-frequency-field" />Feltet Gjentakelsesintervall
...
### <a name="expiration-date-field" />Feltet Utløpsdato/-klokkeslett
...
### <a name="allocating-recurring-journal-amounts-to-several-accounts" />Fordele gjentakelseskladden til flere kontoer
...
#### <a name="example-allocating-rent-payments-to-different-departments" />Eksempel: Fordele leiebetalinger til ulike avdelinger
...
### <a name="calculate-the-reversal-date" />Beregn tilbakeføringsdatoen
...
## <a name="work-with-standard-journals" />Arbeid med standardkladder
...
### <a name="to-save-a-standard-journal" />Slik lagrer du som standardkladd
...
### <a name="to-reuse-a-standard-journal" />Bruke en standardkladd på nytt
...
## <a name="to-renumber-document-numbers-in-journals" />Nummerere bilagsnumre i kladder på nytt
...
### <a name="to-renumber-documents-in-journals" />Slik nummererer du dokumentnumre i kladder på nytt
...
## <a name="see-related-microsoft-trainingtrainingpathsuse-journals-dynamics-365-business-central" />Se relatert [Microsoft-opplæring](/training/paths/use-journals-dynamics-365-business-central/)
