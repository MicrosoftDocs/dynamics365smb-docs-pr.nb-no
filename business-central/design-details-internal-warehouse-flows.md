...
---
# <a name="flows-for-production-assembly-and-jobs" />Flyter for produksjon, montering og prosjekter
...
## <a name="overview-of-different-configuration-options" />Oversikt over ulike konfigurasjonsalternativer
...
### <a name="inbound-flow-put-away" />Inngående flyt (plassering)
...
### <a name="outbound-flow-pick" />Utgående flyt (plukk)
...
## <a name="warehouses-without-dedicated-warehouse-activity" />Lagre uten fast lageraktivitet
...
## <a name="basic-warehouse-configuration" />Enkelt lageroppsett
...
### <a name="flows-to-and-from-production-in-a-basic-warehouse-configuration" />Flyter til og fra produksjon i et enkelt lageroppsett
...
### <a name="flows-to-and-from-assembly-in-a-basic-warehouse-configuration" />Flyter til og fra montering i et enkelt lageroppsett
...
### <a name="flows-for-project-management-in-a-basic-warehouse-configuration" />Flyter for prosjektstyring i et enkelt lageroppsett
...
### <a name="flows-to-and-from-production-in-advanced-warehouse-configurations" />Flyter til og fra produksjon i avanserte lageroppsett
...
### <a name="flows-to-and-from-assembly-in-advanced-warehouse-configurations" />Flyter til og fra montering i avanserte lageroppsett
...
### <a name="flows-to-project-management-in-advanced-warehouse-configurations" />Flyter til prosjektstyring i avanserte lageroppsett
