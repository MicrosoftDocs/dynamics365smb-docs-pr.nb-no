...
ms.author: edupont
---
# <a name="design-details-reservation-order-tracking-and-action-messaging"></a><a name="design-details-reservation-order-tracking-and-action-messaging"></a>Designdetaljer: Reservasjon, ordresporing og handlingsmeldinger
...
## <a name="reservation"></a><a name="reservation"></a>Reservasjon
...
### <a name="offsetting-in-reservations"></a><a name="offsetting-in-reservations"></a>Forskyvning i reservasjoner
...
### <a name="manual-reservation"></a><a name="manual-reservation"></a>Manuell reservasjon
...
### <a name="automatic-reservations"></a><a name="automatic-reservations"></a>Automatiske reservasjoner
...
## <a name="order-tracking"></a><a name="order-tracking"></a>Sporing
...
### <a name="the-order-network"></a><a name="the-order-network"></a>Ordrenettverket
...
### <a name="offsetting-in-order-tracking"></a><a name="offsetting-in-order-tracking"></a>Forskyvning i ordresporing
...
### <a name="example-order-tracking-in-sales-production-and-transfers"></a><a name="example-order-tracking-in-sales-production-and-transfers"></a>Eksempel: Sporing i salg, produksjon og overføringer
...
### <a name="entry-numbers-8-and-9"></a><a name="entry-numbers-8-and-9"></a>Løpenummer 8 og 9
...
### <a name="entry-numbers-10"></a><a name="entry-numbers-10"></a>Løpenummer 10
...
### <a name="entry-numbers-8-and-9-1"></a><a name="entry-numbers-8-and-9-1"></a>Løpenummer 8 og 9
...
### <a name="entry-numbers-12-to-16"></a><a name="entry-numbers-12-to-16"></a>Løpenummer 12 til 16
...
### <a name="entry-numbers-21-and-22"></a><a name="entry-numbers-21-and-22"></a>Løpenummer 21 og 22
...
## <a name="action-messaging"></a><a name="action-messaging"></a>Handlingsmeldingssystem
...
## <a name="order-tracking-and-planning"></a><a name="order-tracking-and-planning"></a>Sporing og planlegging
...
### <a name="planning-system-versus-order-tracking-and-action-messaging"></a><a name="planning-system-versus-order-tracking-and-action-messaging"></a>Planleggingssystemet kontra sporing og handlingsmeldinger
