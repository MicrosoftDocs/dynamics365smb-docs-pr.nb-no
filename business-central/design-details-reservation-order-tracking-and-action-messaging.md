...
ms.author: edupont
---
# <a name="design-details-reservation-order-tracking-and-action-messaging" />Designdetaljer: Reservasjon, ordresporing og handlingsmeldinger
...
## <a name="reservation" />Reservasjon
...
### <a name="offsetting-in-reservations" />Forskyvning i reservasjoner
...
### <a name="manual-reservation" />Manuell reservasjon
...
### <a name="automatic-reservations" />Automatiske reservasjoner
...
### <a name="the-order-network" />Ordrenettverket
...
### <a name="offsetting-in-order-tracking" />Forskyvning i ordresporing
...
### <a name="example-order-tracking-in-sales-production-and-transfers" />Eksempel: Sporing i salg, produksjon og overføringer
...
## <a name="action-messaging" />Handlingsmeldingssystem
...
## <a name="order-tracking-and-planning" />Sporing og planlegging
...
### <a name="planning-system-versus-order-tracking-and-action-messaging" />Planleggingssystemet kontra sporing og handlingsmeldinger
