...
ms.author: edupont
---
# <a name="reconcile-payments-that-cannot-be-applied-automatically" />Avstemme betalinger som ikke kan utlignes automatisk
...
## <a name="to-reconcile-payments-that-cannot-be-applied-automatically" />Avstemme betalinger som ikke kan utlignes automatisk
