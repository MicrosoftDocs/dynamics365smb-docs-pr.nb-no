...
ms.author: edupont
---
# <a name="publish-a-web-service" />Publisere en webtjeneste
...
## <a name="creating-and-publishing-a-web-service" />Opprette og publisere en webtjeneste

De følgende trinnene forklarer hvordan du oppretter og publiserer en webtjeneste.  

### <a name="to-create-and-publish-a-web-service" />Slik oppretter og publiserer du en webtjeneste
...
### <a name="to-verify-the-availability-of-a-web-service" />Slik kontrollerer du tilgjengeligheten til en webtjeneste
