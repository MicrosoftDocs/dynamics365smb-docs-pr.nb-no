...
ms.author: bholtorf
---
# <a name="define-retention-policies"></a><a name="define-retention-policies"></a>Definere oppbevaringspolicyer
...
## <a name="required-setups-and-permissions"></a><a name="required-setups-and-permissions"></a>Nødvendige konfigurasjoner og tillatelser
...
### <a name="to-create-retention-periods"></a><a name="to-create-retention-periods"></a>Slik oppretter du oppbevaringsperioder
...
### <a name="set-up-a-retention-policy"></a><a name="set-up-a-retention-policy"></a>Definere en oppbevaringspolicy
...
## <a name="applying-retention-policies"></a><a name="applying-retention-policies"></a>Bruke oppbevaringspolicyer
...
## <a name="viewing-retention-policy-log-entries"></a><a name="viewing-retention-policy-log-entries"></a>Vise loggoppføringer for oppbevaringspolicy
...
## <a name="including-your-extension-in-a-retention-policy-requires-help-from-a-developer"></a><a name="including-your-extension-in-a-retention-policy-requires-help-from-a-developer"></a>Inkludere utvidelsen i en oppbevaringspolicy (krever hjelp fra en utvikler)
