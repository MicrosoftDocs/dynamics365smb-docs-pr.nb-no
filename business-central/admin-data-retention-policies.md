...
ms.author: bholtorf
---
# <a name="define-retention-policies" />Definere oppbevaringspolicyer
...
## <a name="required-setups-and-permissions" />Nødvendige konfigurasjoner og tillatelser
...
### <a name="to-create-retention-periods" />Slik oppretter du oppbevaringsperioder
...
### <a name="set-up-a-retention-policy" />Definere en oppbevaringspolicy
...
## <a name="applying-retention-policies" />Bruke oppbevaringspolicyer
...
## <a name="viewing-retention-policy-log-entries" />Vise loggoppføringer for oppbevaringspolicy
...
## <a name="including-your-extension-in-a-retention-policy-requires-help-from-a-developer" />Inkludere utvidelsen i en oppbevaringspolicy (krever hjelp fra en utvikler)
