...
---
# <a name="the-service-declaration-extension" />Tjenesteerklæringsutvidelsen
...
## <a name="enable-the-service-declaration-extension" />Aktiver tjenesteerklæringsutvidelsen
...
## <a name="set-up-the-service-declaration-extension" />Konfigurer tjenesteerklæringsutvidelsen

Du kan konfigurere utvidelsen manuelt eller ved å bruke en rapporteringsfil i datautvekslingsdefinisjoner.

### <a name="to-set-up-service-declaration-manually" />Slik konfigurerer du tjenesteerklæring manuelt
...
## <a name="create-new-service-declaration" />Opprett ny tjenesteerklæring
...
## <a name="modify-a-service-declaration" />Endre en tjenesteerklæring
...
## <a name="overview-the-service-declaration-lines" />Oversikt over tjenesteerklæringslinjene
...
## <a name="report-service-declaration-in-a-file" />Rapporter tjenesteerklæring i en fil
...
## <a name="other-considerations" />Andre hensyn
...
### <a name="using-services-in-document-lines" />Bruk av tjenester i dokumentlinjer
