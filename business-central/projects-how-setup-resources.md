...
ms.author: edupont
---
# <a name="set-up-resources-for-projects"></a><a name="set-up-resources-for-projects"></a>Definer ressurser for prosjekter
...
## <a name="to-set-up-a-resource"></a><a name="to-set-up-a-resource"></a>Slik konfigurerer du en ressurs
...
## <a name="to-set-up-a-resource-group"></a><a name="to-set-up-a-resource-group"></a>Slik definerer du en ressursgruppe
...
## <a name="to-set-capacity-for-a-resource"></a><a name="to-set-capacity-for-a-resource"></a>Angi kapasiteten til en ressurs
...
## <a name="to-set-up-alternate-resource-costs"></a><a name="to-set-up-alternate-resource-costs"></a>Slik definerer du alternative ressurskostpriser
...
## <a name="to-set-up-alternate-resource-prices"></a><a name="to-set-up-alternate-resource-prices"></a>Slik definerer du alternative ressurspriser
