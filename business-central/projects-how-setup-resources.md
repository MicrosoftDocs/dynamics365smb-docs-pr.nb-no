...
ms.author: edupont
---
# <a name="set-up-resources-for-projects" />Definer ressurser for prosjekter
...
## <a name="to-set-up-a-resource" />Slik konfigurerer du en ressurs
...
## <a name="to-set-up-a-resource-group" />Slik definerer du en ressursgruppe
...
## <a name="to-set-capacity-for-a-resource" />Angi kapasiteten til en ressurs
...
## <a name="to-set-up-alternate-resource-costs" />Slik definerer du alternative ressurskostpriser
...
## <a name="to-set-up-alternate-resource-prices" />Slik definerer du alternative ressurspriser
