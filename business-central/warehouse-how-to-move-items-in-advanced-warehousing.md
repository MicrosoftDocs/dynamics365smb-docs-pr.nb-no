...
3. Angi bruker-ID-en når du begynner å arbeide med en plassering, om nødvendig.  
  ...
  > [!NOTE]  
  > Linjer sorteres i stigende rekkefølge etter det valgte kriteriet. Hvis du sorterer etter dokument, utføres sorteringen først etter dokumenttype basert på opplistingen **Kildedokument for lageraktivitet**. Hvis du sorterer etter levering, gjøres sorteringen etter måltype basert på feltet **Lagermåltype**.
