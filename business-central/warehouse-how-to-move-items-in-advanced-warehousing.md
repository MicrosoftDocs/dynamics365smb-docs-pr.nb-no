...
# <a name="move-items-in-advanced-warehouse-configurations-that-use-directed-put-away-and-pick" />Flytt varer i avanserte lageroppsett som bruker lagerstyring
...
## <a name="warehouse-movement-worksheet" />Lagerflytteforslag

### <a name="to-move-items-with-the-warehouse-movement-worksheet" />Flytte varer med lagerflytteforslaget
...
### <a name="to-register-the-warehouse-movement" />Slik registrerer du lagerflyttingen
...
## <a name="internal-pick" />Internt plukk

### <a name="to-create-an-internal-pick" />Opprette en intern plukking
...
### <a name="to-register-the-warehouse-pick" />Slik registrerer du lagerplukk
...
## <a name="internal-put-away" />Intern plassering

### <a name="to-create-an-internal-put-away" />Opprette en intern plassering
...
### <a name="to-register-the-warehouse-put-away" />Slik registrerer du lagerplasseringen
...
## <a name="to-register-a-movement-that-has-already-happened" />Slik registrerer du en flytting som allerede har skjedd
