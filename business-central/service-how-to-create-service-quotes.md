...
ms.author: edupont
---
# <a name="create-service-quotes"></a><a name="create-service-quotes"></a><a name="create-service-quotes"></a>Opprette servicetilbud
...
## <a name="to-create-a-service-quote"></a><a name="to-create-a-service-quote"></a><a name="to-create-a-service-quote"></a>Slik oppretter du et servicetilbud
