...
---
# <a name="transfer-inventory-between-locations" />Overføre beholdning mellom lokasjoner
...
## <a name="transfer-orders" />Overføringsordrer
...
## <a name="item-reclassification-journals" />Varereklassifiseringskladder
...
## <a name="to-transfer-items-with-a-transfer-order" />Slik overfører du varer med en overføringsordre
...
### <a name="post-multiple-transfer-orders-in-a-batch" />Bokfør flere overføringsordrer samtidig
...
### <a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch" />Planlegg en jobbkøoppføring for å bokføre flere dokumenter samtidig
...
## <a name="to-transfer-items-with-the-item-reclassification-journal" />Slik overfører du varer med varereklassifiseringskladden
...
## <a name="undo-a-transfer-shipment" />Angre en overføringslevering
