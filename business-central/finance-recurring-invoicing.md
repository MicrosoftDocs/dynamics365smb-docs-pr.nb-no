...
ms.author: andreipa
---
# <a name="work-with-recurring-revenue-in-"></a><a name="work-with-recurring-revenue-in-"></a><a name="work-with-recurring-revenue-in-"></a>Arbeide med gjentakelsesomsetning i [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="register-revenue-with-a-recurring-general-journal"></a><a name="register-revenue-with-a-recurring-general-journal"></a><a name="register-revenue-with-a-recurring-general-journal"></a>Registrere omsetning med en gjentakende finanskladd
...
### <a name="why-use-this-option"></a><a name="why-use-this-option"></a><a name="why-use-this-option"></a>Hvorfor bruke dette alternativet
...
## <a name="create-multiple-invoices-based-on-a-recurring-job-journal"></a><a name="create-multiple-invoices-based-on-a-recurring-job-journal"></a><a name="create-multiple-invoices-based-on-a-recurring-job-journal"></a>Opprette flere fakturaer basert på en gjentakende prosjektkladd
...
### <a name="why-use-this-option-1"></a><a name="why-use-this-option-1"></a><a name="why-use-this-option-1"></a>Hvorfor bruke dette alternativet
...
## <a name="create-multiple-invoices-based-on-recurring-sales-lines"></a><a name="create-multiple-invoices-based-on-recurring-sales-lines"></a><a name="create-multiple-invoices-based-on-recurring-sales-lines"></a>Opprette flere fakturaer basert på gjentakende salgslinjer
...
### <a name="why-use-this-option-2"></a><a name="why-use-this-option-2"></a><a name="why-use-this-option-2"></a>Hvorfor bruke dette alternativet
...
## <a name="recurring-invoices-with-service-contract"></a><a name="recurring-invoices-with-service-contract"></a><a name="recurring-invoices-with-service-contract"></a>Gjentakende fakturaer med servicekontrakt
...
### <a name="why-use-this-option-3"></a><a name="why-use-this-option-3"></a><a name="why-use-this-option-3"></a>Hvorfor bruke dette alternativet
...
## <a name="related-features"></a><a name="related-features"></a><a name="related-features"></a>Relaterte funksjoner
Det finnes flere relaterte funksjoner i [!INCLUDE[prod_short](includes/prod_short.md)].

### <a name="blanket-sales-orders"></a><a name="blanket-sales-orders"></a><a name="blanket-sales-orders"></a>Rammeordrer
...
#### <a name="why-use-this-option-4"></a><a name="why-use-this-option-4"></a><a name="why-use-this-option-4"></a>Hvorfor bruke dette alternativet
...
### <a name="recurring-orders-norway"></a><a name="recurring-orders-norway"></a><a name="recurring-orders-norway"></a>Gjentakelsesordrer (Norge)
...
#### <a name="why-use-this-option-5"></a><a name="why-use-this-option-5"></a><a name="why-use-this-option-5"></a>Hvorfor bruke dette alternativet
...
### <a name="recurring-revenue-and-subscription-billing-by-other-providers"></a><a name="recurring-revenue-and-subscription-billing-by-other-providers"></a><a name="recurring-revenue-and-subscription-billing-by-other-providers"></a>Gjentakelsesomsetning og abonnementsfakturering av andre leverandører
