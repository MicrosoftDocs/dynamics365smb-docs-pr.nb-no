...
ms.author: edupont
---
# <a name="convert-service-contracts-that-include-vat-amounts" />Konvertere servicekontrakter som inkluderer mva-beløp
...
### <a name="to-correct-an-invoice-for-a-prepaid-service-contract" />Slik retter du opp en faktura for en forhåndsbetalt servicekontrakt:
...
### <a name="to-create-a-credit-memo-for-vat-difference" />Slik oppretter du en kreditnota for mva-differanse:
...
### <a name="to-create-contract-expiration-dates-in-contract-lines" />Slik oppretter du kontraktutløpsdatoer i kontraktlinjer:
...
### <a name="to-create-a-new-credit-memo" />Slik oppretter du en ny kreditnota
