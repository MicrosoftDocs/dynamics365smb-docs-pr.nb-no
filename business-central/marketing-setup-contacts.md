...
ms.author: edupont
---
# <a name="set-up-contacts" />Definere kontakter
...
## <a name="to-assign-industry-groups-to-a-contact" />Tilordne bransjegrupper til en kontakt
...
## <a name="to-assign-mailing-groups-to-a-contact" />Slik tilordner du postgrupper til en kontakt
...
## <a name="to-define-a-contacts-alternate-address" />Slik definerer du en kontakts alternative adresse
...
## <a name="to-assign-job-responsibilities-to-a-contact" />Slik tilordner du ansvarsområder til en kontakt
...
## <a name="to-assign-organizational-levels-to-a-contact" />Slik tilordner du organisasjonsnivåer til en kontakt
...
## <a name="to-assign-web-sources-to-a-contact" />Slik tilordner du webkilder til en kontakt
...
## <a name="to-assign-business-relations-to-a-contact" />Tilordne forretningsforbindelser til en kontakt
...
## <a name="automatically-copying-specific-information-from-contact-companies-to-contact-persons" />Automatisk kopiere spesifikk informasjon fra kontaktselskapene til kontaktpersonene
...
## <a name="use-predefined-defaults-on-new-contacts" />Bruk forhåndsdefinerte standarder på nye kontakter
...
## <a name="synchronizing-contacts-with-customers-vendors-and-bank-accounts" />Synkronisere kontakter med kunder, leverandører og bankkonti
...
## <a name="searching-for-duplicate-contacts" />Søke etter duplikatkontakter
