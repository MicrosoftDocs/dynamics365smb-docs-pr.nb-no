...
# <a name="the-vat-group-management-extension-for-the-united-kingdom" />Utvidelsen for mva-gruppestyring for Storbritannia
...
## <a name="forming-a-vat-group" />Danne en mva-gruppe
...
### <a name="license-requirements" />Lisenskrav
...
## <a name="set-up-a-vat-group" />Konfigurer en mva-gruppe
...
### <a name="azure-active-directory-setup-for-group-members" />Azure Active Directory-konfigurasjon for gruppemedlemmer
...
### <a name="group-api-setup" />API-oppsett for gruppe
...
## <a name="set-up-vat-group-members" />Konfigurer mva-gruppemedlemmer
...
### <a name="vat-group-representative-uses-business-central-online" />Mva-grupperepresentanten bruker Business Central Online
...
### <a name="vat-group-representative-uses-business-central-on-premises" />Mva-grupperepresentanten bruker Business Central On-Premises
...
## <a name="set-up-the-vat-group-representative" />Konfigurer mva-grupperepresentanten
...
## <a name="use-the-vat-group-management-features" />Bruk funksjonene for mva-gruppestyring
...
### <a name="review-vat-member-submissions" />Se gjennom mva-medlemssendinger
...
### <a name="create-a-group-vat-return" />Opprett en omsetningsoppgave for gruppe
