...
# <a name="building-power-bi-reports-to-display--data"></a><a name="building-power-bi-reports-to-display--data"></a><a name="building-power-bi-reports-to-display--data"></a>Bygge Power BI-rapporter for å vise [!INCLUDE [prod_long](includes/prod_long.md)]-data
...
## <a name="add--as-a-data-source-in-power-bi-desktop"></a><a name="add--as-a-data-source-in-power-bi-desktop"></a><a name="add--as-a-data-source-in-power-bi-desktop"></a><a name="getdata"></a>Legge til [!INCLUDE[prod_short](includes/prod_short.md)] som en datakilde i Power BI Desktop
...
## <a name="creating-accessible-reports"></a><a name="creating-accessible-reports"></a><a name="creating-accessible-reports"></a>Opprette tilgjengelige rapporter
...
## <a name="creating-reports-to-display-data-associated-with-a-list"></a><a name="creating-reports-to-display-data-associated-with-a-list"></a><a name="creating-reports-to-display-data-associated-with-a-list"></a>Opprette rapporter for å vise data tilknyttet en liste
...
## <a name="using-the--report-theme-optional"></a><a name="using-the--report-theme-optional"></a><a name="using-the--report-theme-optional"></a><a name="theme"></a>Bruke [!INCLUDE [prod_short](includes/prod_short.md)]-rapporttemaet (valgfritt)
...
### <a name="download-the-theme"></a><a name="download-the-theme"></a><a name="download-the-theme"></a>Laste ned temaet
...
### <a name="import-the-theme-on-a-report"></a><a name="import-the-theme-on-a-report"></a><a name="import-the-theme-on-a-report"></a>Importere temaet i en rapport
...
## <a name="publish-reports"></a><a name="publish-reports"></a><a name="publish-reports"></a>Publisere rapporter
...
### <a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page"></a><a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page"></a><a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page"></a>«Kan ikke sette inn en post. Nåværende tilkoblingshensikt er skrivebeskyttet.» feil under tilkobling til egendefinert API-side
