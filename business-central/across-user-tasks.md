...
ms.author: edupont
---
# <a name="define-user-tasks"></a><a name="define-user-tasks"></a>Definere brukeroppgaver
...
## <a name="managing-user-tasks"></a><a name="managing-user-tasks"></a>Administrere brukeroppgaver
...
### <a name="picking-up-user-tasks"></a><a name="picking-up-user-tasks"></a>Plukke opp brukeroppgaver
...
### <a name="deleting-user-tasks"></a><a name="deleting-user-tasks"></a>Slett brukeroppgaver
