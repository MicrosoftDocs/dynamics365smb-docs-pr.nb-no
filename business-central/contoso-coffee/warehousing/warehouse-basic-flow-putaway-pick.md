...
# Gjennomgang av inngående og utgående flyt i grunnleggende lageroppsett
...
5. Endre lagerplasseringen basert på faktisk plassering av varer, og bokfør dokument
    ...
    2.  Angi 20 i feltet **Ant. som skal håndt.** på lagerplasseringslinjen med vare WRB-1000.  
    ...
    4. Fyll ut hyllekoder for varen WRB-1001:

    |Element|Hyllekode|Antall|  
    |----------|-------------------|--------------|  
    |WRB-1001|S-1-03|20|  
    |WRB-1001|S-1-04|10|
...
## Utgående flyt: Plukking og levering i grunnleggende lageroppsett
