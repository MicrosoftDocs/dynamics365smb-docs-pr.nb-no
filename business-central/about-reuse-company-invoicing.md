...
ms.author: bholtorf
---
# <a name="use-the-same-microsoft-365-account-in--and-microsoft-invoicing"></a><a name="use-the-same-microsoft-365-account-in--and-microsoft-invoicing"></a>Bruk samme Microsoft 365-konto i [!INCLUDE[prod_short](includes/prod_long.md)] og Microsoft Invoicing
...
### <a name="to-rename-your-company"></a><a name="to-rename-your-company"></a>Slik endrer du navn på selskapet
...
### <a name="what-about-my-data"></a><a name="what-about-my-data"></a>Hva med dataene mine?
