...
ms.author: edupont
---
# <a name="manage-job-supplies" />Administrere prosjektforsyninger
...
## <a name="to-purchase-items-or-services-for-a-job" />Slik kjøper du varer eller tjenester for et prosjekt
...
## <a name="to-view-the-value-of-purchases-for-a-job" />Slik viser du verdien av kjøp for et prosjekt
...
## <a name="to-post-a-job-related-expense" />Slik bokfører du en prosjektrelatert utgift
