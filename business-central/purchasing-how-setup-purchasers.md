...
ms.author: edupont
---
# <a name="set-up-purchasers"></a><a name="set-up-purchasers"></a><a name="set-up-purchasers"></a>Definere innkjøpere
...
## <a name="to-set-up-purchasers"></a><a name="to-set-up-purchasers"></a><a name="to-set-up-purchasers"></a>Slik definerer du innkjøpere
...
## <a name="to-assign-purchasers-to-vendors"></a><a name="to-assign-purchasers-to-vendors"></a><a name="to-assign-purchasers-to-vendors"></a>Tilordne innkjøpere til leverandører
