...
ms.author: edupont
---
# <a name="work-with-"></a><a name="work-with-"></a>Arbeid med [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="tips-and-tricks"></a><a name="tips-and-tricks"></a><a name="cheatsheet"></a>Tips og triks
...
## <a name="links-to-learn-more"></a><a name="links-to-learn-more"></a>Koblinger til Finn ut mer
...
## <a name="getting-around-in-business-central"></a><a name="getting-around-in-business-central"></a>Navigere i Business Central
Her er en kort video om hvordan du navigerer i [!INCLUDE[prod_short](includes/prod_short.md)].

> [!VIDEO https://www.youtube.com/embed/zqz03iMihx0]

## <a name="choosing-a-desktop-browser"></a><a name="choosing-a-desktop-browser"></a>Velge en skrivebordsleser
...
## <a name="action-bars"></a><a name="action-bars"></a>Handlingsfelter
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/paths/work-pro-data-dynamics-365-business-central/)
