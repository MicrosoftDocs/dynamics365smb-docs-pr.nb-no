...
# <a name="business-central-for-multi-site-and-international-organizations"></a><a name="business-central-for-multi-site-and-international-organizations"></a>Business Central for organisasjoner med flere lokasjoner og internasjonale organisasjoner
...
## <a name="integrating-the-headquarter-company-and-the-sites"></a><a name="integrating-the-headquarter-company-and-the-sites"></a>Integrering av moderselskapet og lokasjonene
...
## <a name="meet-the-needs-of-domestic-and-international-sites"></a><a name="meet-the-needs-of-domestic-and-international-sites"></a>Oppfylle behovene til innenlandske og internasjonale lokasjoner
...
## <a name="consolidate-financial-data"></a><a name="consolidate-financial-data"></a>Konsolidere økonomiske data
...
## <a name="share-business-insight-with-integrated-analytics"></a><a name="share-business-insight-with-integrated-analytics"></a>Dele forretningsinnsikt med integrert analyse
...
## <a name="exchange-data-using-apis-and-xmlports"></a><a name="exchange-data-using-apis-and-xmlports"></a>Utveksle data ved hjelp av API-er og XMLport-er
...
## <a name="promote-an-efficient-intercompany-supply-chain"></a><a name="promote-an-efficient-intercompany-supply-chain"></a>Fremme en effektiv konsernintern forsyningskjede
...
## <a name="respond-quickly-to-new-business-conditions"></a><a name="respond-quickly-to-new-business-conditions"></a>Reagere raskt på nye forretningsforhold
