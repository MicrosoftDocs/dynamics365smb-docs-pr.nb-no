...
## <a name="integrating-the-headquarter-company-and-the-sites"></a>Integrering av moderselskapet og lokasjonene
...
* Når det gjelder nettversjoner, finnes det flere enn [40 lokaliserte lands-/områdeversjoner](/dynamics365/business-central/dev-itpro/compliance/apptest-countries-and-translations?toc=/dynamics365/business-central/toc.json) som du kan installere som utvidelser fra Microsoft AppSource.  
* Når det gjelder lokale versjoner, er [lands-/områdeversjoner](/azure/architecture/solution-ideas/articles/business-central) tilgjengelige som Microsoft-lokaliserte versjoner eller partnerledede tilleggslokaliseringer.
...
## <a name="consolidate-financial-data"></a>Konsolidere økonomiske data
...
## <a name="share-business-insight-with-integrated-analytics"></a>Dele forretningsinnsikt med integrert analyse
...
| **Forretningsbehov** | **Hvordan Business Central støtter det** | **Finn ut mer** |
|-------------------------|-------------------------|-------------------------|
| Del innsikt med lokasjoner uten omfattende IT-støtte. | Opprett KPI-er og instrumentbord for forretningsanalyse i Power BI basert på dataene. | [Koble deg til Power BI fra Business Central lokalt](across-working-with-business-central-in-powerbi.md) |
...
## <a name="exchange-data-using-apis-and-xmlports"></a>Utveksle data ved hjelp av API-er og XMLport-er
...
## <a name="respond-quickly-to-new-business-conditions"></a>Reagere raskt på nye forretningsforhold
