...
## Komme i gang med [!INCLUDE[prod_short](includes/cds_long_md.md)]
...
## Standard og egendefinerteenheter
...
## Se relatert [Microsoft-opplæring](/training/modules/use-model-driven-apps-common-data-service/)
