...
---
# <a name="create-workflows-to-connect-tasks-in-business-processes" />Opprett arbeidsflyter for å koble til oppgaver i forretningsprosesser
...
## <a name="to-create-a-workflow" />Slik oppretter du en arbeidsflyt:
...
## <a name="example-of-creating-a-new-workflow-using-existing-events" />Eksempel på oppretting av ny arbeidsflyt ved bruk av eksisterende hendelser
