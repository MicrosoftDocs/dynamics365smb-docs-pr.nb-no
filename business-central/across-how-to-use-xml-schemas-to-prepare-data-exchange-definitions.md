...
ms.author: edupont
---
# <a name="use-xml-schemas-to-prepare-data-exchange-definitions" />Bruke XML-skjemaer til å klargjøre datautvekslingsdefinisjoner
...
## <a name="to-load-an-xml-schema-file" />Slik laster du inn en XML-skjemafil:
...
### <a name="to-select-or-clear-nodes-in-an-xml-schema" />Slik velger eller fjerner du noder i et XML-skjema:
...
### <a name="to-generate-a-data-exchange-definition-that-is-based-on-an-xml-schema" />Slik genererer du en datautvekslingsdefinisjon som er basert på et XML-skjema:
