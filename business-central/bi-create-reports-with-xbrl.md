...
ms.author: edupont
---
# <a name="create-reports-with-xbrl" />Opprette rapporter med XBRL
...
## <a name="xbrl-comprises-the-following-components" />XBRL består av følgende komponenter
...
## <a name="layered-taxonomies" />Lagdeling av taksonomier
...
## <a name="linkbases" />Koblingsbaser
...
## <a name="set-up-xbrl-lines" />Konfigurer XBRL-linjer
...
## <a name="import-an-xbrl-taxonomy" />Importere en XBRL-taksonomi
...
## <a name="update-an-xbrl-taxonomy" />Oppdatere en XBRL-taksonomi
...
## <a name="see-related-training-at-microsoft-learnlearnmodulesxbrl-reports-dynamics-365-business-centralindex" />Se relatert opplæring på [Microsoft Learn](/learn/modules/xbrl-reports-dynamics-365-business-central/index).
