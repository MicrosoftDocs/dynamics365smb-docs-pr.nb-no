...
ms.author: edupont
---
# <a name="create-reports-with-xbrl"></a><a name="create-reports-with-xbrl"></a><a name="create-reports-with-xbrl"></a>Opprette rapporter med XBRL
...
## <a name="xbrl-comprises-the-following-components"></a><a name="xbrl-comprises-the-following-components"></a><a name="xbrl-comprises-the-following-components"></a>XBRL består av følgende komponenter
...
## <a name="layered-taxonomies"></a><a name="layered-taxonomies"></a><a name="layered-taxonomies"></a>Lagdeling av taksonomier
...
## <a name="linkbases"></a><a name="linkbases"></a><a name="linkbases"></a>Koblingsbaser
...
## <a name="set-up-xbrl-lines"></a><a name="set-up-xbrl-lines"></a><a name="set-up-xbrl-lines"></a>Konfigurer XBRL-linjer
...
## <a name="import-an-xbrl-taxonomy"></a><a name="import-an-xbrl-taxonomy"></a><a name="import-an-xbrl-taxonomy"></a>Importere en XBRL-taksonomi
...
## <a name="update-an-xbrl-taxonomy"></a><a name="update-an-xbrl-taxonomy"></a><a name="update-an-xbrl-taxonomy"></a>Oppdatere en XBRL-taksonomi
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Se relatert opplæring på [Microsoft Learn](/learn/modules/xbrl-reports-dynamics-365-business-central/index).
