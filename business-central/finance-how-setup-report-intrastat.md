...
description: Denne artikkelen forklarer hvordan du konfigurerer Intrastat-rapporteringsfunksjoner for å rapportere handel med selskaper i andre EU-land/-områder.
author: altotovi
ms.author: altotovi
...
---
# <a name="set-up-intrastat-reporting"></a>Definer Intrastat-rapportering
...
Intrastat-rapportering er basert på standard EU-forskrifter som gjelder for alle land/områder. Det er imidlertid forskjeller i de enkelte landene/områdene. Hvert land/område har regler om hva og hvordan det skal rapporteres.

> [!NOTE]
> Intrastat-informasjon gjelder ikke flytting av tjenester mellom land/områder. Informasjonen gjelder i stedet bare varer som varer og aktiva. Hvis den lokale regjeringen krever at du registrerer flytting av tjenester mellom land/områder, kan du bruke funksjonen **Tjenestedeklarasjon**.
>
> Denne funksjonen er tilgjengelig som en app du kan laste ned fra [AppSource](https://go.microsoft.com/fwlink/?linkid=2081646). Hvis du vil bruke denne funksjonen, må du installere den på siden **Administrasjon av utvidelse**.
...
1. Velg ikonet :::image type="icon" source="media/ui-search/search_small.png" border="false":::, angi **Funksjonsstyring**, og velg deretter den relaterte koblingen.
...
6. Når oppsettet er fullført, velger du **Fullfør** for å begynne å bruke den nye Intrastat-opplevelsen.
    ...
    > [!NOTE]
    > Avhengig av selskapets lokasjon er det nok å aktivere funksjonen beskrevet tidligere. For land/områder som har bestemte funksjoner for Intrastat-rapportering, må du aktivere den land-/områdespesifikke Intrastat-appen i tillegg til kjerneutvidelsen.
...
2. På hurtigfanen **Generelt** velger eller angir du feltinformasjon etter behov. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)] Tabellen nedenfor beskriver noen av nøkkelfeltene.
   ...
   | **Inkluder direkte leveringer** | Angir om transaksjoner for direkte levering er inkludert i Intrastat-rapporter. Hvis du vil ha mer informasjon, kan du se [Arbeid med Intrastat-rapportering](finance-how-report-intrastat.md).  |  
...
4. På hurtigfanen **Standardtransaksjoner** velger eller angir du feltinformasjon etter behov. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)] Tabellen nedenfor beskriver noen av nøkkelfeltene.
...
5. På hurtigfanen **Rapportering** velger eller angir du feltinformasjonen etter behov. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)] Tabellen nedenfor beskriver noen av nøkkelfeltene.
...
6. På hurtigfanen **Nummerering** angir du verdien i feltet **Intrastat-numre**.
...
> [!NOTE]
> [!INCLUDE[prod_long](includes/prod_long.md)] inneholder den forhåndskonfigurerte datautvekslingsdefinisjonen for Intrastat for alle lokaliserte land/områder. Hvis du vil finne ut mer om hvordan du oppretter en ny datautvekslingsdefinisjon, kan du se [Definer datautvekslingsdefinisjoner](across-how-to-set-up-data-exchange-definitions.md).
...
I noen land/områder krever skattemyndighetene at Intrastat-rapporter for eksempel må inkludere leveringsmåten for kjøp eller andre verdier ved salg over en viss grense.
...
>
> Vær forsiktig når du definerer valideringsregler ettersom de kan være forskjellige mellom land/områder.
...
| **Kode for opprinnelsesland** | Bruk de to bokstavers ISO alfa-kodene på elementet eller aktivakortet for landet/området der varen ble anskaffet eller produsert. Hvis varen ble produsert i mer enn ett land, er opprinnelseslandet/-området det siste landet/området der det ble behandlet betraktelig. |
...
* **Inn-/utpunkt**: Angi lokasjonene der du leverer eller mottar varer til eller fra andre land/områder. En flyplass er et eksempel på et inn-/utpunkt. Du angir inn-/utpunkt på hurtigfanen **Utenrikshandel** i salgs- og kjøpsdokumenter. Denne informasjonen kopieres fra varepostene når du oppretter Intrastat-kladden.
...
#### <a name="set-up-fixed-assets-for-intrastat"></a>Definer aktiva for Intrastat
...
#### <a name="set-up-vendors-for-intrastat"></a>Konfigurer leverandører for Intrastat
...
#### <a name="set-up-customers-for-intrastat"></a>Konfigurer kunder for Intrastat
...
Hvis det er en grunn til å utelate en bestemt vare eller et aktivum fra Intrastat-rapportering, endrer du alternativet på kortet ved å merke feltet **Ekskluder fra Intrastat-rapport**. Bruk dette feltet på kortet **Varemal** til å opprette flere varer som er utelatt fra Intrastat-rapporteringen. 
...
#### <a name="set-up-tariff-numbers"></a>Konfigurer tariffnumre
