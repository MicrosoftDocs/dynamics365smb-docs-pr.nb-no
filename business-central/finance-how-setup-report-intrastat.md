...
---
# <a name="set-up-intrastat-reporting" />Definer Intrastat-rapportering
...
## <a name="enable-the-new-intrastat-experience" />Aktivere den nye Intrastat-opplevelsen
...
## <a name="intrastat-configuration" />Intrastat-konfigurasjon

Før du kan bruke Intrastat-rapporter er det flere konfigurasjoner som må defineres.

### <a name="intrastat-reporting-setup" />Intrastat-rapporteringsoppsett
...
### <a name="set-mandatory-fields-with-the-intrastat-report-checklist" />Angi obligatoriske felt med sjekklisten for Intrastat-rapport
...
## <a name="use-custom-codeunits-in-intrastat-reporting" />Bruke egendefinerte codeunits i Intrastat-rapportering
...
## <a name="other-intrastat-configurations" />Andre Intrastat-konfigurasjoner
...
#### <a name="set-up-transport-methods" />Definere transportmåter
...
#### <a name="set-up-transaction-nature-codes" />Definere transaksjonskoder
...
### <a name="other-related-configurations" />Andre relaterte konfigurasjoner
...
#### <a name="set-up-fixed-assets-for-intrastat" />Definer aktiva for Intrastat
...
#### <a name="set-up-vendors-for-intrastat" />Konfigurer leverandører for Intrastat
...
#### <a name="set-up-customers-for-intrastat" />Konfigurer kunder for Intrastat
...
#### <a name="exclude-items-and-fixed-assets-from-intrastat-reporting" />Utelate varer og aktiva fra Intrastat-rapportering
...
##### <a name="exclude-an-item-from-intrastat-reporting" />Utelate en vare fra Intrastat-rapportering

1. Velg ikonet ![Lyspære som åpner funksjonen Fortell meg.](media/ui-search/search_small.png "Fortell hva du vil gjøre") og angi **Varer** og velg den relaterte koblingen.
2. Velg varen du vil konfigurere, og merk av for **Utelat fra Intrastat-rapportering** på hurtigfanen **Kostnad og bokføring**.

##### <a name="exclude-a-fixed-asset-from-intrastat-reporting" />Utelate et aktiva fra Intrastat-rapportering

1. Velg ikonet ![Lyspære som åpner funksjonen Fortell meg.](media/ui-search/search_small.png "Fortell hva du vil gjøre") og angi **Aktiva**, og velg deretter den relaterte koblingen.
2. Velg aktivaet du vil konfigurere.
3. Utvid hurtigfanen **Intrastat**, og merk av for **Utelat fra Intrastat-rapport**.

#### <a name="set-up-tariff-numbers" />Konfigurer tariffnumre
...
## <a name="enter-country-specific-intrastat-settings" />Angi landsspesifikke Intrastat-innstillinger
...
### <a name="czech-republic" />Den tsjekkiske republikk
