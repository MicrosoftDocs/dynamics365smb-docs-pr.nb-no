...
# <a name="setting-up-troubleshooting-for-service-items" />Definere feilsøking av servicevarer
...
## <a name="to-set-up-troubleshooting-guidelines" />Slik definerer du retningslinjer for feilsøking
...
## <a name="to-assign-troubleshooting-guidelines-to-items-service-items-or-service-item-groups" />Tilordne retningslinjer for feilsøking til varer, servicevarer eller servicevaregrupper.
