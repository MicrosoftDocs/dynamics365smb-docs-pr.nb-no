...
ms.author: edupont
---
# <a name="specify-posting-periods"></a><a name="specify-posting-periods"></a>Angi bokføringsperioder

Bruk bokføringsperioder til å angi når brukere kan postere til finans.  

## <a name="to-specify-posting-periods"></a><a name="to-specify-posting-periods"></a>Slik angir du bokføringsperioder
