...
## <a name="table-480-dimension-set-entry"></a><a name="table-480-dimension-set-entry"></a>Tabell 480, Dimensjonssettpost
...
## <a name="table-481-dimension-set-tree-node"></a><a name="table-481-dimension-set-tree-node"></a>Tabell 481, Trenode for dimensjonssett
...
## <a name="table-482-reclas-dimension-set-buffer"></a><a name="table-482-reclas-dimension-set-buffer"></a>Tabell 482 Reklass. dimensjonssettbuffer
...
## <a name="transaction-and-budget-tables"></a><a name="transaction-and-budget-tables"></a>Transaksjons- og budsjettabeller
...
### <a name="table-83-item-journal-line"></a><a name="table-83-item-journal-line"></a>Tabell 83, Varekladdlinje
...
### <a name="table-349-dimension-value"></a><a name="table-349-dimension-value"></a>Tabell 349, Dimensjonsverdi
I tillegg til andre dimensjonsfelt i denne tabellen er disse feltene viktige:  
...
### <a name="tables-that-contain-the-dimension-set-id-field"></a><a name="tables-that-contain-the-dimension-set-id-field"></a>Tabeller som inneholder Dimensjonssett-ID-feltet
