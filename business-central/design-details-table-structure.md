...
## <a name="transaction-and-budget-tables" />Transaksjons- og budsjettabeller
...
### <a name="tables-that-contain-the-dimension-set-id-field" />Tabeller som inneholder Dimensjonssett-ID-feltet
