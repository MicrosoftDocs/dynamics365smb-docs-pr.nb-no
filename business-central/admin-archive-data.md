...
# <a name="the-data-archive-extension"></a><a name="the-data-archive-extension"></a>Dataarkiv-utvidelsen
...
## <a name="start-archiving-data"></a><a name="start-archiving-data"></a>Start arkivering av data
...
## <a name="storage-considerations"></a><a name="storage-considerations"></a>Lagringshensyn
