...
ms.author: edupont
---
# <a name="flush-components-according-to-operation-output"></a><a name="flush-components-according-to-operation-output"></a>Lagertrekke komponenter i henhold til operasjonsavgang
...
## <a name="automatic-consumption-posting-flushing-methods"></a><a name="automatic-consumption-posting-flushing-methods"></a>Metoder for automatisk forbruksbokføring (lagertrekk)
...
### <a name="automatic-reporting---forward-flush-the-entire-order"></a><a name="automatic-reporting---forward-flush-the-entire-order"></a>Automatisk rapportering - lagertrekk fremover for hele ordren
...
### <a name="automatic-reporting---forward-flushing-by-operation"></a><a name="automatic-reporting---forward-flushing-by-operation"></a>Automatisk rapportering - lagertrekk fremover etter operasjon
...
### <a name="automatic-reporting---back-flushing-by-operation"></a><a name="automatic-reporting---back-flushing-by-operation"></a>Automatisk rapportering - lagertrekk bakover etter operasjon
...
### <a name="automatic-reporting---back-flushing-the-entire-order"></a><a name="automatic-reporting---back-flushing-the-entire-order"></a>Automatisk rapportering - lagertrekk bakover for hele ordren
...
## <a name="to-flush-components-according-to-operation-output"></a><a name="to-flush-components-according-to-operation-output"></a>Slik utfører du lagertrekk i henhold til operasjonsavgang:
...
## <a name="flushing-methods"></a><a name="flushing-methods"></a>Trekkmetoder
