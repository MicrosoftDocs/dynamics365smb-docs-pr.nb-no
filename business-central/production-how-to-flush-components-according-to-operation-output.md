...
ms.author: edupont
---
# <a name="flush-components-according-to-operation-output" />Lagertrekke komponenter i henhold til operasjonsavgang
...
## <a name="automatic-consumption-posting-flushing-methods" />Metoder for automatisk forbruksbokføring (lagertrekk)
...
### <a name="automatic-reporting---forward-flush-the-entire-order" />Automatisk rapportering - lagertrekk fremover for hele ordren
...
### <a name="automatic-reporting---forward-flushing-by-operation" />Automatisk rapportering - lagertrekk fremover etter operasjon
...
### <a name="automatic-reporting---back-flushing-by-operation" />Automatisk rapportering - lagertrekk bakover etter operasjon
...
### <a name="automatic-reporting---back-flushing-the-entire-order" />Automatisk rapportering - lagertrekk bakover for hele ordren
...
## <a name="to-flush-components-according-to-operation-output" />Slik utfører du lagertrekk i henhold til operasjonsavgang:
...
## <a name="flushing-methods" />Trekkmetoder
