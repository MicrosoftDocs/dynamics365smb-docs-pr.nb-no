...
ms.author: edupont
---
# <a name="legacy-create-and-modify-custom-report-layouts"></a><a name="legacy-create-and-modify-custom-report-layouts"></a>(Eldre) Opprette og endre et egendefinert rapportoppsett
...
## <a name="create-a-custom-layout"></a><a name="create-a-custom-layout"></a>Opprett et egendefinert oppsett
...
## <a name="modifying-a-custom-layout"></a><a name="modifying-a-custom-layout"></a><a name="ModifyCustomLayout"></a>Endre et egendefinert oppsett
...
### <a name="modify-a-custom-layout"></a><a name="modify-a-custom-layout"></a>Endre et egendefinert oppsett
