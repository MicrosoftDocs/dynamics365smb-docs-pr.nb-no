...
ms.author: jswymer
---
# <a name="use-the-include-prodshortincludesprodshortmd-apps-in-power-bi" />Bruk [!INCLUDE [prod_short](includes/prod_short.md)]-appene i Power BI
...
## <a name="connect-the-includeprodshortincludesprodshortmd-app-to-your-data" />Koble [!INCLUDE[prod_short](includes/prod_short.md)]-appen til dataene dine
...
### <a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display" />Melding: Det finnes ingen aktiverte rapporter. Klikk på Velg rapport for å se en liste over rapporter du kan vise.
...
### <a name="you-need-a-power-bi-pro-license-to-install-the-includeprodshortincludesprodshortmd-app-in-power-bi" />Du trenger en Power BI Pro-lisens for å installere [!INCLUDE[prod_short](includes/prod_short.md)]-appen i Power BI
...
### <a name="parameter-validation-failed-please-make-sure-all-parameters-are-valid" />"Parametervalidering mislyktes, du må kontrollere at alle parametrene er gyldige"
...
### <a name="message-your-data-source-cant-be-refreshed-because-the-credentials-are-invalid-please-update-your-credentials-and-try-again" />Melding: Datakilden kan ikke oppdateres fordi legitimasjonen er ugyldig. Oppdater legitimasjonen, og prøv på nytt.
...
### <a name="incorrect-company-name" />Feil selskapsnavn
...
### <a name="the-key-didnt-match-any-rows-in-the-table" />Nøkkelen samsvarer ikke med noen rader i tabellen
...
### <a name="historical-data-appears-to-be-missing" />Historisk data ser ut til å mangle
...
### <a name="i-only-see-data-for-a-single-company" />Jeg ser bare data for ett selskap
