...
ms.author: jswymer
---
# <a name="use-the--apps-in-power-bi"></a><a name="use-the--apps-in-power-bi"></a><a name="use-the--apps-in-power-bi"></a>Bruk [!INCLUDE [prod_short](includes/prod_short.md)]-appene i Power BI
...
## <a name="connect-the--app-to-your-data"></a><a name="connect-the--app-to-your-data"></a><a name="connect-the--app-to-your-data"></a>Koble [!INCLUDE[prod_short](includes/prod_short.md)]-appen til dataene dine
...
## <a name="fixing-problems"></a><a name="fixing-problems"></a><a name="fixing-problems"></a>Løse problemer
...
### <a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a><a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a><a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a>Melding: Det finnes ingen aktiverte rapporter. Klikk på Velg rapport for å se en liste over rapporter du kan vise.
...
### <a name="you-need-a-power-bi-pro-license-to-install-the--app-in-power-bi"></a><a name="you-need-a-power-bi-pro-license-to-install-the--app-in-power-bi"></a><a name="you-need-a-power-bi-pro-license-to-install-the--app-in-power-bi"></a>Du trenger en Power BI Pro-lisens for å installere [!INCLUDE[prod_short](includes/prod_short.md)]-appen i Power BI
...
### <a name="incorrect-company-name"></a><a name="incorrect-company-name"></a><a name="incorrect-company-name"></a>Feil selskapsnavn
...
### <a name="the-key-didnt-match-any-rows-in-the-table"></a><a name="the-key-didnt-match-any-rows-in-the-table"></a><a name="the-key-didnt-match-any-rows-in-the-table"></a>Nøkkelen samsvarer ikke med noen rader i tabellen
...
### <a name="historical-data-appears-to-be-missing"></a><a name="historical-data-appears-to-be-missing"></a><a name="historical-data-appears-to-be-missing"></a>Historisk data ser ut til å mangle
...
### <a name="i-only-see-data-for-a-single-company"></a><a name="i-only-see-data-for-a-single-company"></a><a name="i-only-see-data-for-a-single-company"></a>Jeg ser bare data for ett selskap
...
### <a name="what-now"></a><a name="what-now"></a><a name="what-now"></a>Hva nå?
