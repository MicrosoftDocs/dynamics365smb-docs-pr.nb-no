...
ms.author: jswymer
---
# <a name="use-the--apps-in-power-bi"></a>Bruk [!INCLUDE [prod_short](includes/prod_short.md)]-appene i Power BI
...
2. Velg **Apper** i navigasjonsruten.
    
    **Apper**-siden vises.

3. På **Apper**-siden velger du **Hent apper** øverst til høyre på siden.
    
    **Power BI-apper** åpnes, der du kan søke etter appene som er tilgjengelige for [!INCLUDE[prod_short](includes/prod_short.md)].

    ![Naviger til Hent apper.](./media/across-how-to-connect-powerbi-d365-content-packs/powerbi-get-data.png)

> [!TIP] 
> Du kan også få tilgang til **Power BI-rapporter** fra [!INCLUDE [prod_short](includes/prod_short.md)] Naviger til Power BI-rapportdelen og **Velg rapporter** på startsiden. Velg **Tjenester** eller **Min organisasjon** fra **Hent rapporter**. Organisasjonsgalleriet i Power BI eller Microsoft AppSource åpnes, og viser bare apper relater til [!INCLUDE[prod_short](includes/prod_short.md)].

5. Skriv inn **Dynamics 365 Business Central** i **Søk**-boksen.
6. Velg appen du vil bruke, velg **Få det nå** og deretter **Installer**.  

    Når installasjonen er fullført, er appen tilgjengelig fra **Apper** på navigasjonsmenyen i Power BI.

## <a name="connect-the--app-to-your-data"></a>Koble [!INCLUDE[prod_short](includes/prod_short.md)]-appen til dataene dine
...
### <a name="message-there-are-no-enabled-reports-select-report-to-see-a-list-of-reports-that-you-can-display"></a>Melding: Det finnes ingen aktiverte rapporter. Klikk rapporten for å se en liste over rapporter du kan vise.
...
### <a name="you-need-a-power-bi-pro-license-to-install-the--app-in-power-bi"></a>Du trenger en Power BI Pro-lisens for å installere [!INCLUDE[prod_short](includes/prod_short.md)]-appen i Power BI
