...
ms.author: edupont
---
# <a name="work-with-manufacturing-batch-units-of-measure" />Arbeide med produksjonsbunkeenhet
...
## <a name="to-create-a-production-bom-using-a-batch-unit-of-measure" />Slik oppretter du en produksjonsstykkliste ved å bruke en produksjonsbunkeenhet
...
## <a name="to-calculate-a-manufacturing-batch-unit-of-measure-on-a-production-order" />Slik beregner du en produksjonsbunkeenhet i en produksjonsordre
