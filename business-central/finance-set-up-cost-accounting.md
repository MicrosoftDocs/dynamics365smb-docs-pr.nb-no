...
ms.author: edupont
---
# <a name="setting-up-cost-accounting"></a><a name="setting-up-cost-accounting"></a>Definere kostregnskap

Før du begynner å arbeide med kostregnskap, må du utføre konfigurasjonsprosedyrer.

## <a name="balances-between-cost-type-cost-center-and-cost-object"></a><a name="balances-between-cost-type-cost-center-and-cost-object"></a>Balanser mellom kosttype, kostsenter og kostobjekt
...
## <a name="setting-up-cost-types"></a><a name="setting-up-cost-types"></a>Definere kosttyper
...
### <a name="to-transfer-the-general-ledger-chart-of-accounts-to-the-chart-of-cost-types"></a><a name="to-transfer-the-general-ledger-chart-of-accounts-to-the-chart-of-cost-types"></a>Slik overfører du finanskontoplanen til diagrammet med kosttyper:
...
### <a name="to-set-up-new-cost-types-in-the-chart-of-cost-types-page"></a><a name="to-set-up-new-cost-types-in-the-chart-of-cost-types-page"></a>Slik definerer du nye kosttyper på siden Diagram med kosttyper:
...
### <a name="to-update-cost-types"></a><a name="to-update-cost-types"></a>Slik oppdaterer du kosttyper:
...
## <a name="defining-the-relationship-between-cost-types-and-general-ledger-accounts"></a><a name="defining-the-relationship-between-cost-types-and-general-ledger-accounts"></a>Definere forholdet mellom kostnadstyper og finanskontoer
...
### <a name="relationship-between-general-ledger-accounts-and-cost-types"></a><a name="relationship-between-general-ledger-accounts-and-cost-types"></a>Forhold mellom finanskontoer og kostnadstyper
...
### <a name="cost-types-without-a-relationship-to-the-general-ledger"></a><a name="cost-types-without-a-relationship-to-the-general-ledger"></a>Kosttyper uten en relasjon til finans
...
## <a name="setting-up-cost-centers"></a><a name="setting-up-cost-centers"></a>Definere kostsentre
...
### <a name="to-transfer-dimension-values-in-the-general-ledger-to-the-chart-of-cost-centers"></a><a name="to-transfer-dimension-values-in-the-general-ledger-to-the-chart-of-cost-centers"></a>Slik overfører du dimensjonsverdier i finans til diagrammet med kostsentre:
...
### <a name="to-create-new-cost-centers-in-the-chart-of-cost-centers-page"></a><a name="to-create-new-cost-centers-in-the-chart-of-cost-centers-page"></a>Slik oppretter du nye kostsentre på siden Diagram med kostsentre:
...
## <a name="setting-up-cost-objects"></a><a name="setting-up-cost-objects"></a>Definere kostobjekter
...
### <a name="to-transfer-dimension-values-from-the-general-ledger-to-the-chart-of-cost-objects"></a><a name="to-transfer-dimension-values-from-the-general-ledger-to-the-chart-of-cost-objects"></a>Slik overfører du dimensjonsverdier fra finans til diagrammet med kostobjekter:
...
### <a name="to-create-new-cost-objects-in-the-chart-of-cost-objects-page"></a><a name="to-create-new-cost-objects-in-the-chart-of-cost-objects-page"></a>Slik oppretter du nye kostobjekter på siden Diagram med kostobjekter:
...
## <a name="defining-cost-centers-and-cost-objects-for-chart-of-accounts"></a><a name="defining-cost-centers-and-cost-objects-for-chart-of-accounts"></a>Definere kostsentre og kostobjekter for kontoplanen
...
### <a name="defining-default-dimension-values-for-general-ledger-accounts"></a><a name="defining-default-dimension-values-for-general-ledger-accounts"></a>Definere standard dimensjonsverdier for finanskontoer
...
### <a name="defining-dimension-values-for-overhead-costs-and-direct-costs"></a><a name="defining-dimension-values-for-overhead-costs-and-direct-costs"></a>Definere dimensjonsverdier for indirekte kostnader og direkte kostnader
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/modules/cost-accounting-dynamics-365-business-central/)
