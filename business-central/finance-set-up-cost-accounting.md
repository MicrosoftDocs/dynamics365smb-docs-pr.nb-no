...
Du kan velge **Handlinger** > **Funksjoner** > **Oppdater kostregnskapsdimensjoner** for å oppdatere kostregnskapdimensjoner.
1. Velg ikonet ![Lyspære som åpner funksjonen Fortell meg 2.](media/ui-search/search_small.png "Fortell hva du vil gjøre") og angi **Diagram med kostsentre** og velg deretter den relaterte koblingen.  
1. I fanebladet **Handlinger**, under **Funksjoner** velger du **Hent kostsentre fra dimensjon** for å overføre dimensjonsverdier til kostsenterdiagrammet. Funksjonen overfører dimensjonsverdiene som du definerte i trinn 1.  
