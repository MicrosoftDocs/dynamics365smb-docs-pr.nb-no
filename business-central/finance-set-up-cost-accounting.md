...
ms.author: edupont
---
# <a name="setting-up-cost-accounting" />Definere kostregnskap

Før du begynner å arbeide med kostregnskap, må du utføre konfigurasjonsprosedyrer.

## <a name="balances-between-cost-type-cost-center-and-cost-object" />Balanser mellom kosttype, kostsenter og kostobjekt
...
## <a name="setting-up-cost-types" />Definere kosttyper
...
### <a name="to-transfer-the-general-ledger-chart-of-accounts-to-the-chart-of-cost-types" />Slik overfører du finanskontoplanen til diagrammet med kosttyper:
...
### <a name="to-set-up-new-cost-types-in-the-chart-of-cost-types-page" />Slik definerer du nye kosttyper på siden Diagram med kosttyper:
...
### <a name="to-update-cost-types" />Slik oppdaterer du kosttyper:
...
## <a name="defining-the-relationship-between-cost-types-and-general-ledger-accounts" />Definere forholdet mellom kostnadstyper og finanskontoer
...
### <a name="relationship-between-general-ledger-accounts-and-cost-types" />Forhold mellom finanskontoer og kostnadstyper
...
### <a name="cost-types-without-a-relationship-to-the-general-ledger" />Kosttyper uten en relasjon til finans
...
## <a name="setting-up-cost-centers" />Definere kostsentre
...
### <a name="to-transfer-dimension-values-in-the-general-ledger-to-the-chart-of-cost-centers" />Slik overfører du dimensjonsverdier i finans til diagrammet med kostsentre:
...
### <a name="to-create-new-cost-centers-in-the-chart-of-cost-centers-page" />Slik oppretter du nye kostsentre på siden Diagram med kostsentre:
...
## <a name="setting-up-cost-objects" />Definere kostobjekter
...
### <a name="to-transfer-dimension-values-from-the-general-ledger-to-the-chart-of-cost-objects" />Slik overfører du dimensjonsverdier fra finans til diagrammet med kostobjekter:
...
### <a name="to-create-new-cost-objects-in-the-chart-of-cost-objects-page" />Slik oppretter du nye kostobjekter på siden Diagram med kostobjekter:
...
## <a name="defining-cost-centers-and-cost-objects-for-chart-of-accounts" />Definere kostsentre og kostobjekter for kontoplanen
...
### <a name="defining-default-dimension-values-for-general-ledger-accounts" />Definere standard dimensjonsverdier for finanskontoer
...
### <a name="defining-dimension-values-for-overhead-costs-and-direct-costs" />Definere dimensjonsverdier for indirekte kostnader og direkte kostnader
...
## <a name="see-related-microsoft-training" />Se relatert [Microsoft-opplæring](/training/modules/cost-accounting-dynamics-365-business-central/)
