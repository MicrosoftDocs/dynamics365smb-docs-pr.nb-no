...
# <a name="viewing-service-statistics"></a><a name="viewing-service-statistics"></a>Vise servicestatistikk
...
## <a name="viewing-statistics-for-service-orders"></a><a name="viewing-statistics-for-service-orders"></a>Vise statistikk for serviceordrer
...
### <a name="view-totals-for-a-service-order"></a><a name="view-totals-for-a-service-order"></a>Vise totaler for en serviceordre
...
### <a name="view-shipping-information"></a><a name="view-shipping-information"></a>Vise leveringsopplysninger
...
### <a name="view-order-details"></a><a name="view-order-details"></a>Vise ordredetaljer
...
### <a name="analyze-service-order-lines"></a><a name="analyze-service-order-lines"></a>Analysere serviceordrelinjer
...
### <a name="view-customer-information"></a><a name="view-customer-information"></a>Vise kundeopplysninger
Se saldoen på kundens konto samt den maksimale kreditten som kan tilstås kunden du har opprettet servicedokumentet for.

## <a name="viewing-service-item-statistics"></a><a name="viewing-service-item-statistics"></a>Vise servicevarestatistikk
...
## <a name="use-trendscapes"></a><a name="use-trendscapes"></a>Bruk Trendscapes
...
## <a name="viewing-gains-and-losses-on-contracts"></a><a name="viewing-gains-and-losses-on-contracts"></a>Vise agio og disagio for kontrakter
...
## <a name="viewing-statistics-for-posted-service-documents"></a><a name="viewing-statistics-for-posted-service-documents"></a>Vise servicestatistikk for bokførte dokumenter
...
### <a name="posted-service-shipment-statistics"></a><a name="posted-service-shipment-statistics"></a>Statistikk for bokført servicefølgeseddel
...
### <a name="posted-service-invoice-statistics"></a><a name="posted-service-invoice-statistics"></a>Statistikk for bokført servicefaktura
...
### <a name="posted-service-credit-memo-statistics"></a><a name="posted-service-credit-memo-statistics"></a>Statistikk for bokført salgskreditnota (service)
