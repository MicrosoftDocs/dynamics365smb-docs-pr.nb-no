---
title: Se gjennom og utligne betalinger manuelt etter automatisk søknad
...
---
# <a name="review-and-apply-payments-manually-after-automatic-application"></a>Se gjennom og utligne betalinger manuelt etter automatisk søknad
...
Eventuelle gevinst- og tapjusteringer som kreves på grunn av valutakonverteringer, håndteres ikke automatisk av [!INCLUDE[prod_short](includes/prod_short.md)].
