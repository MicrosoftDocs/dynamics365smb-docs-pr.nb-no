...
ms.author: edupont
---
# <a name="collect-payments-with-sepa-direct-debit" />Innkreve betalinger med SEPA direct debit
...
## <a name="setting-up-sepa-direct-debit" />Definere SEPA Direct Debit
...
### <a name="to-set-up-your-bank-account-for-sepa-direct-debit" />Slik konfigurerer du din bankkonto for SEPA direct debit
...
### <a name="to-set-up-the-customers-payment-method-for-sepa-direct-debit" />Slik konfigurerer du kundens betalingsmåte for SEPA direct debit
...
#### <a name="to-set-up-the-direct-debit-mandate-that-represents-the-customer-agreement" />Slik konfigurerer du direct debit-belastningsfullmakten som representerer kundeavtalen
...
## <a name="creating-sepa-direct-debit-collection-entries-and-export-to-a-bank-file" />Opprette poster for SEPA Direct Debit-oppkreving og eksportere til en bankfil
...
### <a name="to-create-a-direct-debit-collection" />Slik oppretter du en avtalegirooppkreving
...
### <a name="to-export-a-direct-debit-collection-entry-to-a-bank-file" />Slik oppretter du en post for avtalegirosamling til en bankfil
...
### <a name="to-reject-a-direct-debit-collection-entry" />Slik avviser du poster for avtalegirosamlinger
...
### <a name="to-close-a-direct-debit-collection" />Slik lukker du en avtalegirosamling
...
## <a name="posting-sepa-direct-debit-payment-receipts" />Bokføre kvitteringer for SEPA Direct Debit
...
### <a name="to-post-a-direct-debit-payment-receipt-from-the-direct-debit-collections-page" />Slik bokfører du en kvittering for direct debit fra siden Direct Debit-samlinger
