...
# <a name="set-up-fault-reporting"></a><a name="set-up-fault-reporting"></a><a name="set-up-fault-reporting"></a>Konfigurere feilrapportering
...
## <a name="to-specify-the-overall-level-of-fault-reporting"></a><a name="to-specify-the-overall-level-of-fault-reporting"></a><a name="to-specify-the-overall-level-of-fault-reporting"></a>Angi det generelle nivået for feilrapportering
...
## <a name="to-create-fault-and-resolution-code-relationships"></a><a name="to-create-fault-and-resolution-code-relationships"></a><a name="to-create-fault-and-resolution-code-relationships"></a>Opprette relasjoner mellom feilkode og løsningskode
