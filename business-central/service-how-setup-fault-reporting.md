...
# <a name="set-up-fault-reporting" />Konfigurere feilrapportering
...
## <a name="to-specify-the-overall-level-of-fault-reporting" />Angi det generelle nivået for feilrapportering
...
## <a name="to-create-fault-and-resolution-code-relationships" />Opprette relasjoner mellom feilkode og løsningskode
