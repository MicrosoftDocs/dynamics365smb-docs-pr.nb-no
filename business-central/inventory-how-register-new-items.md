...
## <a name="to-create-a-new-item-card"></a><a name="to-create-a-new-item-card"></a>Opprette et nytt varekort
...
### <a name="to-save-the-item-card-as-a-template"></a><a name="to-save-the-item-card-as-a-template"></a>Lagre varekortet som en mal
...
### <a name="items-used-in-production-orders"></a><a name="items-used-in-production-orders"></a>Varer som brukes i produksjonsordrer
...
## <a name="to-set-up-multiple-vendors-for-an-item"></a><a name="to-set-up-multiple-vendors-for-an-item"></a>Slik definerer du flere leverandører for varer
...
## <a name="set-up-item-substitutions"></a><a name="set-up-item-substitutions"></a>Konfigurer vareerstatninger
...
### <a name="to-make-an-item-substitution"></a><a name="to-make-an-item-substitution"></a>Slik lager du en vareerstatning
...
## <a name="deleting-item-cards"></a><a name="deleting-item-cards"></a>Slette varekort
...
## <a name="manage-inventory-in-warehouses"></a><a name="manage-inventory-in-warehouses"></a>Håndtere lager på lagre
...
## <a name="planning"></a><a name="planning"></a>Planl.
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relatert [Microsoft-opplæring](/training/modules/create-items/)
