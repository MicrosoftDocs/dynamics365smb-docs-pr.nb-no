...
## <a name="to-create-a-new-item-card" />Opprette et nytt varekort
...
### <a name="to-save-the-item-card-as-a-template" />Lagre varekortet som en mal
...
### <a name="items-used-in-production-orders" />Varer som brukes i produksjonsordrer
...
## <a name="to-set-up-multiple-vendors-for-an-item" />Slik definerer du flere leverandører for varer
...
## <a name="set-up-item-substitutions" />Konfigurer vareerstatninger
...
### <a name="to-make-an-item-substitution" />Slik lager du en vareerstatning
...
## <a name="deleting-item-cards" />Slette varekort
...
## <a name="manage-inventory-in-warehouses" />Håndtere lager på lagre
