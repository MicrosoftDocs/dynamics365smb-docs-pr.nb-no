...
---
# Plukke for produksjon, montering eller jobber i avanserte lageroppsett
...
7. Velg handlingen **Opprett plukk**. Siden **Opprett plukk** åpnes, der du kan legge til mer informasjon i plukkingen.  
    ...
    |Maks Nr. plukkildedok.|Oppretter plukkdokumenter som dekker opp til det angitte antallet kildedokumenter.|
