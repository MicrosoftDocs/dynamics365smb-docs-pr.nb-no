...
---
# <a name="set-up-data-exchange-definitions"></a>Konfigurer datautvekslingsdefinisjoner
...
Vanligvis setter du opp datautvekslingsdefinisjoner på siden **Datautvekslingsdefinisjon**. Når det gjelder oppdatering av valutakurser, er det imidlertid raskere å bruke en valutakurstjeneste. Lær mer på [Oppdatere valutakurser](finance-how-update-currencies.md#set-up-a-currency-exchange-rate-service)
...
Du kan også gruppere etter et hvilket som helst felt, bruke nøkkelindeksen til å sortere resultatene og de nye transformeringstypene **Avrunding** og **Feltoppslag**.
