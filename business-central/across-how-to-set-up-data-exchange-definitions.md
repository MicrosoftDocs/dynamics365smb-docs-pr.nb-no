...
ms.author: bholtorf
---
# <a name="set-up-data-exchange-definitions" />Definere datautvekslingsdefinisjoner
...
## <a name="create-a-data-exchange-definition" />Opprette en datautvekslingsdefinisjon
...
## <a name="transformation-rules" />Transformasjonsregler
...
### <a name="tip-for-developers-example-of-the-custom-option" />Tips for utviklere: eksempel på det egendefinerte alternativet
...
## <a name="export-a-data-exchange-definition-as-an-xml-file-for-use-by-others" />Eksporter en datautvekslingsdefinisjon som en XML-fil som andre kan bruke
...
## <a name="import-an-existing-data-exchange-definition" />Importere en eksisterende datautvekslingsdefinisjon
